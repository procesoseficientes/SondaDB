...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [SONDA].[BULK_DATA_SP_IMPORT_INVENTORY]
*/
-- =============================================
CREATE PROCEDURE [SONDA].[BULK_DATA_SP_IMPORT_INVENTORY]
AS
BEGIN
	SET NOCOUNT ON;
	--
	TRUNCATE TABLE [SWIFT_EXPRESS].[SONDA].[SWIFT_INVENTORY]

	MERGE [SWIFT_EXPRESS].[SONDA].[SWIFT_INVENTORY]  SIV
	USING ( SELECT * FROM  [SWIFT_INTERFACES_ONLINE].[SONDA].[ERP_VIEW_INVENTORY] ) EVI 
	ON (
