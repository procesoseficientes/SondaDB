...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [SWIFT_INTERFACES_QA].[SONDA].[BULK_DATA_SP_IMPORT_CUSTOMER]
*/
-- =============================================
CREATE PROCEDURE [SONDA].[BULK_DATA_SP_IMPORT_CUSTOMER]
AS
BEGIN
  SET NOCOUNT ON;
  --
	TRUNCATE TABLE [SWIFT_INTERFACES_QA].[SONDA].[SWIFT_ERP_CUSTOMERS];

	MERGE [SWIFT_INTERFACES_QA].[SONDA].[SWIFT_ERP_CUSTOMERS] [TRG]
	USING
		(SELECT
				*
			FROM
				[SWIFT_INTERFACES_ONLINE_QA].[SONDA].[ERP_VIEW_COSTUMER])
		AS [SRC]
