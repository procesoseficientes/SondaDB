...
BEGIN
  SET NOCOUNT ON;
   ...
   -- ------------------------------------------------------------------------------------  
  TRUNCATE TABLE SWIFT_EXPRESS.[SONDA].SWIFT_TRADE_AGREEMENT_DISCOUNT
  TRUNCATE TABLE SWIFT_EXPRESS.[SONDA].SWIFT_TRADE_AGREEMENT_BY_CUSTOMER  
  DELETE SWIFT_EXPRESS.[SONDA].SWIFT_TRADE_AGREEMENT
  
  -- ------------------------------------------------------------------------------------
  -- Obtiene las listas descuento 
  -- ------------------------------------------------------------------------------------
  INSERT INTO SWIFT_EXPRESS.[SONDA].SWIFT_TRADE_AGREEMENT(
  ...
  -- ------------------------------------------------------------------------------------
  INSERT INTO SWIFT_EXPRESS.[SONDA].SWIFT_TRADE_AGREEMENT_BY_CUSTOMER(
    TRADE_AGREEMENT_ID
	,CODE_CUSTOMER
  )
  SELECT
  ...
  INNER JOIN SWIFT_EXPRESS.[SONDA].SWIFT_TRADE_AGREEMENT TA ON (
  ...
  --
  INSERT INTO SWIFT_EXPRESS.[SONDA].SWIFT_TRADE_AGREEMENT_DISCOUNT(
    TRADE_AGREEMENT_ID
	,CODE_SKU
	,DISCOUNT
  )
