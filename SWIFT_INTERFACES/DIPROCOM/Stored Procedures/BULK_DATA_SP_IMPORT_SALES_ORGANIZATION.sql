...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [DIPROCOM].[BULK_DATA_SP_IMPORT_SALES_ORGANIZATION]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[BULK_DATA_SP_IMPORT_SALES_ORGANIZATION]
AS
BEGIN
	SET NOCOUNT ON;
	--
	MERGE [SWIFT_EXPRESS].[DIPROCOM].[SWIFT_SALES_ORGANIZATION] SG
	USING (SELECT * FROM [SWIFT_INTERFACES_ONLINE].[DIPROCOM].[ERP_VIEW_SALES_ORGANIZATION]) AS VSG
