...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [DIPROCOM].[BULK_DATA_SP_IMPORT_SALES_OFFICE]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[BULK_DATA_SP_IMPORT_SALES_OFFICE]
AS
BEGIN
	SET NOCOUNT ON;
	--
	MERGE [SWIFT_EXPRESS].[DIPROCOM].[SWIFT_SALES_OFFICE] SO
	USING (SELECT * FROM [SWIFT_INTERFACES_ONLINE].[DIPROCOM].[ERP_VIEW_SALES_OFFICE]) AS VSO
