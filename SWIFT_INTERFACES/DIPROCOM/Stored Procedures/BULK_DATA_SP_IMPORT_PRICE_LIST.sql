...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [SWIFT_INTERFACES_QA].[DIPROCOM].[BULK_DATA_SP_IMPORT_PRICE_LIST]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[BULK_DATA_SP_IMPORT_PRICE_LIST]
AS
BEGIN
	SET NOCOUNT ON;
	--
	MERGE  [SWIFT_EXPRESS_QA].[DIPROCOM].[SWIFT_PRICE_LIST] AS [TGR]
	USING (SELECT * FROM  [SWIFT_INTERFACES_ONLINE_QA].[DIPROCOM].[ERP_PRICE_LIST]) AS [SRC] 
