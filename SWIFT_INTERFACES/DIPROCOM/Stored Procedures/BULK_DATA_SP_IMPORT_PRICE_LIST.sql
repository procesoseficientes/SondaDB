...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [SWIFT_INTERFACES_QA].[SONDA].[BULK_DATA_SP_IMPORT_PRICE_LIST]
*/
-- =============================================
...
BEGIN
	SET NOCOUNT ON;
	--
	MERGE  [SWIFT_EXPRESS_QA].[SONDA].[SWIFT_PRICE_LIST] AS [TGR]
	USING (SELECT * FROM  [SWIFT_INTERFACES_ONLINE_QA].[SONDA].[ERP_PRICE_LIST]) AS [SRC] 
