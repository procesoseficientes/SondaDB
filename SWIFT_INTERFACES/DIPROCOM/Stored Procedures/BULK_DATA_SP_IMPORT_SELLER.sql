...
BEGIN
	...
	TRUNCATE TABLE  [SWIFT_EXPRESS_QA].[SONDA].[SWIFT_SELLER]

	SET NOCOUNT ON;
	--
	MERGE [SWIFT_EXPRESS_QA].[SONDA].[SWIFT_SELLER] TRG
	USING (SELECT * FROM SWIFT_INTERFACES_ONLINE_QA.[SONDA].ERP_VIEW_SELLER) AS SRC
	ON 
