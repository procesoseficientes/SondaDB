...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [DIPROCOM].[BULK_DATA_SP_IMPORT_PROVIDER]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[BULK_DATA_SP_IMPORT_PROVIDER]
AS
BEGIN
	SET NOCOUNT ON;
	--
	MERGE DIPROCOM.SWIFT_ERP_PROVIDERS TRG
	USING (SELECT * FROM SWIFT_INTERFACES_ONLINE.DIPROCOM.ERP_VIEW_PROVIDERS) AS SRC
