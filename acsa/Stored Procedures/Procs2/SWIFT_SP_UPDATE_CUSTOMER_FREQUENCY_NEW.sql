...
-- Ejemplo de Ejecucion:				
    EXEC [acsa].SWIFT_SP_UPDATE_CUSTOMER_FREQUENCY_NEW
        @CODE_FREQUENCY = 1027
      , @SUNDAY = '0'
      , @MONDAY = '0'
      , @TUESDAY = '0'
      ...
      , @SATURDAY = '1'
      , @FREQUENCY_WEEKS = '2'
      , @LAST_UPDATED_BY = 'gerente@acsa'

*/
-- =============================================

CREATE PROCEDURE [acsa].SWIFT_SP_UPDATE_CUSTOMER_FREQUENCY_NEW (@CODE_FREQUENCY INT
, @SUNDAY VARCHAR(10)
, @MONDAY VARCHAR(10)
, @TUESDAY VARCHAR(10)
