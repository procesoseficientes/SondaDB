...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [acsa].SWIFT_SP_MERGE_CUSTOMERS_FROM_MANIFEST_LOAD_EXCEL
  @CODE_CUSTOMER = 'D001'
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_MERGE_CUSTOMERS_FROM_MANIFEST_LOAD_EXCEL] @CODE_CUSTOMER VARCHAR(50)
...
BEGIN
  ...
  BEGIN TRY
    ...
    MERGE [acsa].SWIFT_CUSTOMERS TRG
    USING (SELECT
