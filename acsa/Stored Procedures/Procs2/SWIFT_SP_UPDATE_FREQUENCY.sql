...
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_FREQUENCY]
    @ID_FREQUENCY AS INT,
...
SELECT @CODE_FREQUENCY_OLD = CODE_FREQUENCY FROM [acsa].SWIFT_FREQUENCY WHERE ID_FREQUENCY= @ID_FREQUENCY		
	...
	EXEC [acsa].[SONDA_SP_GENERATE_ROUTE_PLAN] @CODE_FREQUENCY_OLD, @CODE_FREQUENCY
	IF @@error = 0 BEGIN
