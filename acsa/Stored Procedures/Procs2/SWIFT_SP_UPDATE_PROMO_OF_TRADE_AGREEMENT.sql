...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_UPDATE_PROMO_OF_TRADE_AGREEMENT]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_PROMO_OF_TRADE_AGREEMENT] (@TRADE_AGREEMENT_ID INT
, @PROMO_ID INT
...
BEGIN
  ...
  --
  BEGIN TRY
    UPDATE [acsa].SWIFT_TRADE_AGREEMENT_BY_PROMO
