...
-- Ejemplo de Ejecucion:
        EXEC [acsa].SWIFT_SP_UPDATE_OR_DELETE_PROMO_OF_DISCOUNT_BY_PAYMENT_AND_FAMILY 
		@PROMO_ID = 0,
		@XML = NULL, 
		@LOGIN_ID = ''
*/
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_OR_DELETE_PROMO_OF_DISCOUNT_BY_PAYMENT_AND_FAMILY] (@PROMO_ID INT
, @XML XML
, @LOGIN_ID VARCHAR)
AS
BEGIN
