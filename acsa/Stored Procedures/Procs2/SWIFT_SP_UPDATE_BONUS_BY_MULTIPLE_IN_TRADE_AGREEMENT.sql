...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_UPDATE_BONUS_BY_MULTIPLE_IN_TRADE_AGREEMENT]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_BONUS_BY_MULTIPLE_IN_TRADE_AGREEMENT](
...
BEGIN
	BEGIN TRY
		UPDATE [acsa].[SWIFT_TRADE_AGREEMENT_BONUS_BY_MULTIPLE]
		SET 
