...
-- Ejemplo de Ejecucion:
				...
				--
				EXEC [acsa].[SWIFT_SP_UPDATE_DISCOUNT_BY_GENERAL_AMOUNT]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_DISCOUNT_BY_GENERAL_AMOUNT](
...
BEGIN
	BEGIN TRY
		--
		UPDATE [acsa].[SWIFT_TRADE_AGREEMENT_DISCOUNT_BY_GENERAL_AMOUNT]
		SET	
			DISCOUNT = @DISCOUNT
		WHERE 
