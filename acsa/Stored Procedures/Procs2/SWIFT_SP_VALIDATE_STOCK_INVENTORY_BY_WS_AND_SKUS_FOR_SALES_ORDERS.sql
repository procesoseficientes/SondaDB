...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_VALIDATE_STOCK_INVENTORY_BY_WS_AND_SKUS_FOR_SALES_ORDERS]
...
BEGIN
	...
	SELECT
		...
		,S.VALUE SALES_ORDER
	INTO #SALES_ORDER
	FROM [acsa].[SWIFT_FN_SPLIT](@SALES_ORDERS,@DELIMITER) S
	...
	INTO #INVENTORY
	FROM #SALES_ORDER SO
	INNER JOIN [acsa].SONDA_SALES_ORDER_DETAIL SOD ON (
