...
BEGIN
	...
	BEGIN
		...
		BEGIN TRY
			...
			INSERT INTO [acsa_SERVER].[acsa].[dbo].[REPLICA_FACTURA_ENC]
			(	
				[SERIE] ,
				[NUMERO_FACTURA] ,
				[FECHA_DE_FACTURA] ,
			...
			INSERT INTO [acsa_SERVER].SONDA.dbo.REPLICA_FACTURA_DET
			( 
				SERIE ,
				NUMERO_FACTURA ,
				PRODUCT0 ,
		...
		BEGIN CATCH
			...
			DELETE FROM [acsa_SERVER].[acsa].[dbo].[REPLICA_FACTURA_DET]
			WHERE SERIE = @SERIE AND NUMERO_FACTURA = @FACTURA

			DELETE FROM [acsa_SERVER].[acsa].[dbo].[REPLICA_FACTURA_ENC]
			WHERE SERIE = @SERIE AND NUMERO_FACTURA = @FACTURA
