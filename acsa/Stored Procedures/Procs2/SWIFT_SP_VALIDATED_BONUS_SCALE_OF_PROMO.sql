...
Ejemplo de Ejecucion:
	...
	EXEC [acsa].SWIFT_SP_VALIDATED_BONUS_SCALE_OF_PROMO
		@PROMO_ID = 21
		,@CODE_SKU = '100005'
		,@PACK_UNIT = 7
		,@LOW_LIMIT = 1
...
=======================================================*/
CREATE PROCEDURE [acsa].[SWIFT_SP_VALIDATED_BONUS_SCALE_OF_PROMO] (@PROMO_ID INT
, @CODE_SKU VARCHAR(50)
, @PACK_UNIT INT
...
BEGIN
  ...
  SELECT TOP 1
    @MESSAGE =
              ...
              END
  FROM [acsa].[SWIFT_PROMO_BONUS_BY_SCALE] AS S
