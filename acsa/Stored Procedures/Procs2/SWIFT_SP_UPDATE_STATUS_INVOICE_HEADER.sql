...
/*
	EXECUTE  [acsa].[SWIFT_SP_UPDATE_STATUS_INVOICE_HEADER] 
					   @INVOICE_ID = 195
...
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_STATUS_INVOICE_HEADER]
	@INVOICE_ID INT
...
BEGIN
	SET NOCOUNT ON;
	DECLARE @RESULT INT = [acsa].[SONDA_FN_CAN_VOID_INVOICE](@CDF_SERIE, @CDF_RESOLUCION, @INVOICE_ID)
    IF @RESULT = 1
	BEGIN
