CREATE PROCEDURE [acsa].[SWIFT_SP_INSERT_HIST_INVENTORY]
AS
  INSERT INTO [acsa].SWIFT_HIST_INVENTORY
    SELECT
      SERIAL_NUMBER
     ,WAREHOUSE
     ,LOCATION
    ...
    FROM (SELECT
      ...
      ,I.LAST_UPDATE_BY
      ,I.INVENTORY
      FROM [acsa].SWIFT_INVENTORY I) T1
    INNER JOIN (SELECT
        A.INVENTORY
