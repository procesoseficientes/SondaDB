...
/*	Ejemplo de execucion
		EXEC [acsa].SWIFT_GET_STOCK_FOR_PICKING @CODE_WAREHOUSE = 'C001'
*/
-- =============================================

CREATE PROC [acsa].[SWIFT_GET_STOCK_FOR_PICKING]
@CODE_WAREHOUSE VARCHAR(50)
AS
	SELECT *
	INTO #RESERVED
	FROM [acsa].[SWIFT_FN_GET_INVENTORY_RESERVED](@CODE_WAREHOUSE)
	--
	SELECT *
	INTO #TEMP
