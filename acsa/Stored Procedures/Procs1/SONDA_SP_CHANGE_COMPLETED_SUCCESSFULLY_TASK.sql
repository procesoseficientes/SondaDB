...
Ejemplo de Ejecucion:
	EXEC [acsa].[SONDA_SP_CHANGE_COMPLETED_SUCCESSFULLY_TASK]
		@TASK_ID = 40125
    ...
    ,@TASK_SEQ = 2
		--
		SELECT * FROM [acsa].[SWIFT_TASKS] WHERE TASK_ID = 40125
======================================================*/
CREATE PROCEDURE [acsa].[SONDA_SP_CHANGE_COMPLETED_SUCCESSFULLY_TASK] (@TASK_ID INT
