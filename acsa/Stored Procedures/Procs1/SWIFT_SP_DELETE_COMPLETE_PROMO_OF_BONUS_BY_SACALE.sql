...
-- Ejemplo de Ejecucion:
				EXEC [acsa].SWIFT_SP_DELETE_COMPLETE_PROMO_OF_BONUS_BY_SACALE
				@PROMO_ID = 2128
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_DELETE_COMPLETE_PROMO_OF_BONUS_BY_SACALE] (@PROMO_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  -- -----------------------------------------------------------------
  ...
  BEGIN TRY
    ...
    BEGIN
      ...
      -- --------------------------------------------------------------------------------
      DELETE FROM [acsa].[SWIFT_PROMO_BONUS_BY_SCALE]
      WHERE [PROMO_ID] = @PROMOTION_ID
