...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_GET_TRADE_AGREEMENT_SKU_BY_BONUS_RULE]
					@TRADE_AGREEMENT_ID = 1043
					,@COMBO_ID = 1003
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_TRADE_AGREEMENT_SKU_BY_BONUS_RULE](
...
BEGIN
	...
	INNER JOIN [acsa].[SWIFT_TRADE_AGREEMENT_SKU_BY_BONUS_RULE] [CRS] ON (
