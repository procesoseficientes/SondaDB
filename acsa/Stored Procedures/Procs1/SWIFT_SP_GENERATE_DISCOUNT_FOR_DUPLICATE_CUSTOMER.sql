...
-- Ejemplo de Ejecucion:
        EXEC [acsa].[SWIFT_SP_GENERATE_DISCOUNT_FOR_DUPLICATE_CUSTOMER]
					@CODE_ROUTE = '4'
					,@TYPE = 'GENERAL_AMOUNT'
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GENERATE_DISCOUNT_FOR_DUPLICATE_CUSTOMER] (@CODE_ROUTE VARCHAR(250)
, @TYPE VARCHAR(250))
AS
BEGIN
  SET NOCOUNT ON;
  ...
  , [ORDER])
    SELECT
     ...
     ,CASE @TYPE
      ...
      END
     ,[ORDER]
    FROM [acsa].[SWIFT_DISCOUNT_PRIORITY] [DP]
