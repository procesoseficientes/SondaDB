...
-- Ejemplo de Ejecucion:
				...
				--
				EXEC [acsa].[SWIFT_SP_DELETE_PROMO_FROM_TRADE_AGREEMENT]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_DELETE_PROMO_FROM_TRADE_AGREEMENT] (@TRADE_AGREEMENT_ID INT
, @PROMO_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  BEGIN TRY
    DELETE FROM [acsa].SWIFT_TRADE_AGREEMENT_BY_PROMO
