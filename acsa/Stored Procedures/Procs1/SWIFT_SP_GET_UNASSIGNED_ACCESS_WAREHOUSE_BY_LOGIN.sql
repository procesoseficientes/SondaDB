...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_GET_UNASSIGNED_ACCESS_WAREHOUSE_BY_LOGIN]
					@LOGIN = 'gerente@acsa'
					,@DISTRIBUTION_CENTER_ID = 1
				--
				SELECT * FROM [acsa].[SWIFT_WAREHOUSE_BY_USER_WITH_ACCESS] WHERE [USER_CORRELATIVE] = 3
				SELECT * FROM [acsa].[SWIFT_WAREHOUSE_X_DISTRIBUTION_CENTER] WHERE [DISTRIBUTION_CENTER_ID] = 1
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_UNASSIGNED_ACCESS_WAREHOUSE_BY_LOGIN](
...
BEGIN
	...
	LEFT JOIN [acsa].[SWIFT_WAREHOUSE_BY_USER_WITH_ACCESS] [WUA] ON (
