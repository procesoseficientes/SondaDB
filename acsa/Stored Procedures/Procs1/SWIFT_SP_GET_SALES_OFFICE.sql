...
-- Ejemplo de Ejecucion:
		...
		//Una en especifico
		EXEC [acsa].[SWIFT_SP_GET_SALES_OFFICE]
		@SALES_OFFICE_ID = 2
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_SALES_OFFICE](
...
BEGIN
	...
	FROM [acsa].[SWIFT_SALES_OFFICE] [SOFF]
		LEFT JOIN [acsa].[SWIFT_SALES_ORGANIZATION] [SORG] ON [SOFF].[SALES_ORGANIZATION_ID] = [SORG].[SALES_ORGANIZATION_ID]
