...
-- Ejemplo de Ejecucion:
				EXEC  [acsa].[SWIFT_SP_INSERT_ZONE] @CODE_ZONE = '2', @DESCRIPTION_ZONE = 'Zona 2'
SELECT * FROM [acsa].[SWIFT_ZONE]
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_INSERT_ZONE] (
...
BEGIN
  SET NOCOUNT ON;
	...
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [acsa].[SWIFT_ZONE] ([CODE_ZONE], [DESCRIPTION_ZONE], [LAST_UPDATED_BY], [LAST_UPDATE])
