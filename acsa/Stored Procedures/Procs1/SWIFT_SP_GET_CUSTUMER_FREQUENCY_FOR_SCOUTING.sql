...
-- Ejemplo de Ejecucion:
        EXEC [acsa].[SWIFT_SP_GET_CUSTUMER_FREQUENCY_FOR_SCOUTING] @CODE_ROUTE = 'GUA0017@ARIUM'
*/
-- =============================================
CREATE PROC [acsa].[SWIFT_SP_GET_CUSTUMER_FREQUENCY_FOR_SCOUTING]
...
BEGIN
	...
	INNER JOIN [acsa].[SWIFT_VIEW_ALL_COSTUMER] [VC] ON ([CF].[CODE_CUSTOMER] = [VC].[CODE_CUSTOMER])
