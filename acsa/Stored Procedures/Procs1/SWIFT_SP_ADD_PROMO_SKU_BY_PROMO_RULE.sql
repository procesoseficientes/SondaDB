...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_ADD_PROMO_SKU_BY_PROMO_RULE]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_ADD_PROMO_SKU_BY_PROMO_RULE](
...
BEGIN
	...
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [acsa].[SWIFT_PROMO_SKU_BY_PROMO_RULE]
				(
