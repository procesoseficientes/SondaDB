...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SONDA_SP_GET_DELIVERY_TASKS]
				@LOGIN_ID = 'ADOLFO@acsa'
*/
-- =============================================
CREATE PROCEDURE [acsa].SONDA_SP_GET_DELIVERY_TASKS (@LOGIN_ID VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  INNER JOIN [acsa].[SWIFT_VIEW_ALL_COSTUMER] AS VC
