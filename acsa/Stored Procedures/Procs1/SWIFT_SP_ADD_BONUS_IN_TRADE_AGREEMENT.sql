...
-- Ejemplo de Ejecucion:
				EXEC [acsa].SWIFT_SP_ADD_BONUS_IN_TRADE_AGREEMENT
...
*/
-- =============================================
CREATE PROCEDURE [acsa].SWIFT_SP_ADD_BONUS_IN_TRADE_AGREEMENT(
...
BEGIN
	BEGIN TRY
		...
		DECLARE @ID INT
		--
		INSERT INTO [acsa].SWIFT_TRADE_AGREEMENT_BONUS (
			TRADE_AGREEMENT_ID
			,CODE_SKU
			,PACK_UNIT
			,LOW_LIMIT
