...
Ejemplo de Ejecucion:
            ...
            EXEC [acsa].[SONDA_SP_GET_ITEM_HISTORY_BY_ROUTE]  
				@CODE_ROUTE = RUDI@acsa
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_GET_ITEM_HISTORY_BY_ROUTE] @CODE_ROUTE VARCHAR(50)
AS
BEGIN
    SET NOCOUNT ON;
    --
    ...
    FROM [acsa].[SONDA_ITEM_HISTORY] [H]
