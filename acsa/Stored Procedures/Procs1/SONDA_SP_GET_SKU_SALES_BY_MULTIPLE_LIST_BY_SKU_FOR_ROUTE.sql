...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SONDA_SP_GET_SKU_SALES_BY_MULTIPLE_LIST_BY_SKU_FOR_ROUTE]
					@CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_GET_SKU_SALES_BY_MULTIPLE_LIST_BY_SKU_FOR_ROUTE] (
...
BEGIN
    ...
    ,[SMS].[PROMO_TYPE]
    ,[SMS].[FREQUENCY]
	FROM [acsa].[SWIFT_SKU_SALES_BY_MULTIPLE_LIST_BY_SKU] AS [SMS]
