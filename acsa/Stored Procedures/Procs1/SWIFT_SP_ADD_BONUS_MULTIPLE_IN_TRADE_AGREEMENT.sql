...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_ADD_BONUS_MULTIPLE_IN_TRADE_AGREEMENT]
					...
					,@BONUS_QTY = 1
				-- 
				SELECT * FROM [acsa].[SWIFT_TRADE_AGREEMENT_BONUS_BY_MULTIPLE]
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_ADD_BONUS_MULTIPLE_IN_TRADE_AGREEMENT](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [acsa].[SWIFT_TRADE_AGREEMENT_BONUS_BY_MULTIPLE]
				(
					[TRADE_AGREEMENT_ID]
					,[CODE_SKU]
					,[PACK_UNIT]
