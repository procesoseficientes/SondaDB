...
-- Ejemplo de Ejecucion:
                EXEC [acsa].SWIFT_SP_GET_UNASIGNED_ROUTE_BY_QUIZ
*/
-- ============================================= 

-- ============================================= 
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_UNASIGNED_ROUTE_BY_QUIZ] (@QUIZ_ID INT)
AS
BEGIN
SELECT 
	RO.CODE_ROUTE, 
...
WHERE RO.CODE_ROUTE NOT IN (SELECT ROUTE_CODE FROM [acsa].SWIFT_ASIGNED_QUIZ WHERE QUIZ_ID = @QUIZ_ID) 
