...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_GENERATE_DISCOUNT_BY_GENERAL_AMOUNT_BY_CHANNEL_FOR_DUPLICATE]
					@CODE_ROUTE = '44'
					,@ORDER = 2
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GENERATE_DISCOUNT_BY_GENERAL_AMOUNT_BY_CHANNEL_FOR_DUPLICATE] (@CODE_ROUTE VARCHAR(250)
