...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_GENERATE_SKU_SALES_BY_MULTIPLE_BY_CHANNEL_FOR_DUPLICATE]
					@CODE_ROUTE = '44'
					,@ORDER = 2
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GENERATE_SKU_SALES_BY_MULTIPLE_BY_CHANNEL_FOR_DUPLICATE] (@CODE_ROUTE VARCHAR(50)
, @ORDER INT)
AS
BEGIN
  SET NOCOUNT ON;
