...
-- Ejemplo de Ejecucion:
			EXEC  [acsa].[SWIFT_SP_ADD_BONUS_BY_COMBO_RULE_TO_PROMO] @PROMO_RULE_BY_COMBO_ID = 2
                                                              ,@PROMO_ID = 6
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_ADD_BONUS_BY_COMBO_RULE_TO_PROMO] (@COMBO_ID INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    INSERT INTO [acsa].[SWIFT_PROMO_BY_COMBO_PROMO_RULE] ([COMBO_ID], [BONUS_TYPE], [BONUS_SUB_TYPE], [IS_BONUS_BY_LOW_PURCHASE], [IS_BONUS_BY_COMBO], [LOW_QTY])
    ...
    INSERT INTO [acsa].[SWIFT_PROMO_BY_BONUS_RULE] ([PROMO_ID], [PROMO_RULE_BY_COMBO_ID])
      VALUES (@PROMO_ID, @ID);
