...
FROM [acsa].SWIFT_CYCLE_COUNT_DETAIL AS A
WHERE COUNT_ID = @COUNT_ID
--SET @COUNT_TYPE = (SELECT COUNT_TYPE
--FROM [acsa].SWIFT_CYCLE_COUNT_HEADER
--WHERE  COUNT_ID = @COUNT_ID)

--EXEC [acsa].SWIFT_SP_GET_COUNT_HEADER_BY_ID '53'

--SELECT * FROM [acsa].SWIFT_CYCLE_COUNT_DETAIL WHERE
