...
-- EJEMPLO DE EJECUCION: 
		...
		EXEC [acsa].[SONDA_SP_GET_BONUS_LIST_BY_CUSTOMER_FOR_ROUTE]
			@CODE_ROUTE = 'RUDI@acsa'
		
*/			
-- =====================================================
CREATE PROCEDURE [acsa].[SONDA_SP_GET_BONUS_LIST_BY_CUSTOMER_FOR_ROUTE] (
...
BEGIN
	...
	--
	SELECT @GENERATE_BONUS_LIST_FROM_TRADE_AGREEMENT = [acsa].[SWIFT_FN_GET_PARAMETER]('ERP_HARDCODE_VALUES','GENERATE_BONUS_LIST_FROM_TRADE_AGREEMENT')
