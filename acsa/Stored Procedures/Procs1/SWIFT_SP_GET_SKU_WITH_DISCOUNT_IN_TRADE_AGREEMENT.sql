...
-- Ejemplo de Ejecucion:
				EXEC [acsa].SWIFT_SP_GET_SKU_WITH_DISCOUNT_IN_TRADE_AGREEMENT
					@TRADE_AGREEMENT_ID = 2
*/
-- =============================================
CREATE PROCEDURE [acsa].SWIFT_SP_GET_SKU_WITH_DISCOUNT_IN_TRADE_AGREEMENT(
...
BEGIN
	...
	FROM [acsa].SWIFT_VIEW_ALL_SKU VS
		INNER JOIN [acsa].SWIFT_TRADE_AGREEMENT_DISCOUNT TAD ON (
