...
-- Ejemplo de Ejecucion:
		--
		EXEC [acsa].SONDA_SP_INSERT_DEVOLUTION_DETAIL
			@DEVOLUTION_ID = 1
			,@CODE_SKU = '100002'
			,@QTY_SKU = 10
			,@IS_GOOD_STATE = 1
			...
			--
			SELECT * FROM [acsa].SONDA_DEVOLUTION_INVENTORY_DETAIL
			--
			SELECT * FROM [acsa].SONDA_POS_SKUS WHERE ROUTE_ID = 'C001'
*/
-- =============================================
CREATE PROCEDURE [acsa].SONDA_SP_INSERT_DEVOLUTION_DETAIL (@DEVOLUTION_ID INT
...
BEGIN
  ...
  --
  BEGIN TRY
    INSERT INTO [acsa].[SONDA_DEVOLUTION_INVENTORY_DETAIL] ([DEVOLUTION_ID]
    , [CODE_SKU]
    , [QTY_SKU]
    , [IS_GOOD_STATE]
    , [POSTED_DATETIME]
