...
-- Ejemplo de Ejecucion:
				exec [acsa].[SONDA_SP_GET_DETALLE_X_ORDEN_VENTA] @SALES_ORDER_ID = 0001
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_GET_DETALLE_X_ORDEN_VENTA]
...
BEGIN
	...
	Inner Join [acsa].[SONDA_SALES_ORDER_HEADER] AS E	on (D.SALES_ORDER_ID = E.SALES_ORDER_ID) 
