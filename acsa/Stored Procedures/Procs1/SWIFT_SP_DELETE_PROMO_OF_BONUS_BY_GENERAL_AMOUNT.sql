...
-- Ejemplo de Ejecucion:
			EXEC  [acsa].[SWIFT_SP_DELETE_PROMO_OF_BONUS_BY_GENERAL_AMOUNT] @PROMO_BONUS_BY_GENERAL_AMOUNT_ID = 2
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_DELETE_PROMO_OF_BONUS_BY_GENERAL_AMOUNT] (@PROMO_BONUS_BY_GENERAL_AMOUNT_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
