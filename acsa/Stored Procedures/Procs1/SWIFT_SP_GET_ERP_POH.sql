...
-- Ejemplo de Ejecucion:
        ...
        EXECUTE @RC = [acsa].SWIFT_SP_GET_ERP_POH @RECEPTION_HEADER
GO
*/
CREATE PROC [acsa].[SWIFT_SP_GET_ERP_POH] @RECEPTION_HEADER VARCHAR(50)
AS
  ...
  SELECT TOP 1
    @DOC_NUM = ERP_DOC
  FROM [acsa].SWIFT_TXN_X_DOC_ERP stxde INNER JOIN [acsa].SWIFT_RECEPTION_HEADER srh
...
FROM [acsa].SWIFT_RECEPTION_HEADER  AS t    
    INNER JOIN
