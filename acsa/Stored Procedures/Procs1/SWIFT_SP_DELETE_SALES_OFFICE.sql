...
-- Ejemplo de Ejecucion:
				SELECT * FROM [acsa].[SWIFT_SALES_OFFICE]
				--
				EXEC [acsa].[SWIFT_SP_DELETE_SALES_OFFICE]
					@SALES_OFFICE_ID = 3
				-- 
				SELECT * FROM [acsa].[SWIFT_SALES_OFFICE] 
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_DELETE_SALES_OFFICE](
	@SALES_OFFICE_ID INT
)
AS
BEGIN
	BEGIN TRY
		DELETE FROM [acsa].[SWIFT_SALES_OFFICE]
