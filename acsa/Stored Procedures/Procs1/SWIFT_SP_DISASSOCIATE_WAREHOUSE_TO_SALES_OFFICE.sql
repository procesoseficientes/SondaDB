...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_DISASSOCIATE_WAREHOUSE_TO_SALES_OFFICE]
					@CODE_WAREHOUSE = 'BODEGA_CENTRAL'
				-- 
				SELECT * FROM [acsa].SWIFT_WAREHOUSES
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_DISASSOCIATE_WAREHOUSE_TO_SALES_OFFICE](
	@CODE_WAREHOUSE VARCHAR(50)
)
AS
BEGIN
	BEGIN TRY
		UPDATE [acsa].SWIFT_WAREHOUSES
		SET	
