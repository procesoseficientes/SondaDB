...
-- Ejemplo de Ejecucion:
				SELECT * FROM [acsa].SWIFT_PROMO_DISCOUNT_BY_GENERAL_AMOUNT
				--
				EXEC [acsa].[SWIFT_SP_DELETE_DISCOUNT_BY_GENERAL_AMOUNT_ASSOCIATED_TO_PROMOTION_OF_DISCOUNT_BY_GENERAL_AMOUNT]
				@DISCOUNT_BY_GENERAL_AMOUNT_ID = 8
				-- 
				SELECT * FROM [acsa].SWIFT_PROMO_DISCOUNT_BY_GENERAL_AMOUNT
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_DELETE_DISCOUNT_BY_GENERAL_AMOUNT_ASSOCIATED_TO_PROMOTION_OF_DISCOUNT_BY_GENERAL_AMOUNT] (@DISCOUNT_BY_GENERAL_AMOUNT_ID INT)
AS
BEGIN
  BEGIN TRY
    ...
    --
    DELETE FROM [acsa].[SWIFT_PROMO_DISCOUNT_BY_GENERAL_AMOUNT]
    WHERE [DISCOUNT_BY_GENERAL_AMOUNT_ID] = @DISCOUNT_BY_GENERAL_AMOUNT_ID
    --
