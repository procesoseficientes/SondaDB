...
CREATE PROCEDURE [acsa].[SWIFT_SP_INSERT_QUESTION] (@QUIZ_ID INT
...
BEGIN TRY
  ...
  INSERT INTO [acsa].[SWIFT_QUESTION] ([QUIZ_ID], [QUESTION], [ORDER], [REQUIRED], [TYPE_QUESTION], [LAST_UPDATE], [LAST_UPDATE_BY])
