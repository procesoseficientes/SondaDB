...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SONDA_SP_ADD_BUSINESS_RIVAL_POLL]
				...
				--
				SELECT * FROM [acsa].[SONDA_BUSINESS_RIVAL_POLL]
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_ADD_BUSINESS_RIVAL_POLL](
...
BEGIN
	...
	DECLARE @ROUTE INT
	--
	SELECT @ROUTE = [acsa].[SWIFT_FN_GET_ROUTE_ID_FROM_CODE_ROUTE](@CODE_ROUTE)
	--
	INSERT INTO [acsa].[SONDA_BUSINESS_RIVAL_POLL]
			(
				[INVOICE_RESOLUTION]
				,[INVOICE_SERIE]
				,[INVOICE_NUM]
