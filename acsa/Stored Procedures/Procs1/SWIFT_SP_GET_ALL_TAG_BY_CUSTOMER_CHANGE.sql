...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_GET_ALL_TAG_BY_CUSTOMER_CHANGE]
					@CUSTOMER = 3875
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_ALL_TAG_BY_CUSTOMER_CHANGE](
	@CUSTOMER INT
)
AS
BEGIN
	...
	SELECT
		...
		,CASE
			...
			ELSE 1
		END [IS_CONFIG]
	FROM [acsa].[SWIFT_TAGS] [T]
	LEFT JOIN [acsa].[SWIFT_TAG_X_CUSTOMER_CHANGE] [C] ON (
