...
-- Ejemplo de Ejecucion:
				...
				--
				EXEC [acsa].[SWIFT_SP_DELETE_TRADE_AGREEMENT_SKU_BY_BONUS_RULE]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_DELETE_TRADE_AGREEMENT_SKU_BY_BONUS_RULE](
...
BEGIN
	BEGIN TRY
		DELETE FROM [acsa].[SWIFT_TRADE_AGREEMENT_SKU_BY_BONUS_RULE] 
