...
-- Ejemplo de Ejecucion:
				EXEC [acsa].SWIFT_SP_ELIMINATE_FULL_SWIFT_PROMO_DISCOUNT_BY_PAYMENT_TYPE_AND_FAMILY
				@PROMO_ID = 2121
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_ELIMINATE_FULL_SWIFT_PROMO_DISCOUNT_BY_PAYMENT_TYPE_AND_FAMILY](
	@PROMO_ID INT
)
WITH RECOMPILE
AS
BEGIN
	...
	BEGIN TRY
		...
		PROMOTION_NOT_ASSOCIATED_WITH_A_COMMERCIAL_AGREEMENT:
			...
			-- -------------------------------------------------------------------------------
			DELETE FROM [acsa].[SWIFT_PROMO_DISCOUNT_BY_PAYMENT_TYPE_AND_FAMILY] WHERE [PROMO_ID] = @PROMOTION_ID;      
