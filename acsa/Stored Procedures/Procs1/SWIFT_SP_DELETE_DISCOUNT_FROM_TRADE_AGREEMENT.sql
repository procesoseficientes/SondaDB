...
-- Ejemplo de Ejecucion:
				EXEC [acsa].SWIFT_SP_DELETE_DISCOUNT_FROM_TRADE_AGREEMENT
					@TRADE_AGREEMENT_DISCUOUNT_ID = 4
				-- 
				SELECT * FROM [acsa].SWIFT_TRADE_AGREEMENT_DISCOUNT
*/
-- =============================================
CREATE PROCEDURE [acsa].SWIFT_SP_DELETE_DISCOUNT_FROM_TRADE_AGREEMENT(
