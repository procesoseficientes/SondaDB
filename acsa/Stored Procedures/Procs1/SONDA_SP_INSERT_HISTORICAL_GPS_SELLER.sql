...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SONDA_SP_INSERT_HISTORICAL_GPS_SELLER]
				@CODE_ROUTE = '46'
				...
				-- 
				SELECT * FROM [acsa].[SONDA_HISTORICAL_GPS_SELLER] 
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_INSERT_HISTORICAL_GPS_SELLER](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [acsa].[SONDA_HISTORICAL_GPS_SELLER]
				(
					[CODE_ROUTE]
					,[GPS]
					,[LONGITUDE]
	...
	BEGIN CATCH
		...
		EXEC [acsa].[SONDA_SP_INSERT_SONDA_SERVER_ERROR_LOG] 
