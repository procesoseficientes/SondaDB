...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_INSERT_WAREHOUSE_ACCESS_TO_USER]
					@USER_CORRELATIVE = 1
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_INSERT_WAREHOUSE_ACCESS_TO_USER](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [acsa].[SWIFT_WAREHOUSE_BY_USER_WITH_ACCESS]
				(
					[USER_CORRELATIVE]
					,[CODE_WAREHOUSE]
				)
