...
-- Ejemplo de Ejecucion:
				SELECT * FROM 
				--
				EXEC [acsa].[SWIFT_SP_DELETE_WAREHOUSE_X_DISTRIBUTION_CENTER]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_DELETE_WAREHOUSE_X_DISTRIBUTION_CENTER](
	@DISTRIBUTION_CENTER_ID INT
...
BEGIN
	BEGIN TRY
		...
		BEGIN
			DELETE FROM [acsa].[SWIFT_WAREHOUSE_X_DISTRIBUTION_CENTER]
