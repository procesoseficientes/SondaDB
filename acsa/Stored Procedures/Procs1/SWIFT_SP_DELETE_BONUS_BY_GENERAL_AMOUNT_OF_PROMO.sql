...
-- Ejemplo de Ejecucion:
			EXEC  [acsa].[SWIFT_SP_DELETE_BONUS_BY_GENERAL_AMOUNT_OF_PROMO] @PROMO_BONUS_BY_GENERAL_AMOUNT_ID = 2
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_DELETE_BONUS_BY_GENERAL_AMOUNT_OF_PROMO] (@PROMO_BONUS_BY_GENERAL_AMOUNT_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
