...
-- Ejemplo de Ejecucion:
				SELECT * FROM [acsa].SWIFT_PROMO WHERE PROMO_ID = 6
        SELECT * FROM [acsa].SWIFT_PROMO_BY_BONUS_RULE
				--
				EXEC [acsa].[SWIFT_SP_DELETE_PROMO_BY_BONUS_RULE]
					@PROMO_ID = 6
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_DELETE_BONUS_COMBO_RULE_OF_PROMO] (@PROMO_ID INT
