...
EXEC [acsa].[SONDA_SP_VALIDATE_DOCUMENT_SEQUENCES] 
	@XML = 
	'
<Data>
	<docSquences>
...
*/
-- =============================================
-- DROP PROCEDURE [acsa].[SONDA_SP_VALIDATE_DOCUMENT_SEQUENCES]
CREATE PROCEDURE [acsa].[SONDA_SP_VALIDATE_DOCUMENT_SEQUENCES] (@XML XML)
AS
	BEGIN
		SET NOCOUNT ON;
		DECLARE
