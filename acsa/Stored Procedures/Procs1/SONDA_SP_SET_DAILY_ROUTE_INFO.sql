...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_SET_DAILY_ROUTE_INFO]
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  BEGIN TRY
    ...
    DELETE [acsa].[SONDA_WEEKLY_SUMMARIE]
    ...
    FROM [acsa].[SONDA_SERVER_ERROR_LOG] [SL]
    ...
    BEGIN
      ...
      IF @SEVERITY_CODE = -90
      BEGIN
        INSERT INTO [acsa].[SONDA_WEEKLY_SUMMARIE] ([CODE_ROUTE], [ROUTE_STARTED_AT], [ROUTE_FINISHED_AT], [TRANSACTIONS], [MIN_BATT], [MAX_BATT], [TOTAL_AMOUNT], [FIRST_TXN], [LAST_TXN], [WEEK_NUMBER], [LOGIN_ID])
      ...
      BEGIN
        ...
        UPDATE [acsa].[SONDA_WEEKLY_SUMMARIE]
