...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_GET_SERIAL_NUMBER_BY_MANIFEST] @MANIFEST_HEADER_ID = 2145
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_SERIAL_NUMBER_BY_MANIFEST]
	(
...
AS
    ...
    SELECT TOP 1
			...
			FROM
				[acsa].[SWIFT_SETUP_EXTERNAL_SOURCE] AS [S]
			WHERE
