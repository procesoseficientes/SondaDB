...
-- Ejemplo de Ejecucion:
				EXEC  [acsa].[SWIFT_SP_GET_WAREHOUSE_BY_ZONE] @ID_ZONE = 1

*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_WAREHOUSE_BY_ZONE] (@ID_ZONE INT )
AS
BEGIN
  SET NOCOUNT ON;
  --
 ...
 SELECT 
  ...
  FROM [acsa].[SWIFT_WAREHOUSES] [W]
    INNER JOIN [acsa].[SWIFT_WAREHOUSE_X_ZONE] [SWXZ] ON [W].[CODE_WAREHOUSE] = [SWXZ].[CODE_WAREHOUSE]
