CREATE PROCEDURE [acsa].[SWIFT_INSERT_IN_RECEPTION_DETAIL]
@RECEPTION_HEADER INT
AS
INSERT INTO [acsa].SWIFT_RECEPTION_DETAIL(RECEPTION_HEADER,CODE_SKU,DESCRIPTION_SKU,EXPECTED,SCANNED,RESULT,LAST_UPDATE,DIFFERENCE)
