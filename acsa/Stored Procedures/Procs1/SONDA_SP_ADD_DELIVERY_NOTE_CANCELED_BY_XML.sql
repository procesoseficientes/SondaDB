...
-- Ejemplo de Ejecucion:
		EXEC [acsa].[SONDA_SP_ADD_DELIVERY_NOTE_CANCELED_BY_XML]
		@XML = '
			<Data>
				<notasDeEntrega>
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_ADD_DELIVERY_NOTE_CANCELED_BY_XML](
	@XML XML
)
AS
BEGIN
	...
	BEGIN TRY
		...
		FROM [acsa].[SONDA_DELIVERY_NOTE_HEADER] AS [DN]
