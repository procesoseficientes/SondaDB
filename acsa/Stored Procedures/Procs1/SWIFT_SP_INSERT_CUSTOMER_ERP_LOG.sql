...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_INSERT_CUSTOMER_ERP_LOG]
					@ID = -1
					...
					,@TYPE = 'SCOUTING'
				-- 
				SELECT * FROM [acsa].[SWIFT_SEND_CUSTOMER_ERP_LOG]
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_INSERT_CUSTOMER_ERP_LOG](
	@ID INT
...
BEGIN
	BEGIN TRY
		--
		INSERT INTO [acsa].[SWIFT_SEND_CUSTOMER_ERP_LOG]
				(
					[ID]
