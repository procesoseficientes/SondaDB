...
-- Ejemplo de Ejecucion:
        EXEC [acsa].[SONDA_SP_GET_LIST_OF_SPECIAL_PRICE_BY_SCALE_FOR_ROUTE]
		@CODE_ROUTE = '136'
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_GET_LIST_OF_SPECIAL_PRICE_BY_SCALE_FOR_ROUTE]
	(
...
AS
	...
	--
		...
		FROM
			[acsa].[SWIFT_SPECIAL_PRICE_LIST] [SPL]
		WHERE
	...
	--
		...
		FROM
			[acsa].[SWIFT_SPECIAL_PRICE_LIST_BY_SCALE] AS [SPLBS]
