...
-- Ejemplo de Ejecucion:				
				--select * from [acsa].[OP_WMS_FUNC_GET_PICKING_TASK] (16507)
*/
-- =============================================
CREATE FUNCTION [acsa].[OP_WMS_FUNC_GET_PICKING_TASK]
(              
                @pTASK_ID INT                
)
RETURNS TABLE 
...
(
	SELECT 
		...
		,T.TASK_STATUS
		,(SELECT VALUE_TEXT_CLASSIFICATION FROM [acsa].SWIFT_CLASSIFICATION WHERE GROUP_CLASSIFICATION = 'PICKING' AND CLASSIFICATION =  PH.CLASSIFICATION_PICKING) AS PICKING_TYPE		
