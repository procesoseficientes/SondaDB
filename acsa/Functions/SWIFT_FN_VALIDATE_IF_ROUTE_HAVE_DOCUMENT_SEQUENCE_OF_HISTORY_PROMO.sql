...
-- Ejemplo de Ejecucion:
        SELECT [acsa].[SWIFT_FN_VALIDATE_IF_ROUTE_HAVE_DOCUMENT_SEQUENCE_OF_HISTORY_PROMO]('demo')
...
*/
-- =============================================
CREATE FUNCTION [acsa].[SWIFT_FN_VALIDATE_IF_ROUTE_HAVE_DOCUMENT_SEQUENCE_OF_HISTORY_PROMO] (@CODE_ROUTE VARCHAR(50))
RETURNS INT
AS
BEGIN
