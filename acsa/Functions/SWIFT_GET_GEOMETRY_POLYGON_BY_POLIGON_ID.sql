...
/*
	SELECT [acsa].SWIFT_GET_GEOMETRY_POLYGON_BY_POLIGON_ID (9) AS VALUE
*/
-- =============================================
CREATE FUNCTION [acsa].[SWIFT_GET_GEOMETRY_POLYGON_BY_POLIGON_ID] (@POLYGON_ID INT)
RETURNS GEOMETRY
AS
	BEGIN
