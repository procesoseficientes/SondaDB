...
-- Ejemplo de Ejecucion:
        SELECT [acsa].[SONDA_FN_CAN_VOID_SALE_ORDER]('C',505)
		--
		SELECT [acsa].[SONDA_FN_CAN_VOID_SALE_ORDER]('B',17)
		--
		SELECT [acsa].[SONDA_FN_CAN_VOID_SALE_ORDER]('SGERENT',60)
*/
-- =============================================
CREATE FUNCTION [acsa].SONDA_FN_CAN_VOID_SALE_ORDER
(
