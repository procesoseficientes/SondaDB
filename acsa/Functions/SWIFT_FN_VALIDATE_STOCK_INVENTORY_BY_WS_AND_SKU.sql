...
-- Ejemplo de Ejecucion:
		...
		SELECT [acsa].[SWIFT_FN_VALIDATE_STOCK_INVENTORY_BY_WS_AND_SKU]('BODEGA_CENTRAL','100003','4')
*/
-- =============================================
CREATE FUNCTION [acsa].[SWIFT_FN_VALIDATE_STOCK_INVENTORY_BY_WS_AND_SKU](
...
AS BEGIN
	...
	LEFT JOIN [acsa].[SWIFT_FN_GET_INVENTORY_RESERVED](@CODE_WAREHOUSE) IR
