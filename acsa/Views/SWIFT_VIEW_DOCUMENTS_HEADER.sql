...
-- Ejemplo de Ejecucion:
        SELECT * FROM [acsa].[SWIFT_VIEW_DOCUMENTS_HEADER]
*/
-- =============================================
CREATE VIEW [acsa].[SWIFT_VIEW_DOCUMENTS_HEADER]
AS
SELECT
...
INNER JOIN [acsa].[SONDA_SALES_ORDER_DETAIL] [D] WITH (NOLOCK)
