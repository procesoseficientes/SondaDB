...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'acsa', @level1type = N'VIEW', @level1name = N'SWIFT_VIEW_HIST_SKU';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'acsa', @level1type = N'VIEW', @level1name = N'SWIFT_VIEW_HIST_SKU';
