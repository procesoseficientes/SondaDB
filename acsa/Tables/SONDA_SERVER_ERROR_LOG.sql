CREATE TABLE [acsa].[SONDA_SERVER_ERROR_LOG] (
...
CREATE NONCLUSTERED INDEX [IN_SONDA_SERVER_ERROR_LOG_DOC_SERIE_DOC_NUM]
    ON [acsa].[SONDA_SERVER_ERROR_LOG]([DOC_SERIE] ASC, [DOC_NUM] ASC)
    INCLUDE([CODE_ROUTE]);


GO
CREATE NONCLUSTERED INDEX [IN_SONDA_SERVER_ERROR_LOG_SEVERITY_CODE_LOG_DATETIME]
    ON [acsa].[SONDA_SERVER_ERROR_LOG]([SEVERITY_CODE] ASC, [LOG_DATETIME] ASC);
