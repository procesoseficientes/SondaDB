CREATE TABLE [acsa].[SWIFT_CUSTOMERS_NEW] (
    ...
    FOREIGN KEY ([OWNER_ID]) REFERENCES [acsa].[SWIFT_COMPANY] ([COMPANY_ID])
);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_CUSTOMERS_NEW_CODE_CUSTOMER]
    ON [acsa].[SWIFT_CUSTOMERS_NEW]([CODE_CUSTOMER] ASC)
    INCLUDE([CUSTOMER]);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_CUSTOMERS_NEW_IS_POSTED_ERP]
    ON [acsa].[SWIFT_CUSTOMERS_NEW]([IS_POSTED_ERP] ASC, [CODE_CUSTOMER] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX_SWIFT_CUSTOMERS_NEW_CODE_CUSTOMER_SERVER_POSTED_DATETIME]
    ON [acsa].[SWIFT_CUSTOMERS_NEW]([CODE_CUSTOMER] ASC, [SERVER_POSTED_DATETIME] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX_SWIFT_CUSTOMERS_NEW_CODE_ROUTE_CODE_CUSTOMER_HH_POST_DATETIME]
    ON [acsa].[SWIFT_CUSTOMERS_NEW]([CODE_ROUTE] ASC, [CODE_CUSTOMER_HH] ASC, [POST_DATETIME] ASC);
