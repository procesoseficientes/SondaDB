CREATE TABLE [acsa].[SWIFT_PROMO_SPECIAL_PRICE_LIST_BY_SCALE] (
    ...
    CONSTRAINT [PROMO_ID] FOREIGN KEY ([PROMO_ID]) REFERENCES [acsa].[SWIFT_PROMO] ([PROMO_ID])
);
...
CREATE NONCLUSTERED INDEX [SWIFT_PROMO_SPECIAL_PRICE_T0]
    ON [acsa].[SWIFT_PROMO_SPECIAL_PRICE_LIST_BY_SCALE]([CODE_SKU] ASC, [PACK_UNIT] ASC, [PROMO_ID] ASC)
...
CREATE NONCLUSTERED INDEX [SWIFT_PROMO_SPECIAL_PRICE_LAST_UPDATE]
    ON [acsa].[SWIFT_PROMO_SPECIAL_PRICE_LIST_BY_SCALE]([LAST_UPDATE] ASC);
