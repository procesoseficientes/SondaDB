CREATE TABLE [acsa].[SWIFT_TRADE_AGREEMENT_BONUS] (
    ...
    CONSTRAINT [FK__SWIFT_TRA__PACK___66EBDBF8] FOREIGN KEY ([PACK_UNIT]) REFERENCES [acsa].[SONDA_PACK_UNIT] ([PACK_UNIT]),
    CONSTRAINT [FK__SWIFT_TRA__PACK___67E00031] FOREIGN KEY ([PACK_UNIT_BONUS]) REFERENCES [acsa].[SONDA_PACK_UNIT] ([PACK_UNIT]),
    CONSTRAINT [FK__SWIFT_TRA__TRADE__65F7B7BF] FOREIGN KEY ([TRADE_AGREEMENT_ID]) REFERENCES [acsa].[SWIFT_TRADE_AGREEMENT] ([TRADE_AGREEMENT_ID]),
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_TRADE_AGREEMENT_BONUS_TRADE_AGREEMENT_ID]
    ON [acsa].[SWIFT_TRADE_AGREEMENT_BONUS]([TRADE_AGREEMENT_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_TRADE_AGREEMENT_BONUS_TRADE_AGREEMENT_ID_CODE_SKU]
    ON [acsa].[SWIFT_TRADE_AGREEMENT_BONUS]([TRADE_AGREEMENT_ID] ASC, [CODE_SKU] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_TRADE_AGREEMENT_BONUS_TRADE_AGREEMENT_ID_CODE_SKU_PACK_UNIT]
    ON [acsa].[SWIFT_TRADE_AGREEMENT_BONUS]([TRADE_AGREEMENT_ID] ASC, [CODE_SKU] ASC, [PACK_UNIT] ASC);
