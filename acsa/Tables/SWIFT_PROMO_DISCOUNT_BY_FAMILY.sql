CREATE TABLE [acsa].[SWIFT_PROMO_DISCOUNT_BY_FAMILY] (
    ...
    CONSTRAINT [FK__SWIFT_PRO__PROMO__3906AC65] FOREIGN KEY ([PROMO_ID]) REFERENCES [acsa].[SWIFT_PROMO] ([PROMO_ID])
);
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_DISCOUNT_BY_FAMILY_PROMO_ID]
    ON [acsa].[SWIFT_PROMO_DISCOUNT_BY_FAMILY]([PROMO_ID] ASC)
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_DISCOUNT_BY_FAMILY_LAST_UPDATE]
    ON [acsa].[SWIFT_PROMO_DISCOUNT_BY_FAMILY]([LAST_UPDATE] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX_SWIFT_PROMO_DISCOUNT_BY_FAMILY_T0]
    ON [acsa].[SWIFT_PROMO_DISCOUNT_BY_FAMILY]([CODE_FAMILY_SKU] ASC, [PROMO_ID] ASC)
