...
-- Ejemplo de Ejecucion:
				EXEC [SONDA].[SWIFT_SP_GENERATE_DISCOUNT_BY_GENERAL_AMOUNT_BY_TRADE_AGREEMENT_FOR_DUPLICATE]
					@CODE_ROUTE = '44'
					,@ORDER = 1
*/
-- =============================================
CREATE PROCEDURE [SONDA].[SWIFT_SP_GENERATE_DISCOUNT_BY_GENERAL_AMOUNT_BY_TRADE_AGREEMENT_FOR_DUPLICATE] (@CODE_ROUTE VARCHAR(250)
, @ORDER INT) 
AS
BEGIN
  SET NOCOUNT ON;
