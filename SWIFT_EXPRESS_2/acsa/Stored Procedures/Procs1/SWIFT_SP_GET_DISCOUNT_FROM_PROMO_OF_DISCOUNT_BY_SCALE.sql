...
BEGIN
	...
	FROM [SONDA].[SONDA_PACK_UNIT] [PU1] 
		...
		INNER JOIN [SONDA].[SWIFT_VIEW_ALL_SKU] [VAS1] ON [VAS1].[CODE_SKU] = [PDS].[CODE_SKU]	COLLATE DATABASE_DEFAULT
		LEFT JOIN [SONDA].[SWIFT_FAMILY_SKU] FS ON [FS].[CODE_FAMILY_SKU] = [VAS1].[CODE_FAMILY_SKU] COLLATE DATABASE_DEFAULT
