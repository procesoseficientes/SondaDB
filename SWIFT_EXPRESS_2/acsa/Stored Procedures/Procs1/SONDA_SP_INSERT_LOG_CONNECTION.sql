...
-- Ejemplo de Ejecucion:
		EXEC [SONDA].[SONDA_SP_INSERT_LOG_CONNECTION]
		@LOGIN_USER = 'prueba'
		, @ROUTE_USER = 'prueba@[SONDA]'
		, @DEVICE_USER = 'e39cbcecbc62d5d6'
		, @MESSAGE = 'Prueba mensaje'
		-----
		SELECT * FROM [SONDA].SONDA_HISTORY_CONNECTION_OF_USER
*/
-- =============================================
CREATE PROCEDURE [SONDA].[SONDA_SP_INSERT_LOG_CONNECTION](
...
BEGIN
	SET NOCOUNT ON;
	--
	INSERT INTO [SONDA].[SONDA_HISTORY_CONNECTION_OF_USER]
			(
				[LOGIN_USER]
				,[ROUTE_USER]
				,[DEVICE_USER]
