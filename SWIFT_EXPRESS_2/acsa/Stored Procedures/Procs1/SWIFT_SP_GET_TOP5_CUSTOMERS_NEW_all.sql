...
EXECUTE @RC = [SONDA].SWIFT_SP_GET_TOP5_CUSTOMERS_NEW
GO
  
*/
-- =============================================

create PROCEDURE [SONDA].[SWIFT_SP_GET_TOP5_CUSTOMERS_NEW_all]
AS
  ...
  INNER JOIN [SONDA].SWIFT_CUSTOMER_FREQUENCY_NEW scfn
