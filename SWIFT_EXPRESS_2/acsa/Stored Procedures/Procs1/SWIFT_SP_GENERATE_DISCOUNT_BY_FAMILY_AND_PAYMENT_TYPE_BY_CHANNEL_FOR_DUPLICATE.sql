...
-- Ejemplo de Ejecucion:
				EXEC [SONDA].SWIFT_SP_GENERATE_DISCOUNT_BY_FAMILY_AND_PAYMENT_TYPE_BY_CHANNEL_FOR_DUPLICATE
					@CODE_ROUTE = '44'
					,@ORDER = 2
*/
-- =============================================
...
-- =============================================
CREATE PROCEDURE [SONDA].[SWIFT_SP_GENERATE_DISCOUNT_BY_FAMILY_AND_PAYMENT_TYPE_BY_CHANNEL_FOR_DUPLICATE] (@CODE_ROUTE VARCHAR(250)
