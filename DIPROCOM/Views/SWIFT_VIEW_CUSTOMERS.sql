...
-- Ejemplo de Ejecucion:
		SELECT * FROM [DIPROCOM].SWIFT_VIEW_CUSTOMERS
*/

CREATE VIEW [DIPROCOM].[SWIFT_VIEW_CUSTOMERS]
AS SELECT
...
SELECT
 ...
 ,[COLONY]
 ,[GPS]
FROM [SWIFT_INTERFACES].[DIPROCOM].[ERP_VIEW_COSTUMER]
