...
-- Ejemplo de Ejecucion:
		SELECT * FROM [PACASA].SWIFT_VIEW_CUSTOMERS
*/

CREATE VIEW [PACASA].[SWIFT_VIEW_CUSTOMERS]
AS SELECT
...
SELECT
 ...
 ,[COLONY]
 ,[GPS]
FROM [SWIFT_INTERFACES].[PACASA].[ERP_VIEW_COSTUMER]
