...
-- Ejemplo de Ejecucion:
        SELECT * FROM [DIPROCOM].[SWIFT_VIEW_INVENTORY_BY_WAREHOUSE]
*/
-- =============================================
CREATE VIEW [DIPROCOM].[SWIFT_VIEW_INVENTORY_BY_WAREHOUSE]
AS (
	SELECT
		[I].[WAREHOUSE]
		,[I].[SKU]
	...
	LEFT OUTER JOIN [DIPROCOM].[SWIFT_VIEW_ALL_SKU] [S] ON (
		[I].[SKU] = [S].[CODE_SKU]
	)
	GROUP BY
		[I].[WAREHOUSE]
