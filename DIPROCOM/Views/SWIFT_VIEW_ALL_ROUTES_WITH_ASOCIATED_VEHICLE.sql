...
-- Ejemplo de Ejecucion:
			SELECT * FROM [PACASA].[SWIFT_VIEW_ALL_ROUTES_WITH_ASOCIATED_VEHICLE]
*/
-- =============================================
CREATE VIEW [PACASA].[SWIFT_VIEW_ALL_ROUTES_WITH_ASOCIATED_VEHICLE]
AS
  SELECT 
