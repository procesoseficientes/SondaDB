CREATE VIEW [acsa].[SWIFT_VIEW_LOCATION_INVENTORY]
AS
SELECT  DISTINCT   
...
FROM         [acsa].SWIFT_INVENTORY AS A LEFT OUTER JOIN
                      [acsa].SWIFT_BATCHES AS E ON A.BATCH_ID = E.BATCH
					LEFT OUTER JOIN
                      [acsa].SWIFT_VIEW_ALL_SKU AS D ON A.SKU = D.CODE_SKU
WHERE A.ON_HAND > 0 
GROUP BY 
A.WAREHOUSE,
A.SERIAL_NUMBER, 
