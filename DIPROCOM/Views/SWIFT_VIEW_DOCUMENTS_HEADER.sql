...
-- Ejemplo de Ejecucion:
        SELECT * FROM [PACASA].[SWIFT_VIEW_DOCUMENTS_HEADER]
*/
-- =============================================
CREATE VIEW [PACASA].[SWIFT_VIEW_DOCUMENTS_HEADER]
AS
SELECT
...
INNER JOIN [PACASA].[SONDA_SALES_ORDER_DETAIL] [D] WITH (NOLOCK)
