...
-- Ejemplo de Ejecucion:
        SELECT * FROM [DIPROCOM].[SWIFT_VIEW_DOCUMENTS_HEADER]
*/
-- =============================================
CREATE VIEW [DIPROCOM].[SWIFT_VIEW_DOCUMENTS_HEADER]
AS
SELECT
...
INNER JOIN [DIPROCOM].[SONDA_SALES_ORDER_DETAIL] [D] WITH (NOLOCK)
...
INNER JOIN [DIPROCOM].[USERS] AS [US]
