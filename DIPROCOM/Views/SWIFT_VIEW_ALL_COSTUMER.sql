...
-- Ejemplo de Ejecucion:
				SELECT * FROM [PACASA].[SWIFT_VIEW_ALL_COSTUMER] WHERE CUSTOMER = '42082'
*/
-- =============================================
CREATE VIEW [PACASA].[SWIFT_VIEW_ALL_COSTUMER]
AS
SELECT
	RTRIM(LTRIM([CODE_CUSTOMER])) COLLATE DATABASE_DEFAULT [CODE_CUSTOMER]
	,[CODE_CUSTOMER]
	,[NAME_CUSTOMER]
	,[PHONE_CUSTOMER]
	,[ADRESS_CUSTOMER]
...
SELECT
	...
	,[C].CODE_CUSTOMER_ALTERNATE
	  ,[C].[GROUP_NUM]
       ,[C].[SPECIAL_MARKER]
FROM
	[SWIFT_INTERFACES].[PACASA].[ERP_VIEW_COSTUMER] [C], 
	(SELECT P.VALUE FROM [PACASA].[SWIFT_PARAMETER] [P] WHERE
