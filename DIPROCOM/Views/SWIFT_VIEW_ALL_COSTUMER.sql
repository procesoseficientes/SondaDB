...
-- Ejemplo de Ejecucion:
				SELECT * FROM [DIPROCOM].[SWIFT_VIEW_ALL_COSTUMER] WHERE CUSTOMER = '42082'
*/
-- =============================================
CREATE VIEW [DIPROCOM].[SWIFT_VIEW_ALL_COSTUMER]
AS
SELECT
...
SELECT
	...
	,[C].CODE_CUSTOMER_ALTERNATE
	  ,[C].[GROUP_NUM]
       ,[C].[SPECIAL_MARKER]
FROM
	[SWIFT_INTERFACES].[DIPROCOM].[ERP_VIEW_COSTUMER] [C], 
	(SELECT P.VALUE FROM [DIPROCOM].[SWIFT_PARAMETER] [P] WHERE
