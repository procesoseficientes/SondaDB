...
-- Ejemplo de Ejecucion:
        SELECT * FROM [acsa].[SWIFT_VIEW_DOCUMENTS_DETAIL]
*/
-- =============================================
CREATE VIEW [acsa].[SWIFT_VIEW_DOCUMENTS_DETAIL]
AS
	SELECT 
		H.DOC_SERIE
	...
	INNER JOIN [acsa].SONDA_SALES_ORDER_HEADER H ON (
		H.SALES_ORDER_ID = D.SALES_ORDER_ID
	)
	LEFT OUTER JOIN [acsa].SWIFT_VIEW_ALL_SKU S ON (
	...
	SELECT
		...
		,'INVOICE' AS [DOC_TYPE]
	FROM [acsa].[SONDA_POS_INVOICE_DETAIL] AS D
	LEFT OUTER JOIN [acsa].[SWIFT_VIEW_ALL_SKU] AS S ON (
		D.SKU = S.CODE_SKU COLLATE DATABASE_DEFAULT
	)
