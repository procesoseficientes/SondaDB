...
-- Ejemplo de Ejecucion:
        SELECT * FROM [DIPROCOM].[SWIFT_VIEW_DOCUMENTS_DETAIL]
*/
-- =============================================
CREATE VIEW [DIPROCOM].SWIFT_VIEW_DOCUMENTS_DETAIL
AS
	SELECT 
		H.DOC_SERIE
	...
	INNER JOIN [DIPROCOM].SONDA_SALES_ORDER_HEADER H ON (
	...
	SELECT
		...
		,'INVOICE' AS [DOC_TYPE]
	FROM [DIPROCOM].[SONDA_POS_INVOICE_DETAIL] AS D
	LEFT OUTER JOIN [DIPROCOM].[SWIFT_VIEW_ALL_SKU] AS S ON (
		D.SKU = S.CODE_SKU
	)
