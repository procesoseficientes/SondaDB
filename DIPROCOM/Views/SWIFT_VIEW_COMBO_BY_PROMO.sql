...
-- Ejemplo de Ejecucion: 		
  	SELECT * FROM [acsa].[SWIFT_VIEW_COMBO_BY_PROMO]
*/
-- =============================================
CREATE VIEW [acsa].[SWIFT_VIEW_COMBO_BY_PROMO]
AS
...
SELECT
 ...
 ,[CPR].[LOW_QTY]
 ,[PBR].[PROMO_ID]
FROM [acsa].[SWIFT_PROMO_BY_COMBO_PROMO_RULE] [CPR]
INNER JOIN [acsa].[SWIFT_PROMO_BY_BONUS_RULE] [PBR]
