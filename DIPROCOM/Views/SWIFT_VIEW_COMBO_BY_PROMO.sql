...
-- Ejemplo de Ejecucion: 		
  	SELECT * FROM [PACASA].[SWIFT_VIEW_COMBO_BY_PROMO]
*/
-- =============================================
CREATE VIEW [PACASA].[SWIFT_VIEW_COMBO_BY_PROMO]
AS
...
SELECT
 ...
 ,[CPR].[LOW_QTY]
 ,[PBR].[PROMO_ID]
FROM [PACASA].[SWIFT_PROMO_BY_COMBO_PROMO_RULE] [CPR]
INNER JOIN [PACASA].[SWIFT_PROMO_BY_BONUS_RULE] [PBR]
