...
-- Ejemplo de Ejecucion: 		
  	SELECT * FROM [DIPROCOM].[SWIFT_VIEW_COMBO_BY_PROMO]
*/
-- =============================================
CREATE VIEW [DIPROCOM].[SWIFT_VIEW_COMBO_BY_PROMO]
AS
...
SELECT
 ...
 ,[CPR].[LOW_QTY]
 ,[PBR].[PROMO_ID]
FROM [DIPROCOM].[SWIFT_PROMO_BY_COMBO_PROMO_RULE] [CPR]
INNER JOIN [DIPROCOM].[SWIFT_PROMO_BY_BONUS_RULE] [PBR]
