...
-- Ejemplo de Ejecucion:
        SELECT * FROM [acsa].[SWIFT_VW_ERP_SALES_ORDER_HEADER]
*/
-- =============================================
CREATE VIEW [acsa].[SWIFT_VW_ERP_SALES_ORDER_HEADER]
AS
	SELECT DISTINCT 
		(P.SAP_REFERENCE)
		,P.DOC_TYPE
	...
	LEFT JOIN [acsa].[SWIFT_VEHICLE_X_USER] svxu ON (svxu.LOGIN = P.CODE_OPER)
	LEFT JOIN [acsa].[SWIFT_VEHICLES] sv  ON (sv.VEHICLE = svxu.VEHICLE)
