CREATE VIEW [DIPROCOM].[SWIFT_VIEW_ORDERS]
AS
SELECT     
	A.ORDER_SERIAL, 
	A.PRESALE_ROUTE, 
    ...
    (SELECT     
		SUM(QTY)
		FROM  DIPROCOM.SWIFT_SKUS_BY_ORDER AS X
	...
	A.CREATED_DATESTAMP
FROM     DIPROCOM.SWIFT_ORDERS AS A 
	LEFT OUTER JOIN
         DIPROCOM.SWIFT_TASKS AS B ON A.TASK_SOURCE = B.TASK_ID
