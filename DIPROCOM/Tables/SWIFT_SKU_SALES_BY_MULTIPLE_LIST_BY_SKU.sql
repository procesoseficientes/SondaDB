CREATE TABLE [PACASA].[SWIFT_SKU_SALES_BY_MULTIPLE_LIST_BY_SKU] (
    ...
    FOREIGN KEY ([SALES_BY_MULTIPLE_LIST_ID]) REFERENCES [PACASA].[SWIFT_SKU_SALES_BY_MULTIPLE_LIST] ([SALES_BY_MULTIPLE_LIST_ID])
);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_SKU_SALES_BY_MULTIPLE_LIST_BY_SKU_SALES_BY_MULTIPLE_LIST_ID]
    ON [PACASA].[SWIFT_SKU_SALES_BY_MULTIPLE_LIST_BY_SKU]([SALES_BY_MULTIPLE_LIST_ID] ASC)
