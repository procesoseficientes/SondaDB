CREATE TABLE [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_CUSTOMER] (
    ...
    CONSTRAINT [FK_TRADE_AGREEMENT_BY_CUSTOMER] FOREIGN KEY ([TRADE_AGREEMENT_ID]) REFERENCES [DIPROCOM].[SWIFT_TRADE_AGREEMENT] ([TRADE_AGREEMENT_ID])
);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_TRADE_AGREEMENT_BY_CUSTOMER_CODE_CUSTOMER_TRADE_AGREEMENT_ID]
    ON [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_CUSTOMER]([TRADE_AGREEMENT_ID] ASC, [CODE_CUSTOMER] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_TRADE_AGREEMENT_BY_CUSTOMER_LAST_UPDATE]
    ON [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_CUSTOMER]([LAST_UPDATE] ASC);
