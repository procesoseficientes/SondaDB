CREATE TABLE [acsa].[SWIFT_PROMO_BONUS_BY_SCALE] (
    ...
    FOREIGN KEY ([PACK_UNIT_BONUS]) REFERENCES [acsa].[SONDA_PACK_UNIT] ([PACK_UNIT]),
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_BONUS_BY_SCALE_LAST_UPDATE]
    ON [acsa].[SWIFT_PROMO_BONUS_BY_SCALE]([LAST_UPDATE] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_BONUS_BY_SCALE_PROMO_ID]
    ON [acsa].[SWIFT_PROMO_BONUS_BY_SCALE]([PROMO_ID] ASC)
