CREATE TABLE [DIPROCOM].[SWIFT_PROMO_BONUS_BY_SCALE] (
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_BONUS_BY_SCALE_LAST_UPDATE]
    ON [DIPROCOM].[SWIFT_PROMO_BONUS_BY_SCALE]([LAST_UPDATE] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_BONUS_BY_SCALE_PROMO_ID]
    ON [DIPROCOM].[SWIFT_PROMO_BONUS_BY_SCALE]([PROMO_ID] ASC)
