CREATE TABLE [PACASA].[SWIFT_DISCOUNT_LIST_BY_CUSTOMER] (
    ...
    CONSTRAINT [FK_SWIFT_DISCOUNT_LIST_BY_CUSTOMER_SWIFT_DISCOUNT_LIST] FOREIGN KEY ([DISCOUNT_LIST_ID]) REFERENCES [PACASA].[SWIFT_DISCOUNT_LIST] ([DISCOUNT_LIST_ID])
);


GO
CREATE NONCLUSTERED INDEX [IDX_SWIFT_DISCOUNT_LIST_BY_CUSTOMER_T0]
    ON [PACASA].[SWIFT_DISCOUNT_LIST_BY_CUSTOMER]([CODE_CUSTOMER] ASC)
    INCLUDE([DISCOUNT_LIST_ID]);


GO
CREATE NONCLUSTERED INDEX [IDX_SWIFT_DISCOUNT_LIST_BY_CUSTOMER_T1]
    ON [PACASA].[SWIFT_DISCOUNT_LIST_BY_CUSTOMER]([DISCOUNT_LIST_ID] ASC)
