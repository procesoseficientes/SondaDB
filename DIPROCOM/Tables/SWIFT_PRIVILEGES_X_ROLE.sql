CREATE TABLE [PACASA].[SWIFT_PRIVILEGES_X_ROLE] (
    ...
    CONSTRAINT [FK_SWIFT_PRIVILEGES_X_ROLE_SWIFT_ROLE] FOREIGN KEY ([ROLE_ID]) REFERENCES [PACASA].[SWIFT_ROLE] ([ROLE_ID])
);


GO
CREATE NONCLUSTERED INDEX [IDX_SWIFT_PRIVILEGES_X_ROLE_PRIVILEGE_ID]
    ON [PACASA].[SWIFT_PRIVILEGES_X_ROLE]([PRIVILEGE_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX_SWIFT_PRIVILEGES_X_ROLE_ROLE_ID]
    ON [PACASA].[SWIFT_PRIVILEGES_X_ROLE]([ROLE_ID] ASC);
