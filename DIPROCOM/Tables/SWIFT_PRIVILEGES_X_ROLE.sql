CREATE TABLE [DIPROCOM].[SWIFT_PRIVILEGES_X_ROLE] (
    ...
    CONSTRAINT [FK_SWIFT_PRIVILEGES_X_ROLE_SWIFT_ROLE] FOREIGN KEY ([ROLE_ID]) REFERENCES [DIPROCOM].[SWIFT_ROLE] ([ROLE_ID])
);


GO
CREATE NONCLUSTERED INDEX [IDX_SWIFT_PRIVILEGES_X_ROLE_PRIVILEGE_ID]
    ON [DIPROCOM].[SWIFT_PRIVILEGES_X_ROLE]([PRIVILEGE_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX_SWIFT_PRIVILEGES_X_ROLE_ROLE_ID]
    ON [DIPROCOM].[SWIFT_PRIVILEGES_X_ROLE]([ROLE_ID] ASC);
