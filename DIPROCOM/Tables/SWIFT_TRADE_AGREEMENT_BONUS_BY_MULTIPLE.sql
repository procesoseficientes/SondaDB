CREATE TABLE [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BONUS_BY_MULTIPLE] (
    ...
    CONSTRAINT [FK__SWIFT_TRA__PACK___2D150B75] FOREIGN KEY ([PACK_UNIT]) REFERENCES [DIPROCOM].[SONDA_PACK_UNIT] ([PACK_UNIT]),
    CONSTRAINT [FK__SWIFT_TRA__PACK___2E092FAE] FOREIGN KEY ([PACK_UNIT_BONUS]) REFERENCES [DIPROCOM].[SONDA_PACK_UNIT] ([PACK_UNIT]),
    CONSTRAINT [FK__SWIFT_TRA__TRADE__2C20E73C] FOREIGN KEY ([TRADE_AGREEMENT_ID]) REFERENCES [DIPROCOM].[SWIFT_TRADE_AGREEMENT] ([TRADE_AGREEMENT_ID]),
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_TRADE_AGREEMENT_BONUS_BY_MULTIPLE_TRADE_AGREEMENT]
    ON [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BONUS_BY_MULTIPLE]([TRADE_AGREEMENT_ID] ASC)
