CREATE TABLE [DIPROCOM].[SONDA_CLEARANCES] (
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'OR ROUTE_ID', @level0type = N'SCHEMA', @level0name = N'DIPROCOM', @level1type = N'TABLE', @level1name = N'SONDA_CLEARANCES', @level2type = N'COLUMN', @level2name = N'POS_ID';
