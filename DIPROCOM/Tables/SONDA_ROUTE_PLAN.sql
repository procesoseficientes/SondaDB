CREATE TABLE [DIPROCOM].[SONDA_ROUTE_PLAN] (
...
CREATE NONCLUSTERED INDEX [IN_SONDA_ROUTE_PLAN_CODE_ROUTE]
    ON [DIPROCOM].[SONDA_ROUTE_PLAN]([CODE_ROUTE] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SONDA_ROUTE_PLAN_CODE_ROUTE_RELATED_CLIENT_CODE]
    ON [DIPROCOM].[SONDA_ROUTE_PLAN]([CODE_ROUTE] ASC, [RELATED_CLIENT_CODE] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SONDA_ROUTE_PLAN_RELATED_CLIENT_CODE]
    ON [DIPROCOM].[SONDA_ROUTE_PLAN]([RELATED_CLIENT_CODE] ASC);
