CREATE TABLE [acsa].[SWIFT_ROUTES] (
    ...
    CONSTRAINT [FK__SWIFT_ROU__TRADE__29CE8A76] FOREIGN KEY ([TRADE_AGREEMENT_ID]) REFERENCES [acsa].[SWIFT_TRADE_AGREEMENT] ([TRADE_AGREEMENT_ID])
);
