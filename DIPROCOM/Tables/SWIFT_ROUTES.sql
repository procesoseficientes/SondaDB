CREATE TABLE [DIPROCOM].[SWIFT_ROUTES] (
    ...
    CONSTRAINT [PK__SWIFT_RO__90C52FA81FBBE57E] PRIMARY KEY CLUSTERED ([ROUTE] ASC),
    CONSTRAINT [FK__SWIFT_ROU__TRADE__29CE8A76] FOREIGN KEY ([TRADE_AGREEMENT_ID]) REFERENCES [DIPROCOM].[SWIFT_TRADE_AGREEMENT] ([TRADE_AGREEMENT_ID])
);
