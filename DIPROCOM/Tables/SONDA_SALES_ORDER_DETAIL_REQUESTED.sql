CREATE TABLE [DIPROCOM].[SONDA_SALES_ORDER_DETAIL_REQUESTED] (
    ...
    CONSTRAINT [FK_SONDA_SALES_ORDER_DETAIL_REQUESTED] FOREIGN KEY ([ORDER_ID]) REFERENCES [DIPROCOM].[SONDA_SALES_ORDER_HEADER_REQUESTED] ([ORDER_ID])
);
