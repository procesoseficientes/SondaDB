CREATE TABLE [DIPROCOM].[SWIFT_TRANSFER_DETAIL] (
    ...
    CONSTRAINT [FK_SWIFT_TRANSFER_DETAIL_SWIFT_TRANSFER_HEADER] FOREIGN KEY ([TRANSFER_ID]) REFERENCES [DIPROCOM].[SWIFT_TRANSFER_HEADER] ([TRANSFER_ID]),
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_TRANSFER_DETAIL_TRANSFER_ID]
    ON [DIPROCOM].[SWIFT_TRANSFER_DETAIL]([TRANSFER_ID] ASC)
    INCLUDE([SKU_CODE]);
