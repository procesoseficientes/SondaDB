CREATE TABLE [DIPROCOM].[SWIFT_FREQUENCY_X_CUSTOMER] (
    ...
    CONSTRAINT [FK_SWIFT_FREQUENCY_X_CUSTOMER_SWIFT_FREQUENCY] FOREIGN KEY ([ID_FREQUENCY]) REFERENCES [DIPROCOM].[SWIFT_FREQUENCY] ([ID_FREQUENCY])
);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_FREQUENCY_X_CUSTOMER_CODE_CUSTOMER]
    ON [DIPROCOM].[SWIFT_FREQUENCY_X_CUSTOMER]([CODE_CUSTOMER] ASC)
    INCLUDE([ID_FREQUENCY]);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_FREQUENCY_X_CUSTOMER_ID_FREQUENCY]
    ON [DIPROCOM].[SWIFT_FREQUENCY_X_CUSTOMER]([ID_FREQUENCY] ASC)
