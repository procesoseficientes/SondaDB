CREATE TABLE [PACASA].[SWIFT_FREQUENCY_X_CUSTOMER] (
    ...
    CONSTRAINT [FK_SWIFT_FREQUENCY_X_CUSTOMER_SWIFT_FREQUENCY] FOREIGN KEY ([ID_FREQUENCY]) REFERENCES [PACASA].[SWIFT_FREQUENCY] ([ID_FREQUENCY])
);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_FREQUENCY_X_CUSTOMER_CODE_CUSTOMER]
    ON [PACASA].[SWIFT_FREQUENCY_X_CUSTOMER]([CODE_CUSTOMER] ASC)
    INCLUDE([ID_FREQUENCY]);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_FREQUENCY_X_CUSTOMER_ID_FREQUENCY]
    ON [PACASA].[SWIFT_FREQUENCY_X_CUSTOMER]([ID_FREQUENCY] ASC)
