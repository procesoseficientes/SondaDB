CREATE TABLE [PACASA].[SWIFT_CUSTOMER_CHANGE] (
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_CUSTOMER_CHANGE_CODE_CUSTOMER_POSTED_DATETIME]
    ON [PACASA].[SWIFT_CUSTOMER_CHANGE]([CODE_CUSTOMER] ASC, [POSTED_DATETIME] ASC);


GO
CREATE NONCLUSTERED INDEX [INDEX_CODE_CUSTOMER_SWIFT_CUSTOMER_CHANGE]
    ON [PACASA].[SWIFT_CUSTOMER_CHANGE]([CODE_CUSTOMER] ASC);
