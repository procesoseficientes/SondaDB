CREATE TABLE [PACASA].[SONDA_SALES_ORDER_HEADER] (
    ...
    CONSTRAINT [FK_SONDA_SALES_ORDER_HEADER_SWIFT_TASKS] FOREIGN KEY ([TASK_ID]) REFERENCES [PACASA].[SWIFT_TASKS] ([TASK_ID])
);


GO
CREATE NONCLUSTERED INDEX [IDX_SONDA_SALES_ORDER_HEADER_TO]
    ON [PACASA].[SONDA_SALES_ORDER_HEADER]([CLIENT_ID] ASC)
    INCLUDE([TOTAL_AMOUNT], [POSTED_DATETIME]);


GO
CREATE NONCLUSTERED INDEX [IN_SONDA_SALES_ORDER_HEADER_DOC_SERIE_NUM]
    ON [PACASA].[SONDA_SALES_ORDER_HEADER]([DOC_SERIE] ASC, [DOC_NUM] ASC)
...
CREATE NONCLUSTERED INDEX [IN_SONDA_SALES_ORDER_HEADER_IS_ACTIVE_ROUTE_IS_POSTED_ERP_DOC_SERIE_NUM]
    ON [PACASA].[SONDA_SALES_ORDER_HEADER]([IS_ACTIVE_ROUTE] ASC, [IS_POSTED_ERP] ASC, [DOC_SERIE] ASC, [DOC_NUM] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SONDA_SALES_ORDER_HEADER_IS_ACTIVE_ROUTE_POS_TERMINAL_DOC_SERIE_NUM]
    ON [PACASA].[SONDA_SALES_ORDER_HEADER]([IS_ACTIVE_ROUTE] ASC, [POS_TERMINAL] ASC, [DOC_SERIE] ASC, [DOC_NUM] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SONDA_SALES_ORDER_HEADER_POS_TERMINAL_CLIENT_ID_DOC_SERIE_NUM]
    ON [PACASA].[SONDA_SALES_ORDER_HEADER]([POS_TERMINAL] ASC, [CLIENT_ID] ASC, [DOC_SERIE] ASC, [DOC_NUM] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SONDA_SALES_ORDER_POS_TERMINAL]
    ON [PACASA].[SONDA_SALES_ORDER_HEADER]([POS_TERMINAL] ASC)
    INCLUDE([IS_ACTIVE_ROUTE], [IS_READY_TO_SEND]);


GO
CREATE NONCLUSTERED INDEX [IN_SONDA_SALES_ORDER_HEADER_DEMAND_DISPATCH]
    ON [PACASA].[SONDA_SALES_ORDER_HEADER]([IS_VOID] ASC, [IS_DRAFT] ASC, [HAVE_PICKING] ASC, [POSTED_DATETIME] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SONDA_SALES_ORDER_HEADER_WAREHOUSE]
    ON [PACASA].[SONDA_SALES_ORDER_HEADER]([WAREHOUSE] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX_SONDA_SALES_ORDER_HEADER_SERVER_POSTED_DATETIME]
    ON [PACASA].[SONDA_SALES_ORDER_HEADER]([SALES_ORDER_ID] ASC)
    INCLUDE([SERVER_POSTED_DATETIME]);


GO
CREATE NONCLUSTERED INDEX [IDX_SALES_ORDER_TASK_ID]
    ON [PACASA].[SONDA_SALES_ORDER_HEADER]([TASK_ID] ASC);
