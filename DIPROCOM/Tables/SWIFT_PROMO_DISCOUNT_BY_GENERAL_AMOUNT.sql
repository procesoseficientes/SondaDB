CREATE TABLE [DIPROCOM].[SWIFT_PROMO_DISCOUNT_BY_GENERAL_AMOUNT] (
...
CREATE NONCLUSTERED INDEX [ID_SWIFT_PROMO_DISCOUNT_BY_GENERAL_AMOUNT_LAST_UPDATE]
    ON [DIPROCOM].[SWIFT_PROMO_DISCOUNT_BY_GENERAL_AMOUNT]([LAST_UPDATE] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX_SWIFT_PROMO_DISCOUNT_BY_GENERAL_AMOUNT_DISCOUNT_BY_GENERAL_AMOUNT_ID]
    ON [DIPROCOM].[SWIFT_PROMO_DISCOUNT_BY_GENERAL_AMOUNT]([DISCOUNT_BY_GENERAL_AMOUNT_ID] ASC)
