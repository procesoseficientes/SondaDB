CREATE TABLE [PACASA].[SWIFT_PROMO_BONUS_BY_MULTIPLE] (
    ...
    FOREIGN KEY ([PACK_UNIT_BONUS]) REFERENCES [PACASA].[SONDA_PACK_UNIT] ([PACK_UNIT]),
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_BONUS_BY_MULTIPLE_LAST_UPDATE]
    ON [PACASA].[SWIFT_PROMO_BONUS_BY_MULTIPLE]([LAST_UPDATE] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_BONUS_BY_MULTIPLE_PROMO]
    ON [PACASA].[SWIFT_PROMO_BONUS_BY_MULTIPLE]([PROMO_ID] ASC)
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_BONUS_BY_MULTIPLE_PROMO_PROMO_ID_PACK_UNIT]
    ON [PACASA].[SWIFT_PROMO_BONUS_BY_MULTIPLE]([PROMO_ID] ASC, [PACK_UNIT] ASC, [PACK_UNIT_BONUS] ASC)
