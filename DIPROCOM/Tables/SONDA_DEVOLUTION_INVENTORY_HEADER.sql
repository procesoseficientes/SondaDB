CREATE TABLE [PACASA].[SONDA_DEVOLUTION_INVENTORY_HEADER] (
...
CREATE NONCLUSTERED INDEX [IN_SONDA_DEVOLUTION_INVENTORY_DEVOLUTION_ID]
    ON [PACASA].[SONDA_DEVOLUTION_INVENTORY_HEADER]([DEVOLUTION_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SONDA_DEVOLUTION_INVENTORY_HEADER_CODE_ROUTE]
    ON [PACASA].[SONDA_DEVOLUTION_INVENTORY_HEADER]([CODE_ROUTE] ASC);
