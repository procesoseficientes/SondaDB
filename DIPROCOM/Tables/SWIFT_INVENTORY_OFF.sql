CREATE TABLE [PACASA].[SWIFT_INVENTORY_OFF] (
...
CREATE NONCLUSTERED INDEX [IDX_SERIAL_NUMBER_WAREHOUSE_SKU_INVENTORY_OFF]
    ON [PACASA].[SWIFT_INVENTORY_OFF]([SERIAL_NUMBER] ASC, [WAREHOUSE] ASC, [SKU] ASC)
    INCLUDE([INVENTORY], [ON_HAND]);


GO
CREATE NONCLUSTERED INDEX [IDX_WAREHOUSE_INVENTORY_OFF]
    ON [PACASA].[SWIFT_INVENTORY_OFF]([WAREHOUSE] ASC)
