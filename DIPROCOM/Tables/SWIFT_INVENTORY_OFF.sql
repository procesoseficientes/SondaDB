CREATE TABLE [DIPROCOM].[SWIFT_INVENTORY_OFF] (
    ...
    [TXN_ID]               INT           NULL,
    [IS_SCANNED]           INT           CONSTRAINT [DF_ADD_COLUM_INVENTARY_OFF] DEFAULT ((1)) NULL,
    [RELOCATED_DATE]       DATETIME      CONSTRAINT [DF_ADD_DATE_AT_COLUM_INVENTARY_OFF] DEFAULT ('') NULL,
    [PALLET_ID]            INT           NULL,
...
CREATE NONCLUSTERED INDEX [IDX_SERIAL_NUMBER_WAREHOUSE_SKU_INVENTORY_OFF]
    ON [DIPROCOM].[SWIFT_INVENTORY_OFF]([SERIAL_NUMBER] ASC, [WAREHOUSE] ASC, [SKU] ASC)
    INCLUDE([INVENTORY], [ON_HAND]);


GO
CREATE NONCLUSTERED INDEX [IDX_WAREHOUSE_INVENTORY_OFF]
    ON [DIPROCOM].[SWIFT_INVENTORY_OFF]([WAREHOUSE] ASC)
