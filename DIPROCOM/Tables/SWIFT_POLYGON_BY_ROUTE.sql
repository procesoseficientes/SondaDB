CREATE TABLE [DIPROCOM].[SWIFT_POLYGON_BY_ROUTE] (
    [ROUTE]           INT NOT NULL,
    ...
    CONSTRAINT [FK_SWIFT_POLYGON_BY_ROUTE_ROUTE] FOREIGN KEY ([ROUTE]) REFERENCES [DIPROCOM].[SWIFT_ROUTES] ([ROUTE]),
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_POLYGON_BY_ROUTE_ID_FREQUENCY]
    ON [DIPROCOM].[SWIFT_POLYGON_BY_ROUTE]([ID_FREQUENCY] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_POLYGON_BY_ROUTE_ROUTE]
    ON [DIPROCOM].[SWIFT_POLYGON_BY_ROUTE]([ROUTE] ASC);
