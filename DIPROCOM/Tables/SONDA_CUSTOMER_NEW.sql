CREATE TABLE [DIPROCOM].[SONDA_CUSTOMER_NEW] (
...
CREATE NONCLUSTERED INDEX [IDX_DOC_SERIE_DOC_NUM_SYNC_ID_CUSTOMERS_NEW]
    ON [DIPROCOM].[SONDA_CUSTOMER_NEW]([DOC_SERIE] ASC, [DOC_NUM] ASC, [SYNC_ID] ASC, [IS_READY_TO_SEND] ASC)
    INCLUDE([CODE_CUSTOMER]);


GO
CREATE NONCLUSTERED INDEX [IN_SONDA_SCOUTING_CODE_ROUTE]
    ON [DIPROCOM].[SONDA_CUSTOMER_NEW]([CODE_ROUTE] ASC)
