CREATE TABLE [PACASA].[SWIFT_BONUS_LIST_BY_SKU_MULTIPLE] (
    ...
    CONSTRAINT [FK_SWIFT_BONUS_LIST_BY_SKU_MULTIPLE_SWIFT_BONUS_LIST] FOREIGN KEY ([BONUS_LIST_ID]) REFERENCES [PACASA].[SWIFT_BONUS_LIST] ([BONUS_LIST_ID]),
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_BONUS_LIST_BY_SKU_MULTIPLE_BONUS_LIST_ID]
    ON [PACASA].[SWIFT_BONUS_LIST_BY_SKU_MULTIPLE]([BONUS_LIST_ID] ASC)
