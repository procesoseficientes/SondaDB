CREATE TABLE [DIPROCOM].[SWIFT_BONUS_LIST_BY_SKU_MULTIPLE] (
    ...
    CONSTRAINT [FK_SWIFT_BONUS_LIST_BY_SKU_MULTIPLE_SWIFT_BONUS_LIST] FOREIGN KEY ([BONUS_LIST_ID]) REFERENCES [DIPROCOM].[SWIFT_BONUS_LIST] ([BONUS_LIST_ID]),
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_BONUS_LIST_BY_SKU_MULTIPLE_BONUS_LIST_ID]
    ON [DIPROCOM].[SWIFT_BONUS_LIST_BY_SKU_MULTIPLE]([BONUS_LIST_ID] ASC)
