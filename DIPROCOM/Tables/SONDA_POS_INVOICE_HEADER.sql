CREATE TABLE [PACASA].[SONDA_POS_INVOICE_HEADER] (
...
CREATE NONCLUSTERED INDEX [IN_SONDA_POS_INVOICE_HEADER_POS_TERMINAL_POSTED_BY]
    ON [PACASA].[SONDA_POS_INVOICE_HEADER]([POS_TERMINAL] ASC, [POSTED_BY] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SONDA_INVOICE_POS_TERMINAL]
    ON [PACASA].[SONDA_POS_INVOICE_HEADER]([POS_TERMINAL] ASC)
    INCLUDE([IS_ACTIVE_ROUTE], [IS_READY_TO_SEND]);


GO
CREATE NONCLUSTERED INDEX [IndexSondaPosHeader]
    ON [PACASA].[SONDA_POS_INVOICE_HEADER]([IS_READY_TO_SEND] ASC, [INVOICED_DATETIME] ASC);
