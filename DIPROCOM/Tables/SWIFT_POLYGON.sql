CREATE TABLE [PACASA].[SWIFT_POLYGON] (
    ...
    FOREIGN KEY ([POLYGON_ID_PARENT]) REFERENCES [PACASA].[SWIFT_POLYGON] ([POLYGON_ID]),
    FOREIGN KEY ([POLYGON_ID_PARENT]) REFERENCES [PACASA].[SWIFT_POLYGON] ([POLYGON_ID]),
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_POLYGON_POLYGON_ID_PARENT]
    ON [PACASA].[SWIFT_POLYGON]([POLYGON_ID_PARENT] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_POLYGON_POLYGON_NAME]
    ON [PACASA].[SWIFT_POLYGON]([POLYGON_NAME] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_POLYGON_POLYGON_POLYGON_ID_PARENT_SUB_TYPE]
    ON [PACASA].[SWIFT_POLYGON]([POLYGON_ID_PARENT] ASC, [SUB_TYPE] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_POLYGON_POLYGON_POLYGON_TYPE]
    ON [PACASA].[SWIFT_POLYGON]([POLYGON_TYPE] ASC);


GO

CREATE trigger [PACASA].[POLYGON_borrar]
  on [PACASA].[SWIFT_POLYGON]
  for delete
  as
