CREATE TABLE [PACASA].[SWIFT_PROMO_DISCOUNT_BY_SCALE] (
...
CREATE NONCLUSTERED INDEX [IDX_SWIFT_PROMO_DISCOUNT_BY_SCALE_T0]
    ON [PACASA].[SWIFT_PROMO_DISCOUNT_BY_SCALE]([CODE_SKU] ASC, [PACK_UNIT] ASC, [PROMO_ID] ASC)
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_DISCOUNT_BY_SCALE_LAST_UPDATE]
    ON [PACASA].[SWIFT_PROMO_DISCOUNT_BY_SCALE]([LAST_UPDATE] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_DISCOUNT_BY_SCALE_PROMO_ID]
    ON [PACASA].[SWIFT_PROMO_DISCOUNT_BY_SCALE]([PROMO_ID] ASC)
