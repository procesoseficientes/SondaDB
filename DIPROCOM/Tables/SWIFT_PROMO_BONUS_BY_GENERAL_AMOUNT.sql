CREATE TABLE [DIPROCOM].[SWIFT_PROMO_BONUS_BY_GENERAL_AMOUNT] (
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_BONUS_BY_GENERAL_AMOUNT_LAST_UPDATE]
    ON [DIPROCOM].[SWIFT_PROMO_BONUS_BY_GENERAL_AMOUNT]([LAST_UPDATE] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_BONUS_BY_GENERAL_AMOUNT_PROMO_ID_LOW_LIMIT_HIGH_LIMIT]
    ON [DIPROCOM].[SWIFT_PROMO_BONUS_BY_GENERAL_AMOUNT]([PROMO_ID] ASC)
