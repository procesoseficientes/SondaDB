CREATE TABLE [PACASA].[SWIFT_BONUS_LIST_BY_COMBO] (
    ...
    FOREIGN KEY ([BONUS_LIST_ID]) REFERENCES [PACASA].[SWIFT_BONUS_LIST] ([BONUS_LIST_ID]),
    CONSTRAINT [FK_SWIFT_BONUS_LIST_BY_COMBO_SWIFT_COMBO] FOREIGN KEY ([COMBO_ID]) REFERENCES [PACASA].[SWIFT_COMBO] ([COMBO_ID])
);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_BONUS_LIST_BY_COMBO_BONUS_LIST_ID]
    ON [PACASA].[SWIFT_BONUS_LIST_BY_COMBO]([BONUS_LIST_ID] ASC)
