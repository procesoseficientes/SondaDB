CREATE TABLE [PACASA].[SWIFT_TRADE_AGREEMENT_BY_PROMO] (
    ...
    FOREIGN KEY ([TRADE_AGREEMENT_ID]) REFERENCES [PACASA].[SWIFT_TRADE_AGREEMENT] ([TRADE_AGREEMENT_ID])
);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_TRADE_AGREEMENT_BY_PROMO_LAST_UPDATE]
    ON [PACASA].[SWIFT_TRADE_AGREEMENT_BY_PROMO]([LAST_UPDATE] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_TRADE_AGREEMENT_BY_PROMO_PROMO_ID]
    ON [PACASA].[SWIFT_TRADE_AGREEMENT_BY_PROMO]([PROMO_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_TRADE_AGREEMENT_BY_PROMO_PROMO_ID_TRADE_AGREEMENT_ID]
    ON [PACASA].[SWIFT_TRADE_AGREEMENT_BY_PROMO]([PROMO_ID] ASC, [TRADE_AGREEMENT_ID] ASC)
    INCLUDE([FREQUENCY]);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_TRADE_AGREEMENT_BY_PROMO_TRADE_AGREEMENT_ID]
    ON [PACASA].[SWIFT_TRADE_AGREEMENT_BY_PROMO]([TRADE_AGREEMENT_ID] ASC);
