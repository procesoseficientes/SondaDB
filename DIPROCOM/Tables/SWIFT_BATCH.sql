CREATE TABLE [DIPROCOM].[SWIFT_BATCH] (
    ...
    CONSTRAINT [FK_SWIFT_BATCH_TASK_ID] FOREIGN KEY ([TASK_ID]) REFERENCES [DIPROCOM].[SWIFT_TASKS] ([TASK_ID])
);


GO
CREATE NONCLUSTERED INDEX [IDX_BATCH_TASK_ID]
    ON [DIPROCOM].[SWIFT_BATCH]([TASK_ID] ASC);
