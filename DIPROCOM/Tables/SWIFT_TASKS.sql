CREATE TABLE [DIPROCOM].[SWIFT_TASKS] (
...
CREATE NONCLUSTERED INDEX [IDX_STATUS_TASK]
    ON [DIPROCOM].[SWIFT_TASKS]([TASK_ID] ASC, [TASK_STATUS] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX_STATUS_TASK_ID]
    ON [DIPROCOM].[SWIFT_TASKS]([TASK_ID] ASC)
    INCLUDE([TASK_STATUS], [ASSIGEND_TO], [TASK_DATE]);


GO
CREATE NONCLUSTERED INDEX [IDX_TASK_ID_TASK_DATE_ASSIGNED_TO]
    ON [DIPROCOM].[SWIFT_TASKS]([TASK_DATE] ASC, [ASSIGEND_TO] ASC)
    INCLUDE([TASK_ID]);


GO
CREATE NONCLUSTERED INDEX [IDX_TASKS]
    ON [DIPROCOM].[SWIFT_TASKS]([TASK_TYPE] ASC, [SCHEDULE_FOR] ASC, [ASSIGEND_TO] ASC, [TASK_STATUS] ASC)
