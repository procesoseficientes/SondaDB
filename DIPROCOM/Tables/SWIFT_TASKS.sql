CREATE TABLE [PACASA].[SWIFT_TASKS] (
...
CREATE NONCLUSTERED INDEX [IDX_STATUS_TASK]
    ON [PACASA].[SWIFT_TASKS]([TASK_ID] ASC, [TASK_STATUS] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX_STATUS_TASK_ID]
    ON [PACASA].[SWIFT_TASKS]([TASK_ID] ASC)
    INCLUDE([TASK_STATUS], [ASSIGEND_TO], [TASK_DATE]);


GO
CREATE NONCLUSTERED INDEX [IDX_TASK_ID_TASK_DATE_ASSIGNED_TO]
    ON [PACASA].[SWIFT_TASKS]([TASK_DATE] ASC, [ASSIGEND_TO] ASC)
    INCLUDE([TASK_ID]);


GO
CREATE NONCLUSTERED INDEX [IDX_TASKS]
    ON [PACASA].[SWIFT_TASKS]([TASK_TYPE] ASC, [SCHEDULE_FOR] ASC, [ASSIGEND_TO] ASC, [TASK_STATUS] ASC)
...
CREATE NONCLUSTERED INDEX [IX_SWIFT_TASKS_CODE_ROUTE]
    ON [PACASA].[SWIFT_TASKS]([CODE_ROUTE] ASC)
...
CREATE NONCLUSTERED INDEX [IN_SWIFT_TASKS_TASK_TYPE_ASSIGNED_TO]
    ON [PACASA].[SWIFT_TASKS]([TASK_TYPE] ASC, [ASSIGEND_TO] ASC)
