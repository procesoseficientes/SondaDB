CREATE TABLE [DIPROCOM].[SWIFT_PROMO_BY_COMBO_PROMO_RULE] (
    ...
    FOREIGN KEY ([COMBO_ID]) REFERENCES [DIPROCOM].[SWIFT_COMBO] ([COMBO_ID])
);


GO
CREATE NONCLUSTERED INDEX [IDX_SWIFT_PROMO_BY_COMBO_PROMO_RULE_COMBO_ID]
    ON [DIPROCOM].[SWIFT_PROMO_BY_COMBO_PROMO_RULE]([COMBO_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_BY_COMBO_PROMO_RULE_LAST_UPDATE]
    ON [DIPROCOM].[SWIFT_PROMO_BY_COMBO_PROMO_RULE]([LAST_UPDATE] ASC);
