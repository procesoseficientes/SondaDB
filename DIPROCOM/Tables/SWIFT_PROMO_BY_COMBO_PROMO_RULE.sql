CREATE TABLE [PACASA].[SWIFT_PROMO_BY_COMBO_PROMO_RULE] (
    ...
    FOREIGN KEY ([COMBO_ID]) REFERENCES [PACASA].[SWIFT_COMBO] ([COMBO_ID])
);


GO
CREATE NONCLUSTERED INDEX [IDX_SWIFT_PROMO_BY_COMBO_PROMO_RULE_COMBO_ID]
    ON [PACASA].[SWIFT_PROMO_BY_COMBO_PROMO_RULE]([COMBO_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_PROMO_BY_COMBO_PROMO_RULE_LAST_UPDATE]
    ON [PACASA].[SWIFT_PROMO_BY_COMBO_PROMO_RULE]([LAST_UPDATE] ASC);
