CREATE TABLE [DIPROCOM].[SWIFT_SELLER] (
    ...
    CONSTRAINT [FK_SWIFT_SELLER_SALES_OFFICE_ID] FOREIGN KEY ([SALES_OFFICE_ID]) REFERENCES [DIPROCOM].[SWIFT_SALES_OFFICE] ([SALES_OFFICE_ID])
);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_SELLER_SELLER_CODE]
    ON [DIPROCOM].[SWIFT_SELLER]([SELLER_CODE] ASC)
    INCLUDE([SELLER_NAME]);
