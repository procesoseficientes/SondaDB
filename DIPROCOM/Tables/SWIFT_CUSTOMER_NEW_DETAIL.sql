CREATE TABLE [PACASA].[SWIFT_CUSTOMER_NEW_DETAIL] (
    ...
    CONSTRAINT [FK_DIPROCOM_SWIFT_CUSTOMER_NEW_DETAIL_SWIFT_CUSTOMERS_NEW] FOREIGN KEY ([CUSTOMER]) REFERENCES [PACASA].[SWIFT_CUSTOMERS_NEW] ([CUSTOMER])
);
