CREATE TABLE [PACASA].[SWIFT_SPECIAL_PRICE_PRIORITY] (
...
GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_SPECIAL_PRICE_PRIORITY_ORDER_ACTIVE_SWIFT_INTERFACE_ONLINE]
    ON [PACASA].[SWIFT_SPECIAL_PRICE_PRIORITY]([ORDER] ASC, [ACTIVE_SWIFT_INTERFACE_ONLINE] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_SPECIAL_PRICE_PRIORITY_ORDER_ACTIVE_SWIFT_EXPRESS]
    ON [PACASA].[SWIFT_SPECIAL_PRICE_PRIORITY]([ORDER] ASC, [ACTIVE_SWIFT_EXPRESS] ASC)
    INCLUDE([LINKED_TO], [SPECIAL_PRICE_PRIORITY_ID]);
