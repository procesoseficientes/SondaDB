CREATE TABLE [PACASA].[SONDA_SALES_ORDER_DETAIL] (
    ...
    CONSTRAINT [FK_SONDA_SALES_ORDER_DETAIL_SONDA_SALES_ORDER_HEADER] FOREIGN KEY ([SALES_ORDER_ID]) REFERENCES [PACASA].[SONDA_SALES_ORDER_HEADER] ([SALES_ORDER_ID])
);
