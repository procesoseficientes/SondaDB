CREATE TABLE [DIPROCOM].[SONDA_SALES_ORDER_DETAIL] (
    ...
    [DISCOUNT_BY_FAMILY]                          NUMERIC (18, 6) NULL,
    [DISCOUNT_BY_GENERAL_AMOUNT]                  NUMERIC (18, 6) NULL,
    [DISCOUNT_BY_FAMILY_AND_PAYMENT_TYPE]         NUMERIC (18, 6) NULL,
    ...
    CONSTRAINT [FK_SONDA_SALES_ORDER_DETAIL_SONDA_SALES_ORDER_HEADER] FOREIGN KEY ([SALES_ORDER_ID]) REFERENCES [DIPROCOM].[SONDA_SALES_ORDER_HEADER] ([SALES_ORDER_ID])
);
