CREATE TABLE [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE] (
    ...
    CONSTRAINT [FK__SWIFT_TRA__COMBO__5E0D488B] FOREIGN KEY ([COMBO_ID]) REFERENCES [DIPROCOM].[SWIFT_COMBO] ([COMBO_ID])
);


GO
CREATE NONCLUSTERED INDEX [IN_SWIFT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE_COMBO_ID]
    ON [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE]([COMBO_ID] ASC);
