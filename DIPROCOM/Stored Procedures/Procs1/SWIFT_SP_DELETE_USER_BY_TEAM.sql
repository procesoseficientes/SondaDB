...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_DELETE_USER_BY_TEAM]
					  @TEAM_ID = 1          
				-- 
				SELECT * FROM [PACASA].[SWIFT_TEAM]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_DELETE_USER_BY_TEAM] (@TEAM_ID INT, @USER_ID INT = NULL)
AS
BEGIN
  BEGIN TRY
    --

    DELETE FROM [PACASA].[SWIFT_USER_BY_TEAM]
