...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_DELETE_USER_BY_TEAM]
					  @TEAM_ID = 1          
				-- 
				SELECT * FROM [DIPROCOM].[SWIFT_TEAM]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_DELETE_USER_BY_TEAM] (@TEAM_ID INT, @USER_ID INT = NULL)
AS
BEGIN
  BEGIN TRY
    --

    DELETE FROM [DIPROCOM].[SWIFT_USER_BY_TEAM]
