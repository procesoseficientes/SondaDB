...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_PROPOSAL_FROM_FREQUENCY_BY_POLYGON]
					@POLYGON_ID = 1111
				--				
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_PROPOSAL_FROM_FREQUENCY_BY_POLYGON](
	@POLYGON_ID INT
)
AS
BEGIN
...
--
  ...
  INNER JOIN DIPROCOM.SWIFT_POLYGON_X_CUSTOMER PC ON (
