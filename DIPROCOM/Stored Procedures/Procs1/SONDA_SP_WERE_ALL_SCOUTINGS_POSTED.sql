...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_WERE_ALL_SCOUTINGS_POSTED] (@QUANTITY INT, @ROUTE_ID VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON; 
  DECLARE @COUNT INT;
  ...
  SELECT @COUNT= COUNT(1) FROM [DIPROCOM].SONDA_CUSTOMER_NEW scn
    WHERE    
