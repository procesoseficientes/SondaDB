...
EXECUTE @RC = [acsa].SONDA_SP_VALIDATE_DEPOSITS_WERE_POSTED @XML
                                                          ,@JSON
GO
 
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_VALIDATE_DEPOSIT_IS_POSTED] (@DEPOSIT_ID INT
, @DEPOSIT_ID_HH INT
...
BEGIN
  ...
  FROM [acsa].SONDA_DEPOSITS [H] /*WITH(ROWLOCK,XLOCK,HOLDLOCK)*/
  ...
  EXISTE:
    ...
    PRINT 'Existe'
    --
    INSERT INTO [acsa].[SONDA_DEPOSIT_LOG_EXISTS] ([LOG_DATETIME]
    , EXISTS_DEPOSIT
    , [DOC_SERIE]
    , [DOC_NUM]
    , [CODE_ROUTE]
