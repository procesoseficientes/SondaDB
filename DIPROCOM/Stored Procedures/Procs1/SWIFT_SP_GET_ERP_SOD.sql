...
CREATE PROC [DIPROCOM].[SWIFT_SP_GET_ERP_SOD] @PICKING_HEADER VARCHAR(50)
AS
...
SELECT   r.LineNum , r.ObjType,r.ItemCode,r.DocEntry, r.OpenQty FROM BD_Prueba_Viscosa.DBO.RDR1 r  INNER JOIN BD_Prueba_Viscosa.dbo.ORDR o
