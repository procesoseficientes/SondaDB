...
/*
	Ejemplo Ejecucion: 
    EXEC [DIPROCOM].[SWIFT_SP_GET_ROUTES_BY_SELLER] @SELLER_CODE = N'-1'
 */
-- =============================================

CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_ROUTES_BY_SELLER]
...
BEGIN
	...
	SELECT
		...
		,[NAME_COUNTRY]
		,[SELLER_CODE]
	FROM [SWIFT_EXPRESS].[DIPROCOM].[SWIFT_ROUTES]
