...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GENERATE_BONUS_BY_CHANNEL_FOR_DUPLICATE]
					@CODE_ROUTE = 'RUDI@DIPROCOM'
					,@ORDER = 2
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GENERATE_BONUS_BY_CHANNEL_FOR_DUPLICATE] (@CODE_ROUTE VARCHAR(250)
, @ORDER INT)
AS
BEGIN
  SET NOCOUNT ON;
  ...
  , [FREQUENCY])
    ...
    LEFT JOIN [DIPROCOM].[SWIFT_BONUS_LIST_BY_SKU] [BLBS]
      ON (
