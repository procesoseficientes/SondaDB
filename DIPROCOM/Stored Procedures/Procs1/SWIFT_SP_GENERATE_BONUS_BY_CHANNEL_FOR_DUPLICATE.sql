...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GENERATE_BONUS_BY_CHANNEL_FOR_DUPLICATE]
					@CODE_ROUTE = 'RUDI@DIPROCOM'
					,@ORDER = 2
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GENERATE_BONUS_BY_CHANNEL_FOR_DUPLICATE] (@CODE_ROUTE VARCHAR(250)
, @ORDER INT)
AS
BEGIN
  SET NOCOUNT ON;
  ...
  , [FREQUENCY])
    ...
    LEFT JOIN [PACASA].[SWIFT_BONUS_LIST_BY_SKU] [BLBS]
      ON (
