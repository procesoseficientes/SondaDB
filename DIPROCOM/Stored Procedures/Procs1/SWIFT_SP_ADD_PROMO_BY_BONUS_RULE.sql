...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_ADD_PROMO_BY_BONUS_RULE]
					@PROMO_ID = 6
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_ADD_PROMO_BY_BONUS_RULE](
	@PROMO_ID INT
...
BEGIN
	...
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [DIPROCOM].[SWIFT_PROMO_BY_BONUS_RULE]
				(
					[PROMO_ID]
