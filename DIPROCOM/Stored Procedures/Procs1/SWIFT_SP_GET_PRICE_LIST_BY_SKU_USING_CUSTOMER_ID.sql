...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_PRICE_LIST_BY_SKU_USING_CUSTOMER_ID]  
					@CODE_ROUTE = 'ES000035'
					,@CODE_CUSTOMER = 'CS006519'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_PRICE_LIST_BY_SKU_USING_CUSTOMER_ID](
...
BEGIN
	...
	SELECT 
		...
		,[SPS].[HIGH_LIMIT]
		,[SPS].[PRICE]
	FROM [DIPROCOM].[SWIFT_PRICE_LIST_BY_CUSTOMER_FOR_ROUTE] [PLC]
	INNER JOIN [DIPROCOM].[SWIFT_PRICE_LIST_BY_SKU_PACK_SCALE_FOR_ROUTE] [SPS] ON (
