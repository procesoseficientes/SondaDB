...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_PROMO_TYPE]
					@PROMO_TYPE = 'BONUS_BY_SCALE'
				--
				EXEC [DIPROCOM].[SWIFT_SP_GET_PROMO_TYPE]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_PROMO_TYPE](
...
BEGIN
	...
	SELECT [PROMO_ID]
			,[PROMO_NAME]
			,[PROMO_TYPE] 
	FROM [DIPROCOM].[SWIFT_PROMO] WHERE [PROMO_TYPE] = @PROMO_TYPE OR @PROMO_TYPE IS NULL
END
