...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_PROMO_TYPE]
					@PROMO_TYPE = 'BONUS_BY_SCALE'
				--
				EXEC [PACASA].[SWIFT_SP_GET_PROMO_TYPE]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_PROMO_TYPE](
...
BEGIN
	...
	SELECT [PROMO_ID]
			,[PROMO_NAME]
			,[PROMO_TYPE] 
	FROM [PACASA].[SWIFT_PROMO] WHERE [PROMO_TYPE] = @PROMO_TYPE OR @PROMO_TYPE IS NULL
END
