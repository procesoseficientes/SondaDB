...
-- Ejemplo de Ejecucion:
	...
	EXECUTE [DIPROCOM].[SWIFT_SP_INSERT_CUSTOMER_NEW_DETAIL] 
		@CUSTOMER = '2230'
	   ,@CODE_CUSTOMER = ''
	   ,@SALE_ROUTE  =''
	   ,@REFERENCE_CBC  =''
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_CUSTOMER_NEW_DETAIL]
	 @CUSTOMER INT
...
BEGIN TRY
	--
	IF(SELECT 1 FROM [DIPROCOM].[SWIFT_CUSTOMER_NEW_DETAIL] WHERE [CUSTOMER] = @CUSTOMER) = 1 BEGIN
		UPDATE [DIPROCOM].[SWIFT_CUSTOMER_NEW_DETAIL]
	...
	END
	ELSE BEGIN
		INSERT INTO [DIPROCOM].[SWIFT_CUSTOMER_NEW_DETAIL]
		(
			[CUSTOMER]
			,[SALE_ROUTE]
			,[REFERENCE_CBC]
		...
		--EXEC [DIPROCOM].[SWIFT_SP_UPDATE_SCOUTING] @STATUS = 'ACCEPTED', @USER = @LAST_UPDATED_BY, @COMMENTS = @COMMENTS, @CUSTOMER = @CUSTOMER
