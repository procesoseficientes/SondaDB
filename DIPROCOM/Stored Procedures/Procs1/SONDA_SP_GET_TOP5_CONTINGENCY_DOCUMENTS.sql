...
-- Ejemplo de Ejecucion:
	EXEC [PACASA].[SONDA_SP_GET_TOP5_CONTINGENCY_DOCUMENTS]
  
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_TOP5_CONTINGENCY_DOCUMENTS]
AS
BEGIN
    ...
    SELECT @SHIPMENT_ATTEMPTS
        = [PACASA].[SWIFT_FN_GET_PARAMETER]('SONDA_FEL_CONFIGURATION', 'FEL_CONTINGENCY_DOCUMENT_SHIPMENT_ATTEMPTS');
    ...
    SELECT TOP (5)
           ...
           (
               ...
               FROM [PACASA].[SWIFT_VIEW_CUSTOMERS] AS [VC]
