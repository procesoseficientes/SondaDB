...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_INSERT_HISTORICAL_GPS_SELLER]
				@CODE_ROUTE = '46'
				...
				-- 
				SELECT * FROM [PACASA].[SONDA_HISTORICAL_GPS_SELLER] 
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_INSERT_HISTORICAL_GPS_SELLER](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [PACASA].[SONDA_HISTORICAL_GPS_SELLER]
				(
					[CODE_ROUTE]
					,[GPS]
					,[LONGITUDE]
	...
	BEGIN CATCH
		...
		EXEC [PACASA].[SONDA_SP_INSERT_SONDA_SERVER_ERROR_LOG] 
