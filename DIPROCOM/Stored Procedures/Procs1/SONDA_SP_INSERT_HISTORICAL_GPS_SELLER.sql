...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SONDA_SP_INSERT_HISTORICAL_GPS_SELLER]
				@CODE_ROUTE = '46'
				...
				-- 
				SELECT * FROM [DIPROCOM].[SONDA_HISTORICAL_GPS_SELLER] 
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_INSERT_HISTORICAL_GPS_SELLER](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [DIPROCOM].[SONDA_HISTORICAL_GPS_SELLER]
				(
					[CODE_ROUTE]
					,[GPS]
					,[LONGITUDE]
	...
	BEGIN CATCH
		...
		EXEC DIPROCOM.[SONDA_SP_INSERT_SONDA_SERVER_ERROR_LOG] 
