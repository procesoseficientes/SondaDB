...
-- Ejemplo de Ejecucion:
        EXEC [PACASA].[SWIFT_SP_GET_OPERATOR_BY_VEHICLE]
		--
		EXEC [PACASA].[SWIFT_SP_GET_OPERATOR_BY_VEHICLE]
			@CODE_VEHICLE = '001'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_OPERATOR_BY_VEHICLE]
...
BEGIN
	...
	FROM [PACASA].[SWIFT_VIEW_OPERATOR] [O]
	INNER JOIN [PACASA].[SWIFT_VEHICLE_X_USER] [VU] ON (
		[O].[LOGIN] = [VU].[LOGIN]
	)
