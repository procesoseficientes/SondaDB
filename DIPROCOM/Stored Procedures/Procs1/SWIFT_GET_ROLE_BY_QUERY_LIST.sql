CREATE PROCEDURE [DIPROCOM].[SWIFT_GET_ROLE_BY_QUERY_LIST] (@QUERY_LIST_ID INT)
AS 
BEGIN 
 ...
 DECLARE	@TEAM_ROLE TABLE
  ...
  SELECT QR.TEAM_ID	
  FROM [DIPROCOM].[SWIFT_QUERY_LIST_BY_ROLE] [QR]
  ...
  -- ---------------------------------------------------------------------------------------
	...
	---------------------------------------------------------------------------------------------
			...
			SELECT @NAMEROLE=NAME FROM DIPROCOM.SWIFT_ROLE
