...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_PRICE_LIST_BY_SKU_PACK_SCALE_bk_anterior] (
...
BEGIN
	...
	INNER JOIN [acsa].SWIFT_PRICE_LIST_BY_CUSTOMER splbc ON (
	...
	SELECT  [acsa].[SWIFT_FN_GET_PRICE_LIST_BY_WH](@WAREHOUSES)
	--SELECT [acsa].SWIFT_FN_GET_PARAMETER('ERP_HARDCODE_VALUES','PRICE_LIST');
	--
	SELECT DISTINCT
		PL.[CODE_PRICE_LIST]
		,PL.[CODE_SKU]
