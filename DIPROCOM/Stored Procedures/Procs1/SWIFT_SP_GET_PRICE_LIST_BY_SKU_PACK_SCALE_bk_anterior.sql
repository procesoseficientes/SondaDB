...
*/
-- =============================================
CREATE PROCEDURE [SONDA].[SWIFT_SP_GET_PRICE_LIST_BY_SKU_PACK_SCALE_bk_anterior] (
...
BEGIN
	...
	INNER JOIN [SONDA].SWIFT_PRICE_LIST_BY_CUSTOMER splbc ON (
	...
	SELECT  [SONDA].[SWIFT_FN_GET_PRICE_LIST_BY_WH](@WAREHOUSES)
