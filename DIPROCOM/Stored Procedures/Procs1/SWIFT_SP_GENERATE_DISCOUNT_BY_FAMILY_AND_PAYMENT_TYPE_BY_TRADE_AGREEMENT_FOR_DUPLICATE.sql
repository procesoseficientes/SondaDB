...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GENERATE_DISCOUNT_BY_FAMILY_AND_PAYMENT_TYPE_BY_TRADE_AGREEMENT_FOR_DUPLICATE]
					@CODE_ROUTE = '44'
					,@ORDER = 1
*/
-- =============================================
...
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GENERATE_DISCOUNT_BY_FAMILY_AND_PAYMENT_TYPE_BY_TRADE_AGREEMENT_FOR_DUPLICATE] (@CODE_ROUTE VARCHAR(250)
, @ORDER INT)
AS
BEGIN
  SET NOCOUNT ON;
...
[PDPF].[PROMO_ID] = [P].[PROMO_ID]
    ...
    LEFT JOIN [DIPROCOM].[SWIFT_DISCOUNT_LIST_BY_PAYMENT_TYPE_AND_FAMILY] [DGF]
      ON (
