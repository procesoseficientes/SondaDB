...
-- Description:			    SP que genera los descuentos por familia y tipo de pago por acuerdo comercial de los clientes en acuerdo comercial por cliente y canal

/*
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GENERATE_DISCOUNT_BY_FAMILY_AND_PAYMENT_TYPE_BY_TRADE_AGREEMENT_FOR_DUPLICATE]
					@CODE_ROUTE = '44'
					,@ORDER = 1
*/
-- =============================================
...
CREATE PROCEDURE [PACASA].[SWIFT_SP_GENERATE_DISCOUNT_BY_FAMILY_AND_PAYMENT_TYPE_BY_TRADE_AGREEMENT_FOR_DUPLICATE] (@CODE_ROUTE VARCHAR(250)
, @ORDER INT)
AS
BEGIN
  SET NOCOUNT ON;
...
[PDPF].[PROMO_ID] = [P].[PROMO_ID]
    ...
    LEFT JOIN [PACASA].[SWIFT_DISCOUNT_LIST_BY_PAYMENT_TYPE_AND_FAMILY] [DGF]
      ON (
