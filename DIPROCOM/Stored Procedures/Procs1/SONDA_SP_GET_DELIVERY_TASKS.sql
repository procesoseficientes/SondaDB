...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_GET_DELIVERY_TASKS]
				@LOGIN_ID = 'ADOLFO@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [PACASA].SONDA_SP_GET_DELIVERY_TASKS (@LOGIN_ID VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  INNER JOIN [PACASA].[SWIFT_VIEW_ALL_COSTUMER] AS VC
