...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SONDA_SP_GET_DELIVERY_TASKS]
				@LOGIN_ID = 'ADOLFO@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SONDA_SP_GET_DELIVERY_TASKS (@LOGIN_ID VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  INNER JOIN [DIPROCOM].[SWIFT_VIEW_ALL_COSTUMER] AS VC
