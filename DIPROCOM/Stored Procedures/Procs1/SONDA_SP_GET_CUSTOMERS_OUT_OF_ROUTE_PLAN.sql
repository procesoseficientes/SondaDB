...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_GET_CUSTOMERS_OUT_OF_ROUTE_PLAN]
					@CODE_ROUTE = '4'
					,@FILTER = 'TIENDA'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_CUSTOMERS_OUT_OF_ROUTE_PLAN](
...
BEGIN
	...
	LEFT JOIN [PACASA].[SONDA_ROUTE_PLAN] [R] ON (
