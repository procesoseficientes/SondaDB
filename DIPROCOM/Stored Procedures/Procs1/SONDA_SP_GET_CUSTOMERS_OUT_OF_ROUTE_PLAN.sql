...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SONDA_SP_GET_CUSTOMERS_OUT_OF_ROUTE_PLAN]
					@CODE_ROUTE = '4'
					,@FILTER = 'TIENDA'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_CUSTOMERS_OUT_OF_ROUTE_PLAN](
