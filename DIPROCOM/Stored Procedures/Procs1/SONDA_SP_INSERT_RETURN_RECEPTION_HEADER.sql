...
--				   [DIPROCOM].SONDA_DOC_ROUTE_RETURN_HEADER 
...
Ejemplo de Ejecucion:
					...
					EXEC [DIPROCOM].[SONDA_SP_INSERT_RETURN_RECEPTION_HEADER] 
					@USER_LOGIN = 'oper1@DIPROCOM'
					,@WAREHOUSE_SOURCE = 'V004'
					,@WAREHOUSE_TARGET = 'C001'
					,@STATUS_DOC =NULL 

					SELECT * FROM [DIPROCOM].[SONDA_DOC_ROUTE_RETURN_HEADER]
		
				
*/
-- =============================================

CREATE PROCEDURE [DIPROCOM].SONDA_SP_INSERT_RETURN_RECEPTION_HEADER
(
...
BEGIN
    ...
    BEGIN TRY
		...
		FROM [DIPROCOM].USERS AS FU 
		WHERE FU.LOGIN = @USER_LOGIN
		
		INSERT INTO [DIPROCOM].[SONDA_DOC_ROUTE_RETURN_HEADER] (
			USER_LOGIN
			,WAREHOUSE_SOURCE
			,WAREHOUSE_TARGET
			,NAME_USER
