...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [DIPROCOM].[SWIFT_SP_CLEAN_DUPLICATE_CUSTOMER_IN_DISCOUNT_LIST_BY_ROUTE]
					@CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_CLEAN_DUPLICATE_CUSTOMER_IN_DISCOUNT_LIST_BY_ROUTE] (
