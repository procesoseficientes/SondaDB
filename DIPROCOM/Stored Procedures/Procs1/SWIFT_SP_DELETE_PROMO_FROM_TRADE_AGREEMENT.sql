...
-- Ejemplo de Ejecucion:
				...
				--
				EXEC [PACASA].[SWIFT_SP_DELETE_PROMO_FROM_TRADE_AGREEMENT]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_DELETE_PROMO_FROM_TRADE_AGREEMENT] (@TRADE_AGREEMENT_ID INT
, @PROMO_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  BEGIN TRY
    DELETE FROM [PACASA].SWIFT_TRADE_AGREEMENT_BY_PROMO
