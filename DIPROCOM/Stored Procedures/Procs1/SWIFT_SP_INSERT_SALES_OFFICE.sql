...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_INSERT_SALES_OFFICE]
				@SALES_ORGANIZATION_ID = 1
				,@NAME_SALES_OFFICE = 'PRUEBA OFIVENTAS'
				,@DESCRIPTION_SALES_OFFICE = 'PRUEBA OFIVENTAS'
				-- 
				SELECT * FROM [PACASA].[SWIFT_SALES_OFFICE] 
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_INSERT_SALES_OFFICE](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [PACASA].[SWIFT_SALES_OFFICE]
				(
