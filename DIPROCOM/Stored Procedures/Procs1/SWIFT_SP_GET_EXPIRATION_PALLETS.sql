...
-- Ejemplo de Ejecucion:				
				--
EXECUTE  [PACASA].[SWIFT_SP_GET_EXPIRATION_PALLETS]
			@CODE_SKU='100018',
			@TASK_ID = 14174
				--				
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_EXPIRATION_PALLETS]
...
BEGIN 
	...
	INNER JOIN [PACASA].[SWIFT_TASKS] TK ON (PH.PICKING_HEADER = TK.PICKING_NUMBER)
	...
	INNER JOIN [PACASA].[SWIFT_BATCH] AS BC ON (PA.[BATCH_ID] = BC.[BATCH_ID])
	INNER JOIN [PACASA].[SWIFT_VIEW_ALL_SKU] AS SU  ON (SU.[CODE_SKU] = BC.[SKU])	
	WHERE PA.QTY > 0	
