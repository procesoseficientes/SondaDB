...
-- Ejemplo de Ejecucion:
		--
		EXEC [DIPROCOM].SONDA_SP_INSERT_DEVOLUTION_HEADER
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SONDA_SP_INSERT_DEVOLUTION_HEADER
(
...
BEGIN
	...
	BEGIN TRY
		...
		--
		UPDATE [DIPROCOM].SWIFT_DOCUMENT_SEQUENCE SET CURRENT_DOC = @DOC_NUM WHERE SERIE = @DOC_SERIE AND ASSIGNED_TO = @CODE_ROUTE
		--
