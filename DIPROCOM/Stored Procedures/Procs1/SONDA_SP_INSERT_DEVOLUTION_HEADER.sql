...
-- Ejemplo de Ejecucion:
		--
		EXEC [PACASA].SONDA_SP_INSERT_DEVOLUTION_HEADER
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].SONDA_SP_INSERT_DEVOLUTION_HEADER
(
...
BEGIN
	...
	BEGIN TRY
		...
		--
		UPDATE [PACASA].SWIFT_DOCUMENT_SEQUENCE SET CURRENT_DOC = @DOC_NUM WHERE SERIE = @DOC_SERIE AND ASSIGNED_TO = @CODE_ROUTE
		--
