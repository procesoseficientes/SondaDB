...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_GET_UNASSIGNED_SKU_FOR_MULTIPLE_SALES]
					@TRADE_AGREEMENT_ID = 43
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_UNASSIGNED_SKU_FOR_MULTIPLE_SALES](
...
BEGIN
	...
	LEFT JOIN [acsa].[SWIFT_TRADE_AGREEMENT_SKU_SALES_BY_MULTIPLE] [TAS] ON (
