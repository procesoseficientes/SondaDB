...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_UNASSIGNED_SKU_FOR_MULTIPLE_SALES]
					@TRADE_AGREEMENT_ID = 43
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_UNASSIGNED_SKU_FOR_MULTIPLE_SALES](
...
BEGIN
	...
	LEFT JOIN [PACASA].[SWIFT_TRADE_AGREEMENT_SKU_SALES_BY_MULTIPLE] [TAS] ON (
