...
-- Ejemplo de Ejecucion:
				exec [DIPROCOM].SONDA_SP_GET_CONSIGNMENTS_BY_ROUTE  @CODE_ROUTE = 'RUDI@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_CONSIGNMENTS_BY_ROUTE] @CODE_ROUTE VARCHAR(50)
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  SELECT
   ...
   ,[H].[IS_CLOSED]
   ,[H].[CONSIGNMENT_TYPE]
  FROM [DIPROCOM].SWIFT_CONSIGNMENT_HEADER H
