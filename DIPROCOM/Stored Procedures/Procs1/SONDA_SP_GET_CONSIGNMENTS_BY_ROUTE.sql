...
-- Ejemplo de Ejecucion:
				exec [PACASA].SONDA_SP_GET_CONSIGNMENTS_BY_ROUTE  @CODE_ROUTE = 'RUDI@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_CONSIGNMENTS_BY_ROUTE] @CODE_ROUTE VARCHAR(50)
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  SELECT
   ...
   ,[H].[IS_CLOSED]
   ,[H].[CONSIGNMENT_TYPE]
  FROM [PACASA].SWIFT_CONSIGNMENT_HEADER H
