...
-- Ejemplo de Ejecucion:
				exec [acsa].SONDA_SP_GET_CONSIGNMENTS_BY_ROUTE  @CODE_ROUTE = 'RUDI@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_GET_CONSIGNMENTS_BY_ROUTE] @CODE_ROUTE VARCHAR(50)
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  SELECT
   ...
   ,[H].[IS_CLOSED]
   ,[H].[CONSIGNMENT_TYPE]
  FROM [acsa].SWIFT_CONSIGNMENT_HEADER H
