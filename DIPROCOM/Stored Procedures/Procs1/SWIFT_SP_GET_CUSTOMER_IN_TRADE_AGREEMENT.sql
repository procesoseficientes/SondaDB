...
Ejemplo de Ejecución:
	...
	EXEC [DIPROCOM].[SWIFT_SP_GET_CUSTOMER_IN_TRADE_AGREEMENT]
		@TRADE_AGREEMENT_ID = 1

==================================================*/

CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_CUSTOMER_IN_TRADE_AGREEMENT]
(
...
BEGIN
	SELECT
		...
		,VAC.NAME_CUSTOMER
		,VAC.ADRESS_CUSTOMER
	FROM [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_CUSTOMER] AS TA
