/****** Object:  StoredProcedure [DIPROCOM].[SWIFT_SP_INSERT_PALLET]    Script Date: 20/12/2015 9:09:38 AM ******/
-- =============================================
-- Autor:				jose.garcia
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_PALLET]
	@BATCH_ID INT
	,@STATUS VARCHAR(20)
	,@QTY INT
...
BEGIN
	...
	BEGIN TRAN
	BEGIN TRY
		INSERT INTO [DIPROCOM].[SWIFT_PALLET](
			[BATCH_ID]
			,[STATUS]
			,[QTY]
			,[LAST_UPDATE]
