...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_ASSOCIATE_SKU_OF_SALES_BY_MULTIPLE_TO_PROMOTION_OF_SKU_SALES_BY_MULTIPLE]
					@PROMO_ID = 9
					, @CODE_SKU = '100011'
					, @PACK_UNIT = 1
					, @MULTIPLE = 10
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_ASSOCIATE_SKU_OF_SALES_BY_MULTIPLE_TO_PROMOTION_OF_SKU_SALES_BY_MULTIPLE](
	@PROMO_ID INT,
	@CODE_SKU VARCHAR(50),
	@PACK_UNIT INT,
	@MULTIPLE INT
