...
-- Description:			SP que genera las bonificaciones por multiplo desde acuerdo comercial de canal para los clientes asociados a un canla que tambien esten en un acuerdo comercial de cliente
...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GENERATE_BONUS_MULTIPLE_BY_CHANNEL_FOR_DUPLICATE]
					@CODE_ROUTE = '44'
					,@ORDER = 2
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GENERATE_BONUS_MULTIPLE_BY_CHANNEL_FOR_DUPLICATE] (@CODE_ROUTE VARCHAR(250)
, @ORDER INT)
AS
BEGIN
  SET NOCOUNT ON;
  ...
  -- ------------------------------------------------------------------------------------
  -- Genera las bonificaciones por canal
  -- ------------------------------------------------------------------------------------
