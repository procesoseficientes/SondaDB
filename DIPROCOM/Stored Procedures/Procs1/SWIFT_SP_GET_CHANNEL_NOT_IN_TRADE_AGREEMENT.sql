...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].SWIFT_SP_GET_CHANNEL_NOT_IN_TRADE_AGREEMENT 
						@TRADE_AGREEMENT_ID = 1
*/
-- =============================================
CREATE PROCEDURE [PACASA].SWIFT_SP_GET_CHANNEL_NOT_IN_TRADE_AGREEMENT(
...
BEGIN
	...
	--
	SET @TYPE_CHANNEL = [PACASA].SWIFT_FN_GET_PARAMETER('TRADE_AGREEMENT','CHANNEL_FOR_TRADE_AGREEMENT')
	--
	SELECT
		C.CHANNEL_ID
		,C.CODE_CHANNEL
	...
	FROM [PACASA].SWIFT_CHANNEL C
	LEFT JOIN [PACASA].SWIFT_TRADE_AGREEMENT_BY_CHANNEL TAC ON (
