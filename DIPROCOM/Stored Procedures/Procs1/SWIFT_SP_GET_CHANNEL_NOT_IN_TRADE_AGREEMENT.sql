...
-- Ejemplo de Ejecucion:
				EXEC [acsa].SWIFT_SP_GET_CHANNEL_NOT_IN_TRADE_AGREEMENT 
						@TRADE_AGREEMENT_ID = 1
*/
-- =============================================
CREATE PROCEDURE [acsa].SWIFT_SP_GET_CHANNEL_NOT_IN_TRADE_AGREEMENT(
...
BEGIN
	...
	--
	SET @TYPE_CHANNEL = [acsa].SWIFT_FN_GET_PARAMETER('TRADE_AGREEMENT','CHANNEL_FOR_TRADE_AGREEMENT')
	--
	SELECT
		C.CHANNEL_ID
		,C.CODE_CHANNEL
	...
	FROM [acsa].SWIFT_CHANNEL C
	LEFT JOIN [acsa].SWIFT_TRADE_AGREEMENT_BY_CHANNEL TAC ON (
