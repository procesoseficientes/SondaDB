...
*/
-- =============================================
CREATE  PROCEDURE [DIPROCOM].[SWIFT_SP_AAA]          
	@TASK_ID INT 
...
  			FROM DIPROCOM.[SWIFT_MANIFEST_HEADER] H 
            INNER JOIN DIPROCOM.[SWIFT_MANIFEST_DETAIL] D ON (D.CODE_MANIFEST_HEADER=H.MANIFEST_HEADER)
