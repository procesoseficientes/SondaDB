...
-- Ejemplo de Ejecucion:
	EXEC [DIPROCOM].[SONDA_SP_VALIDATE_FEL_DATA_ON_INVOICE]
	 @CODE_ROUTE = '46',
     @INVOICE_NUM = 180,
     @FEL_SHIPMENT = 1
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_VALIDATE_FEL_DATA_ON_INVOICE]
(
...
BEGIN
    ...
    FROM [DIPROCOM].[SONDA_POS_INVOICE_HEADER] AS [IH]
        INNER JOIN [DIPROCOM].[SONDA_POS_RES_SAT] AS [SR]
            ON (
