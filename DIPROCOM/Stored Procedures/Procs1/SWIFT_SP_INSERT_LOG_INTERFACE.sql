...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_INSERT_LOG_INTERFACE]
				-- 
				SELECT * FROM [acsa].[SWIFT_LOG_INTERFACE] 
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_INSERT_LOG_INTERFACE](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [acsa].[SWIFT_LOG_INTERFACE]
				(
					[ERP_TARGET]
					,[OPERATION_TYPE]
					,[OBJECT_NAME]
