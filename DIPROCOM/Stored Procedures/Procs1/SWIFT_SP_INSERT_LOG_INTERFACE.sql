...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_INSERT_LOG_INTERFACE]
				-- 
				SELECT * FROM [PACASA].[SWIFT_LOG_INTERFACE] 
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_INSERT_LOG_INTERFACE](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [PACASA].[SWIFT_LOG_INTERFACE]
				(
					[ERP_TARGET]
					,[OPERATION_TYPE]
					,[OBJECT_NAME]
