...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_INSERT_LOG_INTERFACE]
				-- 
				SELECT * FROM [DIPROCOM].[SWIFT_LOG_INTERFACE] 
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_LOG_INTERFACE](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [DIPROCOM].[SWIFT_LOG_INTERFACE]
				(
					[ERP_TARGET]
					,[OPERATION_TYPE]
					,[OBJECT_NAME]
