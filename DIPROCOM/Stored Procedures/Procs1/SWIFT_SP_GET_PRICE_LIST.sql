...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_PRICE_LIST]
				@CODE_PRICE_LIST = 14
				--
				EXEC [DIPROCOM].[SWIFT_SP_GET_PRICE_LIST]
				@CODE_PRICE_LIST = NULL
				--
				SELECT * FROM [DIPROCOM].[SWIFT_PRICE_LIST]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_PRICE_LIST](
...
BEGIN
	...
	SELECT [PL].[CODE_PRICE_LIST]
			...
			,[PL].[LAST_UPDATE]
			,[PL].[LAST_UPDATE_BY] 
	FROM [DIPROCOM].[SWIFT_PRICE_LIST] AS [PL]
