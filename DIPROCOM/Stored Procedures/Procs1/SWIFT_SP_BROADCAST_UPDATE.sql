...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_BROADCAST_UPDATE] @CODE_BROADCAST = '',@ADDRESSEE = '' ,@STATUS = 'RECEIVED'
				--
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_BROADCAST_UPDATE]
...
BEGIN
	SET NOCOUNT ON;
    --
	UPDATE [DIPROCOM].[SWIFT_PENDING_BROADCAST]
	SET STATUS = @STATUS
