...
Ejemplo de Ejecucion:
				--
				EXEC [PACASA].OP_WMS_SP_UPDATE_CERTIFICATE_DEPOSIT_DETAIL 
					@ID_DEPOSIT_DETAIL = 1
					,@ID_DEPOSIT_HEADER = 1
					,@DOC_ID = 49231
...
CREATE PROCEDURE [PACASA].[OP_WMS_SP_UPDATE_CERTIFICATE_DEPOSIT_DETAIL]
(
...
BEGIN
	...
	BEGIN TRY
	-----------------------------------------
	SELECT @STATUS = CH.STATUS FROM [PACASA].[OP_WMS_CERTIFICATE_DEPOSIT_HEADER] AS CH WHERE CH.CERTIFICATE_DEPOSIT_ID_HEADER = @ID_DEPOSIT_HEADER
	-----------------------------------------
	...
	UPDATE [PACASA].[OP_WMS_CERTIFICATE_DEPOSIT_DETAIL]
	SET [DOC_ID] = @DOC_ID
	...
	UPDATE [PACASA].[OP_WMS_CERTIFICATE_DEPOSIT_HEADER] 
