...
Ejemplo de Ejecucion:
				--
				EXEC [SONDA].OP_WMS_SP_UPDATE_CERTIFICATE_DEPOSIT_DETAIL 
					@ID_DEPOSIT_DETAIL = 1
					,@ID_DEPOSIT_HEADER = 1
					,@DOC_ID = 49231
				...
				SELECT * FROM [SONDA].[OP_WMS_CERTIFICATE_DEPOSIT_DETAIL]
				--	
*/
-- =============================================

CREATE PROCEDURE [SONDA].[OP_WMS_SP_UPDATE_CERTIFICATE_DEPOSIT_DETAIL]
(
...
BEGIN
	...
	BEGIN TRY
	-----------------------------------------
	SELECT @STATUS = CH.STATUS FROM [SONDA].[OP_WMS_CERTIFICATE_DEPOSIT_HEADER] AS CH WHERE CH.CERTIFICATE_DEPOSIT_ID_HEADER = @ID_DEPOSIT_HEADER
	-----------------------------------------
	...
	UPDATE [SONDA].[OP_WMS_CERTIFICATE_DEPOSIT_DETAIL]
	SET [DOC_ID] = @DOC_ID
	...
	UPDATE [SONDA].[OP_WMS_CERTIFICATE_DEPOSIT_HEADER] 
