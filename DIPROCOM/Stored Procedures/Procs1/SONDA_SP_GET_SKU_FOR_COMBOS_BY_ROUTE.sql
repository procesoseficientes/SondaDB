...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_GET_SKU_FOR_COMBOS_BY_ROUTE]
					@CODE_ROUTE = '4'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_SKU_FOR_COMBOS_BY_ROUTE](
...
BEGIN
	...
	INNER JOIN [PACASA].[SWIFT_BONUS_LIST_BY_COMBO] [BLC] ON (
