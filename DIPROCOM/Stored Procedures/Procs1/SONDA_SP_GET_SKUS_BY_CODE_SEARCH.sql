...
Ejemplo de Ejecucion:
		EXEC [DIPROCOM].SONDA_SP_GET_SKUS_BY_CODE_SEARCH @CODE_CUSTUMER = 'as'
				
*/
-- =============================================

CREATE PROCEDURE [DIPROCOM].SONDA_SP_GET_SKUS_BY_CODE_SEARCH
  @CODE_CUSTUMER VARCHAR(50)
AS 
  SELECT VS.CODE_SKU, VS.DESCRIPTION_SKU
				FROM [DIPROCOM].[SWIFT_VIEW_ALL_SKU] VS
