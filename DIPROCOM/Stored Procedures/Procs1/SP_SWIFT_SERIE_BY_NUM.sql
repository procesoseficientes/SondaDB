CREATE PROCEDURE [DIPROCOM].[SP_SWIFT_SERIE_BY_NUM]
AS
...
select 
	...
	,count(doc_num) [TOTAL]
	INTO  #SERIE
from  DIPROCOM.SONDA_SALES_ORDER_HEADER (NOLOCK)
...
INSERT INTO DIPROCOM.swift_serie_by_num
SELECT * FROM #SERIE
...
INSERT INTO DIPROCOM.swift_customer_by_sale
SELECT * FROM #CST
