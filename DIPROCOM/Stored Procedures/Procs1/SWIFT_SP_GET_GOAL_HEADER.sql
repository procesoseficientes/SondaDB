...
-- Ejemplo de Ejecucion:
	EXEC [DIPROCOM].[SWIFT_SP_GET_GOAL_HEADER] @STATUS = 'CREATED'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_GOAL_HEADER] @STATUS AS VARCHAR(25)
AS
BEGIN
    SET NOCOUNT ON;
    --
    ...
    FROM [DIPROCOM].[SWIFT_GOAL_HEADER] [GH]
        INNER JOIN [DIPROCOM].[SWIFT_TEAM] [B]
