...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_ASSIGNED_ACCESS_WAREHOUSE_BY_LOGIN]
					@LOGIN = 'rudi@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_ASSIGNED_ACCESS_WAREHOUSE_BY_LOGIN](
...
BEGIN
	...
	FROM [PACASA].[SWIFT_WAREHOUSES] [SW]
		INNER JOIN [PACASA].[SWIFT_WAREHOUSE_BY_USER_WITH_ACCESS] [SWUA] ON [SWUA].[CODE_WAREHOUSE] = [SW].[CODE_WAREHOUSE]
