...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_ASSIGNED_ACCESS_WAREHOUSE_BY_LOGIN]
					@LOGIN = 'rudi@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_ASSIGNED_ACCESS_WAREHOUSE_BY_LOGIN](
...
BEGIN
	...
	FROM [DIPROCOM].[SWIFT_WAREHOUSES] [SW]
		INNER JOIN [DIPROCOM].[SWIFT_WAREHOUSE_BY_USER_WITH_ACCESS] [SWUA] ON [SWUA].[CODE_WAREHOUSE] = [SW].[CODE_WAREHOUSE]
