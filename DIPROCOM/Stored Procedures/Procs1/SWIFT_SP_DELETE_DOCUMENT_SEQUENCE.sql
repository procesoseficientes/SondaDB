...
-- Ejemplo de Ejecucion:				
		...
		EXECUTE  [DIPROCOM].[SWIFT_SP_DELETE_DOCUMENT_SEQUENCE]
...
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_DELETE_DOCUMENT_SEQUENCE]
	@ID_DOCUMENT_SECUENCE varchar(50)
AS
BEGIN TRY
		
		DELETE FROM [DIPROCOM].[SWIFT_DOCUMENT_SEQUENCE]
