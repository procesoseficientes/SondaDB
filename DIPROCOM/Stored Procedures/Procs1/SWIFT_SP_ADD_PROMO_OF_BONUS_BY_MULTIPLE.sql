...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_ADD_PROMO_OF_BONUS_BY_MULTIPLE]
					@PROMO_ID = 5, -- int
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_ADD_PROMO_OF_BONUS_BY_MULTIPLE](
	@PROMO_ID INT
	,@CODE_SKU VARCHAR(50)
	,@PACK_UNIT INT 
	,@MULTIPLE INT
...
BEGIN
	...
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [PACASA].[SWIFT_PROMO_BONUS_BY_MULTIPLE]
				(
					[PROMO_ID]
					,[CODE_SKU]
					,[PACK_UNIT]
