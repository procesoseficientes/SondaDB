...
-- Ejemplo de Ejecucion:
				EXEC DIPROCOM.[SP_GET_USER_BY_LICENSES] '<ArrayOfString>
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_USER_BY_LICENSES] @XML XML
AS
...
-- -------------------------------------------------------------------------------
	...
	BEGIN 
		...
		FROM
			[DIPROCOM].[USERS] [USR]
		LEFT JOIN [DIPROCOM].[SWIFT_ROUTES] AS [R]
