...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_INSERT_SALES_ORGANIZATION]
					@NAME_SALES_ORGANIZATION = 'Organizacion de Ventas 1'
					, @DESCRIPTION_SALES_ORGANIZATION = 'Organizacion de Ventas 1'
				-- 
				SELECT * FROM [PACASA].[SWIFT_SALES_ORGANIZATION] 
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_INSERT_SALES_ORGANIZATION](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [PACASA].[SWIFT_SALES_ORGANIZATION]
				(
