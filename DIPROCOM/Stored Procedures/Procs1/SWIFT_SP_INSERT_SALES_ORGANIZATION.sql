...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_INSERT_SALES_ORGANIZATION]
					@NAME_SALES_ORGANIZATION = 'Organizacion de Ventas 1'
					, @DESCRIPTION_SALES_ORGANIZATION = 'Organizacion de Ventas 1'
				-- 
				SELECT * FROM [DIPROCOM].[SWIFT_SALES_ORGANIZATION] 
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_SALES_ORGANIZATION](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [DIPROCOM].[SWIFT_SALES_ORGANIZATION]
				(
