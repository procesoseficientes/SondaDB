...
-- Ejemplo de Ejecucion:
      ...
      EXECUTE @RC = [acsa].SWIFT_SP_GET_ERP_SOS @PICKING_HEADER
      GO
*/
-- =============================================
CREATE PROC [acsa].[SWIFT_SP_GET_ERP_POS]
...
FROM [acsa].SWIFT_TXNS T
	INNER JOIN [acsa].SWIFT_TXNS_SERIES TS ON (T.TXN_ID = TS.TXN_ID AND T.TXN_CODE_SKU = TS.TXN_CODE_SKU)
