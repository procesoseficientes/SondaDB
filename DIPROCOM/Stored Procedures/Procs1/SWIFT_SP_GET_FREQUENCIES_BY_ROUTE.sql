...
/* Ejemplo de ejecucion
	...
	EXEC [DIPROCOM].[SWIFT_SP_GET_FREQUENCIES_BY_ROUTE] 
					@CODE_ROUTE = '99'
					,@TYPE_TASK = 'PRESALE'
					,@DAY = 3
...
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_FREQUENCIES_BY_ROUTE]
...
BEGIN
    BEGIN TRY
        ...
        FROM [DIPROCOM].[SWIFT_FREQUENCY] [F]
            INNER JOIN [DIPROCOM].[SWIFT_FREQUENCY_BY_POLYGON] [PBR]
