...
-- Description:			SP que elimina una promocion de descuento por monto general siempre y cuando no este asociada a un Acuerdo Comercial

/*
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_ELIMINATE_FULL_PROMOTION_OF_DISCOUNT_BY_GENERAL_AMOUNT]
				@PROMO_ID = 20
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_ELIMINATE_FULL_PROMOTION_OF_DISCOUNT_BY_GENERAL_AMOUNT](
	@PROMO_ID INT
)
AS
BEGIN
	...
	BEGIN TRY
		...
		PROMOTION_NOT_ASSOCIATED_WITH_A_COMMERCIAL_AGREEMENT:
			...
			-- -------------------------------------------------------------------------------
			DELETE FROM DIPROCOM.SWIFT_PROMO_DISCOUNT_BY_GENERAL_AMOUNT WHERE [PROMO_ID] = @PROMOTION_ID;
