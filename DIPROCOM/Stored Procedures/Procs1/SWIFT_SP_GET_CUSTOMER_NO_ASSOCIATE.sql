...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [DIPROCOM].[SWIFT_SP_GET_CUSTOMER_NO_ASSOCIATE]
					@ID_FREQUENCY = 1059
					,@CODE_ROUTE = '001'
					,@FREQUENCY = 0
					,@SUNDAY = 0
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_CUSTOMER_NO_ASSOCIATE]
	@ID_FREQUENCY INT
...
BEGIN
	...
	-- ------------------------------------------------------------------------------------
	INSERT INTO #CLIENT
	EXEC [DIPROCOM].[SWIFT_SP_GET_CUSTOMERS_IN_POLYGON] @CODE_ROUTE = @CODE_ROUTE
	...
	WHERE C.CODE_CUSTOMER NOT IN (SELECT F.CODE_CUSTOMER FROM [DIPROCOM].[SWIFT_FREQUENCY_X_CUSTOMER] F WHERE F.ID_FREQUENCY = ' + CAST(@ID_FREQUENCY AS VARCHAR) + ')'
