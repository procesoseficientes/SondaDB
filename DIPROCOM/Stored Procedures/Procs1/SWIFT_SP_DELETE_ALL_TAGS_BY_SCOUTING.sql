...
-- EJEMPLO DE EJECUCION: 
		EXEC [PACASA].[SWIFT_SP_DELETE_ALL_TAGS_BY_SCOUTING]
			@CUSTOMER_ID = '2290'
		------------------------------------------------
		...
		------------------------------------------------
=========================================================*/
CREATE PROCEDURE [PACASA].[SWIFT_SP_DELETE_ALL_TAGS_BY_SCOUTING]
( 
...
BEGIN
	...
	BEGIN TRY
		--
		DELETE FROM [PACASA].[SWIFT_TAG_X_CUSTOMER_NEW]
