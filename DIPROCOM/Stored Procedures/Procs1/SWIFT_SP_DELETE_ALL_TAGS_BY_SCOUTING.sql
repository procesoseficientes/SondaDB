...
-- EJEMPLO DE EJECUCION: 
		EXEC [DIPROCOM].[SWIFT_SP_DELETE_ALL_TAGS_BY_SCOUTING]
			@CUSTOMER_ID = '2290'
		------------------------------------------------
		...
		------------------------------------------------
=========================================================*/
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_DELETE_ALL_TAGS_BY_SCOUTING]
( 
...
BEGIN
	...
	BEGIN TRY
		--
		DELETE FROM [DIPROCOM].[SWIFT_TAG_X_CUSTOMER_NEW]
