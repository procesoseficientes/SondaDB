...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SONDA_SP_ADD_CANCELED_DELIVERY_BY_XML]
				@XML = '
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_ADD_CANCELED_DELIVERY_BY_XML] (@XML XML)
AS
BEGIN
  BEGIN TRY
    DECLARE @ID INT
    ...
    BEGIN
      ...
      INSERT INTO [DIPROCOM].[SONDA_DELIVERY_CANCELED] (
