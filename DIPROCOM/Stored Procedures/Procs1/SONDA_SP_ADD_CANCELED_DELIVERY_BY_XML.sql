...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_ADD_CANCELED_DELIVERY_BY_XML]
				@XML = '
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_ADD_CANCELED_DELIVERY_BY_XML] (@XML XML)
AS
BEGIN
  BEGIN TRY
    DECLARE @ID INT
    ...
    BEGIN
      ...
      INSERT INTO [PACASA].[SONDA_DELIVERY_CANCELED] (
