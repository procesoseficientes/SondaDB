...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [DIPROCOM].[SWIFT_SP_GENERATE_BONUS_FROM_TRADE_AGREEMENT]
					@CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GENERATE_BONUS_FROM_TRADE_AGREEMENT] (
...
BEGIN
	...
	-- ------------------------------------------------------------------------------------
	EXEC [DIPROCOM].[SWIFT_SP_CLEAN_BONUS_LIST_BY_ROUTE]
	...
	-- ------------------------------------------------------------------------------------
	EXEC [DIPROCOM].[SWIFT_SP_CLEAN_DUPLICATE_CUSTOMER_IN_BONUS_LIST_BY_ROUTE]
		@CODE_ROUTE = @CODE_ROUTE

	-- ------------------------------------------------------------------------------------
	-- Genera lista para los clientes repetidos
	-- ------------------------------------------------------------------------------------
	EXEC [DIPROCOM].[SWIFT_SP_GENERATE_BONUS_FOR_DUPLICATE_CUSTOMER]
		@CODE_ROUTE = @CODE_ROUTE
		,@TYPE = 'SCALE'
