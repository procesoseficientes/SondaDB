CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_DETAIL_INCOME]
@INCOMEHEADER INT,
@CODE_SKU VARCHAR(50),
@EXPECTED FLOAT,
...
IF EXISTS (SELECT CODE_SKU FROM DIPROCOM.SWIFT_TEMP_RECEPTION_DETAIL WHERE CODE_SKU = @CODE_SKU AND RECEPTION_HEADER = @INCOMEHEADER)
            BEGIN
