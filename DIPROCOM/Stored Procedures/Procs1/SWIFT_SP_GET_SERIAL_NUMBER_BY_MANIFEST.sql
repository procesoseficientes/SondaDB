...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_SERIAL_NUMBER_BY_MANIFEST] @MANIFEST_HEADER_ID = 2145
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_SERIAL_NUMBER_BY_MANIFEST]
	(
...
AS
    ...
    SELECT TOP 1
			...
			FROM
				[PACASA].[SWIFT_SETUP_EXTERNAL_SOURCE] AS [S]
			WHERE
