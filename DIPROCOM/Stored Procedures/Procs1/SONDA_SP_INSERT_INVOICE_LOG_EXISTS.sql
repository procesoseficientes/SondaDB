...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SONDA_SP_INSERT_INVOICE_LOG_EXISTS]
					...
					,@JSON = NULL
				-- 
				SELECT * FROM [DIPROCOM].[SONDA_INVOICE_LOG_EXISTS]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_INSERT_INVOICE_LOG_EXISTS](
	@EXISTS_INVOICE INT
...
BEGIN
	...
	--
	BEGIN TRY
		INSERT INTO [DIPROCOM].[SONDA_INVOICE_LOG_EXISTS]
				(
					[LOG_DATETIME]
					,[EXISTS_INVOICE]
					,[DOC_RESOLUTION]
