...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [DIPROCOM].[SWIFT_SP_GET_CUSTOMERS_TO_POLYGON]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_CUSTOMERS_TO_POLYGON]
...
BEGIN
	...
	SELECT @SQL = '
		SELECT TOP 5000
			...
			,C.[LONGITUDE]
			,C.[LATITUDE]
		FROM [DIPROCOM].[SWIFT_VIEW_LATLNG_X_CUSTOMER] C
