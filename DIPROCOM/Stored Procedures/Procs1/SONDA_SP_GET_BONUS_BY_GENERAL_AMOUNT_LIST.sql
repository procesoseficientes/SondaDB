...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SONDA_SP_GET_BONUS_BY_GENERAL_AMOUNT_LIST]
					@CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_BONUS_BY_GENERAL_AMOUNT_LIST](
...
BEGIN
	...
	SELECT DISTINCT
		...
		,[BLGA].[PROMO_TYPE]
    ,[BLGA].[FREQUENCY]
	FROM [DIPROCOM].[SWIFT_BONUS_LIST_BY_GENERAL_AMOUNT] AS [BLGA]
