...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_GET_BONUS_BY_GENERAL_AMOUNT_LIST]
					@CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_BONUS_BY_GENERAL_AMOUNT_LIST](
...
BEGIN
	...
	SELECT DISTINCT
		...
		,[BLGA].[PROMO_TYPE]
    ,[BLGA].[FREQUENCY]
	FROM [PACASA].[SWIFT_BONUS_LIST_BY_GENERAL_AMOUNT] AS [BLGA]
