...
Ejemplo de Ejecucion:
		EXEC [DIPROCOM].[SONDA_SP_GET_SALES_ORDER_PENDING_TO_ERP]	@StartDate='2016-02-27', @EndDate='2017-02-27'
*/
-- =============================================

CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_SALES_ORDER_PENDING_TO_ERP] (@StartDate varchar(20), @EndDate varchar(20))
AS
BEGIN
  SET NOCOUNT ON;
	SELECT 
