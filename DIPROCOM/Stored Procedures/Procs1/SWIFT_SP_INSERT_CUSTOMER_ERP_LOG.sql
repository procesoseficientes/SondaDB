...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_INSERT_CUSTOMER_ERP_LOG]
					@ID = -1
					...
					,@TYPE = 'SCOUTING'
				-- 
				SELECT * FROM [PACASA].[SWIFT_SEND_CUSTOMER_ERP_LOG]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_INSERT_CUSTOMER_ERP_LOG](
	@ID INT
...
BEGIN
	BEGIN TRY
		--
		INSERT INTO [PACASA].[SWIFT_SEND_CUSTOMER_ERP_LOG]
				(
					[ID]
