...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_INSERT_CUSTOMER_ERP_LOG]
					@ID = -1
					...
					,@TYPE = 'SCOUTING'
				-- 
				SELECT * FROM [DIPROCOM].[SWIFT_SEND_CUSTOMER_ERP_LOG]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_CUSTOMER_ERP_LOG](
	@ID INT
...
BEGIN
	BEGIN TRY
		--
		INSERT INTO [DIPROCOM].[SWIFT_SEND_CUSTOMER_ERP_LOG]
				(
					[ID]
