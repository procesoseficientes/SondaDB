...
EXECUTE @RC = [DIPROCOM].SWIFT_SP_CUSTOMER_ERROR_TO_SEND_SAP @CODE_CUSTOMER
                                                       ,@POSTED_RESPONSE
GO
*/	
-- =============================================

CREATE PROCEDURE [DIPROCOM].SWIFT_SP_CUSTOMER_ERROR_TO_SEND_SAP (@CODE_CUSTOMER VARCHAR(50),
...
BEGIN TRY
  ...
  END
  --
  EXEC [DIPROCOM].[SWIFT_SP_INSERT_CUSTOMER_ERP_LOG] @ID = -1 , -- int
