...
-- Ejemplo de Ejecucion:
				EXEC [acsa].SWIFT_SP_GET_CUSTOMER_AVAILABLE_BY_CHANNEL
*/
-- =============================================
CREATE PROCEDURE [acsa].SWIFT_SP_GET_CUSTOMER_AVAILABLE_BY_CHANNEL
AS
BEGIN
	SELECT
		[VC].[CODE_CUSTOMER]
	...
	LEFT JOIN [acsa].[SWIFT_CHANNEL_X_CUSTOMER] [CC] ON ([VC].[CODE_CUSTOMER] = [CC].[CODE_CUSTOMER])
