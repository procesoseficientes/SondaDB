...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].SWIFT_SP_GET_SKU_WITH_BONUS_IN_TRADE_AGREEMENT
					@TRADE_AGREEMENT_ID = 21
*/
-- =============================================
CREATE PROCEDURE [PACASA].SWIFT_SP_GET_SKU_WITH_BONUS_IN_TRADE_AGREEMENT(
...
BEGIN
	SELECT
		...
		,TAB.BONUS_QTY
	FROM [PACASA].SWIFT_TRADE_AGREEMENT_BONUS TAB
