...
/*
	Ejemplo Ejecucion: 
    EXEC [acsa].[SONDA_SP_INSERT_SKU_COLLECTED]
		...
		,@SOURCE_DOC_NUM = 258
	 --
     SELECT * FROM [acsa].[SONDA_SKU_COLLECTED]
 */
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_INSERT_SKU_COLLECTED]
...
BEGIN
	DECLARE @ID INT
		--
	INSERT INTO [acsa].[SONDA_SKU_COLLECTED]
           ([CODE_SKU]
           ,[QTY_SKU]
           ,[IS_GOOD_STATE]
           ,[IMG_1]
