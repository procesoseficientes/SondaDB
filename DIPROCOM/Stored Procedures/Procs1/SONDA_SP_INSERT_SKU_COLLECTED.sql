...
/*
	Ejemplo Ejecucion: 
    EXEC [PACASA].[SONDA_SP_INSERT_SKU_COLLECTED]
		...
		,@SOURCE_DOC_NUM = 258
	 --
     SELECT * FROM [PACASA].[SONDA_SKU_COLLECTED]
 */
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_INSERT_SKU_COLLECTED]
...
BEGIN
	DECLARE @ID INT
		--
	INSERT INTO [PACASA].[SONDA_SKU_COLLECTED]
           ([CODE_SKU]
           ,[QTY_SKU]
           ,[IS_GOOD_STATE]
           ,[IMG_1]
