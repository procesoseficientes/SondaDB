...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SONDA_SP_VALIDATE_IF_EXIST_3PL_MANIFEST] @MANIFEST_HEADER_ID = 1108, @LOGIN_ID = 'RUDI@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_VALIDATE_IF_EXIST_3PL_MANIFEST](
...
BEGIN
	...
	SELECT @DATABASE_NAME = ES.[DATABASE_NAME], @SCHEMA_NAME = ES.[SCHEMA_NAME] FROM [acsa].[SWIFT_SETUP_EXTERNAL_SOURCE] AS ES WHERE ES.[EXTERNAL_SOURCE_ID] > 0;
