...
EXEC [PACASA].[SONDA_SP_VALIDATE_DOCUMENT_SEQUENCES] 
	@XML = 
	'
<Data>
	<docSquences>
...
*/
-- =============================================
-- DROP PROCEDURE [PACASA].[SONDA_SP_VALIDATE_DOCUMENT_SEQUENCES]
CREATE PROCEDURE [PACASA].[SONDA_SP_VALIDATE_DOCUMENT_SEQUENCES] (@XML XML)
AS
	BEGIN
		SET NOCOUNT ON;
		DECLARE
		...
		BEGIN
			...
			BEGIN TRY
				...
				SELECT TOP 1
					@RESULT = 1
				FROM
					[PACASA].[SWIFT_DOCUMENT_SEQUENCE]
				WHERE
					[CURRENT_DOC] = @CURRENT_DOC
