...
EXEC [SONDA].[SONDA_SP_VALIDATE_DOCUMENT_SEQUENCES] 
	@XML = 
	'
<Data>
	<docSquences>
...
*/
-- =============================================
-- DROP PROCEDURE [SONDA].[SONDA_SP_VALIDATE_DOCUMENT_SEQUENCES]
CREATE PROCEDURE [SONDA].[SONDA_SP_VALIDATE_DOCUMENT_SEQUENCES] (@XML XML)
AS
	BEGIN
		SET NOCOUNT ON;
		DECLARE
