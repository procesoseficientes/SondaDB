...
-- Ejemplo de Ejecucion:
      ...
      EXECUTE @RC = DIPROCOM.SWIFT_SP_GET_ERP_ITWH @PICKING_HEADER
      GO
*/
CREATE PROC [DIPROCOM].[SWIFT_SP_GET_ERP_ITWH] 
...
FROM  [BD_Prueba_Viscosa].dbo.OWTQ AS so  LEFT OUTER JOIN
                                                   [BD_Prueba_Viscosa].dbo.WTQ12 AS ae ON ae.DocEntry = so.DocEntry                                                   
