...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_UNASSIGNED_SELLERS_FOR_SALES_OFFICE]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_UNASSIGNED_SELLERS_FOR_SALES_OFFICE]
AS
BEGIN
	SET NOCOUNT ON;
	--
