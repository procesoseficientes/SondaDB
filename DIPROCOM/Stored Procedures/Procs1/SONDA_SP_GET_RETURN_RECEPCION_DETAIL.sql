...
Ejemplo de Ejecucion:
	...
	EXEC [DIPROCOM].[SONDA_SP_GET_RETURN_RECEPCION_DETAIL] 
	@ID_RETURN_HEADER = 1
	 				
*/
-- =============================================

CREATE PROCEDURE [DIPROCOM].SONDA_SP_GET_RETURN_RECEPCION_DETAIL
(
...
BEGIN
    SET NOCOUNT ON;
		...
		SELECT 
			...
			,RD.QTY 
			,RD.DESCRIPTION_SKU
		FROM [DIPROCOM].[SONDA_DOC_ROUTE_RETURN_DETAIL] RD 
