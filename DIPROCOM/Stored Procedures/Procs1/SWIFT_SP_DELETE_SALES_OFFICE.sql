...
-- Ejemplo de Ejecucion:
				SELECT * FROM [DIPROCOM].[SWIFT_SALES_OFFICE]
				--
				EXEC [DIPROCOM].[SWIFT_SP_DELETE_SALES_OFFICE]
					@SALES_OFFICE_ID = 3
				-- 
				SELECT * FROM [DIPROCOM].[SWIFT_SALES_OFFICE] 
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_DELETE_SALES_OFFICE](
	@SALES_OFFICE_ID INT
)
AS
BEGIN
	BEGIN TRY
		DELETE FROM [DIPROCOM].[SWIFT_SALES_OFFICE]
