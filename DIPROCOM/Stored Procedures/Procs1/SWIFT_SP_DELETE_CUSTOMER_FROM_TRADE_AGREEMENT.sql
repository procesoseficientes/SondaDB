...
SELECT * FROM [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_CUSTOMER]
	
  EXEC [DIPROCOM].[SWIFT_SP_DELETE_CUSTOMER_FROM_TRADE_AGREEMENT]
		@TRADE_AGREEMENT_ID = 1038
		,@CODE_CUSTOMER = 'C002'

SELECT * FROM [DIPROCOM].[SWIFT_TRADE_AGREEMENT] WHERE [TRADE_AGREEMENT_ID] = 1

==================================================*/

CREATE PROCEDURE [DIPROCOM].SWIFT_SP_DELETE_CUSTOMER_FROM_TRADE_AGREEMENT (@TRADE_AGREEMENT_ID INT
, @CODE_CUSTOMER VARCHAR(50))
AS
BEGIN
  BEGIN TRY

    DELETE FROM [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_CUSTOMER]
