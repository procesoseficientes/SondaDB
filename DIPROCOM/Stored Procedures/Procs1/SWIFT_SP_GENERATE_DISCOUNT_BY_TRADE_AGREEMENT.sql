...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [PACASA].[SWIFT_SP_GENERATE_DISCOUNT_BY_TRADE_AGREEMENT]
					@CODE_ROUTE = '4'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GENERATE_DISCOUNT_BY_TRADE_AGREEMENT] (@CODE_ROUTE VARCHAR(250))
AS
BEGIN
  SET NOCOUNT ON;
  ...
  BEGIN
    ...
    BEGIN
      ...
      SELECT TOP 1
        @IS_ALREADY = 1
      FROM [PACASA].[SWIFT_DISCOUNT_LIST_BY_CUSTOMER] [DLC]
      INNER JOIN [PACASA].[SWIFT_DISCOUNT_LIST] [DL]
        ON (
