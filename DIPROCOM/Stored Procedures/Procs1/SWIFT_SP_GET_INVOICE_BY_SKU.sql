...
BEGIN
	...
	SELECT @SERIAL_NR = ISNULL([SONDA].[SWIFT_FN_GET_PARAMETER]('ERP_HARDCODE_VALUES','SERIAL_NR'),'')
			,@PAY_DEAL = ISNULL([SONDA].[SWIFT_FN_GET_PARAMETER]('ERP_HARDCODE_VALUES','PAY_DEAL'),'');
	-- ------------------------------------------------------------------------------------
