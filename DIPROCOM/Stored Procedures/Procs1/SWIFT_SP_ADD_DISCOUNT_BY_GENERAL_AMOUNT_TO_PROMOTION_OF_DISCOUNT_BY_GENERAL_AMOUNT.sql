...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_ADD_DISCOUNT_BY_GENERAL_AMOUNT_TO_PROMOTION_OF_DISCOUNT_BY_GENERAL_AMOUNT]
				@PROMO_ID = 8,
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_ADD_DISCOUNT_BY_GENERAL_AMOUNT_TO_PROMOTION_OF_DISCOUNT_BY_GENERAL_AMOUNT](
	@PROMO_ID INT,
...
BEGIN
	...
	BEGIN TRY
		...
		-- ----------------------------------------------------------------------------------------------------------
		EXEC DIPROCOM.[SWIFT_SP_VALID_DISCOUNT_SCALE_FOR_DISCOUNT_BY_GENERAL_AMOUNT] @PROMO_ID,@LOW_AMOUNT,@HIGH_AMOUNT;
		
		-- -----------------------------------------------------------------------------------------------------------
		-- Si no hay conflicto con el rango de descuento, éste se agrega a la promoción de Descuento por Monto General
		-- -----------------------------------------------------------------------------------------------------------
		INSERT INTO DIPROCOM.[SWIFT_PROMO_DISCOUNT_BY_GENERAL_AMOUNT]
				(
					[PROMO_ID]
					,[LOW_AMOUNT]
					,[HIGH_AMOUNT]
