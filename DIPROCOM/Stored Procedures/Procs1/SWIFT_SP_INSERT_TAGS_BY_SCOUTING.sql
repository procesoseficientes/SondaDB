...
-- Description:    Inserta las etiquetas por cliente en la tabla SWIFT_TAG_X_CUSTOMER_NEW

-- Modificacion: 25-06-2016
--			Autor: diego.as
--			Descripcion: Se modifico proceso de insercion para que retorne 
...
-- EJEMPLO DE EJECUCION: 
		EXEC [DIPROCOM].[SWIFT_SP_INSERT_TAGS_BY_SCOUTING]
			@TAG_COLOR = '#33CCCC'
			,@CUSTOMER_ID = '2290'
		------------------------------------------------
		SELECT * FROM [DIPROCOM].[SWIFT_TAG_X_CUSTOMER_NEW]
		WHERE [CUSTOMER] = '2290'
		------------------------------------------------
============================*/
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_TAGS_BY_SCOUTING]
( 
...
BEGIN
	...
	BEGIN TRY
		--
		INSERT INTO [DIPROCOM].[SWIFT_TAG_X_CUSTOMER_NEW](
			[TAG_COLOR]
			,[CUSTOMER]
		)
		VALUES (
