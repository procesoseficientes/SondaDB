...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].SWIFT_SP_GET_CHANNEL_IN_TRADE_AGREEMENT
					@TRADE_AGREEMENT_ID = 1
*/
-- =============================================
CREATE PROCEDURE [PACASA].SWIFT_SP_GET_CHANNEL_IN_TRADE_AGREEMENT(
...
BEGIN
	...
	INNER JOIN [PACASA].SWIFT_CHANNEL C ON (
