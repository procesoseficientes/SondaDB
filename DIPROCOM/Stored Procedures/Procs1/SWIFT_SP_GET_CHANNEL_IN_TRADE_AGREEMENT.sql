...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].SWIFT_SP_GET_CHANNEL_IN_TRADE_AGREEMENT
					@TRADE_AGREEMENT_ID = 1
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_GET_CHANNEL_IN_TRADE_AGREEMENT(
...
BEGIN
	...
	INNER JOIN [DIPROCOM].SWIFT_CHANNEL C ON (
