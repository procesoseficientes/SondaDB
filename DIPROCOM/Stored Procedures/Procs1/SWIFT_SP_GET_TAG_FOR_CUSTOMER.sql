...
-- Ejemplo de Ejecucion:
				exec [DIPROCOM].[SWIFT_SP_GET_TAG_FOR_CUSTOMER] @CODE_CUSTOMER = 'SO-1762'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_TAG_FOR_CUSTOMER]
...
BEGIN
	...
	SELECT 		
		...
		,T.TAG_VALUE_TEXT
		,[T].QRY_GROUP
	FROM  [DIPROCOM].[SWIFT_VIEW_ALL_TAG_X_CUSTOMER_NEW] AS TC
		INNER JOIN [DIPROCOM].[SWIFT_TAGS] AS T ON T.[TAG_COLOR] = TC.[TAG_COLOR]
