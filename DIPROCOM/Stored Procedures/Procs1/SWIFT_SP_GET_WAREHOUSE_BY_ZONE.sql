...
-- Ejemplo de Ejecucion:
				EXEC  [DIPROCOM].[SWIFT_SP_GET_WAREHOUSE_BY_ZONE] @ID_ZONE = 1

*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_WAREHOUSE_BY_ZONE] (@ID_ZONE INT )
AS
BEGIN
  SET NOCOUNT ON;
  --
 ...
 SELECT 
  ...
  FROM [DIPROCOM].[SWIFT_WAREHOUSES] [W]
    INNER JOIN [DIPROCOM].[SWIFT_WAREHOUSE_X_ZONE] [SWXZ] ON [W].[CODE_WAREHOUSE] = [SWXZ].[CODE_WAREHOUSE]
