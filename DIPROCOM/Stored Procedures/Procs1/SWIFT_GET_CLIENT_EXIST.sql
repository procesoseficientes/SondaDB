...
Ejemplo de Ejecucion:
            ...
            EXEC [PACASA].SWIFT_GET_CLIENT_EXIST @CODE_CUSTOMER = "100" 
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_GET_CLIENT_EXIST] @CODE_CUSTOMER VARCHAR(50)
...
BEGIN
  ...
  LEFT JOIN [PACASA].SWIFT_PRICE_LIST_BY_CUSTOMER P
