...
Ejemplo de Ejecucion:
            ...
            EXEC [DIPROCOM].SWIFT_GET_CLIENT_EXIST @CODE_CUSTOMER = "100" 
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_GET_CLIENT_EXIST] @CODE_CUSTOMER VARCHAR(50)
...
BEGIN
  ...
  -- ------------------------------------------------------------------------------------
  SELECT
    @DEFAULT_CODE_PRICE_LIST = CONVERT(INT, VALUE)
  ...
  LEFT JOIN DIPROCOM.SWIFT_PRICE_LIST_BY_CUSTOMER P
    ON (C.CODE_CUSTOMER = P.CODE_CUSTOMER)
