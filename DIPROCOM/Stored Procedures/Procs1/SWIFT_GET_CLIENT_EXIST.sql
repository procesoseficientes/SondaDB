...
Ejemplo de Ejecucion:
            ...
            EXEC [acsa].SWIFT_GET_CLIENT_EXIST @CODE_CUSTOMER = "100" 
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_GET_CLIENT_EXIST] @CODE_CUSTOMER VARCHAR(50)
...
BEGIN
  ...
  LEFT JOIN [acsa].SWIFT_PRICE_LIST_BY_CUSTOMER P
