...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].SWIFT_SP_DELETE_CHANNEL_X_CUSTOMER
					@CHANNEL_ID = 5
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].SWIFT_SP_DELETE_CHANNEL_X_CUSTOMER (@CHANNEL_ID INT
...
BEGIN
  BEGIN TRY
    ...
    UPDATE [PACASA].[SWIFT_TRADE_AGREEMENT_BY_CHANNEL]
