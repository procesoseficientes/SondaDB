...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_DEVOLUTION_INVENTORY_HEADER]
				--
				EXEC [DIPROCOM].[SWIFT_SP_GET_DEVOLUTION_INVENTORY_HEADER]
					@DEVOLUTION_ID = 1005
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_DEVOLUTION_INVENTORY_HEADER](
...
BEGIN
	...
	SELECT
		...
		,CASE [DIH].[IMG_3]
			...
			ELSE [DIH].[IMG_3]
		END [IMG_3]
	FROM [DIPROCOM].[SONDA_DEVOLUTION_INVENTORY_HEADER] [DIH]
