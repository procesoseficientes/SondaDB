...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_DEVOLUTION_INVENTORY_HEADER]
				--
				EXEC [PACASA].[SWIFT_SP_GET_DEVOLUTION_INVENTORY_HEADER]
					@DEVOLUTION_ID = 1005
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_DEVOLUTION_INVENTORY_HEADER](
...
BEGIN
	...
	SELECT
		...
		,CASE [DIH].[IMG_3]
			...
			ELSE [DIH].[IMG_3]
		END [IMG_3]
	FROM [PACASA].[SONDA_DEVOLUTION_INVENTORY_HEADER] [DIH]
