...
-- Ejemplo de Ejecucion:
		exec [PACASA].[SWIFT_SP_GET_SCOUTING_DETAIL]
			@CODE_CUSTOMER = 3145
-- =============================================*/
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_SCOUTING_DETAIL]
(
	@CODE_CUSTOMER INT
) AS
BEGIN
	...
	SELECT [CND].[CUSTOMER]
		...
		,[VAC].[COMMENTS]
		,[VAC].[LAST_UPDATE]
	FROM [PACASA].[SWIFT_CUSTOMER_NEW_DETAIL] AS CND
	INNER JOIN [PACASA].[SWIFT_CUSTOMERS_NEW] AS VAC ON(
