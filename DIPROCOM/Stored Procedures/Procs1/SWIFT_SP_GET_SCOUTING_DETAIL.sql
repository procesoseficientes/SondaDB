...
-- Ejemplo de Ejecucion:
		exec [DIPROCOM].[SWIFT_SP_GET_SCOUTING_DETAIL]
			@CODE_CUSTOMER = 3145
-- =============================================*/
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_SCOUTING_DETAIL]
(
	@CODE_CUSTOMER INT
) AS
BEGIN
	...
	SELECT [CND].[CUSTOMER]
		...
		,[VAC].[COMMENTS]
		,[VAC].[LAST_UPDATE]
	FROM [DIPROCOM].[SWIFT_CUSTOMER_NEW_DETAIL] AS CND
	INNER JOIN [DIPROCOM].[SWIFT_CUSTOMERS_NEW] AS VAC ON(
