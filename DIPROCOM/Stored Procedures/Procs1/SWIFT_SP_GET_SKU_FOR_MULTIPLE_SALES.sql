...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_SKU_FOR_MULTIPLE_SALES]
					@TRADE_AGREEMENT_ID = 21
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_SKU_FOR_MULTIPLE_SALES](
...
BEGIN
	...
	SELECT
		...
		,[TAS].[MULTIPLE]
	FROM [DIPROCOM].[SWIFT_TRADE_AGREEMENT_SKU_SALES_BY_MULTIPLE] [TAS]	
