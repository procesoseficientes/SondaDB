...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_SKU_FOR_MULTIPLE_SALES]
					@TRADE_AGREEMENT_ID = 21
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_SKU_FOR_MULTIPLE_SALES](
...
BEGIN
	...
	SELECT
		...
		,[TAS].[MULTIPLE]
	FROM [PACASA].[SWIFT_TRADE_AGREEMENT_SKU_SALES_BY_MULTIPLE] [TAS]	
