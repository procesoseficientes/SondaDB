...
-- Ejemplo de Ejecucion:
				SELECT * FROM [acsa].[SWIFT_TRADE_AGREEMENT_SKU_SALES_BY_MULTIPLE]
				--
				EXEC [acsa].[SWIFT_SP_DELETE_SKU_SALES_BY_MULTIPLE]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_DELETE_SKU_SALES_BY_MULTIPLE](
...
BEGIN
	BEGIN TRY
		DELETE FROM [acsa].[SWIFT_TRADE_AGREEMENT_SKU_SALES_BY_MULTIPLE]
