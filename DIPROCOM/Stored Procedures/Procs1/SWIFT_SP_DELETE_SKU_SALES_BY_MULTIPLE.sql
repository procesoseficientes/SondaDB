...
-- Ejemplo de Ejecucion:
				...
				--
				EXEC [PACASA].[SWIFT_SP_DELETE_SKU_SALES_BY_MULTIPLE]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_DELETE_SKU_SALES_BY_MULTIPLE](
...
BEGIN
	BEGIN TRY
		DELETE FROM [PACASA].[SWIFT_TRADE_AGREEMENT_SKU_SALES_BY_MULTIPLE]
