...
-- Ejemplo de Ejecucion:
      		EXEC [DIPROCOM].[SWIFT_SP_IMPORT_CUSTOMER_ACCOUNTING_INFORMATION]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_IMPORT_CUSTOMER_ACCOUNTING_INFORMATION]
AS
	BEGIN
--
		SET NOCOUNT ON;
--
		...
		BEGIN TRY
			...
			-- Limpiamos la tabla
			-- -------------------------------------------------------------
			TRUNCATE TABLE [DIPROCOM].[SWIFT_CUSTOMER_ACCOUNTING_INFORMATION];
			...
			EXECUTE (@QUERY);
				...
				-- -------------------------------------------------------------------
			INSERT	INTO [DIPROCOM].[SWIFT_CUSTOMER_ACCOUNTING_INFORMATION]
					(
						[CODE_CUSTOMER]
						,[GROUP_NUM]
						,[CREDIT_LIMIT]
