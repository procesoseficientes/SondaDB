...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_ADD_PROMO_SKU_BY_PROMO_RULE]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_ADD_PROMO_SKU_BY_PROMO_RULE](
...
BEGIN
	...
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [DIPROCOM].[SWIFT_PROMO_SKU_BY_PROMO_RULE]
				(
