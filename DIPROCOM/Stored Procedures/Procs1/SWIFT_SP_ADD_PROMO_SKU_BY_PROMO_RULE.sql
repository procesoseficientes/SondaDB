...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_ADD_PROMO_SKU_BY_PROMO_RULE]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_ADD_PROMO_SKU_BY_PROMO_RULE](
...
BEGIN
	...
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [PACASA].[SWIFT_PROMO_SKU_BY_PROMO_RULE]
				(
