...
-- Ejemplo de Ejecucion:
				--
				EXEC [DIPROCOM].[SWIFT_SP_INSERT_POLYGON_POINT]
					@POLYGON_ID = 10
					,@POSITION = 21
					,@LATITUDE = '14.6318799'
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_POLYGON_POINT] (@POLYGON_ID INT
, @POSITION INT
...
BEGIN
  ...
  BEGIN TRY
    --
        INSERT INTO [DIPROCOM].[SWIFT_POLYGON_POINT] (POLYGON_ID
        , POSITION
        , LATITUDE
        , LONGITUDE)
