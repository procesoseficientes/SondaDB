...
-- Ejemplo de Ejecucion:
        ...
        EXECUTE @RC = [PACASA].SWIFT_SP_GET_ERP_POH @RECEPTION_HEADER
GO
*/
CREATE PROC [PACASA].[SWIFT_SP_GET_ERP_POH] @RECEPTION_HEADER VARCHAR(50)
AS
  ...
  SELECT TOP 1
    @DOC_NUM = ERP_DOC
  FROM [PACASA].SWIFT_TXN_X_DOC_ERP stxde INNER JOIN [PACASA].SWIFT_RECEPTION_HEADER srh
...
FROM [PACASA].SWIFT_RECEPTION_HEADER  AS t    
    INNER JOIN
