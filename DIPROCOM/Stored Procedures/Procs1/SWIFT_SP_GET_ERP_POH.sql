...
-- Ejemplo de Ejecucion:
        ...
        EXECUTE @RC = DIPROCOM.SWIFT_SP_GET_ERP_POH @RECEPTION_HEADER
GO
*/
CREATE PROC [DIPROCOM].[SWIFT_SP_GET_ERP_POH] @RECEPTION_HEADER VARCHAR(50)
AS
  ...
  SELECT TOP 1
    @DOC_NUM = ERP_DOC
  FROM DIPROCOM.SWIFT_TXN_X_DOC_ERP stxde INNER JOIN DIPROCOM.SWIFT_RECEPTION_HEADER srh
...
FROM [DIPROCOM].SWIFT_RECEPTION_HEADER  AS t    
    INNER JOIN
