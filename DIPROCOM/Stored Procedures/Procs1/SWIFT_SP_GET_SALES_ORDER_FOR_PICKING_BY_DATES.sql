...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_SALES_ORDER_FOR_PICKING_BY_DATES]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_SALES_ORDER_FOR_PICKING_BY_DATES] (
  @STARTDATE DATETIME
  , @ENDDATE DATETIME
  , @LOGIN VARCHAR(50)
)
...
BEGIN
  ...
  INSERT INTO @BODEGAS (CODE_WAREHOUSE)
    SELECT
      WU.CODE_WAREHOUSE
    FROM DIPROCOM.SWIFT_WAREHOUSE_BY_USER_WITH_ACCESS WU
