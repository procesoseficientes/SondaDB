...
-- Ejemplo de Ejecucion:
                EXEC [DIPROCOM].SWIFT_SP_GET_ASSIGNED_CHANNEL_BY_QUIZ @QUIZ_ID = 16
*/
-- =============================================


CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_ASSIGNED_CHANNEL_BY_QUIZ] (@QUIZ_ID INT)
AS 
BEGIN 
...
FROM DIPROCOM.SWIFT_CHANNEL SC 
	LEFT JOIN DIPROCOM.SWIFT_ASIGNED_QUIZ AQ ON AQ.CODE_CHANNEL = SC.CODE_CHANNEL 
