...
-- Ejemplo de Ejecucion:
        exec [PACASA].[SWIFT_SP_GET_CUSTUMER_FOR_SCOUTING_SALES] @CODE_ROUTE = 'ES000035'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_CUSTUMER_FOR_SCOUTING_SALES] (
...
--
	...
	SELECT --TOP 300
		...
		,0--[PACASA].[SONDA_FN_GET_LAST_PURCHASE_FOR_CUSTOMER] ([C].[CODE_CUSTOMER]) 
		AS LAST_PURCHASE
	FROM [PACASA].[SONDA_COSTUMER_FOR_SALES] [C]
	INNER JOIN [PACASA].[USERS] ON (
	...
	SELECT --TOP 300
		...
		,0--[PACASA].[SONDA_FN_GET_LAST_PURCHASE_FOR_CUSTOMER] ([VAC].[CODE_CUSTOMER]) 
		AS LAST_PURCHASE
	FROM [PACASA].[SONDA_COSTUMER_FOR_SALES] [VAC]
