...
-- Ejemplo de Ejecucion:
        exec [SONDA].[SWIFT_SP_GET_CUSTUMER_FOR_SCOUTING_SALES] @CODE_ROUTE = 'ES000035'
*/
-- =============================================
CREATE PROCEDURE [SONDA].[SWIFT_SP_GET_CUSTUMER_FOR_SCOUTING_SALES] (
...
--
	...
	SELECT --TOP 300
		...
		AS LAST_PURCHASE
	FROM [SONDA].[SONDA_COSTUMER_FOR_SALES] [C]
	...
	SELECT --TOP 300
		...
		AS LAST_PURCHASE
	FROM [SONDA].[SONDA_COSTUMER_FOR_SALES] [VAC]
