...
-- Ejemplo de Ejecucion:
			EXEC  [DIPROCOM].[SWIFT_SP_GET_BONUS_BY_GENERAL_AMOUNT_FROM_PROMO] @PROMO_ID = 1103
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_BONUS_BY_GENERAL_AMOUNT_FROM_PROMO] (@PROMO_ID INT) WITH RECOMPILE
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  SELECT
   ...
   ,[BGA].[BONUS_QTY]
  FROM [DIPROCOM].[SWIFT_PROMO_BONUS_BY_GENERAL_AMOUNT] [BGA]
  INNER JOIN [DIPROCOM].[SWIFT_VIEW_ALL_SKU] [VAS]
