...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_ALL_TAG_BY_CUSTOMER_CHANGE]
					@CUSTOMER = 3875
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_ALL_TAG_BY_CUSTOMER_CHANGE](
	@CUSTOMER INT
)
AS
BEGIN
	...
	SELECT
		...
		,CASE
			...
			ELSE 1
		END [IS_CONFIG]
	FROM [DIPROCOM].[SWIFT_TAGS] [T]
	LEFT JOIN [DIPROCOM].[SWIFT_TAG_X_CUSTOMER_CHANGE] [C] ON (
