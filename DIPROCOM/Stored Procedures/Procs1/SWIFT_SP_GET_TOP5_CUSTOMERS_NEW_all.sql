...
EXECUTE @RC = [PACASA].SWIFT_SP_GET_TOP5_CUSTOMERS_NEW
GO
  
*/
-- =============================================

create PROCEDURE [PACASA].[SWIFT_SP_GET_TOP5_CUSTOMERS_NEW_all]
AS
  ...
  INNER JOIN [PACASA].SWIFT_CUSTOMER_FREQUENCY_NEW scfn
