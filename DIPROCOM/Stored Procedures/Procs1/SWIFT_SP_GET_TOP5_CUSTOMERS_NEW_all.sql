...
EXECUTE @RC = DIPROCOM.SWIFT_SP_GET_TOP5_CUSTOMERS_NEW
GO
  
*/
-- =============================================

create PROCEDURE [DIPROCOM].[SWIFT_SP_GET_TOP5_CUSTOMERS_NEW_all]
AS
  ...
  INNER JOIN DIPROCOM.SWIFT_CUSTOMER_FREQUENCY_NEW scfn
