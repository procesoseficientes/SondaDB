...
/*
-- DROP PROCEDURE [DIPROCOM].[SWIFT_SP_GET_RESTOCK_PICKING_DETAIL_FOR_ERP]

-- Ejemplo de Ejecucion:
        EXEC  [DIPROCOM].[SWIFT_SP_GET_RESTOCK_PICKING_DETAIL_FOR_ERP] @PICKING_HEADER ='1003'
          
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_RESTOCK_PICKING_DETAIL_FOR_ERP] (@PICKING_HEADER INT)
