...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_DISASSOCIATE_ROUTE_FROM_TRADE_AGREEMENT]
					@CODE_ROUTE = 'R004'
				-- 
				SELECT * FROM [DIPROCOM].[SWIFT_ROUTES]
        SELECT * FROM [DIPROCOM].[SWIFT_TRADE_AGREEMENT]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_DISASSOCIATE_ROUTE_FROM_TRADE_AGREEMENT (@CODE_ROUTE VARCHAR(50))
AS
BEGIN
  BEGIN TRY
