...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_DISASSOCIATE_ROUTE_FROM_TRADE_AGREEMENT]
					@CODE_ROUTE = 'R004'
				-- 
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].SWIFT_SP_DISASSOCIATE_ROUTE_FROM_TRADE_AGREEMENT (@CODE_ROUTE VARCHAR(50))
AS
BEGIN
  BEGIN TRY
