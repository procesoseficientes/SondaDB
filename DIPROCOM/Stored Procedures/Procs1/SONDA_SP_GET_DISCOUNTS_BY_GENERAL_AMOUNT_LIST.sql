...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_GET_DISCOUNTS_BY_GENERAL_AMOUNT_LIST]
					@CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_DISCOUNTS_BY_GENERAL_AMOUNT_LIST](
...
BEGIN
	...
	SELECT DISTINCT
		...
		,[DLG].[PROMO_TYPE]
    ,[DLG].[FREQUENCY]
	FROM [PACASA].[SWIFT_DISCOUNT_LIST_BY_GENERAL_AMOUNT] AS [DLG]
