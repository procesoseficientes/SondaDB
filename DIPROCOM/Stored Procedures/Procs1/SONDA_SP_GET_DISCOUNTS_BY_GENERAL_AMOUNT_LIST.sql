...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SONDA_SP_GET_DISCOUNTS_BY_GENERAL_AMOUNT_LIST]
					@CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_GET_DISCOUNTS_BY_GENERAL_AMOUNT_LIST](
...
BEGIN
	...
	SELECT DISTINCT
		...
		,[DLG].[PROMO_TYPE]
    ,[DLG].[FREQUENCY]
	FROM [acsa].[SWIFT_DISCOUNT_LIST_BY_GENERAL_AMOUNT] AS [DLG]
