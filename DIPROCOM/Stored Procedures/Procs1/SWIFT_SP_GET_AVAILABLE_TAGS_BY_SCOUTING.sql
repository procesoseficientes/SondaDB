...
-- EJEMPLO DE EJECUCION: 
		EXEC [PACASA].[SWIFT_SP_GET_AVAILABLE_TAGS_BY_SCOUTING]
...
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_AVAILABLE_TAGS_BY_SCOUTING]
(
...
BEGIN
	...
	BEGIN TRY
		...
		WHERE [T].[TAG_COLOR] 
			...
			FROM [PACASA].[SWIFT_VIEW_ALL_TAG_X_CUSTOMER_NEW] AS TXC 
