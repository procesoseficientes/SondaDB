...
-- Ejemplo de Ejecucion:
			EXEC [DIPROCOM].[SWIFT_SP_INSERT_FAKE_PICKING_HEADER] 	@CLASSIFICATION_PICKING = '4'
													,@CODE_CLIENT = '123123'
													,@REFERENCE = '1231231'
													,@STATUS = 'CLOSED'
													,@ERP_REFERENCE = 0
...
*/
-- =============================================
create PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_FAKE_PICKING_HEADER](
...
BEGIN
	BEGIN TRY
		...
		INSERT	INTO [DIPROCOM].[SWIFT_PICKING_HEADER]
				(
