create PROCEDURE [PACASA].[SWIFT_SP_INSERT_DETAIL_PICKING]
@PICKINGHEADER INT,
@CODE_SKU VARCHAR(50),
@DISPATCH FLOAT,
...
IF EXISTS (SELECT CODE_SKU FROM [PACASA].SWIFT_TEMP_PICKING_DETAIL WHERE CODE_SKU = @CODE_SKU AND PICKING_HEADER = @PICKINGHEADER)
            BEGIN
