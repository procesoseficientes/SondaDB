...
-- Ejemplo de Ejecucion:
	exec [acsa].[SONDA_SP_GET_SALE_X_DATE] @POSTED_DATETIME='20160511 00:00:00.000', @CLOSED_ROUTE_DATETIME='20160822 00:00:00.000', @LOGIN='gerente@DIPROCOM', @IS_AUTHORIZED = 0

*/
-- =============================================
CREATE PROCEDURE [acsa].SONDA_SP_GET_SALE_X_DATE
