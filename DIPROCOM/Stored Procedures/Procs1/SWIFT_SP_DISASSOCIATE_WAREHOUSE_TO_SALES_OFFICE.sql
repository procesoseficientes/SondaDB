...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_DISASSOCIATE_WAREHOUSE_TO_SALES_OFFICE]
					@CODE_WAREHOUSE = 'BODEGA_CENTRAL'
				-- 
				SELECT * FROM [PACASA].SWIFT_WAREHOUSES
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_DISASSOCIATE_WAREHOUSE_TO_SALES_OFFICE](
	@CODE_WAREHOUSE VARCHAR(50)
)
AS
BEGIN
	BEGIN TRY
		UPDATE [PACASA].SWIFT_WAREHOUSES
		SET	
