...
Ejemplo de Ejecucion:
    ...
    EXEC [PACASA].[SONDA_SP_GET_OVERDUE_INVOICE_BY_CUSTOMER] @CODE_ROUTE = '32'
          
	-- Para obtener todas las facturas por cliente
	EXEC [PACASA].[SONDA_SP_GET_OVERDUE_INVOICE_BY_CUSTOMER] @CODE_ROUTE = '46', @CODE_CUSTOMER = 'BO-2091'

*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_OVERDUE_INVOICE_BY_CUSTOMER]
	(
...
AS
  ...
  --
		...
		SELECT
			...
			,[OI].[IS_EXPIRED]
		FROM
			[PACASA].[SWIFT_OVERDUE_INVOICE_BY_CUSTOMER] AS [OI]
