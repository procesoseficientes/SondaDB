...
Ejemplo de Ejecucion:
    ...
    EXEC [acsa].[SONDA_SP_GET_OVERDUE_INVOICE_BY_CUSTOMER] @CODE_ROUTE = '32'
          
	-- Para obtener todas las facturas por cliente
	EXEC [acsa].[SONDA_SP_GET_OVERDUE_INVOICE_BY_CUSTOMER] @CODE_ROUTE = '46', @CODE_CUSTOMER = 'BO-2091'

*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_GET_OVERDUE_INVOICE_BY_CUSTOMER]
	(
...
AS
  ...
  --
		...
		SELECT
			...
			,[OI].[IS_EXPIRED]
		FROM
			[acsa].[SWIFT_OVERDUE_INVOICE_BY_CUSTOMER] AS [OI]
