...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_PORTFOLIO_SKU_AVAILABLE]  @CODE_PORTFOLIO = 5
*/
-- =============================================
CREATE PROC [PACASA].SWIFT_SP_GET_PORTFOLIO_SKU_AVAILABLE
	@CODE_PORTFOLIO VARCHAR(50)
AS
	SELECT *
	FROM [PACASA].SWIFT_VIEW_ALL_SKU S
	WHERE NOT EXISTS(SELECT 1
					FROM [PACASA].SWIFT_VIEW_PORTFOLIO_BY_SKU PS
