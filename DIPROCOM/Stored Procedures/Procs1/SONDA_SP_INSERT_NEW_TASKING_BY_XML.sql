...
EXEC [PACASA].[SONDA_SP_INSERT_NEW_TASKING_BY_XML] @XML = '<?xml version=''1.0''?>
<Data>
    <tasking>
        <taskId>4</taskId>
...
====================================
*/
CREATE PROCEDURE [PACASA].[SONDA_SP_INSERT_NEW_TASKING_BY_XML]
(
    @XML XML,
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- ------------------------------------------------------------------------------------- --
        EXEC [PACASA].[SONDA_SP_VALIDATE_DEVICE_ID_OF_USER_FOR_TRANSACTION] @CODE_ROUTE = @CODE_ROUTE,
                                                                           @DEVICE_ID = @DEVICE_ID;
