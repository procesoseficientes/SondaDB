...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_GET_SALES_ORDER_FOR_DASHBOARD]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_GET_SALES_ORDER_FOR_DASHBOARD]
AS
BEGIN
	SET NOCOUNT ON;
	--
	...
	INNER JOIN [PACASA].[SONDA_SALES_ORDER_DETAIL] [SD] ON (
