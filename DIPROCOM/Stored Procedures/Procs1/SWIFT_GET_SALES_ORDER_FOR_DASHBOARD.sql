...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_GET_SALES_ORDER_FOR_DASHBOARD]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_GET_SALES_ORDER_FOR_DASHBOARD]
AS
BEGIN
	SET NOCOUNT ON;
	--
	...
	INNER JOIN [DIPROCOM].[SONDA_SALES_ORDER_DETAIL] [SD] ON (
