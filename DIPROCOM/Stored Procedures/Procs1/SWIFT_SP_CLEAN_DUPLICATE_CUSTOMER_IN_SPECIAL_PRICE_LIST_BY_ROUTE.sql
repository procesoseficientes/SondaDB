...
-- Ejemplo de Ejecucion:
        EXEC [acsa].[SWIFT_SP_CLEAN_DUPLICATE_CUSTOMER_IN_SPECIAL_PRICE_LIST_BY_ROUTE]
		@CODE_ROUTE = '136'
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_CLEAN_DUPLICATE_CUSTOMER_IN_SPECIAL_PRICE_LIST_BY_ROUTE]
	(
