...
-- Ejemplo de Ejecucion:
			EXEC [DIPROCOM].SWIFT_SP_GET_BASKET_BARCODE_BY_MANIFEST @MANIFEST_HEADER_ID =2151
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_GET_BASKET_BARCODE_BY_MANIFEST (@MANIFEST_HEADER_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  IF EXISTS (SELECT
      TOP 1
        1
      FROM [DIPROCOM].[SWIFT_PARAMETER] [SP]
