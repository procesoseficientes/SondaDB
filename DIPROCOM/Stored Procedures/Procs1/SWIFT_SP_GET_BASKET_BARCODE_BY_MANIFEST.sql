...
-- Ejemplo de Ejecucion:
			EXEC [acsa].SWIFT_SP_GET_BASKET_BARCODE_BY_MANIFEST @MANIFEST_HEADER_ID =2151
*/
-- =============================================
CREATE PROCEDURE [acsa].SWIFT_SP_GET_BASKET_BARCODE_BY_MANIFEST (@MANIFEST_HEADER_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
