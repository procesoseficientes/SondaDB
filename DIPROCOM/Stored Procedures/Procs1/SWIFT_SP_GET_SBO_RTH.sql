CREATE PROC [PACASA].[SWIFT_SP_GET_SBO_RTH]
...
case rt.TYPE_RECEPTION
	when   'RT' then (
						select cl.name_classification from  [PACASA].[SWIFT_CLASSIFICATION] cl 
  ...
  FROM [PACASA].SWIFT_RECEPTION_HEADER  rt
  inner join [PACASA].SWIFT_VIEW_ALL_COSTUMER  cus
