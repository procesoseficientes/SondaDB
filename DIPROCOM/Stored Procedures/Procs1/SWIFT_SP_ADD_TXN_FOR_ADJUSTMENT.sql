...
-- Ejemplo de Ejecucion:				
				--EXEC [DIPROCOM].[SWIFT_SP_ADD_TXN_FOR_ADJUSTMENT]
					...
					--
					SELECT TOP 5 * from [DIPROCOM].[SWIFT_TXNS] ORDER BY 1 DESC
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_ADD_TXN_FOR_ADJUSTMENT]
	@PALLET_ID_OLD INT
	,@PALLET_ID_NEW INT
	,@TASK_ID INT
