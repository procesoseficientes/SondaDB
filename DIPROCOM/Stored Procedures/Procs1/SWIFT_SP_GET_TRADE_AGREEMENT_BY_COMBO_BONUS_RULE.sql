...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE]
					@TRADE_AGREEMENT_ID = 20
					,@COMBO_ID = 5
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE](
...
BEGIN
	...
	FROM [PACASA].[SWIFT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE] [TAR]
	INNER JOIN [PACASA].[SWIFT_TRADE_AGREEMENT_BY_BONUS_RULE] [TAB] ON (
