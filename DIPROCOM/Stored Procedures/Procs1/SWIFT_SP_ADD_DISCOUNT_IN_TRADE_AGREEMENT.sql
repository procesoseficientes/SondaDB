...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].SWIFT_SP_ADD_DISCOUNT_IN_TRADE_AGREEMENT
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_ADD_DISCOUNT_IN_TRADE_AGREEMENT(
...
BEGIN
	BEGIN TRY		
		...
		INSERT INTO [DIPROCOM].[SWIFT_TRADE_AGREEMENT_DISCOUNT]
				(
					[TRADE_AGREEMENT_ID]
					,[CODE_SKU]
					,[PACK_UNIT]
