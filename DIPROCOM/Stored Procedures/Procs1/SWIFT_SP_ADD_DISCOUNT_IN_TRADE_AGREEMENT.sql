...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].SWIFT_SP_ADD_DISCOUNT_IN_TRADE_AGREEMENT
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].SWIFT_SP_ADD_DISCOUNT_IN_TRADE_AGREEMENT(
...
BEGIN
	BEGIN TRY		
		...
		INSERT INTO [PACASA].[SWIFT_TRADE_AGREEMENT_DISCOUNT]
				(
					[TRADE_AGREEMENT_ID]
					,[CODE_SKU]
					,[PACK_UNIT]
