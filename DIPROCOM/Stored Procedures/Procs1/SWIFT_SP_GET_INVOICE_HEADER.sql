...
-- Ejemplo de Ejecucion:
    ...
    EXECUTE @RC = [PACASA].SWIFT_SP_GET_INVOICE_HEADER @idFactura
    GO
*/
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_INVOICE_HEADER]
	(
		@INVOICE_ID INT
...
AS
  ...
  -- ------------------------------------------------------------------------------------
		SELECT
			@INTERFACE_PAYMENT_TYPE = [PACASA].[SWIFT_FN_GET_PARAMETER]('INVOICE' ,
