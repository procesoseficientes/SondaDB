...
Ejemplo de Ejecucion:
            ...
            EXEC [DIPROCOM].[SONDA_SP_GET_ITEM_HISTORY_BY_ROUTE]  
				@CODE_ROUTE = RUDI@DIPROCOM
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_ITEM_HISTORY_BY_ROUTE] @CODE_ROUTE VARCHAR(50)
AS
BEGIN
    SET NOCOUNT ON;
    --
    ...
    FROM [DIPROCOM].[SONDA_ITEM_HISTORY] [H]
