...
Ejemplo de Ejecucion:
            ...
            EXEC [PACASA].[SONDA_SP_GET_ITEM_HISTORY_BY_ROUTE]  
				@CODE_ROUTE = RUDI@DIPROCOM
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_ITEM_HISTORY_BY_ROUTE] @CODE_ROUTE VARCHAR(50)
AS
BEGIN
    SET NOCOUNT ON;
    --
    ...
    FROM [PACASA].[SONDA_ITEM_HISTORY] [H]
