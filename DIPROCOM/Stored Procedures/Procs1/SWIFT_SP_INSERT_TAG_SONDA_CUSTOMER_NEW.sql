...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_INSERT_TAG_SONDA_CUSTOMER_NEW]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_TAG_SONDA_CUSTOMER_NEW](
...
BEGIN
	...
	BEGIN TRY
		--
		INSERT INTO [DIPROCOM].[SONDA_TAG_X_CUSTOMER_NEW]
