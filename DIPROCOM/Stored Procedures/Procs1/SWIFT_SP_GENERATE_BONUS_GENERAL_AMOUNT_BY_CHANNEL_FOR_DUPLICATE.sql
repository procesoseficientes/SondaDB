...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_GENERATE_BONUS_GENERAL_AMOUNT_BY_CHANNEL_FOR_DUPLICATE]
					@CODE_ROUTE = '44'
					,@ORDER = 2
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GENERATE_BONUS_GENERAL_AMOUNT_BY_CHANNEL_FOR_DUPLICATE] (@CODE_ROUTE VARCHAR(250)
, @ORDER INT)
AS
BEGIN
  SET NOCOUNT ON;
  ...
  , [FREQUENCY])
    ...
    INNER JOIN [acsa].[SWIFT_PROMO_BONUS_BY_GENERAL_AMOUNT] [TAB]
      ON (
    ...
    LEFT JOIN [acsa].[SWIFT_BONUS_LIST_BY_GENERAL_AMOUNT] [BLBS]
      ON (
