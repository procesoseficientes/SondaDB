...
-- Ejemplo de Ejecucion:
			EXEC [PACASA].[INSERT_SP_USER]
				...
				,@USE_PACK_UNIT = 1
			--
			SELECT * FROM [PACASA].USERS WHERE [LOGIN] = 'PRUEBA@DIPROCOM'
			--
			DELETE [PACASA].USERS WHERE [LOGIN] = 'PRUEBA@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [PACASA].INSERT_SP_USER @LOGIN VARCHAR(50)
...
BEGIN
  ...
  INSERT INTO [PACASA].[USERS] ([LOGIN]
  , NAME_USER
  , TYPE_USER
  , [PASSWORD]
  , ENTERPRISE
