...
-- Ejemplo de Ejecucion:
			EXEC [DIPROCOM].[INSERT_SP_USER]
				...
				,@USE_PACK_UNIT = 1
			--
			SELECT * FROM [DIPROCOM].USERS WHERE [LOGIN] = 'PRUEBA@DIPROCOM'
			--
			DELETE [DIPROCOM].USERS WHERE [LOGIN] = 'PRUEBA@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].INSERT_SP_USER @LOGIN VARCHAR(50)
...
BEGIN
  ...
  INSERT INTO [DIPROCOM].[USERS] ([LOGIN]
  , NAME_USER
  , TYPE_USER
  , [PASSWORD]
  , ENTERPRISE
