...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_INSERT_WAREHOUSE_ACCESS_TO_USER]
					@USER_CORRELATIVE = 1
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_INSERT_WAREHOUSE_ACCESS_TO_USER](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [PACASA].[SWIFT_WAREHOUSE_BY_USER_WITH_ACCESS]
				(
					[USER_CORRELATIVE]
					,[CODE_WAREHOUSE]
				)
