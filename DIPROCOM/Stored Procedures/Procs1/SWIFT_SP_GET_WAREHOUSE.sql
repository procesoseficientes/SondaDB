/****** Object:  StoredProcedure [PACASA].[SWIFT_SP_GET_WAREHOUSE]    Script Date: 20/12/2015 9:09:38 AM ******/
-- =============================================
-- Autor:				jose.garcia
...
-- Ejemplo de Ejecucion:				
				--
				exec [PACASA].[SWIFT_SP_GET_WAREHOUSE]				--				

*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_WAREHOUSE]
AS
Select [WAREHOUSE]
	  ,[CODE_WAREHOUSE]
...
from [PACASA].[SWIFT_WAREHOUSES] order by (CODE_WAREHOUSE)
