...
-- Ejemplo de Ejecucion:				
				--EXEC  [acsa].[SWIFT_SP_GET_LAST_BATCH_BY_TASK] @TASK_Id = 5219
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_LAST_BATCH_BY_TASK]
    @TASK_Id INT
	,@CODE_SKU VARCHAR(50)
AS
BEGIN 
	...
	SELECT TOP 1
		...
		,B.TASK_ID TaskId
		,(SELECT COUNT(P.PALLET_ID) FROM [acsa].SWIFT_PALLET P WHERE P.TASK_ID = @TASK_Id) AS QtyPallet
