...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_PROMO_NO_ASSOCIATED_TO_TRADE_AGREEMENT] @TRADE_AGREEMENT_ID = 1029
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_PROMO_NON_ASSOCIATED_FOR_TRADE_AGREEMENT] (@TRADE_AGREEMENT_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  SELECT
   ...
   ,CASE [SP].[PROMO_TYPE]
    ...
    END [PROMO_TYPE]
  FROM [PACASA].[SWIFT_PROMO] [SP]
  LEFT JOIN [PACASA].[SWIFT_TRADE_AGREEMENT_BY_PROMO] [STAP]
