...
-- Ejemplo de Ejecucion:
				EXEC [SONDA].[SWIFT_SP_GET_PROMO_NO_ASSOCIATED_TO_TRADE_AGREEMENT] @TRADE_AGREEMENT_ID = 1029
*/
-- =============================================
CREATE PROCEDURE [SONDA].[SWIFT_SP_GET_PROMO_NON_ASSOCIATED_FOR_TRADE_AGREEMENT] (@TRADE_AGREEMENT_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  LEFT JOIN [SONDA].[SWIFT_TRADE_AGREEMENT_BY_PROMO] [STAP]
