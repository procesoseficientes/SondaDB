...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].SWIFT_SP_INSERT_CHANNEL_X_CUSTOMER
					@CHANNEL_ID = 1
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_INSERT_CHANNEL_X_CUSTOMER(
	@CHANNEL_ID INT
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [DIPROCOM].SWIFT_CHANNEL_X_CUSTOMER (
			CHANNEL_ID
			,CODE_CUSTOMER
		) VALUES (
			@CHANNEL_ID
