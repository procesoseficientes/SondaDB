...
-- Ejemplo de Ejecucion:
      ...
      EXECUTE @RC = [PACASA].SWIFT_SP_GET_ERP_ITRS @PICKING_HEADER
      GO
*/
-- =============================================
CREATE PROC [PACASA].SWIFT_SP_GET_ERP_ITRS
...
SELECT   
 CAST(@PICKING_HEADER AS INT) AS DocEntry ,
  ...
  'AVAILABLE'  STATUS 
  FROM [PACASA].SWIFT_TXNS st INNER JOIN [PACASA].SWIFT_TASKS st1
