...
-- Ejemplo de Ejecucion:
      ...
      EXECUTE @RC = [DIPROCOM].SWIFT_SP_GET_ERP_ITRS @PICKING_HEADER
      GO
*/
-- =============================================
CREATE PROC [DIPROCOM].SWIFT_SP_GET_ERP_ITRS
...
SELECT   
 CAST(@PICKING_HEADER AS INT) AS DocEntry ,
  ...
  'AVAILABLE'  STATUS 
  FROM [DIPROCOM].SWIFT_TXNS st INNER JOIN [DIPROCOM].SWIFT_TASKS st1
