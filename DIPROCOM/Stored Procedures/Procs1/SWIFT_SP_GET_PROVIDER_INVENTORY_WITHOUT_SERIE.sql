...
-- Ejemplo de Ejecucion:
				--
				EXEC [DIPROCOM].[SWIFT_SP_GET_PROVIDER_INVENTORY_WITHOUT_SERIE]
				--
				EXEC [DIPROCOM].[SWIFT_SP_GET_PROVIDER_INVENTORY_WITHOUT_SERIE] @CODE_PROVIDER = 'P0001'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_PROVIDER_INVENTORY_WITHOUT_SERIE]
...
BEGIN
	SELECT
		...
		,P.[PALLET_ID]
		,P.[ON_HAND]
	FROM [DIPROCOM].[SWIFT_VIEW_PROVIDER_INVENTORY_WITHOUT_SERIE] P
