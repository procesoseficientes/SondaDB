...
-- Ejemplo de Ejecucion:
				--
				EXEC [PACASA].[SWIFT_SP_GET_PROVIDER_INVENTORY_WITHOUT_SERIE]
				--
				EXEC [PACASA].[SWIFT_SP_GET_PROVIDER_INVENTORY_WITHOUT_SERIE] @CODE_PROVIDER = 'P0001'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_PROVIDER_INVENTORY_WITHOUT_SERIE]
...
BEGIN
	SELECT
		...
		,P.[PALLET_ID]
		,P.[ON_HAND]
	FROM [PACASA].[SWIFT_VIEW_PROVIDER_INVENTORY_WITHOUT_SERIE] P
