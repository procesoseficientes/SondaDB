...
-- Ejemplo de Ejecucion:
				DECLARE 
					...
					,@QTY INT = 1
				--
				SELECT * FROM [PACASA].[SONDA_IS_COMITED_BY_WAREHOUSE] WHERE CODE_WAREHOUSE = @CODE_WAREHOUSE AND CODE_SKU = @CODE_SKU
				--
				EXEC [PACASA].[SONDA_SP_VOID_COMMITED_INVENTORY]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_VOID_COMMITED_INVENTORY]
(	
