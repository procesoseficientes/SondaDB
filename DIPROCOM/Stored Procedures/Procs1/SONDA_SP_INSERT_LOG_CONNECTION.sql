...
-- Ejemplo de Ejecucion:
		EXEC [DIPROCOM].[SONDA_SP_INSERT_LOG_CONNECTION]
		@LOGIN_USER = 'prueba'
		, @ROUTE_USER = 'prueba@DIPROCOM'
		, @DEVICE_USER = 'e39cbcecbc62d5d6'
		, @MESSAGE = 'Prueba mensaje'
		-----
		SELECT * FROM DIPROCOM.SONDA_HISTORY_CONNECTION_OF_USER
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_INSERT_LOG_CONNECTION](
...
BEGIN
	SET NOCOUNT ON;
	--
	INSERT INTO [DIPROCOM].[SONDA_HISTORY_CONNECTION_OF_USER]
			(
				[LOGIN_USER]
				,[ROUTE_USER]
				,[DEVICE_USER]
