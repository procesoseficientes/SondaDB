...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].SWIFT_SP_DELETE_BONUS_FROM_TRADE_AGREEMENT
					@TRADE_AGREEMENT_BONUS_ID = 7
				-- 
				SELECT * FROM [PACASA].SWIFT_TRADE_AGREEMENT_BONUS
*/
-- =============================================
CREATE PROCEDURE [PACASA].SWIFT_SP_DELETE_BONUS_FROM_TRADE_AGREEMENT(
	@TRADE_AGREEMENT_BONUS_ID INT
)
AS
BEGIN
	BEGIN TRY
		DELETE FROM [PACASA].SWIFT_TRADE_AGREEMENT_BONUS
