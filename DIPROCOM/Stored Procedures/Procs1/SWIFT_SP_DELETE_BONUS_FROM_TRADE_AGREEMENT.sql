...
-- Ejemplo de Ejecucion:
				EXEC [acsa].SWIFT_SP_DELETE_BONUS_FROM_TRADE_AGREEMENT
					@TRADE_AGREEMENT_BONUS_ID = 7
				-- 
				SELECT * FROM [acsa].SWIFT_TRADE_AGREEMENT_BONUS
*/
-- =============================================
CREATE PROCEDURE [acsa].SWIFT_SP_DELETE_BONUS_FROM_TRADE_AGREEMENT(
	@TRADE_AGREEMENT_BONUS_ID INT
)
AS
BEGIN
	BEGIN TRY
		DELETE FROM [acsa].SWIFT_TRADE_AGREEMENT_BONUS
