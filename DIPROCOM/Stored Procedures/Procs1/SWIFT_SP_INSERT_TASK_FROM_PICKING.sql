...
-- Ejemplo de Ejecucion:
        ...
        GO
        --
        EXEC [acsa].[SWIFT_SP_INSERT_TASK_FROM_PICKING]
			@PICKING_HEADER = 627
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_INSERT_TASK_FROM_PICKING] (
	@PICKING_HEADER INT
)
AS
BEGIN
	BEGIN TRY
		...
		INNER JOIN [acsa].[SWIFT_VIEW_ALL_COSTUMER] C ON (P.CODE_CLIENT = C.CODE_CUSTOMER)
