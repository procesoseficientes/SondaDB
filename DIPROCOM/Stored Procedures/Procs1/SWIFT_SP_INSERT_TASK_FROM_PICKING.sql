...
-- Ejemplo de Ejecucion:
        ...
        GO
        --
        EXEC [PACASA].[SWIFT_SP_INSERT_TASK_FROM_PICKING]
			@PICKING_HEADER = 627
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_INSERT_TASK_FROM_PICKING] (
	@PICKING_HEADER INT
)
AS
BEGIN
	BEGIN TRY
		...
		INNER JOIN [PACASA].[SWIFT_VIEW_ALL_COSTUMER] C ON (P.CODE_CLIENT = C.CODE_CUSTOMER)
