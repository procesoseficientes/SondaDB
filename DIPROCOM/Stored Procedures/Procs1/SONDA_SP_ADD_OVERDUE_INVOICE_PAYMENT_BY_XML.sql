...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_ADD_OVERDUE_INVOICE_PAYMENT_BY_XML]
				@XML = '
					
				'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_ADD_OVERDUE_INVOICE_PAYMENT_BY_XML]
(@XML XML)
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            BEGIN TRY
                ...
                FROM [PACASA].[SONDA_OVERDUE_INVOICE_PAYMENT_HEADER]
                ...
                BEGIN
                    ...
                    -- ----------------------------------------------------------------------------
                    INSERT INTO [PACASA].[SONDA_OVERDUE_INVOICE_PAYMENT_HEADER]
                    (
                        [CODE_CUSTOMER],
                        [DOC_SERIE],
                        [DOC_NUM],
                    ...
                    -- --------------------------------------------------------------------------------------
                    INSERT INTO [PACASA].[SONDA_OVERDUE_INVOICE_PAYMENT_DETAIL]
                    (
                        [PAYMENT_HEADER_ID],
                        [INVOICE_ID],
                        [DOC_ENTRY],
                    ...
                    -- --------------------------------------------------------------------------------------
                    INSERT INTO [PACASA].[SONDA_PAYMENT_TYPE_DETAIL_FOR_OVERDUE_INVOICE_PAYMENT]
                    (
                        [PAYMENT_HEADER_ID],
                        [PAYMENT_TYPE],
                        [FRONT_IMAGE],
