...
-- Ejemplo de Ejecucion:
				exec [PACASA].[SWIFT_GET_INVENTORY]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_GET_INVENTORY_ANT]
AS
  SELECT 
    A.WAREHOUSE
   ,A.LOCATION
  ...
  INNER JOIN [PACASA].SWIFT_VIEW_ALL_SKU AS D ON (A.SKU = D.CODE_SKU)
  LEFT JOIN [PACASA].SWIFT_BATCH sb ON A.BATCH_ID = sb.BATCH_ID and sb.QTY > 0
  LEFT JOIN [PACASA].SWIFT_PALLET pl ON PL.BATCH_ID = A.PALLET_ID
  WHERE A.ON_HAND > 0  ;
