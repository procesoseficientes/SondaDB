...
-- Ejemplo de Ejecucion:
				exec DIPROCOM.[SWIFT_GET_INVENTORY]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_GET_INVENTORY_ANT]
AS
  SELECT 
    A.WAREHOUSE
   ,A.LOCATION
  ...
  INNER JOIN DIPROCOM.SWIFT_VIEW_ALL_SKU AS D ON (A.SKU = D.CODE_SKU)
  LEFT JOIN DIPROCOM.SWIFT_BATCH sb ON A.BATCH_ID = sb.BATCH_ID and sb.QTY > 0
  LEFT JOIN DIPROCOM.SWIFT_PALLET pl ON PL.BATCH_ID = A.PALLET_ID
  WHERE A.ON_HAND > 0  ;
