...
-- Ejemplo de Ejecucion:
				-- 
  SELECT * FROM [SONDA].[SONDA_SALES_ORDER_LOG_EXISTS]
...
*/
-- =============================================
CREATE PROCEDURE [SONDA].SONDA_SP_VALIDATE_SALE_ORDER_IS_POSTED (@SALES_ORDER_ID INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    FROM [SONDA].[SONDA_SALES_ORDER_HEADER] [H] /*WITH(ROWLOCK,XLOCK,HOLDLOCK)*/
