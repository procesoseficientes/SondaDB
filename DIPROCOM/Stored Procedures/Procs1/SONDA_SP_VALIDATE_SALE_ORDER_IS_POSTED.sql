...
-- Ejemplo de Ejecucion:
				-- 
  SELECT * FROM [PACASA].[SONDA_SALES_ORDER_LOG_EXISTS]
				EXEC [PACASA].[SONDA_SP_VALIDATE_SALE_ORDER_IS_POSTED]
					@SALES_ORDER_ID = 897
					,@SALES_ORDER_ID_HH = -2
					,@DOC_SERIE = 'C'
					,@DOC_NUM = 46
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].SONDA_SP_VALIDATE_SALE_ORDER_IS_POSTED (@SALES_ORDER_ID INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    FROM [PACASA].[SONDA_SALES_ORDER_HEADER] [H] /*WITH(ROWLOCK,XLOCK,HOLDLOCK)*/
    ...
    FROM [PACASA].[SONDA_SALES_ORDER_HEADER] [H] /*WITH(ROWLOCK,XLOCK,HOLDLOCK)*/
    INNER JOIN [PACASA].[SONDA_SALES_ORDER_DETAIL] [D]
      ON (
    ...
    BEGIN
      ...
      SET DOC_NUM = NEXT VALUE FOR [PACASA].SALES_ORDER_NEGATIVE_SEQUENCE
      ...
      SELECT
       ...
       ,@INSERT = 1
      --
      INSERT INTO [PACASA].[SONDA_SALES_ORDER_LOG_EXISTS] ([LOG_DATETIME]
      , [EXISTS_SALES_ORDER]
      , [DOC_SERIE]
      , [DOC_NUM]
      , [CODE_ROUTE]
