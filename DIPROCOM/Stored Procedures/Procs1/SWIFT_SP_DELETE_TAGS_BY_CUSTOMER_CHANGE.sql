...
-- EJEMPLO DE EJECUCION: 
		EXEC [DIPROCOM].[SWIFT_SP_DELETE_TAGS_BY_CUSTOMER_CHANGE]
			@TAG_COLOR = '#33CCCC'
			,@CUSTOMER_ID = '3'
			,@LOGIN = 'gerente@DIPROCOM'
=========================================================*/
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_DELETE_TAGS_BY_CUSTOMER_CHANGE]
( 
...
BEGIN
	...
	BEGIN TRY
		--
		DELETE FROM [DIPROCOM].[SWIFT_TAG_X_CUSTOMER_CHANGE]
