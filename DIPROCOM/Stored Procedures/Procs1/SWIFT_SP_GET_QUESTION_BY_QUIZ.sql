...
-- Ejemplo de Ejecucion:
                EXEC [DIPROCOM].SWIFT_SP_GET_QUESTION_BY_QUIZ @QUIZ_ID = 1
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_QUESTION_BY_QUIZ] (@QUIZ_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  SELECT
   ...
   ,[Q].[LAST_UPDATE]
   ,[Q].[LAST_UPDATE_BY]   
  FROM [DIPROCOM].[SWIFT_QUESTION] [Q]
