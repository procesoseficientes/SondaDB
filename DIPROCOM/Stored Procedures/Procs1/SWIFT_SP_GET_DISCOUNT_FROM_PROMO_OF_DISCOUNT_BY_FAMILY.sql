...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].SWIFT_SP_GET_DISCOUNT_FROM_PROMO_OF_DISCOUNT_BY_FAMILY
				@PROMO_ID = 3299
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_DISCOUNT_FROM_PROMO_OF_DISCOUNT_BY_FAMILY](
	@PROMO_ID INT = NULL
)
AS
BEGIN
	...
	FROM [DIPROCOM].[SWIFT_PROMO_DISCOUNT_BY_FAMILY] [DF]
		INNER JOIN [DIPROCOM].[SWIFT_FAMILY_SKU] [FS] ON ([FS].[CODE_FAMILY_SKU] = [DF].[CODE_FAMILY_SKU])		
