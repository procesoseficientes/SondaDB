...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_CLEAN_DUPLICATE_CUSTOMER_IN_SKU_SALES_BY_MULTIPLE_LIST_BY_ROUTE] (@CODE_ROUTE VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  ...
  INSERT INTO @CUSTOMER
    SELECT
      [SMC].[CODE_CUSTOMER]
    FROM [acsa].[SWIFT_SKU_SALES_BY_MULTIPLE_LIST_BY_CUSTOMER] [SMC]
