...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].SWIFT_SP_DELETE_COMPLETE_PROMO_OF_BONUS_BY_MULTIPLO
				@PROMO_ID = 2128
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_DELETE_COMPLETE_PROMO_OF_BONUS_BY_MULTIPLO] (@PROMO_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  -- -----------------------------------------------------------------
