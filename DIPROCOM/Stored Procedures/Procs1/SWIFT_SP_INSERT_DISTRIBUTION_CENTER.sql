...
-- Ejemplo de Ejecucion:
        EXEC [PACASA].[SWIFT_SP_INSERT_DISTRIBUTION_CENTER]
			...
			,@LONGITUDE = -90.51327
		--
		SELECT * FROM [PACASA].[SWIFT_DISTRIBUTION_CENTER]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_INSERT_DISTRIBUTION_CENTER] (
...
BEGIN
	BEGIN TRY
		...
		DECLARE @ID INT
		--
		INSERT INTO [PACASA].[SWIFT_DISTRIBUTION_CENTER]
    			(
