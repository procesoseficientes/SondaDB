...
-- Ejemplo de Ejecucion:
        --
		EXEC [DIPROCOM].[SWIFT_GET_ALL_PICKING]
			@DTBEGIN = '2016-01-24 10:25:00.863'
			,@DTEND = '20160331'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_GET_ALL_PICKING] (
	@DTBEGIN DATE
	,@DTEND DATE
)
AS
BEGIN
	...
	FROM [DIPROCOM].[SWIFT_PICKING_HEADER] PH
	...
	LEFT JOIN [DIPROCOM].[SWIFT_TASKS] [ST] ON (
