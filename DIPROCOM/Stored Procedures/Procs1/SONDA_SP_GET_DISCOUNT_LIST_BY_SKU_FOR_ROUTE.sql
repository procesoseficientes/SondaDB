...
-- EJEMPLO DE EJECUCION: 
		...
		EXEC [acsa].[SONDA_SP_GET_DISCOUNT_LIST_BY_SKU_FOR_ROUTE]
		@CODE_ROUTE = '136'

*/
-- =====================================================
CREATE PROCEDURE [acsa].[SONDA_SP_GET_DISCOUNT_LIST_BY_SKU_FOR_ROUTE]
	(
...
AS
	...
	--
		SELECT DISTINCT
			...
			,[DLS].[IS_UNIQUE]
		FROM
			[acsa].[SWIFT_DISCOUNT_LIST_BY_SKU] AS [DLS]
