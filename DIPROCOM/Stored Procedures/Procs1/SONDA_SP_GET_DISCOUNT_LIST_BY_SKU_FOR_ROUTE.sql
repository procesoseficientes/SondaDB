...
-- EJEMPLO DE EJECUCION: 
		...
		EXEC [DIPROCOM].[SONDA_SP_GET_DISCOUNT_LIST_BY_SKU_FOR_ROUTE]
		@CODE_ROUTE = '136'

*/
-- =====================================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_DISCOUNT_LIST_BY_SKU_FOR_ROUTE]
	(
...
AS
	...
	--
		...
		SELECT
			[DL].[DISCOUNT_LIST_ID]
		FROM
			[DIPROCOM].[SWIFT_DISCOUNT_LIST] [DL]
		WHERE
	...
	--
		SELECT DISTINCT
			...
			,[DLS].[IS_UNIQUE]
		FROM
			[DIPROCOM].[SWIFT_DISCOUNT_LIST_BY_SKU] AS [DLS]
