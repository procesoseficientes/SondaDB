...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_ADD_PROMO_TO_TRADE_AGREEMENT]
					@TRADE_AGREEMENT_ID = 1, -- int
					@PROMO_ID = 5, -- int
					@FREQUENCY = 'ALWAYS' -- varchar(50)
				-- 
				SELECT * FROM [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_PROMO] 
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_ADD_PROMO_TO_TRADE_AGREEMENT] (@TRADE_AGREEMENT_ID INT
, @PROMO_ID INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    INSERT INTO [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_PROMO] ([TRADE_AGREEMENT_ID]
    , [PROMO_ID]
    , [FREQUENCY])
