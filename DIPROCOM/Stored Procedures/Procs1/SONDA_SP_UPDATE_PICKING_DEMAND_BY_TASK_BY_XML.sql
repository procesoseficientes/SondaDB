...
EXEC [DIPROCOM].[SONDA_SP_UPDATE_PICKING_DEMAND_BY_TASK_BY_XML]
@XML = '
<Data>
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_UPDATE_PICKING_DEMAND_BY_TASK_BY_XML] (@XML XML)
AS
BEGIN
    BEGIN TRY
        --
        ...
        FROM [DIPROCOM].[SONDA_PICKING_DEMAND_BY_TASK] AS [PDBT]
        ...
        -- ---------------------------------------------------------------
        INSERT INTO [DIPROCOM].[SONDA_PICKING_DEMAND_BY_TASK]
        (
            [PICKING_DEMAND_HEADER_ID],
            [TASK_ID],
            [PICKING_DEMAND_STATUS],
        ...
        FROM @PICKING_DEMAND_BY_TASK AS [SRC]
            LEFT JOIN [DIPROCOM].[SONDA_PICKING_DEMAND_BY_TASK] AS [PDBT]
