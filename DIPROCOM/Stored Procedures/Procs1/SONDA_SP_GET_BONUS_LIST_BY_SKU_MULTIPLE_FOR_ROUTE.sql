...
-- Ejemplo de Ejecucion:
        EXEC [PACASA].[SONDA_SP_GET_BONUS_LIST_BY_SKU_MULTIPLE_FOR_ROUTE]
			@CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_BONUS_LIST_BY_SKU_MULTIPLE_FOR_ROUTE] (
...
BEGIN
    ...
    ,[BLS].[PROMO_TYPE]
    ,[BLS].[FREQUENCY]
	FROM [PACASA].[SWIFT_BONUS_LIST_BY_SKU_MULTIPLE] AS [BLS]
