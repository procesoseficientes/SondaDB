...
-- Ejemplo de Ejecucion:
        EXEC [DIPROCOM].[SONDA_SP_GET_BONUS_LIST_BY_SKU_MULTIPLE_FOR_ROUTE]
			@CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_BONUS_LIST_BY_SKU_MULTIPLE_FOR_ROUTE] (
...
BEGIN
    ...
    ,[BLS].[PROMO_TYPE]
    ,[BLS].[FREQUENCY]
	FROM [DIPROCOM].[SWIFT_BONUS_LIST_BY_SKU_MULTIPLE] AS [BLS]
