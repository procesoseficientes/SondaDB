...
-- Ejemplo de Ejecucion:
        EXEC [acsa].[SONDA_SP_GET_BONUS_LIST_BY_SKU_MULTIPLE_FOR_ROUTE]
			@CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_GET_BONUS_LIST_BY_SKU_MULTIPLE_FOR_ROUTE] (
...
BEGIN
    ...
    ,[BLS].[PROMO_TYPE]
    ,[BLS].[FREQUENCY]
	FROM [acsa].[SWIFT_BONUS_LIST_BY_SKU_MULTIPLE] AS [BLS]
