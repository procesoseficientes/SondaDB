...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GENERATE_SKU_SALES_BY_MULTIPLE_LIST_BY_ROUTE_FOR_REPEATED_CUSTOMER](
...
BEGIN
	...
	SELECT
		...
		,[ORDER]
	INTO #PROC
	FROM [PACASA].[SWIFT_SKU_SALES_BY_MULTIPLE_PRIORITY] [SM]
