...
Ejemplo de Ejecucion:
	...
	EXEC [PACASA].[SWIFT_SP_GET_SKU_FOR_PICKING_DEVOLUTION] 
	@TASK_ID = @TASK_NUMBER
	,@PICKING_NUMBER = @P_H
	,@CODE_SKU = @COD_SKU 
...
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_SKU_FOR_PICKING_DEVOLUTION]
(
	@TASK_ID INT
	,@PICKING_NUMBER INT
...
BEGIN
	SET NOCOUNT ON;
		...
		SELECT @PICKING_HEADER = PICKING_NUMBER FROM [PACASA].[SWIFT_TASKS] 
