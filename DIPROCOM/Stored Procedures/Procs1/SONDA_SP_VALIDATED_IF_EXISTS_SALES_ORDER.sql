...
-- EJEMPLO DE EJECUCION: 
		--Existe
		EXEC [acsa].[SONDA_SP_VALIDATED_IF_EXISTS_SALES_ORDER]
			@DOC_SERIE = 'C'
			,@DOC_NUM = 49
		--No existe
		EXEC [acsa].[SONDA_SP_VALIDATED_IF_EXISTS_SALES_ORDER]
...
*/
-- =====================================================
CREATE PROCEDURE [acsa].SONDA_SP_VALIDATED_IF_EXISTS_SALES_ORDER (
...
BEGIN
	...
	INNER JOIN [acsa].SONDA_SALES_ORDER_DETAIL D ON (
