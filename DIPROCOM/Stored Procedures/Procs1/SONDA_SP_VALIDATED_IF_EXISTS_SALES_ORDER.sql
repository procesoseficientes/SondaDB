...
-- EJEMPLO DE EJECUCION: 
		--Existe
		EXEC [PACASA].[SONDA_SP_VALIDATED_IF_EXISTS_SALES_ORDER]
			@DOC_SERIE = 'C'
			,@DOC_NUM = 49
		--No existe
		EXEC [PACASA].[SONDA_SP_VALIDATED_IF_EXISTS_SALES_ORDER]
...
*/
-- =====================================================
CREATE PROCEDURE [PACASA].SONDA_SP_VALIDATED_IF_EXISTS_SALES_ORDER (
...
BEGIN
	...
	INNER JOIN [PACASA].SONDA_SALES_ORDER_DETAIL D ON (
