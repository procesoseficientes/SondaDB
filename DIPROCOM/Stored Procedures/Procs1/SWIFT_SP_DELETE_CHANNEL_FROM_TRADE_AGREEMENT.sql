...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].SWIFT_SP_DELETE_CHANNEL_FROM_TRADE_AGREEMENT
					@TRADE_AGREEMENT_ID = 1
					,@CHANNEL_ID = 1
				-- 
				SELECT * FROM [PACASA].SWIFT_TRADE_AGREEMENT_BY_CHANNEL
*/
-- =============================================
CREATE PROCEDURE [PACASA].SWIFT_SP_DELETE_CHANNEL_FROM_TRADE_AGREEMENT (@TRADE_AGREEMENT_ID INT
, @CHANNEL_ID INT)
AS
BEGIN
  BEGIN TRY

    DELETE FROM [PACASA].SWIFT_TRADE_AGREEMENT_BY_CHANNEL
