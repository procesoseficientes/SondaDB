...
-- Ejemplo de Ejecucion:
				EXEC [acsa].SWIFT_SP_DELETE_CHANNEL_FROM_TRADE_AGREEMENT
					@TRADE_AGREEMENT_ID = 1
					,@CHANNEL_ID = 1
				-- 
				SELECT * FROM [acsa].SWIFT_TRADE_AGREEMENT_BY_CHANNEL
*/
-- =============================================
CREATE PROCEDURE [acsa].SWIFT_SP_DELETE_CHANNEL_FROM_TRADE_AGREEMENT (@TRADE_AGREEMENT_ID INT
, @CHANNEL_ID INT)
AS
BEGIN
  BEGIN TRY

    DELETE FROM [acsa].SWIFT_TRADE_AGREEMENT_BY_CHANNEL
