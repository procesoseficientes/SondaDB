...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].SWIFT_SP_DELETE_CHANNEL_FROM_TRADE_AGREEMENT
					@TRADE_AGREEMENT_ID = 1
					,@CHANNEL_ID = 1
				-- 
				SELECT * FROM [DIPROCOM].SWIFT_TRADE_AGREEMENT_BY_CHANNEL
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_DELETE_CHANNEL_FROM_TRADE_AGREEMENT (@TRADE_AGREEMENT_ID INT
, @CHANNEL_ID INT)
AS
BEGIN
  BEGIN TRY

    DELETE FROM [DIPROCOM].SWIFT_TRADE_AGREEMENT_BY_CHANNEL
