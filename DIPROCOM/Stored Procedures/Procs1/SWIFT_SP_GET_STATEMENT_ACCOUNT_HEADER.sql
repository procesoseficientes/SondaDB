...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_STATEMENT_ACCOUNT_HEADER]
					@CODE_CUSTOMER = '11'
				--
				EXEC [DIPROCOM].[SWIFT_SP_GET_STATEMENT_ACCOUNT_HEADER]
					@CODE_CUSTOMER = '2120'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_STATEMENT_ACCOUNT_HEADER](
...
BEGIN
	...
	-- ------------------------------------------------------------------------------------
	INSERT INTO @INVOICE
	EXEC [DIPROCOM].[SONDA_SP_GET_ACTIVE_OVERDUE_INVOICE_BY_COSTUMER] 
