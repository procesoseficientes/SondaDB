...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GENERATE_SKU_SALES_BY_MULTIPLE_BY_TRADE_AGREEMENT_FOR_DUPLICATE]
					@CODE_ROUTE = '44'
					,@ORDER = 1
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GENERATE_SKU_SALES_BY_MULTIPLE_BY_TRADE_AGREEMENT_FOR_DUPLICATE] (@CODE_ROUTE VARCHAR(50)
, @ORDER INT)
AS
BEGIN
  SET NOCOUNT ON;
  ...
  BEGIN
    ...
    -- ------------------------------------------------------------------------------------
    INSERT INTO [PACASA].[SWIFT_SKU_SALES_BY_MULTIPLE_LIST] ([NAME_SALES_BY_MULTIPLE_LIST]
    , [CODE_ROUTE])
      SELECT DISTINCT
  ...
  , [FREQUENCY])
    ...
    LEFT JOIN [PACASA].[SWIFT_SKU_SALES_BY_MULTIPLE_LIST_BY_SKU] [SMLS]
      ON (
