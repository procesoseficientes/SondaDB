...
Ejemplo de Ejecucion:
			      EXEC [PACASA].[SWIFT_SP_GET_POLYGONS_BY_TYPE] 
					@POLYGON_TYPE = 'SECTOR'
					,@POLYGON_ID_PARENT = NULL
					,@POLYGON_ID = NULL
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_POLYGONS_BY_TYPE] (
...
BEGIN
  --
	...
	FROM [PACASA].[SWIFT_POLYGON] [P1]
	LEFT JOIN [PACASA].[SWIFT_POLYGON] [P2] ON ([P1].[POLYGON_ID_PARENT] = [P2].[POLYGON_ID])
	WHERE
		(
