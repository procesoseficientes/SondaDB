...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_CLEAN_BONUS_LIST_BY_ROUTE] (@CODE_ROUTE VARCHAR(250))
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  INSERT INTO @BONUS
    SELECT DISTINCT
      [B].[BONUS_LIST_ID]
    FROM [PACASA].[SWIFT_BONUS_LIST] [B]
  ...
  -- ------------------------------------------------------------------------------------	
  DELETE [B]
    FROM [PACASA].[SWIFT_BONUS_LIST_BY_CUSTOMER] [B]
    INNER JOIN @BONUS [BL]
      ON (
  ...
  --
  DELETE [B]
    FROM [PACASA].[SWIFT_BONUS_LIST_BY_SKU] [B]
    INNER JOIN @BONUS [BL]
      ON (
      [B].[BONUS_LIST_ID] = [BL].[BONUS_LIST_ID]
      )
  ...
  --
  DELETE [B]
    FROM [PACASA].[SWIFT_BONUS_LIST_BY_SKU_MULTIPLE] [B]
    INNER JOIN @BONUS [BL]
      ON (
      [B].[BONUS_LIST_ID] = [BL].[BONUS_LIST_ID]
      )
  ...
  --
  DELETE [B]
    FROM [PACASA].[SWIFT_BONUS_LIST_BY_COMBO] [B]
    INNER JOIN @BONUS [BL]
      ON (
      [B].[BONUS_LIST_ID] = [BL].[BONUS_LIST_ID]
      )
  ...
  --
  DELETE [B]
    FROM [PACASA].[SWIFT_BONUS_LIST_BY_COMBO_SKU] [B]
    INNER JOIN @BONUS [BL]
      ON (
      [B].[BONUS_LIST_ID] = [BL].[BONUS_LIST_ID]
      )
  ...
  --
  DELETE [B]
    FROM [PACASA].[SWIFT_BONUS_LIST_BY_GENERAL_AMOUNT] [B]
    INNER JOIN @BONUS [BL]
      ON (
      [B].[BONUS_LIST_ID] = [BL].[BONUS_LIST_ID]
      )
