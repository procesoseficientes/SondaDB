...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].SWIFT_SP_DELETE_DISCOUNT_FROM_TRADE_AGREEMENT
					@TRADE_AGREEMENT_DISCUOUNT_ID = 4
				-- 
				SELECT * FROM [DIPROCOM].SWIFT_TRADE_AGREEMENT_DISCOUNT
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_DELETE_DISCOUNT_FROM_TRADE_AGREEMENT(
