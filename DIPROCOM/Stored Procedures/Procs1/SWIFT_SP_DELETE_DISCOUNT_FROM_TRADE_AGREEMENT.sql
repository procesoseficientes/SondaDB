...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].SWIFT_SP_DELETE_DISCOUNT_FROM_TRADE_AGREEMENT
					@TRADE_AGREEMENT_DISCUOUNT_ID = 4
				-- 
				SELECT * FROM [PACASA].SWIFT_TRADE_AGREEMENT_DISCOUNT
*/
-- =============================================
CREATE PROCEDURE [PACASA].SWIFT_SP_DELETE_DISCOUNT_FROM_TRADE_AGREEMENT(
