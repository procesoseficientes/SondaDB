...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SONDA_SP_VALIDATE_DEVICE_ID_OF_USER_FOR_TRANSACTION]
				@CODE_ROUTE = '46'
				,@DEVICE_ID = '3b396881f40a8de3'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_VALIDATE_DEVICE_ID_OF_USER_FOR_TRANSACTION](
...
BEGIN
	...
	FROM DIPROCOM.[USERS] U WHERE U.[SELLER_ROUTE] = @CODE_ROUTE;
	--
