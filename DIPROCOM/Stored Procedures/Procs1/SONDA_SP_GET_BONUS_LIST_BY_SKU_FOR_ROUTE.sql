...
-- EJEMPLO DE EJECUCION: 
		EXEC [DIPROCOM].[SONDA_SP_GET_BONUS_LIST_BY_SKU_FOR_ROUTE]
			@CODE_ROUTE = '44'

*/
-- =====================================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_BONUS_LIST_BY_SKU_FOR_ROUTE] (
...
BEGIN
	...
	SELECT DISTINCT
		...
		,[BLS].[PROMO_TYPE]
    ,[BLS].[FREQUENCY]
	FROM [DIPROCOM].[SWIFT_BONUS_LIST_BY_SKU] AS [BLS]
