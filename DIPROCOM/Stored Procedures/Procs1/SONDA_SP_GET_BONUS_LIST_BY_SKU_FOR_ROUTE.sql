...
-- EJEMPLO DE EJECUCION: 
		EXEC [PACASA].[SONDA_SP_GET_BONUS_LIST_BY_SKU_FOR_ROUTE]
			@CODE_ROUTE = '44'

*/
-- =====================================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_BONUS_LIST_BY_SKU_FOR_ROUTE] (
...
BEGIN
	...
	SELECT DISTINCT
		...
		,[BLS].[PROMO_TYPE]
    ,[BLS].[FREQUENCY]
	FROM [PACASA].[SWIFT_BONUS_LIST_BY_SKU] AS [BLS]
