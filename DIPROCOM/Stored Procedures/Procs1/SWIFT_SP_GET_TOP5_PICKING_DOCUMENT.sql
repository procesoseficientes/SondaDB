...
-- Ejemplo de Ejecucion:
      ...
      GO
      --
      EXEC [PACASA].[SWIFT_SP_GET_TOP5_PICKING_DOCUMENT]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_TOP5_PICKING_DOCUMENT]
  AS
  BEGIN
    SELECT TOP 5
      [sph].[PICKING_HEADER]
     ...
     ,[sph].[CODE_ROUTE]
     ,[sph].[ERP_REFERENCE] 
      FROM [PACASA].[SWIFT_PICKING_HEADER] [sph]
      INNER JOIN [PACASA].[SWIFT_VIEW_ALL_COSTUMER] [svac] ON(
