...
-- Ejemplo de Ejecucion:
      ...
      GO
      --
      EXEC [DIPROCOM].[SWIFT_SP_GET_TOP5_PICKING_DOCUMENT]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_TOP5_PICKING_DOCUMENT]
  AS
  BEGIN
    SELECT TOP 5
      [sph].[PICKING_HEADER]
     ...
     ,[sph].[CODE_ROUTE]
     ,[sph].[ERP_REFERENCE] 
      FROM DIPROCOM.[SWIFT_PICKING_HEADER] [sph]
      INNER JOIN DIPROCOM.[SWIFT_VIEW_ALL_COSTUMER] [svac] ON(
