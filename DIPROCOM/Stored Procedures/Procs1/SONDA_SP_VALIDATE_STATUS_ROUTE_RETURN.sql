...
--				   [DIPROCOM].SONDA_DOC_ROUTE_RETURN_HEADER es igual a 'COMPLETE'
...
Ejemplo de Ejecucion:
					...
					EXEC [DIPROCOM].[SONDA_SP_VALIDATE_STATUS_ROUTE_RETURN] 
					...
					SELECT 
						RH.STATUS_DOC 
					FROM [DIPROCOM].[SONDA_DOC_ROUTE_RETURN_HEADER] AS RH
					WHERE RH.ID_DOC_RETURN_HEADER = @ID_HEADER
*/
-- =============================================


CREATE PROCEDURE [DIPROCOM].[SONDA_SP_VALIDATE_STATUS_ROUTE_RETURN]
