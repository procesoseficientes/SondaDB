...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_CUSTOMER_IN_POLYGON_BY_SELLER]
					@POLYGON_ID = 67
					,@TYPE_TASK = 'PRESALE'
					,@FREQUENCY_WEEKS = 1
					,@DAY = 1
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_CUSTOMER_IN_POLYGON_BY_SELLER] (
	@POLYGON_ID INT
