...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_DELETE_PROMO_BY_SPECIAL_PRICE_LIST_BY_SCALE]
					@PROMO_ID = 82
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_DELETE_PROMO_BY_SPECIAL_PRICE_LIST_BY_SCALE] (@SPECIAL_PRICE_LIST_BY_SCALE_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  BEGIN TRY
    DELETE FROM DIPROCOM.SWIFT_PROMO_SPECIAL_PRICE_LIST_BY_SCALE 
