...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_DELETE_PROMO_BY_SPECIAL_PRICE_LIST_BY_SCALE]
					@PROMO_ID = 82
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_DELETE_PROMO_BY_SPECIAL_PRICE_LIST_BY_SCALE] (@SPECIAL_PRICE_LIST_BY_SCALE_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
