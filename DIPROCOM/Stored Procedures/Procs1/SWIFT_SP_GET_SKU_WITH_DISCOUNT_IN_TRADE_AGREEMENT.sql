...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].SWIFT_SP_GET_SKU_WITH_DISCOUNT_IN_TRADE_AGREEMENT
					@TRADE_AGREEMENT_ID = 2
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_GET_SKU_WITH_DISCOUNT_IN_TRADE_AGREEMENT(
...
BEGIN
	...
	FROM [DIPROCOM].SWIFT_VIEW_ALL_SKU VS
		INNER JOIN [DIPROCOM].SWIFT_TRADE_AGREEMENT_DISCOUNT TAD ON (
