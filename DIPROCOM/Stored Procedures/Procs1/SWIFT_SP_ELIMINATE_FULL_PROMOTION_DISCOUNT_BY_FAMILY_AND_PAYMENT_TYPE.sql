...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_ELIMINATE_FULL_PROMOTION_DISCOUNT_BY_FAMILY_AND_PAYMENT_TYPE]
				@PROMO_ID = 2121
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_ELIMINATE_FULL_PROMOTION_DISCOUNT_BY_FAMILY_AND_PAYMENT_TYPE] (@PROMO_ID INT) WITH RECOMPILE
AS
BEGIN
  SET NOCOUNT ON;
  -- -----------------------------------------------------------------
