...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_GET_SKU_SALES_BY_MULTIPLE_LIST_BY_SKU_FOR_ROUTE]
					@CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_SKU_SALES_BY_MULTIPLE_LIST_BY_SKU_FOR_ROUTE] (
...
BEGIN
    ...
    ,[SMS].[PROMO_TYPE]
    ,[SMS].[FREQUENCY]
	FROM [PACASA].[SWIFT_SKU_SALES_BY_MULTIPLE_LIST_BY_SKU] AS [SMS]
