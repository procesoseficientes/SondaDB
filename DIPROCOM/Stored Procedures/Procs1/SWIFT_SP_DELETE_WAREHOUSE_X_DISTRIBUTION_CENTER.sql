...
-- Ejemplo de Ejecucion:
				SELECT * FROM 
				--
				EXEC [DIPROCOM].[SWIFT_SP_DELETE_WAREHOUSE_X_DISTRIBUTION_CENTER]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_DELETE_WAREHOUSE_X_DISTRIBUTION_CENTER](
	@DISTRIBUTION_CENTER_ID INT
...
BEGIN
	BEGIN TRY
		...
		BEGIN
			DELETE FROM [DIPROCOM].[SWIFT_WAREHOUSE_X_DISTRIBUTION_CENTER]
