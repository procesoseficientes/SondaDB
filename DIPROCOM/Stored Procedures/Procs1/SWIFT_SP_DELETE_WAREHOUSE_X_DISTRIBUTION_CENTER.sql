...
-- Ejemplo de Ejecucion:
				SELECT * FROM 
				--
				EXEC [PACASA].[SWIFT_SP_DELETE_WAREHOUSE_X_DISTRIBUTION_CENTER]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_DELETE_WAREHOUSE_X_DISTRIBUTION_CENTER](
	@DISTRIBUTION_CENTER_ID INT
...
BEGIN
	BEGIN TRY
		...
		BEGIN
			DELETE FROM [PACASA].[SWIFT_WAREHOUSE_X_DISTRIBUTION_CENTER]
