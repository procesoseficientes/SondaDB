...
-- EJEMPLO DE EJECUCION: 
		...
		EXEC [DIPROCOM].[SONDA_SP_GET_BONUS_LIST_BY_CUSTOMER_FOR_ROUTE]
			@CODE_ROUTE = 'RUDI@DIPROCOM'
		
*/			
-- =====================================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_BONUS_LIST_BY_CUSTOMER_FOR_ROUTE] (
...
BEGIN
	...
	--
	SELECT @GENERATE_BONUS_LIST_FROM_TRADE_AGREEMENT = [DIPROCOM].[SWIFT_FN_GET_PARAMETER]('ERP_HARDCODE_VALUES','GENERATE_BONUS_LIST_FROM_TRADE_AGREEMENT')
