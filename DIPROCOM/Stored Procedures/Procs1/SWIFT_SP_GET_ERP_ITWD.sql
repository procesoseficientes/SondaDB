...
-- Ejemplo de Ejecucion:
          ...
          EXECUTE @RC = DIPROCOM.SWIFT_SP_GET_ERP_ITWD @PICKING_HEADER
          GO
*/

CREATE  PROC [DIPROCOM].[SWIFT_SP_GET_ERP_ITWD] 
...
SELECT   r.LineNum , r.ObjType,r.ItemCode,r.DocEntry, r.OpenQty FROM BD_Prueba_Viscosa.DBO.WTQ1 r  INNER JOIN BD_Prueba_Viscosa.dbo.OWTQ o
