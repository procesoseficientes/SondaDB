...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_ELIMINATE_FULL_PROMOTION]
				@PROMO_ID = 2121
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_ELIMINATE_FULL_PROMOTION](
	@PROMO_ID INT
)
WITH RECOMPILE
AS
BEGIN
	...
	BEGIN TRY
		...
		PROMOTION_NOT_ASSOCIATED_WITH_A_COMMERCIAL_AGREEMENT:
			...
			-- -------------------------------------------------------------------------------
			DELETE FROM [PACASA].[SWIFT_PROMO_DISCOUNT_BY_SCALE] WHERE [PROMO_ID] = @PROMOTION_ID;
