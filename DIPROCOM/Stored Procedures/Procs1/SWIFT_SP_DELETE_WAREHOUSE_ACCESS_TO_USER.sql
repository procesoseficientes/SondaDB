...
-- Ejemplo de Ejecucion:
				SELECT * FROM [acsa].SWIFT_WAREHOUSE_BY_USER_WITH_ACCESS
				--
				EXEC [acsa].[SWIFT_SP_DELETE_WAREHOUSE_ACCESS_TO_USER]
					@USER_CORRELATIVE = 1
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_DELETE_WAREHOUSE_ACCESS_TO_USER](
...
BEGIN
	BEGIN TRY
		DELETE FROM [acsa].[SWIFT_WAREHOUSE_BY_USER_WITH_ACCESS]
