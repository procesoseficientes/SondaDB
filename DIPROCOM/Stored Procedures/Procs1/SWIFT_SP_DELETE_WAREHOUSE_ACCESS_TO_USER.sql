...
-- Ejemplo de Ejecucion:
				...
				--
				EXEC [DIPROCOM].[SWIFT_SP_DELETE_WAREHOUSE_ACCESS_TO_USER]
					@USER_CORRELATIVE = 1
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_DELETE_WAREHOUSE_ACCESS_TO_USER](
...
BEGIN
	BEGIN TRY
		DELETE FROM [DIPROCOM].[SWIFT_WAREHOUSE_BY_USER_WITH_ACCESS]
