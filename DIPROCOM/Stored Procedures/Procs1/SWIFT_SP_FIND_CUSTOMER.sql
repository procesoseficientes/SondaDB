...
-- EJEMPLO DE EJECUCION: 
		EXEC [acsa].[SWIFT_SP_FIND_CUSTOMER]
			@FILTER = 'TIENDA'
		--
		EXEC [acsa].[SWIFT_SP_FIND_CUSTOMER]
			@FILTER = '100'
...
*/		
-- =============================================
CREATE PROCEDURE [acsa].SWIFT_SP_FIND_CUSTOMER
		@FILTER VARCHAR(50)
AS
BEGIN
	SET NOCOUNT ON;
	...
	LEFT JOIN [acsa].SWIFT_PRICE_LIST_BY_CUSTOMER P ON (C.CODE_CUSTOMER = P.CODE_CUSTOMER)
