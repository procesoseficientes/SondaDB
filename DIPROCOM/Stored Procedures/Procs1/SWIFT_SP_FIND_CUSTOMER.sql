...
-- EJEMPLO DE EJECUCION: 
		EXEC [DIPROCOM].[SWIFT_SP_FIND_CUSTOMER]
			@FILTER = 'TIENDA'
		--
		EXEC [DIPROCOM].[SWIFT_SP_FIND_CUSTOMER]
			@FILTER = '100'
...
*/		
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_FIND_CUSTOMER
		@FILTER VARCHAR(50)
AS
BEGIN
	SET NOCOUNT ON;
	...
	LEFT JOIN [DIPROCOM].SWIFT_PRICE_LIST_BY_CUSTOMER P ON (C.CODE_CUSTOMER = P.CODE_CUSTOMER)
