...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SONDA_SP_GET_HISTORY_BY_PROMO_FOR_ROUTE]
					@CODE_ROUTE = '136'
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_GET_HISTORY_BY_PROMO_FOR_ROUTE] (@CODE_ROUTE VARCHAR(50)) WITH RECOMPILE
AS
BEGIN
  SET NOCOUNT ON;
  --
 ...
 DECLARE @CUSTOMER TABLE (
  ...
  SELECT
   ...
   ,[HP].[FREQUENCY]
   ,[HP].[IS_POSTED]
  FROM [acsa].[SWIFT_HISTORY_BY_PROMO] [HP]
