...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_GET_HISTORY_BY_PROMO_FOR_ROUTE]
					@CODE_ROUTE = '136'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_HISTORY_BY_PROMO_FOR_ROUTE] (@CODE_ROUTE VARCHAR(50)) WITH RECOMPILE
AS
BEGIN
  SET NOCOUNT ON;
  --
 ...
 DECLARE @CUSTOMER TABLE (
  ...
  SELECT
   ...
   ,[HP].[FREQUENCY]
   ,[HP].[IS_POSTED]
  FROM [PACASA].[SWIFT_HISTORY_BY_PROMO] [HP]
