...
--				   [DIPROCOM].[SONDA_PACK_CONVERSION]
...
Ejemplo de Ejecucion:
		...
		EXEC [DIPROCOM].[SONDA_SP_GET_PACK_CONVERSION]	
				
*/
-- =============================================

CREATE PROC [DIPROCOM].[SONDA_SP_GET_PACK_CONVERSION]
AS
BEGIN
  SET NOCOUNT ON;
  SELECT
   ...
   ,[SPC].[ORDER]
  FROM [DIPROCOM].[SONDA_PACK_CONVERSION] AS SPC
END
