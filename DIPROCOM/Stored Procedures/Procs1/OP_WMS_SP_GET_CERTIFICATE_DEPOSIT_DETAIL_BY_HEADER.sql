...
--				   [SONDA].[OP_WMS_CERTIFICATE_DEPOSIT_DETAIL] 
...
Ejemplo de Ejecucion:
				--
				EXEC [SONDA].OP_WMS_SP_GET_CERTIFICATE_DEPOSIT_DETAIL_BY_HEADER
					@ID_DEPOSIT_HEADER = 1
				--	
*/
-- =============================================

CREATE PROCEDURE [SONDA].[OP_WMS_SP_GET_CERTIFICATE_DEPOSIT_DETAIL_BY_HEADER]
(
	@ID_DEPOSIT_HEADER INT
...
BEGIN
    SET NOCOUNT ON;
        ...
        SELECT 
			...
			,[CDD].[QTY]
			,[CDD].[CUSTOMS_AMOUNT]	
		FROM [SONDA].[OP_WMS_CERTIFICATE_DEPOSIT_DETAIL] AS CDD
