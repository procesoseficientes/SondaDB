...
-- EJEMPLO DE EJECUCION: 
		...
		EXEC [DIPROCOM].[SONDA_SP_GET_PRICE_LIST_BY_CUSTOMER_FOR_ROUTE]
			@CODE_ROUTE = 'RUDI@DIPROCOM'
		
*/			
-- =====================================================

CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_PRICE_LIST_BY_CUSTOMER_FOR_ROUTE]
(
...
BEGIN
	...
	SELECT DISTINCT PL.CODE_PRICE_LIST
		,pl.CODE_CUSTOMER 
	FROM [DIPROCOM].[SWIFT_PRICE_LIST_BY_CUSTOMER] AS PL
	INNER JOIN [DIPROCOM].[SONDA_ROUTE_PLAN] AS RP ON(
