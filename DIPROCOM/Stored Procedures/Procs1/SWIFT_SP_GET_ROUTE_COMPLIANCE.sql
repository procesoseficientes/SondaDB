CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_ROUTE_COMPLIANCE]
AS
BEGIN
	
	DROP INDEX IDX_SALES_DATE_COMPLIANCE ON DIPROCOM.[SWIFT_ROUTE_COMPLIANCE]

	DELETE FROM  DIPROCOM.[SWIFT_ROUTE_COMPLIANCE]
	...
	SELECT
	  ...
	  INSERT INTO [DIPROCOM].[SWIFT_ROUTE_COMPLIANCE]
	  		(
	  			[TASK_ID]
	  			,[TASK_TYPE]
	  			,[SCHEDULE_FOR]
	...
	CREATE INDEX IDX_SALES_DATE_COMPLIANCE ON DIPROCOM.[SWIFT_ROUTE_COMPLIANCE] (SCHEDULE_FOR)
