CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_ROUTE_COMPLIANCE]
AS
BEGIN
	
	DROP INDEX IDX_SALES_DATE_COMPLIANCE ON [PACASA].[SWIFT_ROUTE_COMPLIANCE]

	DELETE FROM  [PACASA].[SWIFT_ROUTE_COMPLIANCE]
	...
	SELECT
	  ...
	  INSERT INTO [PACASA].[SWIFT_ROUTE_COMPLIANCE]
	  		(
	  			[TASK_ID]
	  			,[TASK_TYPE]
	  			,[SCHEDULE_FOR]
	...
	CREATE INDEX IDX_SALES_DATE_COMPLIANCE ON [PACASA].[SWIFT_ROUTE_COMPLIANCE] (SCHEDULE_FOR)
