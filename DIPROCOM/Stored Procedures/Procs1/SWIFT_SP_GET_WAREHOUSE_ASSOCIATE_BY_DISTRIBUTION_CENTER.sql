...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_GET_WAREHOUSE_ASSOCIATE_BY_DISTRIBUTION_CENTER]
					@DISTRIBUTION_CENTER_ID = 1
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_WAREHOUSE_ASSOCIATE_BY_DISTRIBUTION_CENTER](
...
BEGIN
	...
	SELECT 
		...
		,[W].[ADDRESS_WAREHOUSE]
		,[W].[GPS_WAREHOUSE]
	FROM [acsa].[SWIFT_WAREHOUSE_X_DISTRIBUTION_CENTER] AS [SWDC] 
