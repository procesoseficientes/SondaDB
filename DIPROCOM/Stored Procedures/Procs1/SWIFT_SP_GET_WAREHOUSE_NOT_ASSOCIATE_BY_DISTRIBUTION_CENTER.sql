...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_WAREHOUSE_NOT_ASSOCIATE_BY_DISTRIBUTION_CENTER]
					
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_WAREHOUSE_NOT_ASSOCIATE_BY_DISTRIBUTION_CENTER]
...
BEGIN
	...
	FROM [DIPROCOM].[SWIFT_WAREHOUSES] [W]
		--INNER JOIN [DIPROCOM].[SWIFT_WAREHOUSES] [W] ON [W].[CODE_WAREHOUSE] = [SWDC].[CODE_WAREHOUSE]
	WHERE [W].[CODE_WAREHOUSE] NOT IN (
			SELECT [SWDC].[CODE_WAREHOUSE]
			FROM [DIPROCOM].[SWIFT_WAREHOUSE_X_DISTRIBUTION_CENTER] [SWDC]
