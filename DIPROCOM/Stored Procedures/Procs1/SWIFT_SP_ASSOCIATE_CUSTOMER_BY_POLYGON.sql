...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].SWIFT_SP_ASSOCIATE_CUSTOMER_BY_POLYGON @POLYGON_ID = 1
*/
-- =============================================


CREATE PROCEDURE [PACASA].[SWIFT_SP_ASSOCIATE_CUSTOMER_BY_POLYGON](
  @POLYGON_ID INT 
)
AS
...
BEGIN
  ...
  INSERT INTO @NEW_CUSTOMERS ([CODE_CUSTOMER])
   ...
   FROM  @NEW_CUSTOMERS NC
    ...
    DELETE CAP 
    FROM [PACASA].[SWIFT_CUSTOMER_GPS_ASSOCIATE_TO_POLYGON] CAP 
    INNER JOIN  @DELETED_CUSTOMERS DC ON (
      [DC].[CODE_CUSTOMER] = [CAP].[CODE_CUSTOMER]
    )
END
ELSE IF (@POLYGON_TYPE = 'SECTOR') BEGIN
    ...
    SELECT
      [CAP].[CODE_CUSTOMER]
    FROM [PACASA].[SWIFT_POLYGON] [P]
    INNER JOIN [PACASA].[SWIFT_CUSTOMER_ASSOCIATE_TO_POLYGON] [CAP]
      ON (
