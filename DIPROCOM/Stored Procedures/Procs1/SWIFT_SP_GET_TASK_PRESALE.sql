CREATE PROC [acsa].[SWIFT_SP_GET_TASK_PRESALE]
@DATE VARCHAR(150)
AS
SELECT 
	A.COMPLETED_STAMP,
	...
	--(SELECT DISTINCT SELLER_DEFAULT_CODE FROM [acsa].SWIFT_VIEW_ALL_COSTUMER WHERE CODE_CUSTOMER = A.COSTUMER_CODE) AS SELLER,
	A.TASK_SEQ,
	A.EXPECTED_GPS,
	A.EMAIL_TO_CONFIRM,
	A.TASK_COMMENTS,
