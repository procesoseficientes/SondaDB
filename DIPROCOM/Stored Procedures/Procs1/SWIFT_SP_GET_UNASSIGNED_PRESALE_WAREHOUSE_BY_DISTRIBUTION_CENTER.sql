...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_UNASSIGNED_PRESALE_WAREHOUSE_BY_DISTRIBUTION_CENTER]
					@DISTRIBUTION_CENTER_ID = 1
					,@LOGIN = 'rudi@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_UNASSIGNED_PRESALE_WAREHOUSE_BY_DISTRIBUTION_CENTER](
...
BEGIN
	...
	FROM [PACASA].[SWIFT_WAREHOUSES] [W]
		INNER JOIN [PACASA].[SWIFT_WAREHOUSE_X_DISTRIBUTION_CENTER] [SWDC] ON [SWDC].[CODE_WAREHOUSE] = [W].[CODE_WAREHOUSE]
