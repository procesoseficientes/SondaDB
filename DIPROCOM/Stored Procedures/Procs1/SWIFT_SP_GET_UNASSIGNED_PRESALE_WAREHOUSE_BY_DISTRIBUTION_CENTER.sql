...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_GET_UNASSIGNED_PRESALE_WAREHOUSE_BY_DISTRIBUTION_CENTER]
					@DISTRIBUTION_CENTER_ID = 1
					,@LOGIN = 'rudi@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_UNASSIGNED_PRESALE_WAREHOUSE_BY_DISTRIBUTION_CENTER](
...
BEGIN
	...
	FROM [acsa].[SWIFT_WAREHOUSES] [W]
		INNER JOIN [acsa].[SWIFT_WAREHOUSE_X_DISTRIBUTION_CENTER] [SWDC] ON [SWDC].[CODE_WAREHOUSE] = [W].[CODE_WAREHOUSE]
