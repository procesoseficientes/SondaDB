...
Ejemplo de Ejecucion:
    ...
    EXEC [DIPROCOM].[SONDA_SP_GET_CUSTOMER_ACCOUNTING_INFORMATION] @CODE_ROUTE = '32'
          
	-- Para obtener la cuenta corriente de un cliente en especifico
	EXEC [DIPROCOM].[SONDA_SP_GET_CUSTOMER_ACCOUNTING_INFORMATION] @CODE_ROUTE = '46', @CODE_CUSTOMER = '860802'

*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_CUSTOMER_ACCOUNTING_INFORMATION]
	(
...
AS
  ...
  --
		...
		SELECT
			...
			,[AI].[EXTRA_DAYS]
		FROM
			[DIPROCOM].[SWIFT_CUSTOMER_ACCOUNTING_INFORMATION] AS [AI]
