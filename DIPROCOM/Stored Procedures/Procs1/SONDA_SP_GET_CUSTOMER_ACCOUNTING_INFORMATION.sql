...
Ejemplo de Ejecucion:
    ...
    EXEC [acsa].[SONDA_SP_GET_CUSTOMER_ACCOUNTING_INFORMATION] @CODE_ROUTE = '32'
          
	-- Para obtener la cuenta corriente de un cliente en especifico
	EXEC [acsa].[SONDA_SP_GET_CUSTOMER_ACCOUNTING_INFORMATION] @CODE_ROUTE = '46', @CODE_CUSTOMER = '860802'

*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_GET_CUSTOMER_ACCOUNTING_INFORMATION]
	(
...
AS
  ...
  --
		...
		SELECT
			...
			,[AI].[EXTRA_DAYS]
		FROM
			[acsa].[SWIFT_CUSTOMER_ACCOUNTING_INFORMATION] AS [AI]
