...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].SWIFT_SP_GET_SKU_WITHOUT_DISCOUNT_IN_TRADE_AGREEMENT
          @TRADE_AGREEMENT_ID = 43
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_GET_SKU_WITHOUT_DISCOUNT_IN_TRADE_AGREEMENT
...
BEGIN
	...
	--LEFT JOIN [DIPROCOM].SWIFT_TRADE_AGREEMENT_DISCOUNT TAD ON (
