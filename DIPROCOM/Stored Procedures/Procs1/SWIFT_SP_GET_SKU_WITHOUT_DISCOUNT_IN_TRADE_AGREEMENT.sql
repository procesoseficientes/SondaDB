...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].SWIFT_SP_GET_SKU_WITHOUT_DISCOUNT_IN_TRADE_AGREEMENT
          @TRADE_AGREEMENT_ID = 43
*/
-- =============================================
CREATE PROCEDURE [PACASA].SWIFT_SP_GET_SKU_WITHOUT_DISCOUNT_IN_TRADE_AGREEMENT
...
BEGIN
	...
	--LEFT JOIN [PACASA].SWIFT_TRADE_AGREEMENT_DISCOUNT TAD ON (
