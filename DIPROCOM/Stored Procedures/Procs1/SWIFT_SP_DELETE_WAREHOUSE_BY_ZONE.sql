...
-- Ejemplo de Ejecucion:
				EXEC  [PACASA].[SWIFT_SP_DELETE_WAREHOUSE_BY_ZONE] @WAREHOUSE_X_ZONE_ID = 0 ,  @ZONE_ID = 1
SELECT * FROM [PACASA].[SWIFT_WAREHOUSE_X_ZONE]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_DELETE_WAREHOUSE_BY_ZONE] (@WAREHOUSE_X_ZONE_ID INT,
@ZONE_ID INT = NULL)
AS
BEGIN
  SET NOCOUNT ON;
  ...
  BEGIN
    ...
    DELETE [PACASA].[SWIFT_WAREHOUSE_X_ZONE]
