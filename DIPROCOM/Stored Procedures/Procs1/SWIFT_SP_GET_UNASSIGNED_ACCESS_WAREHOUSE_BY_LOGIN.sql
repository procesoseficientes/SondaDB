...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_UNASSIGNED_ACCESS_WAREHOUSE_BY_LOGIN]
					@LOGIN = 'gerente@DIPROCOM'
					,@DISTRIBUTION_CENTER_ID = 1
				--
				SELECT * FROM [DIPROCOM].[SWIFT_WAREHOUSE_BY_USER_WITH_ACCESS] WHERE [USER_CORRELATIVE] = 3
				SELECT * FROM [DIPROCOM].[SWIFT_WAREHOUSE_X_DISTRIBUTION_CENTER] WHERE [DISTRIBUTION_CENTER_ID] = 1
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_UNASSIGNED_ACCESS_WAREHOUSE_BY_LOGIN](
...
BEGIN
	...
	LEFT JOIN [DIPROCOM].[SWIFT_WAREHOUSE_BY_USER_WITH_ACCESS] [WUA] ON (
