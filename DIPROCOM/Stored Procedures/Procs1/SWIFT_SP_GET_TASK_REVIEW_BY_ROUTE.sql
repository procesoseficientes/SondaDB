...
-- Ejemplo de Ejecucion:				
				--EXECUTE [DIPROCOM].[SWIFT_SP_GET_TASK_REVIEW_BY_ROUTE]
							   @CODE_ROUTE= '001' --codigo ruta
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_TASK_REVIEW_BY_ROUTE]
...
BEGIN
	...
	FROM [DIPROCOM].[SWIFT_TASKS] AS TASK 
	INNER JOIN [DIPROCOM].[USERS] AS USERS ON (USERS.[LOGIN] = TASK.[ASSIGEND_TO])
