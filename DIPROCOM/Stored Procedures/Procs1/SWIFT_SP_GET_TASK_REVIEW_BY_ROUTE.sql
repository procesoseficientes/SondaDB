...
-- Ejemplo de Ejecucion:				
				--EXECUTE [PACASA].[SWIFT_SP_GET_TASK_REVIEW_BY_ROUTE]
							   @CODE_ROUTE= '001' --codigo ruta
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_TASK_REVIEW_BY_ROUTE]
...
BEGIN
	...
	FROM [PACASA].[SWIFT_TASKS] AS TASK 
	INNER JOIN [PACASA].[USERS] AS USERS ON (USERS.[LOGIN] = TASK.[ASSIGEND_TO])
