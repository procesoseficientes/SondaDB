...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_GET_DISCOUNTS_BY_GENERAL_AMOUNT_AND_FAMILY]
					@CODE_ROUTE = '44'
*/
-- =============================================

CREATE PROCEDURE [PACASA].[SONDA_SP_GET_DISCOUNTS_BY_GENERAL_AMOUNT_AND_FAMILY] (@CODE_ROUTE VARCHAR(50))
AS
BEGIN
  --
  ...
  SELECT DISTINCT
   ...
   ,[DGF].[PROMO_TYPE]
   ,[DGF].[FREQUENCY]
  FROM [PACASA].[SWIFT_DISCOUNT_LIST_BY_GENERAL_AMOUNT_AND_FAMILY] AS [DGF]
