...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SONDA_SP_GET_DISCOUNTS_BY_GENERAL_AMOUNT_AND_FAMILY]
					@CODE_ROUTE = '44'
*/
-- =============================================

CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_DISCOUNTS_BY_GENERAL_AMOUNT_AND_FAMILY] (@CODE_ROUTE VARCHAR(50))
AS
BEGIN
  --
  ...
  SELECT DISTINCT
   ...
   ,[DGF].[PROMO_TYPE]
   ,[DGF].[FREQUENCY]
  FROM [DIPROCOM].[SWIFT_DISCOUNT_LIST_BY_GENERAL_AMOUNT_AND_FAMILY] AS [DGF]
