...
-- Ejemplo de Ejecucion:
				exec [DIPROCOM].SONDA_SP_CALCULATE_CURRENT_WEEK_PLAN
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_CALCULATE_CURRENT_WEEK_PLAN]
AS
BEGIN
	SET NOCOUNT ON;
	--
	...
	BEGIN
		...
		INNER JOIN [DIPROCOM].[SWIFT_FREQUENCY] F ON (FC.ID_FREQUENCY = F.ID_FREQUENCY)
