...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_SKU_WITH_BONUS_BY_MULTIPLE_IN_TRADE_AGREEMENT]
					@TRADE_AGREEMENT_ID = 20
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_GET_SKU_WITH_BONUS_BY_MULTIPLE_IN_TRADE_AGREEMENT(
...
BEGIN
	...
	SELECT
		...
		,[M].[BONUS_QTY]
	FROM [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BONUS_BY_MULTIPLE] [M]
