...
-- Ejemplo de Ejecucion:
        EXEC [DIPROCOM].[SWIFT_SP_GET_COMMIT_INVETORY]
		--
		SELECT * FROM [DIPROCOM].[SONDA_IS_COMITED_BY_WAREHOUSE]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_COMMIT_INVETORY]
AS
BEGIN
  SET NOCOUNT ON;
  --
	MERGE [DIPROCOM].[SONDA_IS_COMITED_BY_WAREHOUSE] AS CW
	USING (
		SELECT
		...
		INNER JOIN [DIPROCOM].[SONDA_SALES_ORDER_DETAIL] [D] ON (
