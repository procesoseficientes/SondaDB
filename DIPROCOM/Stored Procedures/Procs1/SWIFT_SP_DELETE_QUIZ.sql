...
CREATE PROCEDURE [PACASA].[SWIFT_SP_DELETE_QUIZ] (@QUIZ_ID INT)
AS
BEGIN TRY
...
-- ------------------------------------------------------------------------------------
  ...
  WHERE ANSWER_ID in (SELECT ANSWER_ID FROM [PACASA].SWIFT_QUESTION WHERE [QUIZ_ID] = @QUIZ_ID)
	
  DELETE [PACASA].SWIFT_QUESTION
  WHERE [QUIZ_ID] = @QUIZ_ID

  DELETE [PACASA].[SWIFT_QUIZ]
  WHERE [QUIZ_ID] = @QUIZ_ID
