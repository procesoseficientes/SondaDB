...
-- Ejemplo de Ejecucion:
		...
		//Una en especifico
		EXEC [DIPROCOM].[SWIFT_SP_GET_SALES_OFFICE]
		@SALES_OFFICE_ID = 2
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_SALES_OFFICE](
...
BEGIN
	...
	FROM [DIPROCOM].[SWIFT_SALES_OFFICE] [SOFF]
		LEFT JOIN [DIPROCOM].[SWIFT_SALES_ORGANIZATION] [SORG] ON [SOFF].[SALES_ORGANIZATION_ID] = [SORG].[SALES_ORGANIZATION_ID]
