...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_SKU_NO_ASSOCIATED_BY_COMBO]
					@COMBO_ID = 5
				--
				EXEC [PACASA].[SWIFT_SP_GET_SKU_NO_ASSOCIATED_BY_COMBO]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_SKU_NO_ASSOCIATED_BY_COMBO](
	@COMBO_ID INT = NULL
)
AS
BEGIN
