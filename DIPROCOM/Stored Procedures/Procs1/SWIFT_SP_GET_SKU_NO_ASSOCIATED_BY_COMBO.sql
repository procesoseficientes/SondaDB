...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_SKU_NO_ASSOCIATED_BY_COMBO]
					@COMBO_ID = 5
				--
				EXEC [DIPROCOM].[SWIFT_SP_GET_SKU_NO_ASSOCIATED_BY_COMBO]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_SKU_NO_ASSOCIATED_BY_COMBO](
	@COMBO_ID INT = NULL
)
AS
BEGIN
	...
	LEFT JOIN [DIPROCOM].[SWIFT_SKU_BY_COMBO] [C] ON (
