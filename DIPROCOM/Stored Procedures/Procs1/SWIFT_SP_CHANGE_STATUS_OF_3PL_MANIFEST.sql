...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_CHANGE_STATUS_OF_3PL_MANIFEST]
					@MANIFEST_HEADER_ID = 1108
					,@STATUS = 'ASSIGNED'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_CHANGE_STATUS_OF_3PL_MANIFEST]
	(
...
AS
	...
	--
		...
		--
			...
			FROM
				[DIPROCOM].[SWIFT_SETUP_EXTERNAL_SOURCE]
			WHERE
