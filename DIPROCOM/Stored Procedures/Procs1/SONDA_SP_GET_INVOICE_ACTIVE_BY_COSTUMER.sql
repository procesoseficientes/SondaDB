...
-- Ejemplo de Ejecucion:      
        ...
        EXEC [acsa].SONDA_SP_GET_INVOICE_ACTIVE_BY_COSTUMER @COSTUMER = 'C001'
        
*/

-- =============================================
CREATE PROCEDURE [acsa].SONDA_SP_GET_INVOICE_ACTIVE_BY_COSTUMER @CODE_COSTUMER AS VARCHAR(50)
AS
BEGIN
