...
-- Ejemplo de Ejecucion:      
        ...
        EXEC [DIPROCOM].SONDA_SP_GET_INVOICE_ACTIVE_BY_COSTUMER @COSTUMER = 'C001'
        
*/

-- =============================================
CREATE PROCEDURE [DIPROCOM].SONDA_SP_GET_INVOICE_ACTIVE_BY_COSTUMER @CODE_COSTUMER AS VARCHAR(50)
AS
BEGIN
