...
-- Ejemplo de Ejecucion:      
        ...
        EXEC [PACASA].SONDA_SP_GET_INVOICE_ACTIVE_BY_COSTUMER @COSTUMER = 'C001'
        
*/

-- =============================================
CREATE PROCEDURE [PACASA].SONDA_SP_GET_INVOICE_ACTIVE_BY_COSTUMER @CODE_COSTUMER AS VARCHAR(50)
AS
BEGIN
