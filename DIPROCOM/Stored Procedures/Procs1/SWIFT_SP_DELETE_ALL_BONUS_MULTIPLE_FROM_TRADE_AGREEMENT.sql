...
-- Ejemplo de Ejecucion:
		SELECT * FROM [acsa].[SWIFT_TRADE_AGREEMENT_BONUS_BY_MULTIPLE] WHERE [TRADE_AGREEMENT_ID] = 20
		--
		EXEC [acsa].[SWIFT_SP_DELETE_ALL_BONUS_MULTIPLE_FROM_TRADE_AGREEMENT]
			@TRADE_AGREEMENT_ID = 20
		-- 
		SELECT * FROM [acsa].[SWIFT_TRADE_AGREEMENT_BONUS_BY_MULTIPLE] WHERE [TRADE_AGREEMENT_ID] = 20
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_DELETE_ALL_BONUS_MULTIPLE_FROM_TRADE_AGREEMENT](
