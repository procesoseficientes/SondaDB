...
Ejemplo de Ejecucion:
		...
		EXEC [DIPROCOM].[SONDA_SP_INSERT_PACK_UNIT]
		...
		----------------------------------------			
		SELECT * FROM [DIPROCOM].[SONDA_PACK_UNIT]
		
				
*/
-- =============================================

CREATE PROCEDURE [DIPROCOM].[SONDA_SP_INSERT_PACK_UNIT]
(
...
BEGIN
    ...
    BEGIN TRY
		...
		INSERT INTO [DIPROCOM].[SONDA_PACK_UNIT](
				[CODE_PACK_UNIT]
