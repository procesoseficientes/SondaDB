...
EXEC [DIPROCOM].[SONDA_SP_UPDATE_DOCUMENT_SEQUENCES] 
	@XML = 
	'
<Data>
	<docSquences>
...
*/
-- =============================================
-- DROP PROCEDURE [DIPROCOM].[SONDA_SP_UPDATE_DOCUMENT_SEQUENCES]
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_UPDATE_DOCUMENT_SEQUENCES] (@XML XML)
AS
	BEGIN
		SET NOCOUNT ON;
		DECLARE
