...
EXEC [PACASA].[SONDA_SP_UPDATE_DOCUMENT_SEQUENCES] 
	@XML = 
	'
<Data>
	<docSquences>
...
*/
-- =============================================
-- DROP PROCEDURE [PACASA].[SONDA_SP_UPDATE_DOCUMENT_SEQUENCES]
CREATE PROCEDURE [PACASA].[SONDA_SP_UPDATE_DOCUMENT_SEQUENCES] (@XML XML)
AS
	BEGIN
		SET NOCOUNT ON;
		DECLARE
