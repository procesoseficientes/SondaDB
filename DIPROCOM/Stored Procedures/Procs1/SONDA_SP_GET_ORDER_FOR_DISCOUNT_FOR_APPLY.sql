...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].SONDA_SP_GET_ORDER_FOR_DISCOUNT_FOR_APPLY
				@CODE_ROUTE = '136'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_ORDER_FOR_DISCOUNT_FOR_APPLY] (@CODE_ROUTE VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
  SELECT
   ...
   ,[ODD].[CODE_DISCOUNT]
   ,[ODD].[DESCRIPTION]   
  FROM [DIPROCOM].[SWIFT_ORDER_FOR_DISCOUNT_DETAIL] [ODD]
  INNER JOIN [DIPROCOM].[SWIFT_ORDER_FOR_DISCOUNT_BY_ROUTE] [ODR]
