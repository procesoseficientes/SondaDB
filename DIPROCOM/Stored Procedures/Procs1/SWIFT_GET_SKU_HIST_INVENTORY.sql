CREATE PROCEDURE [DIPROCOM].[SWIFT_GET_SKU_HIST_INVENTORY]
@SKU VARCHAR(50)
AS
...
LEFT OUTER JOIN DIPROCOM.SWIFT_VIEW_ALL_SKU AS D ON A.SKU = D.CODE_SKU

LEFT OUTER JOIN DIPROCOM.SWIFT_BATCHES AS E ON A.BATCH_ID = E.BATCH_ID
