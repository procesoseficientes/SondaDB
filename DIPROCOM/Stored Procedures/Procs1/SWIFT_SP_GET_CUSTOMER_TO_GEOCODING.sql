...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_GET_CUSTOMER_TO_GEOCODING]
					@IS_FOR_SCOUTING = 0
				--
				EXEC [acsa].[SWIFT_SP_GET_CUSTOMER_TO_GEOCODING]
					@IS_FOR_SCOUTING = 1
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_CUSTOMER_TO_GEOCODING](
	@IS_FOR_SCOUTING INT
)
AS
BEGIN
	...
	ELSE
	BEGIN
		EXEC [acsa].[SWIFT_SP_GET_TOP10_CUSTOMERS_TO_GEOCODING]
	END
END
