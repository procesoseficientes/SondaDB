...
-- Ejemplo de Ejecucion:				
				--exec [DIPROCOM].[SWFT_SP_GET_TYPE_PAYMENTS_BY_RECEIPTS]
							   	@PAYMENT_HEADER_ID = 1 
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWFT_SP_GET_TYPE_PAYMENTS_BY_OVERDUE_RECEIPTS] @PAYMENT_HEADER_ID AS INT
AS
SELECT [PT].[PAYMENT_TYPE_ID],
       ...
       [PT].[FRONT_IMAGE],
       [PT].[BACK_IMAGE]
FROM [DIPROCOM].[SONDA_PAYMENT_TYPE_DETAIL_FOR_OVERDUE_INVOICE_PAYMENT] [PT]
