...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GENERATE_SKU_SALES_BY_MULTIPLE_BY_TRADE_AGREEMENT]
					@CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GENERATE_SKU_SALES_BY_MULTIPLE_BY_TRADE_AGREEMENT] (@CODE_ROUTE VARCHAR(50)) WITH RECOMPILE
AS
BEGIN
  SET NOCOUNT ON;
  ...
  , [CODE_CUSTOMER])
    ...
    INNER JOIN [DIPROCOM].[SWIFT_SKU_SALES_BY_MULTIPLE_LIST] [S]
      ON (
  ...
  BEGIN
    ...
    BEGIN
      SELECT TOP 1
        @IS_ALREADY = 1
      FROM [DIPROCOM].[SWIFT_SKU_SALES_BY_MULTIPLE_LIST_BY_CUSTOMER] [SLC]
      INNER JOIN [DIPROCOM].[SWIFT_SKU_SALES_BY_MULTIPLE_LIST] [SL]
        ON (
