...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_SELLER_DETAIL_REPORT_FOR_SUPER]
					@TEAM_ID = 2
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_SELLER_DETAIL_REPORT_FOR_SUPER] (@TEAM_ID INT)
AS
BEGIN
    SET NOCOUNT ON;
	--
    ...
    SELECT TOP 1
       ...
       ,@DISPLAY_DECIMALS = [PACASA].[SWIFT_FN_GET_PARAMETER]('CALCULATION_RULES',
