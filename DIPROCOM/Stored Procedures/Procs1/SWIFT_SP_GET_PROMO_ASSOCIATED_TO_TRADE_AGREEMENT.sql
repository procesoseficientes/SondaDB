...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_PROMO_ASSOCIATED_TO_TRADE_AGREEMENT] (@TRADE_AGREEMENT_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  INNER JOIN [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_PROMO] [STAP]
