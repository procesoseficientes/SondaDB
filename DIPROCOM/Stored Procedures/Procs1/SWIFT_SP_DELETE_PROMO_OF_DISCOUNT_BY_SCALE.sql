...
-- Ejemplo de Ejecucion:
        SELECT * FROM [PACASA].SWIFT_PROMO WHERE PROMO_ID = 7
				SELECT * FROM [PACASA].[SWIFT_PROMO_DISCOUNT_BY_SCALE]
				--
				EXEC [PACASA].[SWIFT_SP_DELETE_PROMO_OF_DISCOUNT_BY_SCALE]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_DELETE_PROMO_OF_DISCOUNT_BY_SCALE] (@PROMO_DISCOUNT_BY_SCALE_ID INT)
AS
BEGIN
  BEGIN TRY
    ...
    SET @PROMO_ID = (SELECT TOP 1
        [PROMO_ID]
      FROM [PACASA].[SWIFT_PROMO_DISCOUNT_BY_SCALE]
      WHERE [PROMO_DISCOUNT_ID] = @PROMO_DISCOUNT_BY_SCALE_ID)
    --
    DELETE FROM [PACASA].[SWIFT_PROMO_DISCOUNT_BY_SCALE]
    WHERE [PROMO_DISCOUNT_ID] = @PROMO_DISCOUNT_BY_SCALE_ID
    --
