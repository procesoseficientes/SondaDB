...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_CUSTUMER_FOR_SCOUTING_ARIUM_20170705] (
...
--
	...
	SELECT --TOP 300
		...
		,0--[acsa].[SONDA_FN_GET_LAST_PURCHASE_FOR_CUSTOMER] ([C].[CODE_CUSTOMER]) 
		AS LAST_PURCHASE
	...
	SELECT --TOP 300
		...
		,0--[acsa].[SONDA_FN_GET_LAST_PURCHASE_FOR_CUSTOMER] ([VAC].[CODE_CUSTOMER]) 
		AS LAST_PURCHASE
