...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SONDA_SP_VALIDATE_SCOUTING_BY_XML] 
				@XML = N'
					<Data>
					<scouting>
						...
						<tagsQty>5</tagsQty>
						<syncId>46|Adolfo@DIPROCOM|2017/06/16 10:21:33|-2</syncId>
					</scouting>
					<scouting>
						...
						<tagsQty>10</tagsQty>
						<syncId>46|Adolfo@DIPROCOM|2017/06/16 10:22:58|-3</syncId>
					</scouting>
					<scouting>
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_VALIDATE_SCOUTING_BY_XML](
	@XML XML
	,@JSON VARCHAR(MAX)
)
AS
