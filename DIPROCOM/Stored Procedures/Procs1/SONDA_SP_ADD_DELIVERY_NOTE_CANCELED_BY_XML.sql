...
-- Ejemplo de Ejecucion:
		EXEC [DIPROCOM].[SONDA_SP_ADD_DELIVERY_NOTE_CANCELED_BY_XML]
		@XML = '
			<Data>
				<notasDeEntrega>
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_ADD_DELIVERY_NOTE_CANCELED_BY_XML](
	@XML XML
)
AS
BEGIN
	...
	BEGIN TRY
		...
		FROM [DIPROCOM].[SONDA_DELIVERY_NOTE_HEADER] AS [DN]
