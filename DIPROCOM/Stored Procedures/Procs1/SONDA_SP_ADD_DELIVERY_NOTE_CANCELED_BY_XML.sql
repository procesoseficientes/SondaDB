...
-- Ejemplo de Ejecucion:
		EXEC [PACASA].[SONDA_SP_ADD_DELIVERY_NOTE_CANCELED_BY_XML]
		@XML = '
			<Data>
				<notasDeEntrega>
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_ADD_DELIVERY_NOTE_CANCELED_BY_XML](
	@XML XML
)
AS
BEGIN
	...
	BEGIN TRY
		...
		FROM [PACASA].[SONDA_DELIVERY_NOTE_HEADER] AS [DN]
