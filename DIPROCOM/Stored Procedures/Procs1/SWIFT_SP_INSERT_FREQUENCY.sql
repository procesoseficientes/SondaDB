CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_FREQUENCY]	
...
AS
BEGIN TRY
IF EXISTS(SELECT 1 FROM [DIPROCOM].[SWIFT_FREQUENCY] WHERE CODE_FREQUENCY = @CODE_FRECUENCY)BEGIN
...
DECLARE @ID NUMERIC(18, 0)
	...
	exec [DIPROCOM].[SONDA_SP_GENERATE_ROUTE_PLAN] @CODE_FREQUENCY_NEW = @CODE_FRECUENCY
	IF @@error = 0 BEGIN		
