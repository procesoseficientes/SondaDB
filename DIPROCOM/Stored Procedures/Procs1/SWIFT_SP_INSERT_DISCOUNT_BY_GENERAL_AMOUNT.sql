...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_INSERT_DISCOUNT_BY_GENERAL_AMOUNT]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_INSERT_DISCOUNT_BY_GENERAL_AMOUNT](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		EXEC [acsa].[SWIFT_SP_VALIDATED_DISCOUNT_SCALE_FOR_GENERAL_AMOUNT] @TRADE_AGREEMENT_ID, @LOW_AMOUNT,@HIGH_AMOUNT
		--
		INSERT INTO [acsa].[SWIFT_TRADE_AGREEMENT_DISCOUNT_BY_GENERAL_AMOUNT] (
			TRADE_AGREEMENT_ID
			,LOW_AMOUNT
			,HIGH_AMOUNT
			,DISCOUNT
