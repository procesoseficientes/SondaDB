...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_INSERT_DISCOUNT_BY_GENERAL_AMOUNT]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_DISCOUNT_BY_GENERAL_AMOUNT](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		EXEC [DIPROCOM].[SWIFT_SP_VALIDATED_DISCOUNT_SCALE_FOR_GENERAL_AMOUNT] @TRADE_AGREEMENT_ID, @LOW_AMOUNT,@HIGH_AMOUNT
		--
		INSERT INTO [DIPROCOM].[SWIFT_TRADE_AGREEMENT_DISCOUNT_BY_GENERAL_AMOUNT] (
			TRADE_AGREEMENT_ID
			,LOW_AMOUNT
			,HIGH_AMOUNT
			,DISCOUNT
