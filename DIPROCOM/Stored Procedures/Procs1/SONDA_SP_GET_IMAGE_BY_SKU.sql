...
-- Ejemplo de Ejecucion:
	EXEC [PACASA].[SONDA_SP_GET_IMAGE_BY_SKU]
	@CODE_ROUTE = '46'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_IMAGE_BY_SKU] @CODE_ROUTE VARCHAR(50)
AS
BEGIN
    SET NOCOUNT ON;
    ...
    -- ---------------------------------------------------------------
    INSERT INTO @SKUS
    EXEC [PACASA].[SONDA_SP_GET_SKU] @CODE_ROUTE = @CODE_ROUTE;
    ...
    SELECT [IBS].[ID],
           ...
           [IBS].[IMAGE4],
           [IBS].[IMAGE5]
    FROM [PACASA].[IMAGE_BY_SKU] AS [IBS]
