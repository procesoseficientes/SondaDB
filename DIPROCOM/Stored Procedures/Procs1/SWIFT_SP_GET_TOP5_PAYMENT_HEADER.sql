...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_TOP5_PAYMENT_HEADER]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_TOP5_PAYMENT_HEADER]
AS
	BEGIN
		SET NOCOUNT ON;
	--
		...
		FROM
			[PACASA].[SONDA_OVERDUE_INVOICE_PAYMENT_HEADER] AS [OIPH]
		WHERE
