...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_TOP5_PAYMENT_HEADER]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_TOP5_PAYMENT_HEADER]
AS
	BEGIN
		SET NOCOUNT ON;
	--
		...
		FROM
			[DIPROCOM].[SONDA_OVERDUE_INVOICE_PAYMENT_HEADER] AS [OIPH]
		WHERE
