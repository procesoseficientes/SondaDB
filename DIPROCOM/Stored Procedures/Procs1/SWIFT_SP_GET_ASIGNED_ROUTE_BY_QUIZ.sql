...
-- Ejemplo de Ejecucion:
                EXEC [PACASA].SWIFT_SP_GET_ASIGNED_ROUTE_BY_QUIZ
*/
-- =============================================

-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_ASIGNED_ROUTE_BY_QUIZ] (@QUIZ_ID INT)
AS
BEGIN
SELECT 
	RO.CODE_ROUTE, 
...
WHERE RO.CODE_ROUTE IN (SELECT ROUTE_CODE FROM [PACASA].SWIFT_ASIGNED_QUIZ WHERE QUIZ_ID = @QUIZ_ID) 
