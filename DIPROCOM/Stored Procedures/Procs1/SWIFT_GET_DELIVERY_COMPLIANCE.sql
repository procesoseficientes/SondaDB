CREATE PROC [DIPROCOM].[SWIFT_GET_DELIVERY_COMPLIANCE]
@DTBEGIN DATE,
@DTEND DATE
AS
SELECT A.MANIFEST_HEADER, (SELECT COUNT(J.CODE_PICKING) FROM DIPROCOM.SWIFT_MANIFEST_DETAIL J WHERE J.CODE_MANIFEST_HEADER = A.MANIFEST_HEADER 
) AS 'CANTIDAD_PEDIDOS', A.CREATED_DATE, A.ACCEPTED_STAMP,A.LAST_UPDATE,A.COMPLETED_STAMP, B.NAME_DRIVER, c.NAME_ROUTE
 FROM DIPROCOM.SWIFT_MANIFEST_HEADER A, DIPROCOM.SWIFT_DRIVERS B, DIPROCOM.SWIFT_ROUTES C
