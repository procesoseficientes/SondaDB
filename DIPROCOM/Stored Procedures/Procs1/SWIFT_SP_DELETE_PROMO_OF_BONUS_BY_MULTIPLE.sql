...
-- Ejemplo de Ejecucion:
				...
				--
				EXEC [PACASA].[SWIFT_SP_DELETE_PROMO_OF_BONUS_BY_MULTIPLE]
					@PROMO_BONUS_BY_MULTIPLE_ID = 149
				-- 
				SELECT * FROM [PACASA].SWIFT_PROMO_BONUS_BY_MULTIPLE
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_DELETE_PROMO_OF_BONUS_BY_MULTIPLE](
...
BEGIN
	...
	--
	BEGIN TRY
		DELETE FROM [PACASA].[SWIFT_PROMO_BONUS_BY_MULTIPLE]
