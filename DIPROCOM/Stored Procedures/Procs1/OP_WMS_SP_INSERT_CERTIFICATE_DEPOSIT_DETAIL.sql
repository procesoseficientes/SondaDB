...
Ejemplo de Ejecucion:
				--
				EXEC [SONDA].OP_WMS_SP_INSERT_CERTIFICATE_DEPOSIT_DETAIL 
					@ID_DEPOSIT_HEADER = 1
					,@DOC_ID = 49231
...
CREATE PROCEDURE [SONDA].[OP_WMS_SP_INSERT_CERTIFICATE_DEPOSIT_DETAIL]
(
...
BEGIN
    ...
    BEGIN TRAN TransAdd
	BEGIN TRY
        INSERT INTO [SONDA].[OP_WMS_CERTIFICATE_DEPOSIT_DETAIL](
