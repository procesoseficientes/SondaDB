...
-- Ejemplo de Ejecucion:
        EXEC [PACASA].SWIFT_GET_ALL_MANIFESTS_LOADED_FROM_EXCEL_BY_DATE
          @START_DATE = '2014-01-21'
          ,@END_DATE = '2016-10-20' 
*/
-- =============================================

CREATE PROCEDURE [PACASA].SWIFT_GET_ALL_MANIFESTS_LOADED_FROM_EXCEL_BY_DATE @START_DATE DATE,
@END_DATE DATE
AS
  ...
  SELECT
   ...
   ,A.LAST_UPDATE_BY
   ,A.STATUS
  FROM [PACASA].SWIFT_MANIFEST_HEADER A
  INNER JOIN [PACASA].SWIFT_DRIVERS B
