...
-- Ejemplo de Ejecucion:
        EXEC [DIPROCOM].SWIFT_GET_ALL_MANIFESTS_LOADED_FROM_EXCEL_BY_DATE
          @START_DATE = '2014-01-21'
          ,@END_DATE = '2016-10-20' 
*/
-- =============================================

CREATE PROCEDURE [DIPROCOM].SWIFT_GET_ALL_MANIFESTS_LOADED_FROM_EXCEL_BY_DATE @START_DATE DATE,
@END_DATE DATE
AS
