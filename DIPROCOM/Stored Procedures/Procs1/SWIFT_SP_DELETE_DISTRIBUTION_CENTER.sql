...
-- Ejemplo de Ejecucion:
        EXEC [PACASA].[SWIFT_SP_DELETE_DISTRIBUTION_CENTER]
			@DISTRIBUTION_CENTER_ID = 2
		--
		SELECT * FROM [PACASA].[SWIFT_DISTRIBUTION_CENTER]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_DELETE_DISTRIBUTION_CENTER] (
...
BEGIN
	BEGIN TRY
		SET NOCOUNT ON;
		--
		DELETE FROM [PACASA].[SWIFT_DISTRIBUTION_CENTER]
