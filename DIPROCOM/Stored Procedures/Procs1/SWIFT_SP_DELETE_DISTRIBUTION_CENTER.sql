...
-- Ejemplo de Ejecucion:
        EXEC [DIPROCOM].[SWIFT_SP_DELETE_DISTRIBUTION_CENTER]
			@DISTRIBUTION_CENTER_ID = 2
		--
		SELECT * FROM [DIPROCOM].[SWIFT_DISTRIBUTION_CENTER]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_DELETE_DISTRIBUTION_CENTER] (
...
BEGIN
	BEGIN TRY
		SET NOCOUNT ON;
		--
		DELETE FROM [DIPROCOM].[SWIFT_DISTRIBUTION_CENTER]
