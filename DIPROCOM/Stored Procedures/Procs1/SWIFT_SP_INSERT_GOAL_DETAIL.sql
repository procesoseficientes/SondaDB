...
-- Ejemplo de Ejecucion:
	exec [DIPROCOM].[SWIFT_SP_INSERT_GOAL_DETAIL]
	@GOAL = '
	<Meta>
		...
		<LAST_UPDATE_BY>gerente@DIPROCOM</LAST_UPDATE_BY>
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_GOAL_DETAIL] @GOAL XML
AS
BEGIN
    --
    SET NOCOUNT ON;
    ...
    BEGIN TRY
        BEGIN
            ...
            -- ---------------------------------------------------------------
            DELETE FROM [DIPROCOM].[SWIFT_GOAL_DETAIL]
            ...
            FROM @GOAL_DETAIL AS [UOT]
                INNER JOIN [DIPROCOM].[SWIFT_GOAL_DETAIL] AS [GD]
            ...
            BEGIN
                ...
                -- -------------------------------------------------------------------------------------------
                INSERT INTO [DIPROCOM].[SWIFT_GOAL_DETAIL]
                (
                    [GOAL_HEADER_ID],
                    [SELLER_ID],
                    [GOAL_BY_SELLER],
