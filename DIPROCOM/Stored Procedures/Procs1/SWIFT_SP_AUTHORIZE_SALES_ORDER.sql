...
-- Ejemplo de Ejecucion:
				SELECT * FROM [DIPROCOM].[SONDA_SALES_ORDER_HEADER] WHERE [SALES_ORDER_ID] = 831
				--
				EXEC [DIPROCOM].[SWIFT_SP_AUTHORIZE_SALES_ORDER]
					@SALES_ORDER_ID = 831
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_AUTHORIZE_SALES_ORDER](
	@SALES_ORDER_ID INT
	,@LOGIN VARCHAR(50)
)
AS
