...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_ADD_BUSINESS_RIVAL_POLL]
				...
				--
				SELECT * FROM [PACASA].[SONDA_BUSINESS_RIVAL_POLL]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_ADD_BUSINESS_RIVAL_POLL](
...
BEGIN
	...
	DECLARE @ROUTE INT
	--
	SELECT @ROUTE = [PACASA].[SWIFT_FN_GET_ROUTE_ID_FROM_CODE_ROUTE](@CODE_ROUTE)
	--
	INSERT INTO [PACASA].[SONDA_BUSINESS_RIVAL_POLL]
			(
				[INVOICE_RESOLUTION]
				,[INVOICE_SERIE]
				,[INVOICE_NUM]
