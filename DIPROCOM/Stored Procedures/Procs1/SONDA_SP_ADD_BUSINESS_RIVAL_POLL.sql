...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SONDA_SP_ADD_BUSINESS_RIVAL_POLL]
				...
				--
				SELECT * FROM [DIPROCOM].[SONDA_BUSINESS_RIVAL_POLL]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_ADD_BUSINESS_RIVAL_POLL](
...
BEGIN
	...
	DECLARE @ROUTE INT
	--
	SELECT @ROUTE = [DIPROCOM].[SWIFT_FN_GET_ROUTE_ID_FROM_CODE_ROUTE](@CODE_ROUTE)
	--
	INSERT INTO [DIPROCOM].[SONDA_BUSINESS_RIVAL_POLL]
			(
				[INVOICE_RESOLUTION]
				,[INVOICE_SERIE]
				,[INVOICE_NUM]
