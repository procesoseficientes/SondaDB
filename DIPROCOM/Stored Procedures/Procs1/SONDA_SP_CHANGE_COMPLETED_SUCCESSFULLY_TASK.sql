...
Ejemplo de Ejecucion:
	EXEC [DIPROCOM].[SONDA_SP_CHANGE_COMPLETED_SUCCESSFULLY_TASK]
		@TASK_ID = 40125
    ...
    ,@TASK_SEQ = 2
		--
		SELECT * FROM [DIPROCOM].[SWIFT_TASKS] WHERE TASK_ID = 40125
======================================================*/
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_CHANGE_COMPLETED_SUCCESSFULLY_TASK] (@TASK_ID INT
