...
-- Ejemplo de Ejecucion:
				SELECT * FROM [DIPROCOM].SWIFT_PROMO WHERE PROMO_ID = 6
        SELECT * FROM [DIPROCOM].SWIFT_PROMO_BY_BONUS_RULE
				--
				EXEC [DIPROCOM].[SWIFT_SP_DELETE_PROMO_BY_BONUS_RULE]
					@PROMO_ID = 6
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_DELETE_BONUS_COMBO_RULE_OF_PROMO] (@PROMO_ID INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    --
    DELETE FROM [DIPROCOM].[SWIFT_PROMO_BY_BONUS_RULE]
    WHERE [PROMO_ID] = @PROMO_ID
      AND [PROMO_RULE_BY_COMBO_ID] = @PROMO_RULE_BY_COMBO_ID
    --
    DELETE FROM [DIPROCOM].[SWIFT_PROMO_BY_COMBO_PROMO_RULE]
    WHERE [PROMO_RULE_BY_COMBO_ID] = @PROMO_RULE_BY_COMBO_ID
    --
