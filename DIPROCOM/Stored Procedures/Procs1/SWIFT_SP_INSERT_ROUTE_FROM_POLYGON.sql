...
-- Ejemplo de Ejecucion:
        EXEC [PACASA].[SWIFT_SP_INSERT_ROUTE_FROM_POLYGON]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].SWIFT_SP_INSERT_ROUTE_FROM_POLYGON (
...
BEGIN
  ...
  BEGIN TRY
    ...
    FOR [PACASA].ROUTE_SEQUENCE
	  --
	  INSERT INTO [PACASA].SWIFT_ROUTES (
      ROUTE
  		,CODE_ROUTE
  		,NAME_ROUTE
  		,LAST_UPDATE_BY
