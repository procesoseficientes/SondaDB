...
-- Ejemplo de Ejecucion:
				exec [PACASA].[SONDA_SP_GET_SALES_ORDER_DETAIL]  @SALES_ORDER_ID = 4021
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_SALES_ORDER_DETAIL]
	@SALES_ORDER_ID INT
...
BEGIN
  ...
  UPDATE [PACASA].[SONDA_SALES_ORDER_DETAIL]
