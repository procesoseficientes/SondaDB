...
Ejemplo de Ejecucion:
	...
	EXEC [PACASA].[SWIFT_SP_CREATE_QR_CODE_LABEL] 
		@pTASK_ID = 16574
...
CREATE PROC [PACASA].[SWIFT_SP_CREATE_QR_CODE_LABEL] 
	@pTASK_ID int,
...
BEGIN
  ...
  BEGIN TRY
    ...
    EXEC @return_value = [PACASA].[SWIFT_SP_GET_NEXT_SEQUENCE] 
		@SEQUENCE_NAME = 'QR_CODE_LABEL'
        ,@pRESULT = @pID OUTPUT

    INSERT INTO [PACASA].SWIFT_QR_CODE_LABEL (
		ID
		, TASK_ID
		, CUSTOMER_NAME
		, CODE_SKU
