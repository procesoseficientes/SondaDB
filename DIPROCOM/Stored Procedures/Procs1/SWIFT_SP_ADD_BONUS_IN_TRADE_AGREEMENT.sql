...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].SWIFT_SP_ADD_BONUS_IN_TRADE_AGREEMENT
					...
					,@BONUS_QTY = 2
				-- 
				SELECT * FROM [PACASA].SWIFT_TRADE_AGREEMENT_BONUS
*/
-- =============================================
CREATE PROCEDURE [PACASA].SWIFT_SP_ADD_BONUS_IN_TRADE_AGREEMENT(
...
BEGIN
	BEGIN TRY
		EXEC [PACASA].[SWIFT_SP_VALIDATED_BONUS_SCALE]
		...
		DECLARE @ID INT
		--
		INSERT INTO [PACASA].SWIFT_TRADE_AGREEMENT_BONUS (
			TRADE_AGREEMENT_ID
			,CODE_SKU
			,PACK_UNIT
			,LOW_LIMIT
