...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].SWIFT_SP_ADD_BONUS_IN_TRADE_AGREEMENT
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_ADD_BONUS_IN_TRADE_AGREEMENT(
...
BEGIN
	BEGIN TRY
		EXEC [DIPROCOM].[SWIFT_SP_VALIDATED_BONUS_SCALE]
		...
		DECLARE @ID INT
		--
		INSERT INTO [DIPROCOM].SWIFT_TRADE_AGREEMENT_BONUS (
			TRADE_AGREEMENT_ID
			,CODE_SKU
			,PACK_UNIT
			,LOW_LIMIT
