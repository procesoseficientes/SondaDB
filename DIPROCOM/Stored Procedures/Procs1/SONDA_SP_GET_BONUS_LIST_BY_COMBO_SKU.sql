...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SONDA_SP_GET_BONUS_LIST_BY_COMBO_SKU]
					@CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_BONUS_LIST_BY_COMBO_SKU](
...
BEGIN
	...
	SELECT DISTINCT
		...
		,[BLC].[QTY]
		,[BLC].[IS_MULTIPLE]
	FROM [DIPROCOM].[SWIFT_BONUS_LIST_BY_COMBO_SKU] [BLC] 
