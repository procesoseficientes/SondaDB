...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_GET_BONUS_LIST_BY_COMBO_SKU]
					@CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_BONUS_LIST_BY_COMBO_SKU](
...
BEGIN
	...
	SELECT DISTINCT
		...
		,[BLC].[QTY]
		,[BLC].[IS_MULTIPLE]
	FROM [PACASA].[SWIFT_BONUS_LIST_BY_COMBO_SKU] [BLC] 
