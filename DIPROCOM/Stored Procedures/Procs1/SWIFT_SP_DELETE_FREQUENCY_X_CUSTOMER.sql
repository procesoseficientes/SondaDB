...
-- Ejemplo de Ejecucion:
				exec [DIPROCOM].[SWIFT_SP_ELIMINAR_FRECUENCIA_POR_CLIENTE] @CODE_CUSTOMER = "0001011110001", @ID_FREQUENCY = 1
        exec [DIPROCOM].[SWIFT_SP_ELIMINAR_FRECUENCIA_POR_CLIENTE] @CODE_CUSTOMER = "0001011110001"
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_DELETE_FREQUENCY_X_CUSTOMER] @CODE_CUSTOMER VARCHAR(50),
...
--  EXEC [DIPROCOM].[SONDA_SP_GENERATE_ROUTE_PLAN] @CODE_FREQUENCY
--                                             ,@CODE_FREQUENCY
  IF @@error = 0
  BEGIN
    SELECT
