...
-- Ejemplo de Ejecucion:
				exec [PACASA].[SWIFT_SP_ELIMINAR_FRECUENCIA_POR_CLIENTE] @CODE_CUSTOMER = "0001011110001", @ID_FREQUENCY = 1
        exec [PACASA].[SWIFT_SP_ELIMINAR_FRECUENCIA_POR_CLIENTE] @CODE_CUSTOMER = "0001011110001"
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_DELETE_FREQUENCY_X_CUSTOMER] @CODE_CUSTOMER VARCHAR(50),
...
--  EXEC [PACASA].[SONDA_SP_GENERATE_ROUTE_PLAN] @CODE_FREQUENCY
--                                             ,@CODE_FREQUENCY
  IF @@error = 0
  BEGIN
    SELECT
