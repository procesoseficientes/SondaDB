...
Ejemplo de Ejecucion:
	...
	EXEC [DIPROCOM].[SONDA_SP_GET_RETURN_RECEPCION_HEADER] 
	@ID_RETURN_HEADER = 2
	 				
*/
-- =============================================

CREATE PROCEDURE [DIPROCOM].SONDA_SP_GET_RETURN_RECEPCION_HEADER
(
...
BEGIN
    SET NOCOUNT ON;
		...
		SELECT TOP 1
			...
			,RH.POSTED_ERP
			,RH.POSTED_RESPONSE
		FROM [DIPROCOM].[SONDA_DOC_ROUTE_RETURN_HEADER] RH 
