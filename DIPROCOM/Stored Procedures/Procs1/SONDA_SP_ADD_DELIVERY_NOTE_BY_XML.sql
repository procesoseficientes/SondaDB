...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_ADD_DELIVERY_NOTE_BY_XML]
				@XML = '
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_ADD_DELIVERY_NOTE_BY_XML] (@XML XML)
AS
BEGIN
    BEGIN TRY
        DECLARE @ID INT,
        ...
        BEGIN
            ...
            BEGIN TRY
                --
                INSERT INTO [PACASA].[SONDA_DELIVERY_NOTE_HEADER]
                (
                    [DOC_SERIE],
                    [DOC_NUM],
                    [CODE_CUSTOMER],
                ...
                --
                INSERT INTO [PACASA].[SONDA_DELIVERY_NOTE_DETAIL]
                (
                    [DELIVERY_NOTE_ID],
                    [CODE_SKU],
                    [QTY],
                ...
                BEGIN
                    --
                    EXEC [PACASA].[SONDA_SP_ADD_DELIVERY_NOTE_BY_INVOICE] @DELIVERY_NOTE_DOC_SERIE = @DELIVERY_NOTE_DOC_SERIE,
