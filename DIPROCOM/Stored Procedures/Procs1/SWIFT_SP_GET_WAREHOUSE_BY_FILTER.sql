/****** Object:  StoredProcedure [DIPROCOM].[SWIFT_SP_GET_WAREHOUSE_BY_FILTER]    Script Date: 20/12/2015 9:09:38 AM ******/
-- =============================================
-- Autor:				jose.garcia
...
-- Ejemplo de Ejecucion:				
				--
				exec [DIPROCOM].[SWIFT_SP_GET_WAREHOUSE_BY_FILTER] @FILTER_WH='klm'		--				

*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_WAREHOUSE_BY_FILTER]
 @FILTER_WH VARCHAR (50) 
AS
SELECT DISTINCT( H.CODE_WAREHOUSE)
FROM [DIPROCOM].[SWIFT_LOCATIONS] L
INNER JOIN [DIPROCOM].[SWIFT_WAREHOUSES] H ON (L.CODE_WAREHOUSE = H.CODE_WAREHOUSE)
