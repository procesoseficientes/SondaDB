...
-- Ejemplo de Ejecucion:
        EXEC [DIPROCOM].[SONDA_SP_GET_LIST_OF_SPECIAL_PRICE_BY_SCALE_FOR_ROUTE]
		@CODE_ROUTE = '136'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_LIST_OF_SPECIAL_PRICE_BY_SCALE_FOR_ROUTE]
	(
...
AS
	...
	--
		...
		FROM
			[DIPROCOM].[SWIFT_SPECIAL_PRICE_LIST] [SPL]
		WHERE
	...
	--
		...
		FROM
			[DIPROCOM].[SWIFT_SPECIAL_PRICE_LIST_BY_SCALE] AS [SPLBS]
