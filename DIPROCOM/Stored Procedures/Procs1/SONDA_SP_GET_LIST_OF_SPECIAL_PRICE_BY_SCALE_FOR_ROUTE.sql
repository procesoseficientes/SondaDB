...
-- Ejemplo de Ejecucion:
        EXEC [PACASA].[SONDA_SP_GET_LIST_OF_SPECIAL_PRICE_BY_SCALE_FOR_ROUTE]
		@CODE_ROUTE = '136'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_LIST_OF_SPECIAL_PRICE_BY_SCALE_FOR_ROUTE]
	(
...
AS
	...
	--
		...
		FROM
			[PACASA].[SWIFT_SPECIAL_PRICE_LIST] [SPL]
		WHERE
	...
	--
		...
		FROM
			[PACASA].[SWIFT_SPECIAL_PRICE_LIST_BY_SCALE] AS [SPLBS]
