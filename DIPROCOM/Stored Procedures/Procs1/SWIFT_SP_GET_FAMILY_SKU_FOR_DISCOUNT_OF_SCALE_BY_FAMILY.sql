...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_FAMILY_SKU_FOR_DISCOUNT_OF_SCALE_BY_FAMILY]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_FAMILY_SKU_FOR_DISCOUNT_OF_SCALE_BY_FAMILY] (@PROMO_ID INT = NULL)
AS
BEGIN
  SELECT
  DISTINCT
   ...
   ,[FS].[LAST_UPDATE]
   ,[FS].[LAST_UPDATE_BY]
  FROM [PACASA].[SWIFT_FAMILY_SKU] [FS]
END;