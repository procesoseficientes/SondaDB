...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_FAMILY_SKU_FOR_DISCOUNT_OF_SCALE_BY_FAMILY]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_FAMILY_SKU_FOR_DISCOUNT_OF_SCALE_BY_FAMILY] (@PROMO_ID INT = NULL)
AS
BEGIN
  SELECT
  DISTINCT
   ...
   ,[FS].[LAST_UPDATE]
   ,[FS].[LAST_UPDATE_BY]
  FROM [DIPROCOM].[SWIFT_FAMILY_SKU] [FS]
END;