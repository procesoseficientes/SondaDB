...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_GET_FAMILY_SKU_FOR_DISCOUNT_OF_SCALE_BY_FAMILY]
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_FAMILY_SKU_FOR_DISCOUNT_OF_SCALE_BY_FAMILY] (@PROMO_ID INT = NULL)
AS
BEGIN
  SELECT
  DISTINCT
