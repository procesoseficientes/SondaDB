...
-- EJEMPLO DE EJECUCION: 
		--
		EXEC [PACASA].[SONDA_SP_VALIDATED_IF_EXISTS_SALES_ORDER_3]
...
*/
-- =====================================================
CREATE PROCEDURE [PACASA].SONDA_SP_VALIDATED_IF_EXISTS_SALES_ORDER_3 (@DOC_SERIE VARCHAR(100)
, @DOC_NUM INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    FROM [PACASA].[SONDA_SALES_ORDER_HEADER] [H]
