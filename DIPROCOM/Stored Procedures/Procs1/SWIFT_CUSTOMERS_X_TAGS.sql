CREATE Procedure [PACASA].SWIFT_CUSTOMERS_X_TAGS
AS
BEGIN
...
DECLARE CUSTOMERS_CUR CURSOR FOR 
	...
	BEGIN
		...
		FROM [PACASA].SWIFT_CUSTOMERS_NEW T0
			LEFT JOIN [PACASA].SWIFT_TAG_X_CUSTOMER_NEW T1 ON T0.CODE_CUSTOMER=T1.CUSTOMER
			INNER JOIN [PACASA].SWIFT_TAGS T2 ON T1.TAG_COLOR= T2.TAG_COLOR
