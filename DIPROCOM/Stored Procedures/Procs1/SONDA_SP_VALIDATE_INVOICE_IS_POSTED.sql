...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_VALIDATE_INVOICE_IS_POSTED]
					@XML = '<?xml version="1.0"?>
<Data>
    <Invoices>
        <IdBo>417</IdBo>
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_VALIDATE_INVOICE_IS_POSTED](
	@XML XML
	,@JSON VARCHAR(MAX)
)
AS
BEGIN
	...
	BEGIN
		...
		EXEC [PACASA].[SONDA_SP_VALIDATED_IF_EXISTS_INVOICE] 
