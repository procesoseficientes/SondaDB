...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SONDA_SP_VALIDATE_INVOICE_IS_POSTED]
					@XML = '<?xml version="1.0"?>
<Data>
    <Invoices>
        <IdBo>417</IdBo>
   ...
   "Data": {
      ...
      "dbuser": "UDIPROCOM",
      "dbuserpass": "DIPROCOMServer1237710",
      "routeid": "7",
      "Source": ""
   }
}'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_VALIDATE_INVOICE_IS_POSTED](
	@XML XML
	,@JSON VARCHAR(MAX)
)
AS
BEGIN
	...
	BEGIN
		...
		EXEC [DIPROCOM].[SONDA_SP_VALIDATED_IF_EXISTS_INVOICE] 
