...
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_QUIZ] (@NAME_QUIZ VARCHAR(50)
...
BEGIN TRY
  ...
  INSERT INTO [DIPROCOM].[SWIFT_QUIZ] ([NAME_QUIZ], [VALID_START_DATETIME], [VALID_END_DATETIME], [ORDER], [REQUIRED], [QUIZ_START], [LAST_UPDATE], [LAST_UPDATE_BY])
