...
-- Ejemplo de Ejecucion:
	EXEC [PACASA].[SONDA_SP_GET_PHRASES_AND_SCENARIOS_FEL]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_PHRASES_AND_SCENARIOS_FEL]
AS
BEGIN
    SELECT [ID] AS [Id],
    ...
    FROM [PACASA].[SONDA_PHRASES_AND_SCENARIOS_FEL];
END;