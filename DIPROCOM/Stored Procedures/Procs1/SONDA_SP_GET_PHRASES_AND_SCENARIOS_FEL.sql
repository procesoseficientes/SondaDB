...
-- Ejemplo de Ejecucion:
	EXEC [DIPROCOM].[SONDA_SP_GET_PHRASES_AND_SCENARIOS_FEL]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_PHRASES_AND_SCENARIOS_FEL]
AS
BEGIN
    SELECT [ID] AS [Id],
    ...
    FROM [DIPROCOM].[SONDA_PHRASES_AND_SCENARIOS_FEL];
END;