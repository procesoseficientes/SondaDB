...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].SWIFT_SP_ADD_CHANNEL_IN_TRADE_AGREEMENT
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].SWIFT_SP_ADD_CHANNEL_IN_TRADE_AGREEMENT(
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [PACASA].SWIFT_TRADE_AGREEMENT_BY_CHANNEL (
			TRADE_AGREEMENT_ID
			,CHANNEL_ID
		) VALUES (
			@TRADE_AGREEMENT_ID
