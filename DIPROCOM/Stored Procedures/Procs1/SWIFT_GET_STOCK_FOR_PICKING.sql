...
/*	Ejemplo de execucion
		EXEC [DIPROCOM].SWIFT_GET_STOCK_FOR_PICKING @CODE_WAREHOUSE = 'C001'
*/
-- =============================================

CREATE PROC [DIPROCOM].[SWIFT_GET_STOCK_FOR_PICKING]
@CODE_WAREHOUSE VARCHAR(50)
AS
	SELECT *
	INTO #RESERVED
	FROM [DIPROCOM].[SWIFT_FN_GET_INVENTORY_RESERVED](@CODE_WAREHOUSE)
	--
	SELECT *
	INTO #TEMP
	FROM [DIPROCOM].[SWIFT_FN_GET_INVENTORY_RESERVED_TEMP]()
	--
	SELECT
...
    	) AS TO_SALE
	INTO #RESULT
	FROM [DIPROCOM].SWIFT_INVENTORY A
