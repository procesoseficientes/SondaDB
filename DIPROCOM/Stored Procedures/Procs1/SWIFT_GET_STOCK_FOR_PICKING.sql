...
/*	Ejemplo de execucion
		EXEC [PACASA].SWIFT_GET_STOCK_FOR_PICKING @CODE_WAREHOUSE = 'C001'
*/
-- =============================================

CREATE PROC [PACASA].[SWIFT_GET_STOCK_FOR_PICKING]
@CODE_WAREHOUSE VARCHAR(50)
AS
	SELECT *
	INTO #RESERVED
	FROM [PACASA].[SWIFT_FN_GET_INVENTORY_RESERVED](@CODE_WAREHOUSE)
	--
	SELECT *
	INTO #TEMP
	FROM [PACASA].[SWIFT_FN_GET_INVENTORY_RESERVED_TEMP]()
	--
	SELECT
