...
Ejemplo de Ejecucion:
				--
				EXEC [DIPROCOM].[SONDA_SP_INSERT_RETURN_RECEPTION_DETAIL] 
				@ID_DOC_RETURN_HEADER = 1 
				,@CODE_SKU = '100020'
				,@QTY = 10
				,@DESCRIPTION_SKU = 'BATERIAS AAA 2PACK'

				SELECT * FROM [DIPROCOM].[SONDA_DOC_ROUTE_RETURN_DETAIL]
				--	
*/
-- =============================================

CREATE PROCEDURE [DIPROCOM].[SONDA_SP_INSERT_RETURN_RECEPTION_DETAIL]
(
...
BEGIN
    ...
    BEGIN TRAN TransAdd
	BEGIN TRY
        INSERT INTO [DIPROCOM].[SONDA_DOC_ROUTE_RETURN_DETAIL] (
