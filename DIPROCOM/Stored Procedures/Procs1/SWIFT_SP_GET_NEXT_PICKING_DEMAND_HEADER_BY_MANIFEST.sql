...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_NEXT_PICKING_DEMAND_HEADER_BY_MANIFEST] @MANIFEST_HEADER_ID = 2145
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_GET_NEXT_PICKING_DEMAND_HEADER_BY_MANIFEST (@MANIFEST_HEADER_ID INT)
AS
BEGIN
  --
  SET NOCOUNT ON;
