...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_INSERT_INVOICE_ERP_LOG]
					@ID = -1
				...
				-- 
				SELECT * FROM [DIPROCOM].[SWIFT_SEND_INVOICE_ERP_LOG]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_INVOICE_ERP_LOG](
	@ID INT
...
BEGIN
	...
	--
	BEGIN TRY
		INSERT INTO [DIPROCOM].[SWIFT_SEND_INVOICE_ERP_LOG]
				(
					[ID]
