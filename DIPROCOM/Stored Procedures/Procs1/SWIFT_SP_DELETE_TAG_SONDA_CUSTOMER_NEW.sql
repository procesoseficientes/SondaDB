...
-- Ejemplo de Ejecucion:
				SELECT * FROM [PACASA].[SONDA_TAG_X_CUSTOMER_NEW] WHERE TAG_COLOR = '#335210' AND CUSTOMER_ID = 3
				--
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_DELETE_TAG_SONDA_CUSTOMER_NEW](
...
BEGIN
	...
	--
	BEGIN TRY
		DELETE FROM [PACASA].[SONDA_TAG_X_CUSTOMER_NEW]
