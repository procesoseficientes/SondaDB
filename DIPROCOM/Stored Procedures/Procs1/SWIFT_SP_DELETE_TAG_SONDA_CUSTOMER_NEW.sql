...
-- Ejemplo de Ejecucion:
				SELECT * FROM [DIPROCOM].[SONDA_TAG_X_CUSTOMER_NEW] WHERE TAG_COLOR = '#335210' AND CUSTOMER_ID = 3
				--
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_DELETE_TAG_SONDA_CUSTOMER_NEW](
...
BEGIN
	...
	--
	BEGIN TRY
		DELETE FROM [DIPROCOM].[SONDA_TAG_X_CUSTOMER_NEW]
