...
-- Ejemplo de Ejecucion:
	EXEC [SONDA].[SONDA_SP_GET_PHRASES_AND_SCENARIOS_FEL_BY_ROUTE]
	@CODE_ROUTE = '46'
*/
-- =============================================

CREATE PROCEDURE [SONDA].[SONDA_SP_GET_PHRASES_AND_SCENARIOS_FEL_BY_ROUTE] (@CODE_ROUTE VARCHAR(50))
AS
BEGIN
    SET NOCOUNT ON;
    ...
    FROM [SONDA].[SONDA_POS_RES_SAT] AS [SPRS]
    ...
    SELECT [SPSFEL].[ID],
           ...
           [SPSFEL].[DESCRIPTION],
           [SPSFEL].[TEXT_TO_SHOW]
    FROM [SONDA].[SONDA_PHRASES_AND_SCENARIOS_FEL] AS [SPSFEL]
