...
-- Ejemplo de Ejecucion:
	EXEC [DIPROCOM].[SONDA_SP_GET_PHRASES_AND_SCENARIOS_FEL_BY_ROUTE]
	@CODE_ROUTE = '46'
*/
-- =============================================

CREATE PROCEDURE [DIPROCOM].[SONDA_SP_GET_PHRASES_AND_SCENARIOS_FEL_BY_ROUTE] (@CODE_ROUTE VARCHAR(50))
AS
BEGIN
    SET NOCOUNT ON;
    ...
    FROM [DIPROCOM].[SONDA_POS_RES_SAT] AS [SPRS]
    ...
    SELECT [SPSFEL].[ID],
           ...
           [SPSFEL].[DESCRIPTION],
           [SPSFEL].[TEXT_TO_SHOW]
    FROM [DIPROCOM].[SONDA_PHRASES_AND_SCENARIOS_FEL] AS [SPSFEL]
