...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SONDA_SP_GET_DEFAULT_BONUS_AND_DISCOUNT_LIST]
					@CODE_ROUTE = '001'
*/
-- =============================================
CREATE PROCEDURE [acsa].[SONDA_SP_GET_DEFAULT_BONUS_AND_DISCOUNT_LIST](
...
BEGIN
	...
	WHERE [TA].[TRADE_AGREEMENT_ID] = [acsa].[SWIFT_FN_GET_TRADE_AGREEMENT_BY_ROUTE](@CODE_ROUTE)
	--
	...
	FROM [acsa].[SWIFT_SKU_SALES_BY_MULTIPLE_LIST] [SSBML] 
