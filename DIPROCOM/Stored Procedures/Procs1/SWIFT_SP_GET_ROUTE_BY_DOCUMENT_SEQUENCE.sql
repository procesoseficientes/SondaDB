...
-- TODO: Set parameter values here.
	...
	EXECUTE [PACASA].[SWIFT_SP_GET_ROUTE_BY_DOCUMENT_SEQUENCE]
                @DOC_TYPE = 'DRAFT'
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_ROUTE_BY_DOCUMENT_SEQUENCE]
	 @DOC_TYPE VARCHAR(50)
...
BEGIN	
  SELECT 
		 VR.CODE_ROUTE
		,VR.NAME_ROUTE
	FROM [PACASA].SWIFT_VIEW_ROUTES VR   
  LEFT JOIN [PACASA].SWIFT_DOCUMENT_SEQUENCE PR ON (VR.CODE_ROUTE = PR.ASSIGNED_TO AND PR.DOC_TYPE = @DOC_TYPE)
