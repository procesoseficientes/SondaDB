...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_ROUTE_BY_DOCUMENT_SEQUENCE]
	 @DOC_TYPE VARCHAR(50)
...
BEGIN	
  SELECT 
		 VR.CODE_ROUTE
		,VR.NAME_ROUTE
	FROM DIPROCOM.SWIFT_VIEW_ROUTES VR   
  LEFT JOIN DIPROCOM.SWIFT_DOCUMENT_SEQUENCE PR ON (VR.CODE_ROUTE = PR.ASSIGNED_TO AND PR.DOC_TYPE = @DOC_TYPE)
