...
-- Ejemplo de Ejecucion:
		--
		EXEC [PACASA].SONDA_SP_INSERT_DEVOLUTION_DETAIL
			@DEVOLUTION_ID = 1
			,@CODE_SKU = '100002'
			,@QTY_SKU = 10
			,@IS_GOOD_STATE = 1
			...
			,@SOURCE_DOC_NUM = 25
			--
			SELECT * FROM [PACASA].SONDA_DEVOLUTION_INVENTORY_HEADER 
			--
			SELECT * FROM [PACASA].SONDA_DEVOLUTION_INVENTORY_DETAIL
			--
			SELECT * FROM [PACASA].SONDA_POS_SKUS WHERE ROUTE_ID = 'C001'
*/
-- =============================================
CREATE PROCEDURE [PACASA].SONDA_SP_INSERT_DEVOLUTION_DETAIL (@DEVOLUTION_ID INT
...
BEGIN
  ...
  --
  BEGIN TRY
    INSERT INTO [PACASA].[SONDA_DEVOLUTION_INVENTORY_DETAIL] ([DEVOLUTION_ID]
    , [CODE_SKU]
    , [QTY_SKU]
    , [IS_GOOD_STATE]
    , [POSTED_DATETIME]
