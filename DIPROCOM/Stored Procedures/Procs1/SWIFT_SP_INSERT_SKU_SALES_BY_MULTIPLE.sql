...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_INSERT_SKU_SALES_BY_MULTIPLE]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_INSERT_SKU_SALES_BY_MULTIPLE](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [acsa].[SWIFT_TRADE_AGREEMENT_SKU_SALES_BY_MULTIPLE]
				(
					[TRADE_AGREEMENT_ID]
					,[CODE_SKU]
					,[PACK_UNIT]
