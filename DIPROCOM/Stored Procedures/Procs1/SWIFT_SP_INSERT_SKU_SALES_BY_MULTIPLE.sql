...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_INSERT_SKU_SALES_BY_MULTIPLE]
					@TRADE_AGREEMENT_ID = 21
					,@CODE_SKU = '100002'
					,@PACK_UNIT = 8
					,@MULTIPLE = 2
				-- 
				SELECT * FROM [PACASA].[SWIFT_TRADE_AGREEMENT_SKU_SALES_BY_MULTIPLE]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_INSERT_SKU_SALES_BY_MULTIPLE](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [PACASA].[SWIFT_TRADE_AGREEMENT_SKU_SALES_BY_MULTIPLE]
				(
					[TRADE_AGREEMENT_ID]
					,[CODE_SKU]
					,[PACK_UNIT]
