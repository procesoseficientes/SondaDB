...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_INSERT_TRADE_AGREEMENT_SKU_BY_BONUS_RULE]
					...
					,@IS_MULTIPLE = 0
				-- 
				SELECT * FROM [PACASA].[SWIFT_TRADE_AGREEMENT_SKU_BY_BONUS_RULE] 
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_INSERT_TRADE_AGREEMENT_SKU_BY_BONUS_RULE](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [PACASA].[SWIFT_TRADE_AGREEMENT_SKU_BY_BONUS_RULE]
				(
