...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_INSERT_TRADE_AGREEMENT_SKU_BY_BONUS_RULE]
					...
					,@IS_MULTIPLE = 0
				-- 
				SELECT * FROM [DIPROCOM].[SWIFT_TRADE_AGREEMENT_SKU_BY_BONUS_RULE] 
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_TRADE_AGREEMENT_SKU_BY_BONUS_RULE](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [DIPROCOM].[SWIFT_TRADE_AGREEMENT_SKU_BY_BONUS_RULE]
				(
