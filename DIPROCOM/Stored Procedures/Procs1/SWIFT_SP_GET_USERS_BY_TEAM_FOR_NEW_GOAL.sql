...
-- Ejemplo de Ejecucion:
	EXEC [DIPROCOM].[SWIFT_SP_GET_USERS_BY_TEAM_FOR_NEW_GOAL]
	@TEAM_ID = 2,
	@SALE_TYPE = 'PRE'
  
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_USERS_BY_TEAM_FOR_NEW_GOAL]
(
    @TEAM_ID INT,
...
BEGIN
    ...
    FROM [DIPROCOM].[SWIFT_USER_BY_TEAM] [UT]
