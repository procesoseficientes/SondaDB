...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GENERATE_CUSTOMER_GPS_CHANGE]
				@CODE_CUSTOMER = 'D010'
				,@GPS = '14.6426207,-90.5131314'
				,@POSTED_BY = 'GERENTE@DIPROCOM'
				 
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GENERATE_CUSTOMER_GPS_CHANGE](
...
BEGIN
	BEGIN TRY
		...
		LEFT JOIN DIPROCOM.[SWIFT_ROUTES] AS SR
