...
-- Ejemplo de Ejecucion:
          ...
          EXECUTE @RC = [DIPROCOM].SWIFT_SP_GET_INVOICE_DETAIL @INVOICE_ID				
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_GET_INVOICE_DETAIL
    @INVOICE_ID INT,
...
AS
  ...
  SELECT @TAX_ID= sp.VALUE FROM [DIPROCOM].SWIFT_PARAMETER sp WHERE sp.GROUP_ID='ERP_HARDCODE_VALUES' AND  sp.PARAMETER_ID='TAX_ID';
...
SELECT 
 ...
 , @TAX_ID TAX_ID 
	FROM  [DIPROCOM].[SONDA_POS_INVOICE_DETAIL] spid 
