...
Ejemplo de Ejecucion:
				--
				EXEC [SONDA].OP_WMS_SP_GET_ALL_CERTIFICATE_DEPOSIT_HEADER_BY_CLIENT_CODE
					@CLIENT_CODE =  '123'
...
CREATE PROCEDURE [SONDA].[OP_WMS_SP_GET_ALL_CERTIFICATE_DEPOSIT_HEADER_BY_CLIENT_CODE]
(
