...
Ejemplo de Ejecucion:
				--
				EXEC [PACASA].OP_WMS_SP_GET_ALL_CERTIFICATE_DEPOSIT_HEADER_BY_CLIENT_CODE
					@CLIENT_CODE =  '123'
...
CREATE PROCEDURE [PACASA].[OP_WMS_SP_GET_ALL_CERTIFICATE_DEPOSIT_HEADER_BY_CLIENT_CODE]
(
