...
-- Ejemplo de Ejecucion:
				...
				--
				exec [DIPROCOM].[SONDA_UPDATE_ACTIVE_ROUTE]
					@Route = '001',
					@pRESULT= @pRESULT
				--
				select @pRESULT
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SONDA_UPDATE_ACTIVE_ROUTE]	
	@Route varchar(50), 	
...
BEGIN	
	...
	AND [POS_TERMINAL] = @Route
	--
	EXEC [DIPROCOM].[SWIFT_SP_ROUTE_CHANGE_ACTIVE] @CODE_ROUTE = @Route ,@IS_ACTIVE_ROUTE = 0
