...
-- Ejemplo de Ejecucion:
				...
				--
				exec [PACASA].[SONDA_UPDATE_ACTIVE_ROUTE]
					@Route = '001',
					@pRESULT= @pRESULT
				--
				select @pRESULT
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_UPDATE_ACTIVE_ROUTE]	
	@Route varchar(50), 	
...
BEGIN	
	...
	AND [POS_TERMINAL] = @Route
	--
	EXEC [PACASA].[SWIFT_SP_ROUTE_CHANGE_ACTIVE] @CODE_ROUTE = @Route ,@IS_ACTIVE_ROUTE = 0
