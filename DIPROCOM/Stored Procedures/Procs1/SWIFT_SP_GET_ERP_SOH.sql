...
-- Ejemplo de Ejecucion:
      ...
      EXECUTE @RC = [PACASA].SWIFT_SP_GET_ERP_SOH @PICKING_HEADER
      GO
*/
CREATE PROC [PACASA].[SWIFT_SP_GET_ERP_SOH] 
...
SELECT @DOC_SAP_RECEPTION= ISNULL(DOC_SAP_RECEPTION,'-1'), @CLASSIFICATION_PICKING=sph.CLASSIFICATION_PICKING   FROM [PACASA].SWIFT_PICKING_HEADER sph
...
IF (@CLASSIFICATION_PICKING='3')  
  BEGIN  
  	EXEC [PACASA].SWIFT_SP_GET_ERP_ITWH @PICKING_HEADER;
    RETURN;
  END
