...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_BROADCAST_NEW] @CODE_BROADCAST = '' ,@SOURCE_TABLE = '' ,@SOURCE_KEY = '' ,@SOURCE_VALUE = ''
				--
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_BROADCAST_NEW]
...
BEGIN
    ...
    --
	INSERT INTO [acsa].[SWIFT_PENDING_BROADCAST]
	(
		[CODE_BROADCAST]
		,[SOURCE_TABLE]
		,[SOURCE_KEY]
