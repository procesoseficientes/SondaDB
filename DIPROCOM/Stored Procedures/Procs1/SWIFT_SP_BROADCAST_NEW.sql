...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_BROADCAST_NEW] @CODE_BROADCAST = '' ,@SOURCE_TABLE = '' ,@SOURCE_KEY = '' ,@SOURCE_VALUE = ''
				--
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_BROADCAST_NEW]
...
BEGIN
    ...
    --
	INSERT INTO [PACASA].[SWIFT_PENDING_BROADCAST]
	(
		[CODE_BROADCAST]
		,[SOURCE_TABLE]
		,[SOURCE_KEY]
