...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_BROADCAST_NEW] @CODE_BROADCAST = '' ,@SOURCE_TABLE = '' ,@SOURCE_KEY = '' ,@SOURCE_VALUE = ''
				--
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_BROADCAST_NEW]
...
BEGIN
    ...
    --
	INSERT INTO [DIPROCOM].[SWIFT_PENDING_BROADCAST]
	(
		[CODE_BROADCAST]
		,[SOURCE_TABLE]
		,[SOURCE_KEY]
