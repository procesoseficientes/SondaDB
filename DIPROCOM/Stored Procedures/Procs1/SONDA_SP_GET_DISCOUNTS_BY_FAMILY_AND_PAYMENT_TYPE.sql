...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SONDA_SP_GET_DISCOUNTS_BY_FAMILY_AND_PAYMENT_TYPE]
					@CODE_ROUTE = '44'
*/
-- =============================================

CREATE PROCEDURE [PACASA].[SONDA_SP_GET_DISCOUNTS_BY_FAMILY_AND_PAYMENT_TYPE] (@CODE_ROUTE VARCHAR(50))
AS
BEGIN
  --
  ...
  SELECT DISTINCT
   ...
   ,[DPF].[PROMO_TYPE]
   ,[DPF].[FREQUENCY]
  FROM [PACASA].[SWIFT_DISCOUNT_LIST_BY_PAYMENT_TYPE_AND_FAMILY] AS [DPF]
