...
-- Ejemplo de Ejecucion:
			EXEC  [DIPROCOM].[SWIFT_SP_ADD_BONUS_BY_GENERAL_AMOUNT_TO_PROMO] @PROMO_NAME = 'Promo Prueba monto general 1', 
                                                                  @LOW_LIMIT = 1000,  
                                                                  @HIGH_LIMIT = 2000,   
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_ADD_BONUS_BY_GENERAL_AMOUNT_TO_PROMO] (@PROMO_ID INT,
...
BEGIN
  ...
  BEGIN TRY
    ...
    -- ----------------------------------------------------------------------------------------------------------
    EXEC [DIPROCOM].[SWIFT_SP_VALIDATE_LIMITS_OF_BONUS_BY_GENERAL_AMOUNT] @PROMO_ID = @PROMO_ID
                                                                    ,@LOW_LIMIT = @LOW_LIMIT
    ...
    -- ----------------------------------------------------------------------------------------------------------
    INSERT INTO [DIPROCOM].[SWIFT_PROMO_BONUS_BY_GENERAL_AMOUNT] ([PROMO_ID], [LOW_LIMIT], [HIGH_LIMIT], [CODE_SKU_BONUS], [PACK_UNIT_BONUS], [BONUS_QTY])
