...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_INSERT_WAREHOUSE_X_DISTRIBUTION_CENTER]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_INSERT_WAREHOUSE_X_DISTRIBUTION_CENTER](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [acsa].[SWIFT_WAREHOUSE_X_DISTRIBUTION_CENTER]
				(
