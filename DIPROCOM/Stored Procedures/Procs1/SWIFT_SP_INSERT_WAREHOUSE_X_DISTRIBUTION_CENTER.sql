...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_INSERT_WAREHOUSE_X_DISTRIBUTION_CENTER]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_INSERT_WAREHOUSE_X_DISTRIBUTION_CENTER](
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [PACASA].[SWIFT_WAREHOUSE_X_DISTRIBUTION_CENTER]
				(
