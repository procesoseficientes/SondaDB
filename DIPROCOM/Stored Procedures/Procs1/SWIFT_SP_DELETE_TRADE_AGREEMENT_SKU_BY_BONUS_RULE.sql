...
-- Ejemplo de Ejecucion:
				...
				--
				EXEC [PACASA].[SWIFT_SP_DELETE_TRADE_AGREEMENT_SKU_BY_BONUS_RULE]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_DELETE_TRADE_AGREEMENT_SKU_BY_BONUS_RULE](
...
BEGIN
	BEGIN TRY
		DELETE FROM [PACASA].[SWIFT_TRADE_AGREEMENT_SKU_BY_BONUS_RULE] 
