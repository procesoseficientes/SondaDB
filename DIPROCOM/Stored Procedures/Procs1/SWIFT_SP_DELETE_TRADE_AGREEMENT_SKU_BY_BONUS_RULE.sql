...
-- Ejemplo de Ejecucion:
				...
				--
				EXEC [DIPROCOM].[SWIFT_SP_DELETE_TRADE_AGREEMENT_SKU_BY_BONUS_RULE]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_DELETE_TRADE_AGREEMENT_SKU_BY_BONUS_RULE](
...
BEGIN
	BEGIN TRY
		DELETE FROM [DIPROCOM].[SWIFT_TRADE_AGREEMENT_SKU_BY_BONUS_RULE] 
