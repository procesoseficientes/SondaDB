...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_GET_COMBOS_NOT_IN_TRADE_AGREEMENT]
					@TRADE_AGREEMENT_ID = 20
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_COMBOS_NOT_IN_TRADE_AGREEMENT](
...
BEGIN
	...
	LEFT JOIN [acsa].[SWIFT_VIEW_COMBO_BY_TRADE_AGREEMENT] [VCTD] ON (
