...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_COMBOS_NOT_IN_TRADE_AGREEMENT]
					@TRADE_AGREEMENT_ID = 20
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_COMBOS_NOT_IN_TRADE_AGREEMENT](
...
BEGIN
	...
	INNER JOIN [PACASA].[SWIFT_SKU_BY_COMBO] [SC] ON (
		[SC].[COMBO_ID] = [C].[COMBO_ID]
	)
	LEFT JOIN [PACASA].[SWIFT_VIEW_COMBO_BY_TRADE_AGREEMENT] [VCTD] ON (
