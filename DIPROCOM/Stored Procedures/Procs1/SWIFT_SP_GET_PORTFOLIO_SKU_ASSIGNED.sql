...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_PORTFOLIO_SKU_ASSIGNED]  @CODE_PORTFOLIO = 4
*/
-- =============================================
CREATE PROC [DIPROCOM].SWIFT_SP_GET_PORTFOLIO_SKU_ASSIGNED
	@CODE_PORTFOLIO VARCHAR(50)
AS	
	SELECT S.*
	FROM [DIPROCOM].SWIFT_VIEW_ALL_SKU S
		INNER JOIN [DIPROCOM].SWIFT_VIEW_PORTFOLIO_BY_SKU PS ON S.CODE_SKU = PS.CODE_SKU
