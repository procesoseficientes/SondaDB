...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_GET_COUNT_CUSTOMER_IN_POLYGON_FOR_DAY_BY_SELLER]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_COUNT_CUSTOMER_IN_POLYGON_FOR_DAY_BY_SELLER](
	@LOGIN VARCHAR(50)
...
BEGIN
	...
	INNER JOIN [DIPROCOM].[SWIFT_SELLER] [SS] ON (
	...
	FROM [DIPROCOM].[SWIFT_POLYGON_BY_ROUTE] [PBR]
	INNER JOIN [DIPROCOM].[SWIFT_FREQUENCY] [SF] ON (
	...
	INNER JOIN [DIPROCOM].[SWIFT_POLYGON] [P2] ON (
		[P2].[POLYGON_ID] = [P].[POLYGON_ID_PARENT]
	)
	INNER JOIN [DIPROCOM].[SWIFT_POLYGON] [P3] ON (
