...
-- Ejemplo de Ejecucion:
        EXEC [PACASA].[SONDA_SP_GET_ANSWERS_BY_ROUTE]
		@CODE_ROUTE = '136'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SONDA_SP_GET_ANSWERS_BY_ROUTE]
...
BEGIN
    ...
    SELECT [SA].[ANSWER_ID],
           [SA].[QUESTION_ID],
           [SA].[ANSWER]
    FROM [PACASA].[SWIFT_ANSWER] [SA]
        INNER JOIN [PACASA].[SWIFT_QUESTION] [SQU]
