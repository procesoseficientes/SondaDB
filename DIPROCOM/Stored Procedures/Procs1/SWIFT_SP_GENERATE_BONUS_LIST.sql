...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [DIPROCOM].[SWIFT_SP_GENERATE_BONUS_LIST]
					@CODE_ROUTE = '44'
				--
				SELECT * FROM [DIPROCOM].SWIFT_BONUS_LIST WHERE CODE_ROUTE = '44'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GENERATE_BONUS_LIST] (
...
BEGIN
	...
	-- ------------------------------------------------------------------------------------
	IF (SELECT [DIPROCOM].[SWIFT_FN_VALIDATE_TRADE_AGREEMENT_BY_ROUTE](@CODE_ROUTE)) = 1
	BEGIN
		DECLARE @TRADE_AGREEMENT_ID INT = NULL
		--
		SELECT @TRADE_AGREEMENT_ID = [DIPROCOM].[SWIFT_FN_GET_TRADE_AGREEMENT_BY_ROUTE](@CODE_ROUTE)
		--
		INSERT INTO @BONUS_LIST
				([NAME_BONUS_LIST])
