...
-- Ejemplo de Ejecucion:
                EXEC [acsa].SWIFT_SP_GET_TOP5_INVOICE_PAYMENTS
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_GET_TOP5_INVOICE_PAYMENTS]
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  SELECT
   ...
   ,@GENERATE_PAYMENT = [acsa].[SWIFT_FN_GET_PARAMETER]('INVOICE',
    'GENERATE_PAYMENT');
