...
-- Ejemplo de Ejecucion:				
				-- EXEC [DIPROCOM].[SWIFT_SP_GET_PALLET] @PALLET_ID = 2


				--				
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_GET_PALLET]
    @PALLET_ID AS INT
AS
BEGIN 
	SET NOCOUNT ON;
	...
	INNER JOIN DIPROCOM.SWIFT_VIEW_ALL_SKU S ON (B.SKU = S.CODE_SKU)
