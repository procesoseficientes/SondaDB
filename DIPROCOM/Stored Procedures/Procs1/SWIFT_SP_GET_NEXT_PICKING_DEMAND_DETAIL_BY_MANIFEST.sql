...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_GET_NEXT_PICKING_DEMAND_DETAIL_BY_MANIFEST] @MANIFEST_HEADER_ID = 2153
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_GET_NEXT_PICKING_DEMAND_DETAIL_BY_MANIFEST] (@MANIFEST_HEADER_ID INT)
AS
BEGIN
  --
  SET NOCOUNT ON;
