...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].SWIFT_SP_GENERATE_DISCOUNT_BY_GENERAL_AMOUNT_AND_FAMILY_BY_TRADE_AGREEMENT_FOR_DUPLICATE
					@CODE_ROUTE = '44'
					,@ORDER = 1
*/
-- =============================================
...
CREATE PROCEDURE [PACASA].[SWIFT_SP_GENERATE_DISCOUNT_BY_GENERAL_AMOUNT_AND_FAMILY_BY_TRADE_AGREEMENT_FOR_DUPLICATE] (@CODE_ROUTE VARCHAR(250)
, @ORDER INT)
AS
BEGIN
  SET NOCOUNT ON;
  ...
  , [FREQUENCY])
    ...
    LEFT JOIN [PACASA].[SWIFT_DISCOUNT_LIST_BY_GENERAL_AMOUNT_AND_FAMILY] [DGF]
      ON (
