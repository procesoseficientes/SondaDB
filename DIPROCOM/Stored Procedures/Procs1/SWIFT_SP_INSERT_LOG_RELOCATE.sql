/****** Object:  StoredProcedure [PACASA].[SWIFT_LOG_RELOCATE_INVENTORY]    Script Date: 03/12/2015 9:09:38 AM ******/
-- =============================================
-- Autor:				JOSE ROBERTO
...
-- Ejemplo de Ejecucion:				
				--
				EXEC [PACASA].[SWIFT_LOG_RELOCATE_INVENTORY]
				  GETDATE()
				 , @LAST_UPDATE_BY='User'
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_INSERT_LOG_RELOCATE]	
...
AS
BEGIN TRY
 INSERT INTO [PACASA].[SWIFT_LOG_RELOCATE_INVENTORY]
			  (			   
	   [LAST_UPDATE]
      ,[LAST_UPDATE_BY]
      ,[WAREHOUSE_TARGET]
