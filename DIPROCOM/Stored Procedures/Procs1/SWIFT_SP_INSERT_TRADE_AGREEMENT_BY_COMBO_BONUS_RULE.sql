...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_INSERT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE]
					@COMBO_ID = 1
				...
				-- 
				SELECT * FROM [PACASA].[SWIFT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE]
				SELECT * FROM [PACASA].[SWIFT_TRADE_AGREEMENT_BY_BONUS_RULE]
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_INSERT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE](
	@COMBO_ID INT
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [PACASA].[SWIFT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE]
				(
					[COMBO_ID]
					,[BONUS_SUB_TYPE]
		...
		--
		INSERT INTO [PACASA].[SWIFT_TRADE_AGREEMENT_BY_BONUS_RULE]
				(
					[TRADE_AGREEMENT_ID]
