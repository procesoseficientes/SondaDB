...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_INSERT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE]
					@COMBO_ID = 1
				...
				-- 
				SELECT * FROM [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE]
				SELECT * FROM [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_BONUS_RULE]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE](
	@COMBO_ID INT
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE]
				(
					[COMBO_ID]
					,[BONUS_SUB_TYPE]
		...
		--
		INSERT INTO [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BY_BONUS_RULE]
				(
					[TRADE_AGREEMENT_ID]
