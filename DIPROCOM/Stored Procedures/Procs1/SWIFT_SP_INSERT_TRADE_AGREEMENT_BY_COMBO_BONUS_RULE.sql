...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_INSERT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE]
					@COMBO_ID = 1
				...
				SELECT * FROM [acsa].[SWIFT_TRADE_AGREEMENT_BY_BONUS_RULE]
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_INSERT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE](
	@COMBO_ID INT
...
BEGIN
	BEGIN TRY
		DECLARE @ID INT
		--
		INSERT INTO [acsa].[SWIFT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE]
				(
					[COMBO_ID]
					,[BONUS_SUB_TYPE]
		...
		--
		INSERT INTO [acsa].[SWIFT_TRADE_AGREEMENT_BY_BONUS_RULE]
				(
					[TRADE_AGREEMENT_ID]
