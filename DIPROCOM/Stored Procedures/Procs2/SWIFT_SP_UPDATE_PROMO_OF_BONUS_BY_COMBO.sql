...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_COMBO]
					...
					,@LOW_QTY = 9
				-- 
				SELECT * FROM [acsa].SWIFT_PROMO_BY_COMBO_PROMO_RULE
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_COMBO] (@PROMO_RULE_BY_COMBO_ID INT
, @COMBO_ID INT
