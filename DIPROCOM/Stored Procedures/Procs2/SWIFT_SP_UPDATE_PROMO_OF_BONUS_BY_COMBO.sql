...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_COMBO]
					...
					,@LOW_QTY = 9
				-- 
				SELECT * FROM [DIPROCOM].SWIFT_PROMO_BY_COMBO_PROMO_RULE
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_COMBO] (@PROMO_RULE_BY_COMBO_ID INT
, @COMBO_ID INT
