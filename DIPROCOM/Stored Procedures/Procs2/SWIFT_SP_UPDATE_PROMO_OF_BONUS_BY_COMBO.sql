...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_COMBO]
					...
					,@LOW_QTY = 9
				-- 
				SELECT * FROM [PACASA].SWIFT_PROMO_BY_COMBO_PROMO_RULE
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_COMBO] (@PROMO_RULE_BY_COMBO_ID INT
, @COMBO_ID INT
