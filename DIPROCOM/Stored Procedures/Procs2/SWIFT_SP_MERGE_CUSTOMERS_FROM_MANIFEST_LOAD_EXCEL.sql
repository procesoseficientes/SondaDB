...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [DIPROCOM].SWIFT_SP_MERGE_CUSTOMERS_FROM_MANIFEST_LOAD_EXCEL
  @CODE_CUSTOMER = 'D001'
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_MERGE_CUSTOMERS_FROM_MANIFEST_LOAD_EXCEL] @CODE_CUSTOMER VARCHAR(50)
...
BEGIN
  ...
  BEGIN TRY
    ...
    MERGE [DIPROCOM].SWIFT_CUSTOMERS TRG
    USING (SELECT
