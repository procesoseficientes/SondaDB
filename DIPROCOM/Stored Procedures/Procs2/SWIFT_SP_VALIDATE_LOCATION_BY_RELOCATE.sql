...
-- Ejemplo de Ejecucion:				
				--
				EXECUTE [DIPROCOM].[SWIFT_SP_VALIDATE_LOCATION_BY_RELOCATE]
					@CODE_LOCATION = 'A3'
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_VALIDATE_LOCATION_BY_RELOCATE]
...
BEGIN
	...
	FROM [DIPROCOM].[SWIFT_LOCATIONS] AS LO 
