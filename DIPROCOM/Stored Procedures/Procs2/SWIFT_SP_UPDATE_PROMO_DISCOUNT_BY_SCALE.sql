...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_UPDATE_PROMO_DISCOUNT_BY_SCALE]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_PROMO_DISCOUNT_BY_SCALE] (@PROMO_DISCOUNT_BY_SCALE_ID INT
...
BEGIN
  BEGIN TRY
    --
    UPDATE [DIPROCOM].[SWIFT_PROMO_DISCOUNT_BY_SCALE]
