...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_UPDATE_PROMO_DISCOUNT_BY_SCALE]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_PROMO_DISCOUNT_BY_SCALE] (@PROMO_DISCOUNT_BY_SCALE_ID INT
...
BEGIN
  BEGIN TRY
    --
    UPDATE [PACASA].[SWIFT_PROMO_DISCOUNT_BY_SCALE]
