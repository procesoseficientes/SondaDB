...
-- Ejemplo de Ejecucion:
        EXEC [PACASA].[SWIFT_SP_UPDATE_TRANSFER_HEADER]
			@TRANSFER_ID  = 52
			,@SELLER_CODE = '-1'
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_TRANSFER_HEADER] (
...
BEGIN
	...
	BEGIN TRY
		...
		FROM [PACASA].[SWIFT_VIEW_SELLER_LOGIN] 
		WHERE[SELLER_CODE] = @SELLER_CODE
			AND [SELLER_ROUTE] = @SELLER_ROUTE
		--
		UPDATE [PACASA].[SWIFT_TRANSFER_HEADER]
		SET	
