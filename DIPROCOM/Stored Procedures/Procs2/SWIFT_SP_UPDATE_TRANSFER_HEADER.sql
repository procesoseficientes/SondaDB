...
-- Ejemplo de Ejecucion:
        EXEC [DIPROCOM].[SWIFT_SP_UPDATE_TRANSFER_HEADER]
			@TRANSFER_ID  = 52
			,@SELLER_CODE = '-1'
			,@SELLER_ROUTE = 'RUDI@DIPROCOM'
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_TRANSFER_HEADER] (
...
BEGIN
	...
	BEGIN TRY
		...
		FROM [DIPROCOM].[SWIFT_VIEW_SELLER_LOGIN] 
		WHERE[SELLER_CODE] = @SELLER_CODE
			AND [SELLER_ROUTE] = @SELLER_ROUTE
		--
		UPDATE [DIPROCOM].[SWIFT_TRANSFER_HEADER]
		SET	
