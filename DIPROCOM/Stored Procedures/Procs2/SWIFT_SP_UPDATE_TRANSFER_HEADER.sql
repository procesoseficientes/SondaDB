...
-- Ejemplo de Ejecucion:
        EXEC [acsa].[SWIFT_SP_UPDATE_TRANSFER_HEADER]
			@TRANSFER_ID  = 52
			,@SELLER_CODE = '-1'
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_TRANSFER_HEADER] (
...
BEGIN
	...
	BEGIN TRY
		...
		FROM [acsa].[SWIFT_VIEW_SELLER_LOGIN] 
		WHERE[SELLER_CODE] = @SELLER_CODE
			AND [SELLER_ROUTE] = @SELLER_ROUTE
		--
		UPDATE [acsa].[SWIFT_TRANSFER_HEADER]
		SET	
