...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_UPDATE_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE](
...
BEGIN
	BEGIN TRY
		UPDATE [PACASA].[SWIFT_TRADE_AGREEMENT_BY_COMBO_BONUS_RULE]
		SET	
			[COMBO_ID] = @COMBO_ID
