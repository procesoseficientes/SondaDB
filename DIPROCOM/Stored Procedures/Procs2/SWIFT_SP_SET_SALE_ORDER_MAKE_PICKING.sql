...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_SET_SALE_ORDER_MAKE_PICKING]
					@SALES_ORDER_ID = 1					
				-- 
				SELECT * FROM SONDA_SALES_ORDER_HEADER WHERE SALES_ORDER_ID = @SALES_ORDER_ID
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_SET_SALE_ORDER_MAKE_PICKING](
	@SALES_ORDER_ID INT	
)
AS
BEGIN
    ...
    UPDATE [PACASA].SONDA_SALES_ORDER_HEADER SET
    HAVE_PICKING = 1
