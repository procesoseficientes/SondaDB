...
BEGIN
	...
	BEGIN
		...
		BEGIN TRY
			...
			INSERT INTO [DIPROCOM_SERVER].[acsa].[dbo].[REPLICA_PEDIDO_ENC]
			(
				[NUMERO_DE_PEDIDO] ,
				[FECHA_PEDIDO] ,
				[CODIGO_DE_CLIENTE] ,
		...
		BEGIN CATCH
			...
			DELETE FROM [DIPROCOM_SERVER].[acsa].[dbo].[REPLICA_PEDIDO_DET]
			WHERE [NUMERO_DE_PEDIDO] = @SALES_ORDER_ID

			DELETE FROM [DIPROCOM_SERVER].[acsa].[dbo].[REPLICA_PEDIDO_ENC]
			WHERE [NUMERO_DE_PEDIDO] = @SALES_ORDER_ID
