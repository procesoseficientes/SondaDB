...
-- EJEMPLO DE EJECUCION: 
		EXEC [PACASA].[SWIFT_SP_UPDATE_CUSTOMER_CHANGE]
			@CUSTOMER = 2
		...
		--
		SELECT * FROM [PACASA].[SWIFT_CUSTOMER_CHANGE] WHERE CUSTOMER = 2
*/
-- =========================================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_CUSTOMER_CHANGE] (
	@CUSTOMER INT
