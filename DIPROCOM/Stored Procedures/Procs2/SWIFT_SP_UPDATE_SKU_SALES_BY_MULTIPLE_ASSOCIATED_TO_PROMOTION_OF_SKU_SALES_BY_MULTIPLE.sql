...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_UPDATE_SKU_SALES_BY_MULTIPLE_ASSOCIATED_TO_PROMOTION_OF_SKU_SALES_BY_MULTIPLE]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_SKU_SALES_BY_MULTIPLE_ASSOCIATED_TO_PROMOTION_OF_SKU_SALES_BY_MULTIPLE] (@SWIFT_PROMO_SKU_SALES_BY_MULTIPLE_ID INT
, @MULTIPLE INT)
AS
BEGIN
  SET NOCOUNT ON;
  ...
  BEGIN TRY
    --
    UPDATE [PACASA].[SWIFT_PROMO_SKU_SALES_BY_MULTIPLE]
