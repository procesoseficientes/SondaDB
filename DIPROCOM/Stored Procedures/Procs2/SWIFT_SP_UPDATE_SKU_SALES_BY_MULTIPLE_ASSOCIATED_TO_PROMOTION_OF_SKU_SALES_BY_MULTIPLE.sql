...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_UPDATE_SKU_SALES_BY_MULTIPLE_ASSOCIATED_TO_PROMOTION_OF_SKU_SALES_BY_MULTIPLE]
					@SWIFT_PROMO_SKU_SALES_BY_MULTIPLE_ID = 2
					, @MULTIPLE = 10
				-- 
				SELECT * FROM [DIPROCOM].[SWIFT_PROMO_SKU_SALES_BY_MULTIPLE]
					WHERE PROMO_ID = 9 AND CODE_SKU = '100011' AND PACK_UNIT = 1
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_SKU_SALES_BY_MULTIPLE_ASSOCIATED_TO_PROMOTION_OF_SKU_SALES_BY_MULTIPLE] (@SWIFT_PROMO_SKU_SALES_BY_MULTIPLE_ID INT
, @MULTIPLE INT)
AS
BEGIN
  SET NOCOUNT ON;
  ...
  BEGIN TRY
    --
    UPDATE [DIPROCOM].[SWIFT_PROMO_SKU_SALES_BY_MULTIPLE]
