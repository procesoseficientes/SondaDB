...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_UPDATE_SKU_SALES_BY_MULTIPLE_ASSOCIATED_TO_PROMOTION_OF_SKU_SALES_BY_MULTIPLE]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_SKU_SALES_BY_MULTIPLE_ASSOCIATED_TO_PROMOTION_OF_SKU_SALES_BY_MULTIPLE] (@SWIFT_PROMO_SKU_SALES_BY_MULTIPLE_ID INT
, @MULTIPLE INT)
AS
BEGIN
  SET NOCOUNT ON;
  ...
  BEGIN TRY
    --
    UPDATE [acsa].[SWIFT_PROMO_SKU_SALES_BY_MULTIPLE]
