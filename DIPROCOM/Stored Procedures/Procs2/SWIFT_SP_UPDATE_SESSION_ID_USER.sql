...
-- Ejemplo de Ejecucion:
				 EXEC [DIPROCOM].[SWIFT_SP_UPDATE_SESSION_ID_USER] 'GERENTE@DIPROCOM','jzc1vajcv1ouddknng3zror4e78fa2db'
					
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_SESSION_ID_USER] (
