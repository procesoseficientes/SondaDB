...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_UPDATE_PROMO_OF_TRADE_AGREEMENT]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_PROMO_OF_TRADE_AGREEMENT] (@TRADE_AGREEMENT_ID INT
, @PROMO_ID INT
...
BEGIN
  ...
  --
  BEGIN TRY
    UPDATE [DIPROCOM].SWIFT_TRADE_AGREEMENT_BY_PROMO
