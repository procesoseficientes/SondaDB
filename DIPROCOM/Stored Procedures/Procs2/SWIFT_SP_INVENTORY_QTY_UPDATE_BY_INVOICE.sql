...
--Ejemplo de Ejecucion:
		--Sin serie
		SELECT * FROM [DIPROCOM].[SWIFT_INVENTORY] WHERE [WAREHOUSE] = 'C001' AND [LOCATION] = 'C001' AND [SKU] = '100017'
		--
		EXEC [DIPROCOM].[SWIFT_SP_INVENTORY_QTY_UPDATE_BY_INVOICE] 
		...
		--Con serie
		SELECT * FROM [DIPROCOM].[SWIFT_INVENTORY] WHERE [WAREHOUSE] = 'C001' AND [LOCATION] = 'A3' AND [SKU] = '100030' AND [SERIAL_NUMBER] = '1000000000'
		--
		EXEC [DIPROCOM].[SWIFT_SP_INVENTORY_QTY_UPDATE_BY_INVOICE] 
			@WAREHOUSE = 'C001', -- varchar(50)
...
*/	
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INVENTORY_QTY_UPDATE_BY_INVOICE]
