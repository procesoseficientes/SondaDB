...
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_MANUAL_FREQUENCY_INFO]
	(
		@XML XML
    ...
    -- -------------------------------------------------------------------------------
			...
			BEGIN
				...
				DELETE
					[FC]
				FROM
					[DIPROCOM].[SWIFT_FREQUENCY_X_CUSTOMER] AS [FC]
				...
				BEGIN
					...
					BEGIN 
						...
						INSERT	INTO [DIPROCOM].[SWIFT_FREQUENCY]
								(
									[CODE_FREQUENCY]
									,[SUNDAY]
									,[MONDAY]
