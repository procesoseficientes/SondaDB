/****** Object:  StoredProcedure [DIPROCOM].[SWIFT_SP_UPDATE_OR_INSERT_INVENTORY_WITH_SERIE]    Script Date: 20/12/2015 9:09:38 AM ******/
-- =============================================
-- Autor:				JOSE ROBERTO
...
-- Ejemplo de Ejecucion:				
				--
	   exec [DIPROCOM].SWIFT_SP_UPDATE_OR_INSERT_INVENTORY_WITH_SERIE
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_RELOCATE_INVENTORY_WITHOUT_SERIE]
	@INVENTORY INT
