/****** Object:  StoredProcedure [PACASA].[SWIFT_SP_UPDATE_OR_INSERT_INVENTORY_WITH_SERIE]    Script Date: 20/12/2015 9:09:38 AM ******/
-- =============================================
-- Autor:				JOSE ROBERTO
...
-- Ejemplo de Ejecucion:				
				--
	   exec [PACASA].SWIFT_SP_UPDATE_OR_INSERT_INVENTORY_WITH_SERIE
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_RELOCATE_INVENTORY_WITHOUT_SERIE]
	@INVENTORY INT
...
BEGIN TRY
	...
	--
	EXEC [PACASA].[SWIFT_SP_RELOCATE_INVENTORY_MOVE] 
		 @INVENTORY = @INVENTORY
  ...
  -- insertar en log
  EXEC [PACASA].[SWIFT_SP_INSERT_LOG_RELOCATE]  
                  @LAST_UPDATE_BY = @LAST_UPDATE_BY
				 , @WAREHOUSE_TARGET = @WAREHOUSE_TARGET
				 , @LOCATION_TARGET = @LOCATION_TARGET
				 , @WAREHOUSE_SOURCE = @WAREHOUSE_SOURCE
