...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_UPDATE_DEVICE_ID]
					@DEVICE_ID = '2b9cd997e9ffcd98',
					@VALIDATION_TYPE = '',
					@ROUTE_ID = 'GUA0032@ARIUM',
					@SONDA_CORE_VERSION = '4.0.8'
				-- 
				SELECT * FROM [DIPROCOM].[USERS] WHERE [SELLER_ROUTE] = 'GUA0032@ARIUM'
				SELECT * FROM [dbo].[SWIFT_USER] WHERE [SELLER_ROUTE] = 'GUA0032@ARIUM'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_DEVICE_ID](
