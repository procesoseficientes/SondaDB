/****** Object:  StoredProcedure [DIPROCOM].[SWIFT_SP_UPDATE_RELOCATE_INVENTORY]    Script Date: 20/12/2015 9:09:38 AM ******/
-- =============================================
-- Autor:				JOSE ROBERTO
...
-- Ejemplo de Ejecucion:				
				--
				exec [DIPROCOM].[SWIFT_SP_UPDATE_RELOCATE_INVENTORY]
				--				
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_RELOCATE_INVENTORY]
