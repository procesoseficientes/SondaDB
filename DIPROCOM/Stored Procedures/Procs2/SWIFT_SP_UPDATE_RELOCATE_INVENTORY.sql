/****** Object:  StoredProcedure [PACASA].[SWIFT_SP_UPDATE_RELOCATE_INVENTORY]    Script Date: 20/12/2015 9:09:38 AM ******/
-- =============================================
-- Autor:				JOSE ROBERTO
...
-- Ejemplo de Ejecucion:				
				--
				exec [PACASA].[SWIFT_SP_UPDATE_RELOCATE_INVENTORY]
				--				
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_RELOCATE_INVENTORY]
