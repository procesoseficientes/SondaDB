...
-- Ejemplo de Ejecucion:
				 EXEC [DIPROCOM].SWIFT_VALIDATE_SESSION_USER 'GERENTE@DIPROCOM','zwtlxyeapvniysfrwqavlkese78fa2db'
					
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_VALIDATE_SESSION_USER] (@LOGIN_ID VARCHAR(100)
