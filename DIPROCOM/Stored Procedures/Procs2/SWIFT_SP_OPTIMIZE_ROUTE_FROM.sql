...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_OPTIMIZE_ROUTE_FROM]  
				@NEW_SEQUENCE = 1, 
				@CODE_ROUTE = 99, 
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_OPTIMIZE_ROUTE_FROM]
    @NEW_SEQUENCE INT,
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- ------------------------------------------------------------------------------------------------------------------------- --
        UPDATE [PACASA].[SWIFT_FREQUENCY_X_CUSTOMER]
        ...
        BEGIN
            ...
            -- ------------------------------------------------------------------------------------------------------------------------- --
            EXEC [PACASA].[SWIFT_SP_SET_CUSTOMER_PRIORITY_IN_FREQUENCY] @ID_FREQUENCY,
                                                                       @CODE_CUST,
                                                                       @PRIORITY,
                                                                       @DISTANCE;
