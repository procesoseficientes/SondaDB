...
-- Ejemplo de Ejecucion:
				SELECT * FROM [acsa].SONDA_CUSTOMER_NEW where CODE_CUSTOMER = 'SO-1758'
				--
				EXEC [acsa].[SWIFT_SP_UPDATE_SONDA_CUSTOMER_NEW]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_SONDA_CUSTOMER_NEW](
