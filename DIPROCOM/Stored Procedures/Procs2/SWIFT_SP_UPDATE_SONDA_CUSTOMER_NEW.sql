...
-- Ejemplo de Ejecucion:
				SELECT * FROM [DIPROCOM].SONDA_CUSTOMER_NEW where CODE_CUSTOMER = 'SO-1758'
				--
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_SONDA_CUSTOMER_NEW](
