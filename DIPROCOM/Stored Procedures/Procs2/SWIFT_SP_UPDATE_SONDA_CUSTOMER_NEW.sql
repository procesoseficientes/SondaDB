...
-- Ejemplo de Ejecucion:
				SELECT * FROM [PACASA].SONDA_CUSTOMER_NEW where CODE_CUSTOMER = 'SO-1758'
				--
				EXEC [PACASA].[SWIFT_SP_UPDATE_SONDA_CUSTOMER_NEW]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_SONDA_CUSTOMER_NEW](
