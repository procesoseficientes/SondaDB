...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_UPDATE_GENERAL_INFO_ON_SCOUTING]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_GENERAL_INFO_ON_SCOUTING](
	@IS_FROM VARCHAR(50) 
...
BEGIN
	...
	BEGIN
		EXEC [DIPROCOM].[SWIFT_SP_UPDATE_INFO_GENERAL_FOR_SCOUTING] 
	...
	ELSE
	BEGIN
		EXEC [DIPROCOM].[SWIFT_SP_UPDATE_SONDA_CUSTOMER_NEW] 
			@CODE_CUSTOMER = @CODE_CUSTOMER, -- varchar(50)
			@NAME_CUSTOMER = @NAME_CUSTOMER, -- varchar(250)
			@PHONE_CUSTOMER = @PHONE_CUSTOMER, -- varchar(250)
			@ADRESS_CUSTOMER = @ADRESS_CUSTOMER, -- varchar(250)
