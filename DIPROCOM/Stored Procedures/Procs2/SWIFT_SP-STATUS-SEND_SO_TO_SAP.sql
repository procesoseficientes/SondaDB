...
EXECUTE @RC = [PACASA].[SWIFT_SP-STATUS-SEND_SO_TO_SAP] @SALES_ORDER_ID
                                                    ,@POSTED_RESPONSE
                                                    ,@ERP_REFERENCE
GO
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP-STATUS-SEND_SO_TO_SAP]
	@SALES_ORDER_ID INT
...
BEGIN TRY
	...
	-- ------------------------------------------------------------------------------------
	SELECT [D].[SALES_ORDER_ID] INTO [#TEMP] FROM [PACASA].[SONDA_SALES_ORDER_DETAIL] [D] WHERE ISNULL([D].[IS_POSTED_ERP], 0) = 0 AND [D].[SALES_ORDER_ID] = @SALES_ORDER_ID
	--
