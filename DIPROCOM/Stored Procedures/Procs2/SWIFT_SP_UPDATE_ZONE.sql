...
-- Ejemplo de Ejecucion:
				EXEC  [DIPROCOM].[SWIFT_SP_UPDATE_ZONE] @ZONE_ID = 2,  @CODE_ZONE = '2', @DESCRIPTION_ZONE = 'Zona 2/1'
SELECT * FROM [DIPROCOM].[SWIFT_ZONE]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_ZONE] (
  @ZONE_ID INT
