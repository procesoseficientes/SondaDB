...
-- Ejemplo de Ejecucion:
        EXEC [DIPROCOM].[SWIFT_SP_VALIDATE_INVOICE_READY_TO_SEND] 
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_VALIDATE_INVOICE_READY_TO_SEND]
AS
BEGIN
	SET NOCOUNT ON;
	--
	...
	FROM [DIPROCOM].[SONDA_POS_INVOICE_HEADER] (NOLOCK) [SO]
	WHERE [SO].[ID] > 0
