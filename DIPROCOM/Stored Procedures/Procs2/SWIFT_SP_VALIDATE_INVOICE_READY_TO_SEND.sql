...
-- Ejemplo de Ejecucion:
        EXEC [PACASA].[SWIFT_SP_VALIDATE_INVOICE_READY_TO_SEND] 
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_VALIDATE_INVOICE_READY_TO_SEND]
AS
BEGIN
	SET NOCOUNT ON;
	--
	...
	FROM [PACASA].[SONDA_POS_INVOICE_HEADER] (NOLOCK) [SO]
	WHERE [SO].[ID] > 0
