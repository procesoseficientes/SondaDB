...
-- Ejemplo de Ejecucion:
        EXEC [acsa].[SWIFT_SP_VALIDATE_INVOICE_READY_TO_SEND] 
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_VALIDATE_INVOICE_READY_TO_SEND]
AS
BEGIN
	SET NOCOUNT ON;
	--
	...
	FROM [acsa].[SONDA_POS_INVOICE_HEADER] (NOLOCK) [SO]
	WHERE [SO].[ID] > 0
