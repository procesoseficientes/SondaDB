...
-- Ejemplo de Ejecucion:
        ...
        GO
        --
        EXEC [DIPROCOM].[SWIFT_SP_VALIDATE_STOCK_INVENTORY_BY_WS_AND_SKUS]
			@CODE_WAREHOUSE = 'C002'
			,@CODE_SKU = '100001|100021'
			,@QTY = '40|1901'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_VALIDATE_STOCK_INVENTORY_BY_WS_AND_SKUS]
...
BEGIN
	...
	SELECT
		...
		,S.VALUE CODE_SKU
	INTO #SKU
	FROM [DIPROCOM].[SWIFT_FN_SPLIT](@CODE_SKU,@DELIMITER) S	
	...
	INTO #QTY
	FROM [DIPROCOM].[SWIFT_FN_SPLIT](@QTY,@DELIMITER) S
	...
	INNER JOIN [DIPROCOM].[SWIFT_VIEW_ALL_SKU] VS ON (VS.CODE_SKU = S.CODE_SKU)
