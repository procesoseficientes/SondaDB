...
-- Ejemplo de Ejecucion:				
				--
EXECUTE  [DIPROCOM].[SWIFT_SP_VALIDATE_SKU_UBICATION] 
    @LOCATION = 2
   ,@CODE_SKU = '20GE'
   ,@PALLET_ID = 1279
				--				
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_VALIDATE_SKU_UBICATION]
...
BEGIN 
  ...
  INNER JOIN [DIPROCOM].[SWIFT_LOCATIONS] AS LO ON (LO.[CODE_LOCATION] = PA.[LOCATION])
