...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_VALIDATE_CUSTOMER_ACQUISITION_FOR_GEOCODING]
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_VALIDATE_CUSTOMER_ACQUISITION_FOR_GEOCODING]
AS
BEGIN
	SET NOCOUNT ON;
	----
	...
	--			,[TYPE_CUSTOMER]
	--		)
	--EXEC [acsa].[SWIFT_SP_GET_TOP10_CUSTOMERS_NEW_TO_GEOCODING]
	----
	--SET @ROWS = @@ROWCOUNT
	-- ------------------------------------------------------------------------------------
	...
	BEGIN
		...
		EXEC [acsa].[SWIFT_SP_GET_TOP10_CUSTOMERS_CHANGE_TO_GEOCODING]
	END
	-- ------------------------------------------------------------------------------------
	-- Envia el resultado
	-- ------------------------------------------------------------------------------------
