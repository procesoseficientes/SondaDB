...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_VALIDATE_CUSTOMER_ACQUISITION_FOR_GEOCODING]
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_VALIDATE_CUSTOMER_ACQUISITION_FOR_GEOCODING]
AS
BEGIN
	SET NOCOUNT ON;
	----
	...
	--			,[TYPE_CUSTOMER]
	--		)
	--EXEC [DIPROCOM].[SWIFT_SP_GET_TOP10_CUSTOMERS_NEW_TO_GEOCODING]
	----
	--SET @ROWS = @@ROWCOUNT
	-- ------------------------------------------------------------------------------------
	...
	BEGIN
		...
		EXEC [DIPROCOM].[SWIFT_SP_GET_TOP10_CUSTOMERS_CHANGE_TO_GEOCODING]
	END
	-- ------------------------------------------------------------------------------------
	-- Envia el resultado
	-- ------------------------------------------------------------------------------------
