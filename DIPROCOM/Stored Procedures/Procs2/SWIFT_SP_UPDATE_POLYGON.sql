...
-- EJEMPLO DE EJECUCION: 
		EXEC [DIPROCOM].[SWIFT_SP_UPDATE_POLYGON]
			@POLYGON_ID = 1099
		...
		--
		SELECT * FROM [DIPROCOM].[SWIFT_POLYGON] WHERE POLYGON_NAME = 'pacopaco2'
		--
		SELECT * FROM [DIPROCOM].SWIFT_ROUTES WHERE NAME_ROUTE = 'pacopaco2'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_UPDATE_POLYGON (
	@POLYGON_ID INT
...
BEGIN
  ...
  -- ------------------------------------------------------------
	...
	-- ------------------------------------------------------------	
  --EXEC [DIPROCOM].[SWIFT_SP_UPDATE_FREQUENCY_BY_POYGON]
  ...
  -- ------------------------------------------------------------
	...
	-- ------------------------------------------------------------	
	IF [DIPROCOM].SWIFT_FN_VALIDATE_POLYGON_HAS_CHILD(@POLYGON_ID) = 0
	BEGIN
...
--    EXEC [DIPROCOM].[SWIFT_SP_UPDATE_ROUTE_FROM_POLYGON]
