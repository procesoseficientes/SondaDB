...
Ejemplo de Ejecucion:
	...
	EXEC [PACASA].[SWIFT_SP_VALIDATE_RECEPTION_BY_PICKING]
	@PICKING_HEADER = 1020
	------------------------------------------
	SELECT * FROM [PACASA].[SWIFT_RECEPTION_HEADER] AS RH
	WHERE RH.SOURCE_DOC = 1020
	 				
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_VALIDATE_RECEPTION_BY_PICKING]
(
	@PICKING_HEADER INT
)
AS
BEGIN
	...
	FROM [PACASA].[SWIFT_RECEPTION_HEADER] AS RH
