...
Ejemplo de Ejecucion:
	...
	EXEC [DIPROCOM].[SWIFT_SP_VALIDATE_RECEPTION_BY_PICKING]
	@PICKING_HEADER = 1020
	------------------------------------------
	SELECT * FROM [DIPROCOM].[SWIFT_RECEPTION_HEADER] AS RH
	WHERE RH.SOURCE_DOC = 1020
	 				
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_VALIDATE_RECEPTION_BY_PICKING]
(
	@PICKING_HEADER INT
)
AS
BEGIN
	...
	FROM [DIPROCOM].[SWIFT_RECEPTION_HEADER] AS RH
