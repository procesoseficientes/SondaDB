...
-- Ejemplo de Ejecucion:
	EXEC [DIPROCOM].[SWIFT_SP_VALIDATED_DISCOUNT_SCALE_FOR_GENERAL_AMOUNT]
...
*/
-- =======================================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_VALIDATED_DISCOUNT_SCALE_FOR_GENERAL_AMOUNT] (
...
BEGIN
	...
	SELECT TOP 1 
		...
		END
	FROM [DIPROCOM].[SWIFT_TRADE_AGREEMENT_DISCOUNT_BY_GENERAL_AMOUNT] AS S
