...
-- Ejemplo de Ejecucion:
	EXEC [PACASA].[SWIFT_SP_VALIDATED_DISCOUNT_SCALE_FOR_GENERAL_AMOUNT]
...
*/
-- =======================================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_VALIDATED_DISCOUNT_SCALE_FOR_GENERAL_AMOUNT] (
...
BEGIN
	...
	SELECT TOP 1 
		...
		END
	FROM [PACASA].[SWIFT_TRADE_AGREEMENT_DISCOUNT_BY_GENERAL_AMOUNT] AS S
