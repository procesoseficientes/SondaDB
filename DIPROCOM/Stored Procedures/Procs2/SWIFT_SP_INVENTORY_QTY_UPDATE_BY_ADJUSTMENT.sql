...
-- Ejemplo de Ejecucion:				
				SELECT * from [PACASA].[SWIFT_INVENTORY] I WHERE PALLET_ID = 42
				--
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_INVENTORY_QTY_UPDATE_BY_ADJUSTMENT]
	@PALLET_ID INT
	,@QTY INT
...
BEGIN	
    ...
    UPDATE [PACASA].[SWIFT_INVENTORY] SET
		ON_HAND = @ON_HAND_NEW
		,LAST_UPDATE = GETDATE()
