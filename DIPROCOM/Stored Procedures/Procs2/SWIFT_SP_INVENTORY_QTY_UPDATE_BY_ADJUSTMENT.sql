...
-- Ejemplo de Ejecucion:				
				SELECT * from [DIPROCOM].[SWIFT_INVENTORY] I WHERE PALLET_ID = 42
				--
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INVENTORY_QTY_UPDATE_BY_ADJUSTMENT]
	@PALLET_ID INT
	,@QTY INT
...
BEGIN	
    ...
    UPDATE [DIPROCOM].[SWIFT_INVENTORY] SET
		ON_HAND = @ON_HAND_NEW
		,LAST_UPDATE = GETDATE()
