...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_UPDATE_BONUS_BY_MULTIPLE_IN_TRADE_AGREEMENT]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_BONUS_BY_MULTIPLE_IN_TRADE_AGREEMENT](
...
BEGIN
	BEGIN TRY
		UPDATE [DIPROCOM].[SWIFT_TRADE_AGREEMENT_BONUS_BY_MULTIPLE]
		SET 
