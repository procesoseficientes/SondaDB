...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].SWIFT_SP_UPDATE_BONUS_IN_TRADE_AGREEMENT
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_UPDATE_BONUS_IN_TRADE_AGREEMENT(
...
BEGIN
	BEGIN TRY
		...
		DECLARE @ID INT
		--
		UPDATE [DIPROCOM].SWIFT_TRADE_AGREEMENT_BONUS
		SET
			TRADE_AGREEMENT_ID = @TRADE_AGREEMENT_ID
			,CODE_SKU = @CODE_SKU
			,PACK_UNIT = @PACK_UNIT
