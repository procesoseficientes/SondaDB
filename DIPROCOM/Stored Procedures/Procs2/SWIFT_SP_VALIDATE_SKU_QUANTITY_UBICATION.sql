...
-- Ejemplo de Ejecucion:				
				--
EXECUTE  [DIPROCOM].[SWIFT_SP_VALIDATE_SKU_QUANTITY_UBICATION] 
    @CODE_SKU='20GE'
   ,@QTY = 2
   ,@LOCATION =  2
   ,@PALLET_ID = 2
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_VALIDATE_SKU_QUANTITY_UBICATION]
...
BEGIN 
  ...
  SELECT COUNT(*) AS VALIDACION_SKU_CANTIDAD 
	...
	INNER JOIN [DIPROCOM].[SWIFT_BATCH] AS BC ON (SU.[SKU] = BC.[SKU])
