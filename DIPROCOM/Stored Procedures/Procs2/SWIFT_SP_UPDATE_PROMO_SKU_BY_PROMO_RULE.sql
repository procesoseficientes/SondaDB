...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_UPDATE_PROMO_SKU_BY_PROMO_RULE]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_PROMO_SKU_BY_PROMO_RULE] (@PROMO_RULE_BY_COMBO_ID INT
, @CODE_SKU VARCHAR(50)
, @PACK_UNIT INT
, @QTY INT
, @IS_MULTIPLE INT)
...
BEGIN
  ...
  BEGIN TRY
    ...
    UPDATE [PACASA].[SWIFT_PROMO_SKU_BY_PROMO_RULE]
    SET [QTY] = @QTY
