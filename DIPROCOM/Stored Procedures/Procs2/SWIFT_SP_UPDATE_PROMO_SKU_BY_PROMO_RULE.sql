...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_UPDATE_PROMO_SKU_BY_PROMO_RULE]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_PROMO_SKU_BY_PROMO_RULE] (@PROMO_RULE_BY_COMBO_ID INT
, @CODE_SKU VARCHAR(50)
, @PACK_UNIT INT
, @QTY INT
, @IS_MULTIPLE INT)
...
BEGIN
  ...
  BEGIN TRY
    ...
    UPDATE [DIPROCOM].[SWIFT_PROMO_SKU_BY_PROMO_RULE]
    SET [QTY] = @QTY
