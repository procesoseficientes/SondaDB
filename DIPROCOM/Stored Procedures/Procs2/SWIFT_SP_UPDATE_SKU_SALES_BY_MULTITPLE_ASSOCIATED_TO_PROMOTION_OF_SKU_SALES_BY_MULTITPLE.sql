...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_UPDATE_SKU_SALES_BY_MULTITPLE_ASSOCIATED_TO_PROMOTION_OF_SKU_SALES_BY_MULTITPLE]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_SKU_SALES_BY_MULTITPLE_ASSOCIATED_TO_PROMOTION_OF_SKU_SALES_BY_MULTITPLE](
