...
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_FREQUENCY]
    @ID_FREQUENCY AS INT,
...
SELECT @CODE_FREQUENCY_OLD = CODE_FREQUENCY FROM [PACASA].SWIFT_FREQUENCY WHERE ID_FREQUENCY= @ID_FREQUENCY		
	...
	EXEC [PACASA].[SONDA_SP_GENERATE_ROUTE_PLAN] @CODE_FREQUENCY_OLD, @CODE_FREQUENCY
	IF @@error = 0 BEGIN
