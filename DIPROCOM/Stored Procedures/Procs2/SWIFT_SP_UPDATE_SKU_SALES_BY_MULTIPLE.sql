...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_UPDATE_SKU_SALES_BY_MULTIPLE]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_SKU_SALES_BY_MULTIPLE](
...
BEGIN
	BEGIN TRY
		UPDATE [PACASA].[SWIFT_TRADE_AGREEMENT_SKU_SALES_BY_MULTIPLE]
		SET	
			[MULTIPLE] = @MULTIPLE
