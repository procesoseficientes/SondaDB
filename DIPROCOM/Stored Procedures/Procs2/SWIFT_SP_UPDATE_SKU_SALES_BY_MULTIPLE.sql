...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_UPDATE_SKU_SALES_BY_MULTIPLE]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_SKU_SALES_BY_MULTIPLE](
...
BEGIN
	BEGIN TRY
		UPDATE [DIPROCOM].[SWIFT_TRADE_AGREEMENT_SKU_SALES_BY_MULTIPLE]
		SET	
			[MULTIPLE] = @MULTIPLE
