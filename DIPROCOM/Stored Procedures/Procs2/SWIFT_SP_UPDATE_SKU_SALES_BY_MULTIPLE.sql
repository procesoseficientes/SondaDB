...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_UPDATE_SKU_SALES_BY_MULTIPLE]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_SKU_SALES_BY_MULTIPLE](
...
BEGIN
	BEGIN TRY
		UPDATE [acsa].[SWIFT_TRADE_AGREEMENT_SKU_SALES_BY_MULTIPLE]
		SET	
			[MULTIPLE] = @MULTIPLE
