...
-- Ejemplo de Ejecucion:
        ...
        EXECUTE @RC = [PACASA].SWIFT_SP_MARK_RECEPTION_AS_SEND_TO_ERP @RECEPTION_HEADER
                                                                ,@POSTED_RESPONSE
        GO
*/
CREATE PROCEDURE [PACASA].SWIFT_SP_MARK_RECEPTION_AS_SEND_TO_ERP @RECEPTION_HEADER INT,
