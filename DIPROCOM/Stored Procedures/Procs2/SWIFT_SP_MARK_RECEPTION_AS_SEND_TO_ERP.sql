...
-- Ejemplo de Ejecucion:
        ...
        EXECUTE @RC = [DIPROCOM].SWIFT_SP_MARK_RECEPTION_AS_SEND_TO_ERP @RECEPTION_HEADER
                                                                ,@POSTED_RESPONSE
        GO
*/
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_MARK_RECEPTION_AS_SEND_TO_ERP @RECEPTION_HEADER INT,
