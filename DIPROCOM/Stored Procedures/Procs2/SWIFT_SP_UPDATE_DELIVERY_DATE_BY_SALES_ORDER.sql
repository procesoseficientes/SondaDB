...
-- Ejemplo de Ejecucion:
        --
		SELECT * FROM [DIPROCOM].[SONDA_SALES_ORDER_HEADER] WHERE [DOC_SERIE] = 'D' AND [DOC_NUM] = 23
		--
		EXEC [DIPROCOM].[SWIFT_SP_UPDATE_DELIVERY_DATE_BY_SALES_ORDER]
			@DOC_SERIE = 'D'
			,@DOC_NUM = 23
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_DELIVERY_DATE_BY_SALES_ORDER]
