...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_VALIDATE_LIMITS_OF_BONUS_BY_GENERAL_AMOUNT]
				@PROMO_ID = 8,
				@LOW_AMOUNT = 1000.000000,
				@HIGH_AMOUNT = 2999.990000
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_VALIDATE_LIMITS_OF_BONUS_BY_GENERAL_AMOUNT] (@PROMO_ID INT
...
BEGIN
  ...
  SELECT TOP 1
    @MESSAGE =
              ...
              END
  FROM [acsa].[SWIFT_PROMO_BONUS_BY_GENERAL_AMOUNT] AS S
