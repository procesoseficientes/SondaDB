...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_UPDATE_TRADE_AGREEMENT_SKU_BY_BONUS_RULE]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_TRADE_AGREEMENT_SKU_BY_BONUS_RULE](
...
BEGIN
	BEGIN TRY
		UPDATE [acsa].[SWIFT_TRADE_AGREEMENT_SKU_BY_BONUS_RULE]
		SET	
			[QTY] = @QTY
