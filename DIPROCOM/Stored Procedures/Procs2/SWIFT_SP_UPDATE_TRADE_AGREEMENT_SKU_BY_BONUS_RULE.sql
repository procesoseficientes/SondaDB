...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_UPDATE_TRADE_AGREEMENT_SKU_BY_BONUS_RULE]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_TRADE_AGREEMENT_SKU_BY_BONUS_RULE](
...
BEGIN
	BEGIN TRY
		UPDATE [DIPROCOM].[SWIFT_TRADE_AGREEMENT_SKU_BY_BONUS_RULE]
		SET	
			[QTY] = @QTY
