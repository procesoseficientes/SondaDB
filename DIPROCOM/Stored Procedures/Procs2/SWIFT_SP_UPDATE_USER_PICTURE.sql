...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_UPDATE_USER_PICTURE]
					@LOGIN = 'rudi@DIPROCOM',
				...
				SELECT IMAGE FROM DIPROCOM.USERS WHERE LOGIN = 'RUDI@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_USER_PICTURE]
    (
     @LOGIN VARCHAR(50)
    ,@IMAGE VARCHAR(MAX)
    )
