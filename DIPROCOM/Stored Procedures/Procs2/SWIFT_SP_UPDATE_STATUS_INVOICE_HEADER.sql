...
/*
	EXECUTE  [PACASA].[SWIFT_SP_UPDATE_STATUS_INVOICE_HEADER] 
					   @INVOICE_ID = 195
...
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_STATUS_INVOICE_HEADER]
	@INVOICE_ID INT
...
BEGIN
	SET NOCOUNT ON;
	DECLARE @RESULT INT = [PACASA].[SONDA_FN_CAN_VOID_INVOICE](@CDF_SERIE, @CDF_RESOLUCION, @INVOICE_ID)
    IF @RESULT = 1
	BEGIN
		UPDATE [PACASA].[SONDA_POS_INVOICE_HEADER] SET
		[STATUS] = @STATUS,
		[VOIDED_INVOICE] = 1,
