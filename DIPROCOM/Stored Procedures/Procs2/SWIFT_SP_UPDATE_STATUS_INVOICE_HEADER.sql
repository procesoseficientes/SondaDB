...
/*
	EXECUTE  [DIPROCOM].[SWIFT_SP_UPDATE_STATUS_INVOICE_HEADER] 
					   @INVOICE_ID = 195
...
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_STATUS_INVOICE_HEADER]
	@INVOICE_ID INT
...
BEGIN
	SET NOCOUNT ON;
	DECLARE @RESULT INT = [DIPROCOM].[SONDA_FN_CAN_VOID_INVOICE](@CDF_SERIE, @CDF_RESOLUCION, @INVOICE_ID)
    IF @RESULT = 1
	BEGIN
		UPDATE [DIPROCOM].[SONDA_POS_INVOICE_HEADER] SET
		[STATUS] = @STATUS,
		[VOIDED_INVOICE] = 1,
