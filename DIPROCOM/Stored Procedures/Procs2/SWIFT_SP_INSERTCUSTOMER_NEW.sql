...
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_INSERTCUSTOMER_NEW]
...
IF @HHID IS NOT NULL
BEGIN
	EXEC @NEW_ID = DIPROCOM.SWIFT_GET_NEW_SEQVAL_CUSTOMER
END
...
INSERT INTO [DIPROCOM].[SWIFT_CUSTOMER_FREQUENCY_NEW]
	(
	CODE_CUSTOMER
	,LAST_UPDATED
	,LAST_UPDATED_BY
