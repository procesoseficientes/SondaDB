...
SET [ATTEMPTED_WITH_ERROR] = [ATTEMPTED_WITH_ERROR] + 1,
...
VALUES
(@SALES_ORDER_ID, 1, 0, GETDATE(), @POSTED_RESPONSE, NULL);
--
--	SELECT
--		1 AS [Resultado]
