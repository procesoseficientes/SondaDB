...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_SET_GEOCODING]
					@IS_FOR_SCOUTING = 1
					,@CODE_CUSTOMER = '172'
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_SET_GEOCODING](
	@IS_FOR_SCOUTING INT
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			EXEC [DIPROCOM].[SWIFT_SP_SET_GEOCODING_TO_CUSTOMER_NEW] 
		...
		BEGIN
			EXEC [DIPROCOM].[SWIFT_SP_SET_GEOCODING_TO_CUSTOMER_CHANGE] 
				@CODE_CUSTOMER = @CODE_CUSTOMER, -- varchar(50)
	...
	ELSE
	BEGIN
		EXEC [DIPROCOM].[SWIFT_SP_SET_GEOCODING_TO_CUSTOMER] 
			@CODE_CUSTOMER = @CODE_CUSTOMER, -- varchar(50)
			@DEPARTAMENT = @DEPARTAMENT, -- varchar(250)
			@MUNICIPALITY = @MUNICIPALITY, -- varchar(250)
			@COLONY = @COLONY -- varchar(250)
