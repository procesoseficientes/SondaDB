...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_SET_GEOCODING]
					@IS_FOR_SCOUTING = 1
					,@CODE_CUSTOMER = '172'
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_SET_GEOCODING](
	@IS_FOR_SCOUTING INT
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			EXEC [acsa].[SWIFT_SP_SET_GEOCODING_TO_CUSTOMER_NEW] 
		...
		BEGIN
			EXEC [acsa].[SWIFT_SP_SET_GEOCODING_TO_CUSTOMER_CHANGE] 
				@CODE_CUSTOMER = @CODE_CUSTOMER, -- varchar(50)
