...
-- Ejemplo de Ejecucion:
				EXEC [SONDA].[UPDATE_SALES_ORDER]
				@WAREHOUSE = 'R006'
				,@POSTED_BY = 'TEC0003@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [SONDA].[UPDATE_SALES_ORDER](
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			FROM [SONDA].[SONDA_SALES_ORDER_HEADER] AS SOH
			INNER JOIN [SONDA].[SONDA_SALES_ORDER_DETAIL] AS SOD
