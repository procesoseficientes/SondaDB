...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[UPDATE_SALES_ORDER]
				@WAREHOUSE = 'R006'
				,@POSTED_BY = 'TEC0003@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [PACASA].[UPDATE_SALES_ORDER](
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			FROM [PACASA].[SONDA_SALES_ORDER_HEADER] AS SOH
			INNER JOIN [PACASA].[SONDA_SALES_ORDER_DETAIL] AS SOD
