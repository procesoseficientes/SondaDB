...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[UPDATE_SALES_ORDER]
				@WAREHOUSE = 'R006'
				,@POSTED_BY = 'TEC0003@DIPROCOM'
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[UPDATE_SALES_ORDER](
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			FROM DIPROCOM.[SONDA_SALES_ORDER_HEADER] AS SOH
			INNER JOIN [DIPROCOM].[SONDA_SALES_ORDER_DETAIL] AS SOD
