...
-- Ejemplo de Ejecucion:
				...
				--
				EXEC [PACASA].[SWIFT_SP_UPDATE_DISCOUNT_BY_GENERAL_AMOUNT]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_DISCOUNT_BY_GENERAL_AMOUNT](
...
BEGIN
	BEGIN TRY
		--
		UPDATE [PACASA].[SWIFT_TRADE_AGREEMENT_DISCOUNT_BY_GENERAL_AMOUNT]
		SET	
			DISCOUNT = @DISCOUNT
		WHERE 
