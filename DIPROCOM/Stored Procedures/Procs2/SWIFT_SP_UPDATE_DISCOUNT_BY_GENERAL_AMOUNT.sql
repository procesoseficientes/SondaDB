...
-- Ejemplo de Ejecucion:
				...
				--
				EXEC [DIPROCOM].[SWIFT_SP_UPDATE_DISCOUNT_BY_GENERAL_AMOUNT]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_DISCOUNT_BY_GENERAL_AMOUNT](
...
BEGIN
	BEGIN TRY
		--
		UPDATE [DIPROCOM].[SWIFT_TRADE_AGREEMENT_DISCOUNT_BY_GENERAL_AMOUNT]
		SET	
			DISCOUNT = @DISCOUNT
		WHERE 
