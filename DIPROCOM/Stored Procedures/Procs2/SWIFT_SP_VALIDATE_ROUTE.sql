...
-- Ejemplo de Ejecucion:				
				...
				exec [acsa].[SWIFT_SP_VALIDATE_ROUTE] @CODE_ROUTE = 'JOSE@DIPROCOM'
				exec [acsa].[SWIFT_SP_VALIDATE_ROUTE] @CODE_ROUTE = 'JOEL@DIPROCOM'
				exec [acsa].[SWIFT_SP_VALIDATE_ROUTE] @CODE_ROUTE = 'ALBERTO@DIPROCOM'
				exec [acsa].[SWIFT_SP_VALIDATE_ROUTE] @CODE_ROUTE = 'RUDI@DIPROCOM'				
