...
-- Ejemplo de Ejecucion:
			EXEC  [PACASA].[SWIFT_SP_UPDATE_BONUS_BY_GENERAL_AMOUNT_OF_PROMO] @PROMO_BONUS_BY_GENERAL_AMOUNT_ID = 2, 
                                                            @PROMO_ID = 1103,                                                            
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_BONUS_BY_GENERAL_AMOUNT_OF_PROMO] (@PROMO_BONUS_BY_GENERAL_AMOUNT_ID INT, @PROMO_ID INT, @CODE_SKU_BONUS VARCHAR(50), @PACK_UNIT_BONUS INT, @BONUS_QTY INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  BEGIN TRY
    ...
    UPDATE [PACASA].[SWIFT_PROMO_BONUS_BY_GENERAL_AMOUNT]
