CREATE PROC [PACASA].[SWIFT_SP_INSERTCUSTOMER]
...
BEGIN
 ...
 --         @pID numeric(18, 0)
	--EXEC @return_value = [PACASA].[SWIFT_SP_GET_NEXT_SEQUENCE] @SEQUENCE_NAME = N'CUSTOMER',
 --                                                             @pRESULT = @ResultCode OUTPUT

	EXEC @CODE_CUSTOMER = [PACASA].SWIFT_GET_NEW_SEQVAL_CUSTOMER
END

INSERT INTO [PACASA].[SWIFT_CUSTOMERS]
           ([CODE_CUSTOMER]
           ,[NAME_CUSTOMER]
