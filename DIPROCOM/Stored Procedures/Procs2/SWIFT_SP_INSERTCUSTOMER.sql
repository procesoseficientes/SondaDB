CREATE PROC [DIPROCOM].[SWIFT_SP_INSERTCUSTOMER]
...
BEGIN
 ...
 --         @pID numeric(18, 0)
	--EXEC @return_value = [DIPROCOM].[SWIFT_SP_GET_NEXT_SEQUENCE] @SEQUENCE_NAME = N'CUSTOMER',
 --                                                             @pRESULT = @ResultCode OUTPUT

	EXEC @CODE_CUSTOMER = DIPROCOM.SWIFT_GET_NEW_SEQVAL_CUSTOMER
END

INSERT INTO [DIPROCOM].[SWIFT_CUSTOMERS]
           ([CODE_CUSTOMER]
           ,[NAME_CUSTOMER]
