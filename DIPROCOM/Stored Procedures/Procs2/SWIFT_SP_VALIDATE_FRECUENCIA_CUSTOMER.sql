...
-- Ejemplo de Ejecucion:
          EXEC [DIPROCOM].SWIFT_SP_VALIDATE_FRECUENCIA_CUSTOMER
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_VALIDATE_FRECUENCIA_CUSTOMER]
...
BEGIN TRY
  ...
  -- ------------------------------------------------------------
	...
	-- ------------------------------------------------------------	
  IF 1 = (SELECT 1
          FROM [DIPROCOM].SWIFT_CUSTOMER_FREQUENCY F
