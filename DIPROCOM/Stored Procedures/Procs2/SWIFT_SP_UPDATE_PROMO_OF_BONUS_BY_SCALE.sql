...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_SCALE]
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_SCALE] (@PROMO_BONUS_BY_SCALE_ID INT
, @BONUS_QTY INT)
AS
BEGIN
  SET NOCOUNT ON;
  ...
  BEGIN TRY
    ...
    UPDATE [PACASA].[SWIFT_PROMO_BONUS_BY_SCALE]
