...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_SCALE]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_SCALE] (@PROMO_BONUS_BY_SCALE_ID INT
, @BONUS_QTY INT)
AS
BEGIN
  SET NOCOUNT ON;
  ...
  BEGIN TRY
    ...
    UPDATE [acsa].[SWIFT_PROMO_BONUS_BY_SCALE]
