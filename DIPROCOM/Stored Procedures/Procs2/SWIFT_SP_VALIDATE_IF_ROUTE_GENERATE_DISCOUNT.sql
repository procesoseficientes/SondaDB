...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_VALIDATE_IF_ROUTE_GENERATE_DISCOUNT] (@CODE_ROUTE VARCHAR(50), @GENERATE_DISCOUNT INT OUTPUT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  FROM [acsa].[SWIFT_PROMO_DISCOUNT_BY_GENERAL_AMOUNT] [DBGA]
  ...
  FROM [acsa].[SWIFT_PROMO_DISCOUNT_BY_SCALE] [DBS]
  ...
  FROM [acsa].[SWIFT_PROMO_DISCOUNT_BY_FAMILY] [DBF]
  ...
  FROM [acsa].[SWIFT_PROMO_DISCOUNT_BY_PAYMENT_TYPE_AND_FAMILY] [DTF]
