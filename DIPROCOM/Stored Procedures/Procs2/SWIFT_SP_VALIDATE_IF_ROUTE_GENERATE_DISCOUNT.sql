...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_VALIDATE_IF_ROUTE_GENERATE_DISCOUNT] (@CODE_ROUTE VARCHAR(50), @GENERATE_DISCOUNT INT OUTPUT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  FROM [PACASA].[SWIFT_PROMO_DISCOUNT_BY_GENERAL_AMOUNT] [DBGA]
  ...
  FROM [PACASA].[SWIFT_PROMO_DISCOUNT_BY_SCALE] [DBS]
  ...
  FROM [PACASA].[SWIFT_PROMO_DISCOUNT_BY_FAMILY] [DBF]
  ...
  FROM [PACASA].[SWIFT_PROMO_DISCOUNT_BY_PAYMENT_TYPE_AND_FAMILY] [DTF]
