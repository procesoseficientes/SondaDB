...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_VALIDATE_IF_ROUTE_GENERATE_SKU_SALES_BY_MULTIPLE] (@CODE_ROUTE VARCHAR(50), @GENERATE_SKU_SALES_BY_MULTIPLE INT OUTPUT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  FROM [DIPROCOM].[SWIFT_PROMO_SKU_SALES_BY_MULTIPLE] [PSSM]
