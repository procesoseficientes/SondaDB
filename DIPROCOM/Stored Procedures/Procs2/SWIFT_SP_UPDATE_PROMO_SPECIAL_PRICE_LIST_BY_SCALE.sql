...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_UPDATE_PROMO_SPECIAL_PRICE]
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_PROMO_SPECIAL_PRICE_LIST_BY_SCALE] (@SPECIAL_PRICE_LIST_BY_SCALE_ID INT
, @PRICE NUMERIC(18, 6)
...
BEGIN
  BEGIN TRY
    --
    UPDATE [DIPROCOM].[SWIFT_PROMO_SPECIAL_PRICE_LIST_BY_SCALE]
    SET [PRICE] = @PRICE
