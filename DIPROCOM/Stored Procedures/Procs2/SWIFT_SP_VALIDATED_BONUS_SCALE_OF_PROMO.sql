...
Ejemplo de Ejecucion:
	...
	EXEC [PACASA].SWIFT_SP_VALIDATED_BONUS_SCALE_OF_PROMO
		@PROMO_ID = 21
		,@CODE_SKU = '100005'
		,@PACK_UNIT = 7
		,@LOW_LIMIT = 1
...
=======================================================*/
CREATE PROCEDURE [PACASA].[SWIFT_SP_VALIDATED_BONUS_SCALE_OF_PROMO] (@PROMO_ID INT
, @CODE_SKU VARCHAR(50)
, @PACK_UNIT INT
...
BEGIN
  ...
  SELECT TOP 1
    @MESSAGE =
              ...
              END
  FROM [PACASA].[SWIFT_PROMO_BONUS_BY_SCALE] AS S
