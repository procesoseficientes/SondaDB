...
-- Ejemplo de Ejecucion:
				EXEC [DIPROCOM].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_MULTIPLE]
					...
					@BONUS_QTY = 2 -- int
				-- 
				SELECT * FROM [DIPROCOM].[SWIFT_PROMO_BONUS_BY_MULTIPLE] 
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_MULTIPLE] (@PROMO_BONUS_BY_MULTIPLE_ID INT
, @PROMO_ID INT
, @CODE_SKU VARCHAR(50)
, @PACK_UNIT INT
, @MULTIPLE INT
...
BEGIN
  ...
  --
  BEGIN TRY
    UPDATE [DIPROCOM].[SWIFT_PROMO_BONUS_BY_MULTIPLE]
