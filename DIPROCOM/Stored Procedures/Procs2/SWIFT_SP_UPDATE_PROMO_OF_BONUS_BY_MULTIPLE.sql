...
-- Ejemplo de Ejecucion:
				EXEC [acsa].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_MULTIPLE]
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_MULTIPLE] (@PROMO_BONUS_BY_MULTIPLE_ID INT
, @PROMO_ID INT
, @CODE_SKU VARCHAR(50)
, @PACK_UNIT INT
, @MULTIPLE INT
...
BEGIN
  ...
  --
  BEGIN TRY
    UPDATE [acsa].[SWIFT_PROMO_BONUS_BY_MULTIPLE]
