...
-- Ejemplo de Ejecucion:
				EXEC [PACASA].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_MULTIPLE]
					...
					@BONUS_QTY = 2 -- int
				-- 
				SELECT * FROM [PACASA].[SWIFT_PROMO_BONUS_BY_MULTIPLE] 
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_PROMO_OF_BONUS_BY_MULTIPLE] (@PROMO_BONUS_BY_MULTIPLE_ID INT
, @PROMO_ID INT
, @CODE_SKU VARCHAR(50)
, @PACK_UNIT INT
, @MULTIPLE INT
...
BEGIN
  ...
  --
  BEGIN TRY
    UPDATE [PACASA].[SWIFT_PROMO_BONUS_BY_MULTIPLE]
