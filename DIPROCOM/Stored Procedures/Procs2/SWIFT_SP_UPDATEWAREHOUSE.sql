...
*/
-- =============================================
CREATE PROC [PACASA].[SWIFT_SP_UPDATEWAREHOUSE]
  @WAREHOUSE int,
...
SET @CODE = (SELECT [CODE_WAREHOUSE] FROM [PACASA].[SWIFT_WAREHOUSES] WHERE @WAREHOUSE = [WAREHOUSE])

EXEC [PACASA].[SWIFT_SP_SET_WAREHOUSE_TO_DISTRIBUTION_CENTER] 
