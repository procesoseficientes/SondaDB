...
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UNASSING_ALL_QUIZ_BY_CHANNEL] (@QUIZ_ID INT)
AS
BEGIN TRY

  DELETE 
    FROM DIPROCOM.SWIFT_ASIGNED_QUIZ WHERE QUIZ_ID = @QUIZ_ID AND ROUTE_CODE IS NULL 
