...
-- Ejemplo de Ejecucion:
        EXEC [PACASA].[SWIFT_SP_VALIDATE_SALES_ORDER_READY_TO_SEND] 
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_VALIDATE_SALES_ORDER_READY_TO_SEND]
AS
BEGIN
	SET NOCOUNT ON;
	--
	...
	FROM [PACASA].[SONDA_SALES_ORDER_HEADER] (NOLOCK) [SO]
	...
	BEGIN
		...
		-- ------------------------------------------------------------------------------------
		SELECT
			@DEFAULT_PROFILE_NAME = [PACASA].[SWIFT_FN_GET_PARAMETER]('VALIDATION_MAIL' , 'DEFAULT_PROFILE_NAME')
			,@DEFAULT_RECIPIENTS = [PACASA].[SWIFT_FN_GET_PARAMETER]('VALIDATION_MAIL' , 'DEFAULT_RECIPIENTS')
			,@DEFAULT_RECIPIENTS_CC = [PACASA].[SWIFT_FN_GET_PARAMETER]('VALIDATION_MAIL' , 'DEFAULT_RECIPIENTS_CC')
			,@DEFAULT_RECIPIENTS_CCO = [PACASA].[SWIFT_FN_GET_PARAMETER]('VALIDATION_MAIL' , 'DEFAULT_RECIPIENTS_CCO')
			,@BODY = ''
