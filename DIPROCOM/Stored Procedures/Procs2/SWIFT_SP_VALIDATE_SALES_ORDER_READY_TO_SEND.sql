...
-- Ejemplo de Ejecucion:
        EXEC [DIPROCOM].[SWIFT_SP_VALIDATE_SALES_ORDER_READY_TO_SEND] 
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_VALIDATE_SALES_ORDER_READY_TO_SEND]
AS
BEGIN
	SET NOCOUNT ON;
	--
	...
	FROM [DIPROCOM].[SONDA_SALES_ORDER_HEADER] (NOLOCK) [SO]
	...
	BEGIN
		...
		-- ------------------------------------------------------------------------------------
		SELECT
			@DEFAULT_PROFILE_NAME = [DIPROCOM].[SWIFT_FN_GET_PARAMETER]('VALIDATION_MAIL' , 'DEFAULT_PROFILE_NAME')
			,@DEFAULT_RECIPIENTS = [DIPROCOM].[SWIFT_FN_GET_PARAMETER]('VALIDATION_MAIL' , 'DEFAULT_RECIPIENTS')
			,@DEFAULT_RECIPIENTS_CC = [DIPROCOM].[SWIFT_FN_GET_PARAMETER]('VALIDATION_MAIL' , 'DEFAULT_RECIPIENTS_CC')
			,@DEFAULT_RECIPIENTS_CCO = [DIPROCOM].[SWIFT_FN_GET_PARAMETER]('VALIDATION_MAIL' , 'DEFAULT_RECIPIENTS_CCO')
			,@BODY = ''
