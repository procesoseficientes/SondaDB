...
-- Ejemplo de Ejecucion:
        EXEC [acsa].[SWIFT_SP_VALIDATE_SALES_ORDER_READY_TO_SEND] 
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_VALIDATE_SALES_ORDER_READY_TO_SEND]
AS
BEGIN
	SET NOCOUNT ON;
	--
	...
	FROM [acsa].[SONDA_SALES_ORDER_HEADER] (NOLOCK) [SO]
	...
	BEGIN
		...
		-- ------------------------------------------------------------------------------------
		SELECT
			@DEFAULT_PROFILE_NAME = [acsa].[SWIFT_FN_GET_PARAMETER]('VALIDATION_MAIL' , 'DEFAULT_PROFILE_NAME')
			,@DEFAULT_RECIPIENTS = [acsa].[SWIFT_FN_GET_PARAMETER]('VALIDATION_MAIL' , 'DEFAULT_RECIPIENTS')
			,@DEFAULT_RECIPIENTS_CC = [acsa].[SWIFT_FN_GET_PARAMETER]('VALIDATION_MAIL' , 'DEFAULT_RECIPIENTS_CC')
			,@DEFAULT_RECIPIENTS_CCO = [acsa].[SWIFT_FN_GET_PARAMETER]('VALIDATION_MAIL' , 'DEFAULT_RECIPIENTS_CCO')
			,@BODY = ''
