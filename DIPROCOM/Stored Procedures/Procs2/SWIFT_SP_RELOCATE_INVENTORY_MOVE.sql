/****** Object:  StoredProcedure [PACASA].[SWIFT_SP_RELOCATE_INVENTORY_MOV]    Script Date: 20/12/2015 9:09:38 AM ******/
-- =============================================
-- Autor:				JOSE ROBERTO
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_RELOCATE_INVENTORY_MOVE]
