...
Ejemplo de ejecucion:
  ...
  EXEC [PACASA].SWIFT_SP_UPDATE_SCOUTING
  --Customer
          @CODE_CUSTOMER = 'C001'
  ...
  --Frequency
	...
	----
    SELECT * FROM [PACASA].[SWIFT_CUSTOMER_FREQUENCY_NEW]
    WHERE CODE_CUSTOMER = 'C001'
    ORDER BY CODE_FREQUENCY DESC
*/

-- ============================================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_UPDATE_INFO_SCOUTING]
( -- ----------------------------------------------------------------------------------
...
BEGIN
	--
	  ...
	  -- ----------------------------------------------------------------------------------
      UPDATE [PACASA].[SWIFT_CUSTOMER_FREQUENCY_NEW]
	  SET [SUNDAY] = @SUNDAY
        	,[MONDAY] = @MONDAY
        	,[TUESDAY] = @TUESDAY
        	,[WEDNESDAY] = @WEDNESDAY
