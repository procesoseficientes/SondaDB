...
Ejemplo de ejecucion:
  ...
  EXEC [DIPROCOM].SWIFT_SP_UPDATE_SCOUTING
  --Customer
          @CODE_CUSTOMER = 'C001'
  ...
  --Frequency
	...
	----
	SELECT * FROM [DIPROCOM].[SWIFT_CUSTOMERS_NEW]
    WHERE CODE_CUSTOMER = 'C001'
    ORDER BY CUSTOMER DESC
	----
    SELECT * FROM [DIPROCOM].[SWIFT_CUSTOMER_FREQUENCY_NEW]
    WHERE CODE_CUSTOMER = 'C001'
    ORDER BY CODE_FREQUENCY DESC
*/

-- ============================================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_UPDATE_INFO_SCOUTING]
( -- ----------------------------------------------------------------------------------
...
BEGIN
	--
	  ...
	  -- ----------------------------------------------------------------------------------
      UPDATE [DIPROCOM].[SWIFT_CUSTOMER_FREQUENCY_NEW]
	  SET [SUNDAY] = @SUNDAY
        	,[MONDAY] = @MONDAY
        	,[TUESDAY] = @TUESDAY
        	,[WEDNESDAY] = @WEDNESDAY
