...
EXECUTE @RC = [DIPROCOM].SWIFT_SP_MARK_PICKING_AS_SEND_TO_ERP @PICKING_HEADER
                                                        ,@POSTED_RESPONSE
                                                        ,@ERP_REFERENCE
GO
*/
CREATE PROCEDURE [DIPROCOM].SWIFT_SP_MARK_PICKING_AS_SEND_TO_ERP @PICKING_HEADER INT,
