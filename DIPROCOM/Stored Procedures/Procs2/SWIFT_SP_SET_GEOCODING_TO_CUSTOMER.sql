...
-- Ejemplo de Ejecucion:
				--
				SELECT * FROM [PACASA].[SWIFT_ERP_CUSTOMERS] WHERE CODE_CUSTOMER = '172'
				--
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_SET_GEOCODING_TO_CUSTOMER] (
...
BEGIN
	SET NOCOUNT ON;
	--
	UPDATE [PACASA].[SWIFT_ERP_CUSTOMERS]
