...
-- Ejemplo de Ejecucion:
				--
				SELECT * FROM [DIPROCOM].[SWIFT_ERP_CUSTOMERS] WHERE CODE_CUSTOMER = '172'
				--
...
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_SET_GEOCODING_TO_CUSTOMER] (
...
BEGIN
	SET NOCOUNT ON;
	--
	UPDATE [DIPROCOM].[SWIFT_ERP_CUSTOMERS]
