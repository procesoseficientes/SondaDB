...
-- Ejemplo de Ejecucion:
				SELECT * FROM [acsa].[SONDA_LIQUIDATION] WHERE [LIQUIDATION_ID] = 6
				--
				EXEC [acsa].[SWIFT_SP_SET_LIQUIDATION_STATUS]
					@LIQUIDATION_ID = 6
...
*/
-- =============================================
CREATE PROCEDURE [acsa].[SWIFT_SP_SET_LIQUIDATION_STATUS](
	@LIQUIDATION_ID INT
