...
-- Ejemplo de Ejecucion:
				SELECT * FROM [PACASA].[SONDA_LIQUIDATION] WHERE [LIQUIDATION_ID] = 6
				--
				EXEC [PACASA].[SWIFT_SP_SET_LIQUIDATION_STATUS]
					@LIQUIDATION_ID = 6
...
*/
-- =============================================
CREATE PROCEDURE [PACASA].[SWIFT_SP_SET_LIQUIDATION_STATUS](
	@LIQUIDATION_ID INT
...
BEGIN
	...
	--
	BEGIN TRY
		UPDATE [PACASA].[SONDA_LIQUIDATION]
		SET
