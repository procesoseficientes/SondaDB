/****** Object:  StoredProcedure [DIPROCOM].[SWIFT_SP_VALIDATE_DOCUMENT_SALE]    Script Date: 20/12/2015 9:09:38 AM ******/
-- =============================================
-- Autor:				JOSE ROBERTO
...
-- Ejemplo de Ejecucion:				
				--
	   exec DIPROCOM.[SWIFT_SP_VALIDATE_DOCUMENT_SALE] @user='a1b2c3'
				--				
*/
-- =============================================
CREATE PROCEDURE [DIPROCOM].[SWIFT_SP_VALIDATE_DOCUMENT_SALE]
	@USER VARCHAR(50),
...
Select   T.CODE_ROUTE,U.DEFAULT_WAREHOUSE, T.TYPE_TASK,  R.AUTH_DOC_TYPE, concat ( R.AUTH_SERIE, ' ', R.AUTH_DOC_FROM ,'-', R.AUTH_DOC_TO ) Resolucion
	from [DIPROCOM].[SWIFT_FREQUENCY] T,[DIPROCOM].[SONDA_POS_RES_SAT] R,[SWIFT_USER] U
