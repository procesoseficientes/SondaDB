...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [DIPROCOM].[ERP_SP_GENERATE_DISCOUNT_LIST]
*/
-- =============================================
create PROCEDURE [DIPROCOM].[ERP_SP_GENERATE_DISCOUNT_LIST]
AS
BEGIN
	SET NOCOUNT ON;
	--
	...
	SELECT
		...
		,[ORDER]
	INTO #PROC
	FROM MDA.SWIFT_DISCOUNT_PRIORITY DP
