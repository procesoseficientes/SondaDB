...
-- Ejemplo de Ejecucion:
        SELECT [DIPROCOM].[SONDA_FN_CAN_VOID_SALE_ORDER]('C',505)
		--
		SELECT [DIPROCOM].[SONDA_FN_CAN_VOID_SALE_ORDER]('B',17)
		--
		SELECT [DIPROCOM].[SONDA_FN_CAN_VOID_SALE_ORDER]('SGERENT',60)
*/
-- =============================================
CREATE FUNCTION [DIPROCOM].SONDA_FN_CAN_VOID_SALE_ORDER
(
