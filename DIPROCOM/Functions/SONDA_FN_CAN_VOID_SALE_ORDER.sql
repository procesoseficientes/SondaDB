...
-- Ejemplo de Ejecucion:
        SELECT [PACASA].[SONDA_FN_CAN_VOID_SALE_ORDER]('C',505)
		--
		SELECT [PACASA].[SONDA_FN_CAN_VOID_SALE_ORDER]('B',17)
		--
		SELECT [PACASA].[SONDA_FN_CAN_VOID_SALE_ORDER]('SGERENT',60)
*/
-- =============================================
CREATE FUNCTION [PACASA].SONDA_FN_CAN_VOID_SALE_ORDER
(
