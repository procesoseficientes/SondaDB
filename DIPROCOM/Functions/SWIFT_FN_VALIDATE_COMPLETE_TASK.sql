...
-- Ejemplo de Ejecucion:
				SELECT [acsa].[SWIFT_FN_VALIDATE_COMPLETE_TASK](5219)
*/
-- =============================================


CREATE FUNCTION [acsa].[SWIFT_FN_VALIDATE_COMPLETE_TASK]
(
	@TASK_ID INT 
)
RETURNS INT
...
BEGIN
	...
	SELECT @RESULT = COUNT(*) FROM [acsa].[SWIFT_BATCH] B WHERE B.TASK_ID = @TASK_ID
	--
	IF @RESULT > 0
	BEGIN
		SELECT @RESULT = COUNT(*)
