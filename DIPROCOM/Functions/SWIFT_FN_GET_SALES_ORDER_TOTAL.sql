...
-- Ejemplo de Ejecucion:
        SELECT [PACASA].[SWIFT_FN_GET_SALES_ORDER_TOTAL](51167)
*/
-- =============================================
CREATE FUNCTION [PACASA].[SWIFT_FN_GET_SALES_ORDER_TOTAL] (@SALES_ORDER_ID INT)
...
BEGIN
    ...
    FROM
        [PACASA].[SONDA_SALES_ORDER_HEADER]
    WHERE
    ...
    FROM
        [PACASA].[SONDA_SALES_ORDER_DETAIL]
    WHERE
        [SALES_ORDER_ID] = @SALES_ORDER_ID;
