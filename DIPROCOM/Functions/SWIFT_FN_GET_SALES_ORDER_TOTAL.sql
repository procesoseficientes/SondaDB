...
-- Ejemplo de Ejecucion:
        SELECT [acsa].[SWIFT_FN_GET_SALES_ORDER_TOTAL](51167)
*/
-- =============================================
CREATE FUNCTION [acsa].[SWIFT_FN_GET_SALES_ORDER_TOTAL] (@SALES_ORDER_ID INT)
