...
-- Ejemplo de Ejecucion:
        SELECT [DIPROCOM].[SWIFT_FN_GET_SALES_ORDER_TOTAL](51167)
*/
-- =============================================
CREATE FUNCTION [DIPROCOM].[SWIFT_FN_GET_SALES_ORDER_TOTAL] (@SALES_ORDER_ID INT)
...
BEGIN
    ...
    FROM
        [DIPROCOM].[SONDA_SALES_ORDER_HEADER]
    WHERE
    ...
    FROM
        [DIPROCOM].[SONDA_SALES_ORDER_DETAIL]
    WHERE
        [SALES_ORDER_ID] = @SALES_ORDER_ID;
