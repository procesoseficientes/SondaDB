...
-- Ejemplo de Ejecucion:
	SELECT [PACASA].[SWIFT_FN_GET_KPI] (5.5,'RUDI@DIPROCOM','SALES_DISTANCE','SALE') AS VALUE
*/
-- =============================================
CREATE FUNCTION [PACASA].[SWIFT_FN_GET_KPI]
(
...
BEGIN
	...
	SELECT
		@VALUE = NAME
	FROM [PACASA].SWIFT_KPI kpi
		LEFT JOIN [PACASA].SWIFT_KPI_X_ROUTE kxr on kpi.KPI = kxr.KPI
