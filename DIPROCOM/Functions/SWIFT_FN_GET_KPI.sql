...
-- Ejemplo de Ejecucion:
	SELECT [acsa].[SWIFT_FN_GET_KPI] (5.5,'RUDI@DIPROCOM','SALES_DISTANCE','SALE') AS VALUE
*/
-- =============================================
CREATE FUNCTION [acsa].[SWIFT_FN_GET_KPI]
(
...
BEGIN
	...
	SELECT
		@VALUE = NAME
	FROM [acsa].SWIFT_KPI kpi
		LEFT JOIN [acsa].SWIFT_KPI_X_ROUTE kxr on kpi.KPI = kxr.KPI
