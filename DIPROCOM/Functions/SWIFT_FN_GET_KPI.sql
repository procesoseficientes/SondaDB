...
-- Ejemplo de Ejecucion:
	SELECT [DIPROCOM].[SWIFT_FN_GET_KPI] (5.5,'RUDI@DIPROCOM','SALES_DISTANCE','SALE') AS VALUE
*/
-- =============================================
CREATE FUNCTION [DIPROCOM].[SWIFT_FN_GET_KPI]
(
...
BEGIN
	...
	SELECT
		@VALUE = NAME
	FROM [DIPROCOM].SWIFT_KPI kpi
		LEFT JOIN [DIPROCOM].SWIFT_KPI_X_ROUTE kxr on kpi.KPI = kxr.KPI
