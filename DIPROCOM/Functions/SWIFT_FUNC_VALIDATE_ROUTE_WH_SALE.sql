...
-- Ejemplo de Ejecucion:	
							SELECT [DIPROCOM].[SWIFT_FUNC_VALIDATE_ROUTE_WH_SALE]('001')
-- =============================================
*/
CREATE FUNCTION [DIPROCOM].[SWIFT_FUNC_VALIDATE_ROUTE_WH_SALE]
( 
...
BEGIN
	...
	FROM  [DIPROCOM].[SWIFT_ROUTES] RT
		...
		INNER JOIN [DIPROCOM].SWIFT_VIEW_WAREHOUSES VH ON (VU.DEFAULT_WAREHOUSE = VH.DESCRIPTION_WAREHOUSE)
