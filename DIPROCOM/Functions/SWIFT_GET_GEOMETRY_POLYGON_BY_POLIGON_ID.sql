...
/*
	SELECT [DIPROCOM].SWIFT_GET_GEOMETRY_POLYGON_BY_POLIGON_ID (9) AS VALUE
*/
-- =============================================
CREATE FUNCTION [DIPROCOM].[SWIFT_GET_GEOMETRY_POLYGON_BY_POLIGON_ID] (@POLYGON_ID INT)
RETURNS GEOMETRY
AS
	BEGIN
  ...
  -- ------------------------------------------------------------------------------------
		...
		SELECT
			...
			,[LONGITUDE]
		FROM
			[DIPROCOM].[SWIFT_POLYGON_POINT] [PP]
		WHERE
