...
-- Ejemplo de Ejecucion:
        SELECT [PACASA].[SWIFT_FN_GET_GOAL_WORK_DAYS]('2018-07-01 00:00:00.000', '2018-08-01 00:00:00.000', 1)
		--
        SELECT [PACASA].[SWIFT_FN_GET_GOAL_WORK_DAYS]('2018-07-01 00:00:00.000', '2018-08-01 00:00:00.000', 0)
*/
-- =============================================
CREATE FUNCTION [PACASA].[SWIFT_FN_GET_GOAL_WORK_DAYS]
    (
     @DATE_FROM DATETIME
    ,@DATE_TO DATETIME
