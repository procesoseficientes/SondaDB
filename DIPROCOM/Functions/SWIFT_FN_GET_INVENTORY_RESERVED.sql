...
/*Ejemplo de Ejecucion:				
				--
				SELECT * FROM [PACASA].[SWIFT_FN_GET_INVENTORY_RESERVED]()
				--				
*/
CREATE FUNCTION [PACASA].[SWIFT_FN_GET_INVENTORY_RESERVED]
(
...
(
	...
	FROM [PACASA].SWIFT_PICKING_DETAIL PD 
	LEFT OUTER JOIN [PACASA].SWIFT_PICKING_HEADER PH ON (PD.PICKING_HEADER = PH.PICKING_HEADER)
	WHERE 
		PH.STATUS <> 'CLOSED' 
