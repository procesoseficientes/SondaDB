...
/*Ejemplo de Ejecucion:				
				--
				SELECT * FROM [DIPROCOM].[SWIFT_FN_GET_INVENTORY_RESERVED]()
				--				
*/
CREATE FUNCTION [DIPROCOM].[SWIFT_FN_GET_INVENTORY_RESERVED]
(
...
(
	...
	FROM [DIPROCOM].SWIFT_PICKING_DETAIL PD 
	LEFT OUTER JOIN [DIPROCOM].SWIFT_PICKING_HEADER PH ON (PD.PICKING_HEADER = PH.PICKING_HEADER)
	WHERE 
		PH.STATUS <> 'CLOSED' 
