...
-- Ejemplo de Ejecucion:
				SELECT * FROM [DIPROCOM].[SWIFT_FN_GET_CUSTUMER_FOR_ROUTE]('001')
*/
-- =============================================
CREATE FUNCTION [DIPROCOM].[SWIFT_FN_GET_CUSTUMER_FOR_ROUTE]
(	
...
BEGIN
	...
	FROM [DIPROCOM].SWIFT_VIEW_ALL_COSTUMER  inner join [DIPROCOM].USERS ON 
	...
	FROM [DIPROCOM].SWIFT_VIEW_ALL_COSTUMER VAC
		INNER JOIN [DIPROCOM].[SONDA_ROUTE_PLAN] RP ON (VAC.CODE_CUSTOMER = RP.RELATED_CLIENT_CODE)
