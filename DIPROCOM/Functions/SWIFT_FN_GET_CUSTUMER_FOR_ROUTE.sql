...
-- Ejemplo de Ejecucion:
				SELECT * FROM [acsa].[SWIFT_FN_GET_CUSTUMER_FOR_ROUTE]('001')
*/
-- =============================================
CREATE FUNCTION [acsa].[SWIFT_FN_GET_CUSTUMER_FOR_ROUTE]
(	
...
BEGIN
	...
	FROM [acsa].SWIFT_VIEW_ALL_COSTUMER  inner join [acsa].USERS ON 
	...
	FROM [acsa].SWIFT_VIEW_ALL_COSTUMER VAC
		INNER JOIN [acsa].[SONDA_ROUTE_PLAN] RP ON (VAC.CODE_CUSTOMER = RP.RELATED_CLIENT_CODE)
