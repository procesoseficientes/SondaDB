...
CREATE  FUNCTION [PACASA].[S_INVENTORY_SERIAL_X_ROUTE]
(        
...
FROM 
 SWIFT_EXPRESS.[PACASA].SWIFT_INVENTORY i 
  INNER JOIN  SWIFT_EXPRESS.[PACASA].USERS u
  ON u.DEFAULT_WAREHOUSE = i.WAREHOUSE
  INNER JOIN SWIFT_EXPRESS.[PACASA].SWIFT_VIEW_ALL_SKU svas
