...
/*
	SELECT [acsa].SWIFT_FN_VALIDATE_POLYGON_HAS_CHILD (10) AS VALUE
*/
-- =============================================
CREATE FUNCTION [acsa].SWIFT_FN_VALIDATE_POLYGON_HAS_CHILD (@POLYGON_ID INT)
RETURNS INT
AS
BEGIN
  ...
  SELECT TOP 1
    @HAS_CHILD =
    1
  FROM [acsa].SWIFT_POLYGON sp
  LEFT JOIN [acsa].SWIFT_POLYGON sp1
