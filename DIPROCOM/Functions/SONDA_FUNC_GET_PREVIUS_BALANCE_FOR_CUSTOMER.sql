...
-- Ejemplo de Ejecucion:
        SELECT [DIPROCOM].[SONDA_FUNC_GET_PREVIUS_BALANCE_FOR_CUSTOMER] ('928') AS PREVIUES_BALANCE
*/
-- =============================================
CREATE FUNCTION [DIPROCOM].[SONDA_FUNC_GET_PREVIUS_BALANCE_FOR_CUSTOMER](
...
BEGIN
	...
	--
	 ...
	 SELECT		
		...
		FROM BD_Prueba_Viscosa.dbo.OINV IV
