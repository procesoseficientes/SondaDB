...
/*
	SELECT [PACASA].SWIFT_GET_CUSTOMERS_COUNT_BY_GEOMETRY_POLYGON ( [PACASA].SWIFT_GET_GEOMETRY_POLYGON_BY_POLIGON_ID (9) ) AS VALUE
*/
-- =============================================
CREATE FUNCTION [PACASA].SWIFT_GET_CUSTOMERS_COUNT_BY_GEOMETRY_POLYGON (@POLYGON GEOMETRY)
RETURNS INT
AS
BEGIN
