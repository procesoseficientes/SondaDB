...
/*
	SELECT [DIPROCOM].SWIFT_GET_CUSTOMERS_COUNT_BY_GEOMETRY_POLYGON ( [DIPROCOM].SWIFT_GET_GEOMETRY_POLYGON_BY_POLIGON_ID (9) ) AS VALUE
*/
-- =============================================
CREATE FUNCTION [DIPROCOM].SWIFT_GET_CUSTOMERS_COUNT_BY_GEOMETRY_POLYGON (@POLYGON GEOMETRY)
RETURNS INT
AS
BEGIN
