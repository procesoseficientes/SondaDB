...
-- Ejemplo de Ejecucion:
		--
		SELECT * FROM [PACASA].[SWIFT_PARAMETER] WHERE [GROUP_ID] = 'CALCULATION_RULES'
		--
        SELECT
			123.5555555
			,[PACASA].[SWIFT_FN_GET_DISPLAY_NUMBER](123.5555555)
*/
-- =============================================
CREATE FUNCTION [PACASA].[SWIFT_FN_GET_DISPLAY_NUMBER] (@IN_VALUE NUMERIC(18, 6))
RETURNS SQL_VARIANT
AS
BEGIN
	DECLARE
	...
	-- ------------------------------------------------
	SET @DEFAULT_DISPLAY_DECIMALS = [PACASA].[SWIFT_FN_GET_PARAMETER]('CALCULATION_RULES','DEFAULT_DISPLAY_DECIMALS'); 
	SET @DISPLAY_DECIMALS_ROUND_TYPE = [PACASA].[SWIFT_FN_GET_PARAMETER]('CALCULATION_RULES','DISPLAY_DECIMALS_ROUND_TYPE'); 
