...
-- Ejemplo de Ejecucion:
		--
		SELECT * FROM [DIPROCOM].[SWIFT_PARAMETER] WHERE [GROUP_ID] = 'CALCULATION_RULES'
		--
        SELECT
			123.5555555
			,[DIPROCOM].[SWIFT_FN_GET_DISPLAY_NUMBER](123.5555555)
*/
-- =============================================
CREATE FUNCTION [DIPROCOM].[SWIFT_FN_GET_DISPLAY_NUMBER] (@IN_VALUE NUMERIC(18, 6))
RETURNS SQL_VARIANT
AS
BEGIN
	DECLARE
	...
	-- ------------------------------------------------
	SET @DEFAULT_DISPLAY_DECIMALS = [DIPROCOM].[SWIFT_FN_GET_PARAMETER]('CALCULATION_RULES','DEFAULT_DISPLAY_DECIMALS'); 
	SET @DISPLAY_DECIMALS_ROUND_TYPE = [DIPROCOM].[SWIFT_FN_GET_PARAMETER]('CALCULATION_RULES','DISPLAY_DECIMALS_ROUND_TYPE'); 
