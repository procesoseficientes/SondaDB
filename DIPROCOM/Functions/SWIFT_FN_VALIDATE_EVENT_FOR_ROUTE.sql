...
-- Ejemplo de Ejecucion:
        SELECT [acsa].[SWIFT_FN_VALIDATE_EVENT_FOR_ROUTE]('NoValidarAntiguedadDeSaldos','RUDI@DIPROCOM')
*/
-- =============================================
CREATE FUNCTION [acsa].[SWIFT_FN_VALIDATE_EVENT_FOR_ROUTE]
( 
...
BEGIN
	...
	INNER JOIN [acsa].[SWIFT_RULE_X_EVENT] [RE] ON (
		[RE].[EVENT_ID] = [E].[EVENT_ID]
	)
	INNER JOIN [acsa].[SWIFT_RULE_X_ROUTE] [RR] ON (
