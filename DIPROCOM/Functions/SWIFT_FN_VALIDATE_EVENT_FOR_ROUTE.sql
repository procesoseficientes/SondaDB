...
-- Ejemplo de Ejecucion:
        SELECT [PACASA].[SWIFT_FN_VALIDATE_EVENT_FOR_ROUTE]('NoValidarAntiguedadDeSaldos','RUDI@DIPROCOM')
*/
-- =============================================
CREATE FUNCTION [PACASA].[SWIFT_FN_VALIDATE_EVENT_FOR_ROUTE]
( 
...
BEGIN
	...
	INNER JOIN [PACASA].[SWIFT_RULE_X_EVENT] [RE] ON (
		[RE].[EVENT_ID] = [E].[EVENT_ID]
	)
	INNER JOIN [PACASA].[SWIFT_RULE_X_ROUTE] [RR] ON (
