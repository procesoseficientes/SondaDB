...
-- Ejemplo de Ejecucion:
        SELECT [DIPROCOM].[SWIFT_FN_VALIDATE_EVENT_FOR_ROUTE]('NoValidarAntiguedadDeSaldos','RUDI@DIPROCOM')
*/
-- =============================================
CREATE FUNCTION [DIPROCOM].[SWIFT_FN_VALIDATE_EVENT_FOR_ROUTE]
( 
...
BEGIN
	...
	INNER JOIN [DIPROCOM].[SWIFT_RULE_X_EVENT] [RE] ON (
		[RE].[EVENT_ID] = [E].[EVENT_ID]
	)
	INNER JOIN [DIPROCOM].[SWIFT_RULE_X_ROUTE] [RR] ON (
